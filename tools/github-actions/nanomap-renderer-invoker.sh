...
tools/github-actions/nanomap-renderer minimap -w 2040 -h 2040 "./_maps/map_files/ShepardStation/ShepardStation.dmm"
...
mv "ShepardStation_nanomap_z1.png" "ShepardStation_nanomap_z1.png"
cd "../../"
...
cp "data/nanomaps/ShepardStation_nanomap_z1.png" "icons/_nanomaps"
