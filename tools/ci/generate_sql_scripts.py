...
scriptLines.append("mysqldump -d -u root -proot -p paradise_gamedb | sed 's/ AUTO_INCREMENT=[0-9]*\\b//' | sed 's/COLLATE=utf8mb4_0900_ai_ci/COLLATE=utf8mb4_unicode_ci/' > UPDATED_SCHEMA.sql\n")
...
scriptLines.append("mysqldump -d -u root -proot -p paradise_gamedb | sed 's/ AUTO_INCREMENT=[0-9]*\\b//' | sed 's/COLLATE=utf8mb4_0900_ai_ci/COLLATE=utf8mb4_unicode_ci/' > FRESH_SCHEMA.sql\n")
