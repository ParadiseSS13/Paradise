...
if grep -El '^\".+\" = \(.+\)' _maps/map_files/cyberiad/cyberiad.dmm _maps/map_files/cyberiad/z2.dmm _maps/map_files/Delta/delta.dmm;	then
    echo -e "${RED}ERROR: Non-TGM formatted map detected. Please convert it using Map Merger!${NC}"
	echo
    st=1
fi;
if grep -P 'Merge Conflict Marker' _maps/map_files/cyberiad/cyberiad.dmm _maps/map_files/cyberiad/z2.dmm _maps/map_files/Delta/delta.dmm; then
...
if grep -P '/obj/merge_conflict_marker' _maps/map_files/cyberiad/cyberiad.dmm _maps/map_files/cyberiad/z2.dmm _maps/map_files/Delta/delta.dmm; then
    echo -e "${RED}ERROR: Merge conflict markers detected in map, please resolve all merge failures!${NC}"
	echo
    st=1
fi;
# TODO: Uncomment in the future, when our maps are standardized
# if grep -P '^\ttag = \"icon' _maps/map_files/cyberiad/cyberiad.dmm _maps/map_files/cyberiad/z2.dmm _maps/map_files/Delta/delta.dmm;	then
#     echo -e "${RED}ERROR: Tag vars from icon state generation detected in maps, please remove them.${NC}"
# 	echo
#     st=1
# fi;
if grep -P 'step_[xy]' _maps/map_files/cyberiad/cyberiad.dmm _maps/map_files/cyberiad/z2.dmm _maps/map_files/Delta/delta.dmm;	then
    echo -e "${RED}ERROR: step_x/step_y variables detected in maps, please remove them.${NC}"
	echo
    st=1
fi;
if grep -P 'pixel_[^xy]' _maps/map_files/cyberiad/cyberiad.dmm _maps/map_files/cyberiad/z2.dmm _maps/map_files/Delta/delta.dmm;	then
    echo -e "${RED}ERROR: incorrect pixel offset variables detected in maps, please remove them.${NC}"
	echo
    st=1
fi;
if grep -Pzo '"\w+" = \(\n[^)]*?/obj/structure/cable,\n[^)]*?/obj/structure/cable,\n[^)]*?/area/.+?\)' _maps/map_files/cyberiad/cyberiad.dmm _maps/map_files/cyberiad/z2.dmm _maps/map_files/Delta/delta.dmm;	then
...
# TODO: Uncomment in the future, when our maps are standardized
# if grep -rzoP 'machinery/door.*{([^}]|\n)*name = .*("|\s)(?!of|and|to)[a-z].*\n' _maps/map_files/cyberiad/cyberiad.dmm _maps/map_files/cyberiad/z2.dmm _maps/map_files/Delta/delta.dmm;	then
...
if grep -P '^/area/.+[\{]' _maps/map_files/cyberiad/cyberiad.dmm _maps/map_files/cyberiad/z2.dmm _maps/map_files/Delta/delta.dmm;	then
    echo -e "${RED}ERROR: Variable editted /area path use detected in a map, please replace with a proper area path.${NC}"
	echo
    st=1
fi;
if grep -P '\W\/turf\s*[,\){]' _maps/map_files/cyberiad/cyberiad.dmm _maps/map_files/cyberiad/z2.dmm _maps/map_files/Delta/delta.dmm; then
...
if grep -ni 'nanotransen' _maps/map_files/cyberiad/cyberiad.dmm _maps/map_files/cyberiad/z2.dmm _maps/map_files/Delta/delta.dmm; then
...
if grep -i '/obj/effect/mapping_helpers/custom_icon' _maps/map_files/cyberiad/cyberiad.dmm _maps/map_files/cyberiad/z2.dmm _maps/map_files/Delta/delta.dmm; then
