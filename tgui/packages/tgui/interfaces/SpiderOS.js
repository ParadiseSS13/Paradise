        ...
        <Flex.Item direction="row">
          ...
          <Button
            ...
            <Tooltip
              ...
              \nОн способен просканировать любые другие наушники и скопировать доступные для прослушки и/или разговора каналы их ключей.\
          ...
          <NoticeBox className="NoticeBox_blue" success={0} danger={0} align="center">
            ...
            <Button
              ...
              <Tooltip
                ...
                \nА так же автоматически применяется при фиксировании применения пользователем исскуства ползучей вдовы.\
                \nПосле применения костюму нужно немного времени на перезарядку.\
            ...
            <Button
              ...
              <Tooltip
                ...
                \nПосле применения костюму нужно немного времени на перезарядку.\
                \nКлоны существуют примерно 20 секунд.\
          ...
          <NoticeBox success={0} danger={0} align="center">
            <Button
              ...
              <Tooltip
                ...
                \nГлавное не промахиваться при стрельбе. После выстрела костюму нужно немного времени на перезарядку.\
            ...
            <Button
              ...
              <Tooltip
                ...
                content={"После пяти секундной подготовки, вводит в вас большое количество лечебных препаратов.\
                \nМногие из них эксперемен- тальны и способны залечить даже сломанные кости и повреждения внутренних органов.\
                \nЦеной такого лечения является принудительный наркоз для защиты нервов пользователя.\
            ...
            <Button
              ...
              <Tooltip
                ...
                \nДля активации используются мозговые импульсы пользователя.\
                \nПоэтому опытные войны клана, могут использовать её даже во сне.\
