          ...
          <Section fill>
            <Grid>
              <Grid.Column>
                <ActionButtons />
                {pipelist
                  .filter((p) => p.pipe_type === 2 && p.pipe_id === whatdpipe)
                  .map((p) => (
          ...
          <Section fill>
            <Grid>
              <Grid.Column>
                <ActionButtons />
                {pipelist
                  .filter((p) => p.pipe_type === transit_pipe_type && p.pipe_id === whatttube)
                  .map((p) => (
                    <Stack.Item key={p.pipe_id}>
                      <Grid>
                        <Grid.Column>
          ...
          <Section fill>
            <Grid>
              <Grid.Column>
                <ActionButtons />
                {pipelist
                  .filter((p) => p.pipe_type === fluid_pipe_type && p.pipe_id === what_f_pipe)
                  .map((p) => (
                    <Stack.Item key={p.pipe_id}>
                      {p.orientations === 1 && (
                        <Grid>
