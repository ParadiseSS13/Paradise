  ...
  return (
    <Window>
      <Window.Content scrollable>
        {!!(isAdmin && isSlaved) && (
          <NoticeBox>
            This unit is slaved to {isSlaved}.
          </NoticeBox>
        )}
        {!!(isMalf || isAIMalf) && (
          <Box>
          ...
          <LabeledList.Item label="Statement Channel">
            {channels.map(c => (
              <Button
                ...
                onClick={
                  () => act('law_channel', { law_channel: c.channel })
                }
              />
            ))}
          </LabeledList.Item>
            ...
            <Table.Row>
              ...
              <Table.Cell>
                <Button
                  ...
                  onClick={
                    () => act('change_supplied_law_position')
                  }
                />
              </Table.Cell>
              <Table.Cell>
...
const LawsetsView = (props, context) => {
  ...
  return (
    <Box>
      {law_sets.map(l => (
        <Section key={l.name} title={l.name + " - " + l.header} buttons={
          <Button
            content="Load Laws"
            icon="download"
            onClick={
              () => act('transfer_laws', { transfer_laws: l.ref })
            }
          />
        }>
          <LabeledList>
              ...
              {!!isMalf && (
                <Fragment>
                  ...
                  <Button
                    ...
                    color="red"
                    onClick={
                      () => act('delete_law', { delete_law: l.ref })
                    }
                  />
                </Fragment>
              )}
