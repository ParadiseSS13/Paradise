...
describe('sanitizeText', () => {
  ...
  it('should sanitize advanced HTML input when advHtml flag is true', ({ expect }) => {
  ...
  it('should allow specific HTML tags when tags array is provided', ({ expect }) => {
  ...
  it('should allow advanced HTML tags when advTags array is provided and advHtml flag is true', ({ expect }) => {
    const input = '<b>Hello, world!</b><iframe src="https://example.com"></iframe>';
