...
const PLASMA_BURN_REQUIRED_OXYGEN_AVAILABILITY: f32 = 10.0;
...
// The reasons a tile can be interesting.
const REASON_DISPLAY: i32 = 1 << 0;
const REASON_HOT: i32 = 1 << 1;
const REASON_WIND: i32 = 1 << 2;
...
struct InterestingTile {
    ...
    // We don't send this to BYOND right now, but it might be useful later, and tracking it here
    // is cheap.
    #[allow(dead_code)]
    fuel_burnt: f32,
}
