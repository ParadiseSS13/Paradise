...
CREATE TABLE `player` (
  ...
  `viewrange` VARCHAR(5) NOT NULL DEFAULT '19x15' COLLATE 'utf8mb4_general_ci',
	`old_lighting` TINYINT(1) NULL DEFAULT NULL,
	`glowlevel` TINYINT(1) NULL DEFAULT NULL,
	`lampsexposure` TINYINT(1) NULL DEFAULT NULL,
	`lampsglare` TINYINT(1) NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
