...
ALTER TABLE `characters` CHANGE COLUMN `physique` `physique` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL;
ALTER TABLE `characters` CHANGE COLUMN `height` `height` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL;
