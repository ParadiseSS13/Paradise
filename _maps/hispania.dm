...
DECLARE_LEVEL(PLANET, SELFLOOPING, list(REACHABLE, STATION_CONTACT, BLOCK_TELEPORT, IMPEDES_MAGIC)),\
DECLARE_LEVEL(DERELICT, CROSSLINKED, list(REACHABLE, ORE_LEVEL, STATION_CONTACT)),\
