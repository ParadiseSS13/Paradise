...
/datum/game_test/room_test/attack_chain_machinery/Run()
	...
	var/obj/protolathe = teleport_to_first(player, /obj/machinery/rnd/protolathe)
	...
	var/obj/imprinter = teleport_to_first(player, /obj/machinery/rnd/circuit_imprinter)
