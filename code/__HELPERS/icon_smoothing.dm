...
/*
	...
	to add the 'SMOOTH_DIAGONAL' flag to the atom's smoothing_flags var (in addition to either SMOOTH_CORNERS or SMOOTH_MORE).
...
/turf/simulated/wall/corners_diagonal_smooth(adjacencies)
	. = ..()
	if(!.)
		return
