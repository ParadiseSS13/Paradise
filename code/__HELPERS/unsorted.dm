...
/obj/proc/atmosanalyzer_scan(datum/gas_mixture/air_contents, mob/user, obj/target = src)
	...
	user.show_message("<span class='notice'>Results of analysis of [bicon(icon)] [target].</span>", MSG_VISIBLE)
	if(total_moles>0)
		...
		user.show_message("<span class='notice'>Pressure: [round(pressure,0.1)] kPa</span>", MSG_VISIBLE)
		user.show_message("<span class='notice'>Nitrogen: [round(n2_concentration*100)] % ([round(air_contents.nitrogen,0.01)] moles)</span>", MSG_VISIBLE)
		user.show_message("<span class='notice'>Oxygen: [round(o2_concentration*100)] % ([round(air_contents.oxygen,0.01)] moles)</span>", MSG_VISIBLE)
		user.show_message("<span class='notice'>CO2: [round(co2_concentration*100)] % ([round(air_contents.carbon_dioxide,0.01)] moles)</span>", MSG_VISIBLE)
		user.show_message("<span class='notice'>Plasma: [round(plasma_concentration*100)] % ([round(air_contents.toxins,0.01)] moles)</span>", MSG_VISIBLE)
		if(unknown_concentration>0.01)
			user.show_message("<span class='danger'>Unknown: [round(unknown_concentration*100)] % ([round(unknown_concentration*total_moles,0.01)] moles)</span>", MSG_VISIBLE)
		user.show_message("<span class='notice'>Total: [round(total_moles,0.01)] moles</span>", MSG_VISIBLE)
		user.show_message("<span class='notice'>Temperature: [round(air_contents.temperature-T0C)] &deg;C</span>", MSG_VISIBLE)
	else
		user.show_message("<span class='notice'>[target] is empty!</span>", MSG_VISIBLE)
	return
