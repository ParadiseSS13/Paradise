...
/proc/admin_mob_info(mob/M, mob/user = usr)
	...
	to_chat(user, "(<a href='?src=[usr.UID()];priv_msg=[M.client.UID()]'>PM</a>) ([ADMIN_PP(M,"PP")]) ([ADMIN_VV(M,"VV")]) ([ADMIN_SM(M,"SM")]) ([ADMIN_FLW(M,"FLW")]) (<A HREF='?_src_=holder;secretsadmin=check_antagonist'>CA</A>)")
