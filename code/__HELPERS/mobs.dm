...
/proc/admin_mob_info(mob/M, mob/user = usr)
	...
	to_chat(user, "(<a href='?src=[usr.UID()];priv_msg=\ref[M]'>PM</a>) [ADMIN_PP(M)] [ADMIN_VV(M)] [ADMIN_SM(M)] [ADMIN_FLW(M)] (<A HREF='?_src_=holder;secretsadmin=check_antagonist'>CA</A>)")
