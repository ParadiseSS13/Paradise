		...
		obj
			item
				device
					radio
						intercom
							global_announcer = create_global_announcer()
...
var
	list
		paper_tag_whitelist = list("center","p","div","span","h1","h2","h3","h4","h5","h6","hr","pre",	\
			"big","small","font","i","u","b","s","sub","sup","tt","br","hr","ol","ul","li","caption","col",	\
			"table","td","th","tr")
var
	list
		paper_blacklist = list("java","onblur","onchange","onclick","ondblclick","onfocus","onkeydown",	\
...
var
	list
		reverse_dir = list(2, 1, 3, 8, 10, 9, 11, 4, 6, 5, 7, 12, 14, 13, 15, 32, 34, 33, 35, 40, 42, 41, 43, 36, 38, 37, 39, 44, 46, 45, 47, 16, 18, 17, 19, 24, 26, 25, 27, 20, 22, 21, 23, 28, 30, 29, 31, 48, 50, 49, 51, 56, 58, 57, 59, 52, 54, 53, 55, 60, 62, 61, 63)
var
	gravity_is_on = 1 //basically unused, just one admin verb..
// Recall time limit:  2 hours
var
	recall_time_limit=72000 //apparently used for the comm console

//////SCORE STUFF
//Goonstyle scoreboard
var
	score_crewscore = 0 // this is the overall var/score for the whole round
var
...
var
	score_nuked_penalty = 0 //penalty for getting blown to bits
...
var
	timezoneOffset = 0 // The difference betwen midnight (of the host computer) and 0 world.ticks.
