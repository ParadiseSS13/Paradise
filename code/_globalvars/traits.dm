...
GLOBAL_LIST_INIT(traits_by_type, list(
	/mob = list(
		...
		//MoodSpeed Traits
		"TRAIT_MOOD_INSANE" = TRAIT_MOOD_INSANE,
		"TRAIT_MOOD_CRAZY" = TRAIT_MOOD_CRAZY,
		"TRAIT_MOOD_UNSTABLE" = TRAIT_MOOD_UNSTABLE,
		"TRAIT_MOOD_DISTURBED" = TRAIT_MOOD_DISTURBED,
		"TRAIT_MOOD_NEUTRAL" = TRAIT_MOOD_NEUTRAL,
		"TRAIT_MOOD_GREAT" = TRAIT_MOOD_GREAT
	),
