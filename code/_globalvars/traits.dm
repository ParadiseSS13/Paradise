...
GLOBAL_LIST_INIT(traits_by_type, list(
	/mob = list(
		...
		"TRAIT_SEESHUD_MEDICAL" = TRAIT_SEESHUD_MEDICAL,
		"TRAIT_SEESHUD_JOB" = TRAIT_SEESHUD_JOB,
		"TRAIT_SEESHUD_SECURITY" = TRAIT_SEESHUD_SECURITY,
		"TRAIT_SEESHUD_HYDROPONIC" = TRAIT_SEESHUD_HYDROPONIC,
		"TRAIT_SEESHUD_DIAGNOSTIC" = TRAIT_SEESHUD_DIAGNOSTIC,
		"TRAIT_SEESHUD_DIAGNOSTIC_ADVANCED" = TRAIT_SEESHUD_DIAGNOSTIC_ADVANCED,
	),
	/obj/item = list(
