...
GLOBAL_VAR_INIT(game_year, (text2num(time2text(world.realtime, "YYYY")) + 540))
GLOBAL_VAR_INIT(current_date_string, "[time2text(world.timeofday, "MMM DD")], [GLOB.game_year]")
