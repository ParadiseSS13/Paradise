...
var
	CHARGELEVEL = 0.0005 // Cap for how fast cells charge, as a percentage-per-tick (.001 means cellcharge is capped to 1% per second)
...
var
	list
		deferred_powernet_rebuilds = list()
...
var
	map_name = "Unknown"	//The name of the map that is loaded. Assigned in world/New()
