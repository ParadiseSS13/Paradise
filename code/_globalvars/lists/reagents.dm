...
var
	list
		base_chemicals = list("water","oxygen","nitrogen","hydrogen","potassium","mercury","carbon",
									"chlorine","fluorine","phosphorus","lithium","sulfur","sacid","radium",
									"iron","aluminum","silicon","sugar","ethanol")
// Standard chemicals
var
	list
		standard_chemicals = list("slimejelly","blood","water","lube","charcoal","toxin","cyanide",
...
var
	list
		rare_chemicals = list("minttoxin","nanites","xenomicrobes","adminordrazine")
// Standard medicines
var
	list
		standard_medicines = list("charcoal","toxin","cyanide","morphine","epinephrine","space_drugs",
...
var
	list
		rare_medicines = list("nanites","xenomicrobes","minttoxin","adminordrazine","blood")
// Drinks
var
	list
		drinks = list("beer2","hot_coco","orangejuice","tomatojuice","limejuice","carrotjuice",
...
var
	global
		list
			blocked_chems = list("polonium", "initropidril", "concentrated_initro",
...
var
	global
		list
			plant_blocked_chems = list()	//filled in /datum/reagents/New() with chems that have can_grow_in_plants = 0

var
	global
		list
			safe_chem_list = list("antihol", "charcoal", "epinephrine", "insulin", "teporone","silver_sulfadiazine", "salbutamol",
