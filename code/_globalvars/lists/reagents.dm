...
// Drinks
GLOBAL_LIST_INIT(drinks, list(/datum/reagent/beer2, /datum/reagent/consumable/hot_coco, /datum/reagent/consumable/drink/orangejuice, /datum/reagent/consumable/drink/tomatojuice, /datum/reagent/consumable/drink/limejuice, 
					/datum/reagent/consumable/drink/carrotjuice, /datum/reagent/consumable/drink/berryjuice, /datum/reagent/consumable/drink/poisonberryjuice, /datum/reagent/consumable/drink/watermelonjuice,
					/datum/reagent/consumable/drink/lemonjuice, /datum/reagent/consumable/drink/banana, /datum/reagent/consumable/drink/nothing, /datum/reagent/consumable/drink/potato_juice,
					/datum/reagent/consumable/drink/milk, /datum/reagent/consumable/drink/milk/soymilk, /datum/reagent/consumable/drink/milk/cream, /datum/reagent/consumable/drink/coffee,
					/datum/reagent/consumable/drink/tea, /datum/reagent/consumable/drink/coffee/icecoffee, /datum/reagent/consumable/drink/tea/icetea, /datum/reagent/consumable/drink/cold/space_cola,
					/datum/reagent/consumable/drink/cold/nuka_cola, /datum/reagent/consumable/drink/cold/spacemountainwind, /datum/reagent/consumable/ethanol/thirteenloko, /datum/reagent/consumable/drink/cold/dr_gibb,
					/datum/reagent/consumable/drink/cold/space_up, /datum/reagent/consumable/drink/cold/lemon_lime, /datum/reagent/consumable/ethanol/beer, /datum/reagent/consumable/ethanol/whiskey,
					/datum/reagent/consumable/ethanol/gin, /datum/reagent/consumable/ethanol/rum, /datum/reagent/consumable/ethanol/vodka, /datum/reagent/holywater, /datum/reagent/consumable/ethanol/tequila,
					/datum/reagent/consumable/ethanol/vermouth, /datum/reagent/consumable/ethanol/wine, /datum/reagent/consumable/drink/cold/tonic, /datum/reagent/consumable/ethanol/kahlua,
					/datum/reagent/consumable/ethanol/cognac, /datum/reagent/consumable/ethanol/ale, /datum/reagent/consumable/drink/cold/sodawater, /datum/reagent/consumable/drink/cold/ice,
					/datum/reagent/consumable/ethanol/bilk, /datum/reagent/consumable/ethanol/atomicbomb, /datum/reagent/consumable/ethanol/threemileisland, /datum/reagent/consumable/ethanol/goldschlager,
					/datum/reagent/consumable/ethanol/patron, /datum/reagent/consumable/ethanol/gintonic, /datum/reagent/consumable/ethanol/cuba_libre, /datum/reagent/consumable/ethanol/whiskey_cola,
					/datum/reagent/consumable/ethanol/martini, /datum/reagent/consumable/ethanol/vodkamartini, /datum/reagent/consumable/ethanol/white_russian, /datum/reagent/consumable/ethanol/screwdrivercocktail,
					/datum/reagent/consumable/ethanol/booger, /datum/reagent/consumable/ethanol/bloody_mary, /datum/reagent/consumable/ethanol/gargle_blaster, /datum/reagent/consumable/ethanol/brave_bull,
					/datum/reagent/consumable/ethanol/tequila_sunrise, /datum/reagent/consumable/ethanol/toxins_special, /datum/reagent/consumable/ethanol/beepsky_smash, /datum/reagent/medicine/salglu_solution,
					/datum/reagent/consumable/ethanol/irish_cream, /datum/reagent/consumable/ethanol/manly_dorf, /datum/reagent/consumable/ethanol/longislandicedtea, /datum/reagent/consumable/ethanol/moonshine,
					/datum/reagent/consumable/ethanol/b52, /datum/reagent/consumable/ethanol/irishcoffee, /datum/reagent/consumable/ethanol/margarita, /datum/reagent/consumable/ethanol/black_russian,
					/datum/reagent/consumable/ethanol/manhattan, /datum/reagent/consumable/ethanol/manhattan_proj, /datum/reagent/consumable/ethanol/whiskeysoda, /datum/reagent/consumable/ethanol/adminfreeze,
					/datum/reagent/consumable/ethanol/antifreeze, /datum/reagent/consumable/ethanol/barefoot, /datum/reagent/consumable/ethanol/snowwhite, /datum/reagent/consumable/ethanol/demonsblood,
					/datum/reagent/consumable/ethanol/vodkatonic, /datum/reagent/consumable/ethanol/ginfizz, /datum/reagent/consumable/ethanol/bahama_mama, /datum/reagent/consumable/ethanol/singulo,
					/datum/reagent/consumable/ethanol/sbiten, /datum/reagent/consumable/ethanol/devilskiss, /datum/reagent/consumable/ethanol/red_mead, /datum/reagent/consumable/ethanol/mead,
					/datum/reagent/consumable/ethanol/iced_beer, /datum/reagent/consumable/ethanol/grog, /datum/reagent/consumable/ethanol/aloe, /datum/reagent/consumable/ethanol/andalusia,
					/datum/reagent/consumable/ethanol/alliescocktail, /datum/reagent/consumable/drink/coffee/soy_latte, /datum/reagent/consumable/drink/coffee/cafe_latte, /datum/reagent/consumable/ethanol/acid_spit,
					/datum/reagent/consumable/ethanol/amasec, /datum/reagent/consumable/ethanol/neurotoxin, /datum/reagent/consumable/ethanol/hippies_delight, /datum/reagent/consumable/drink/bananahonk,
					/datum/reagent/consumable/drink/silencer, /datum/reagent/consumable/ethanol/changelingsting, /datum/reagent/consumable/ethanol/irishcarbomb, /datum/reagent/consumable/ethanol/syndicatebomb,
					/datum/reagent/consumable/ethanol/erikasurprise, /datum/reagent/consumable/ethanol/driestmartini, /datum/reagent/consumable/ethanol/flaming_homer, /datum/reagent/consumable/drink/cold/arnold_palmer,
					/datum/reagent/consumable/ethanol/gimlet, /datum/reagent/consumable/ethanol/sidecar, /datum/reagent/consumable/ethanol/whiskey_sour, /datum/reagent/consumable/ethanol/mint_julep,
