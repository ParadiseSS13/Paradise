...
GLOBAL_LIST_INIT(xenobiology_dissection_bridge, list(
	/mob/living/simple_animal/hostile/asteroid/goliath = /datum/xenobiology_surgery_information/goliath,
	/mob/living/simple_animal/hostile/asteroid/elite/broodmother = /datum/xenobiology_surgery_information/goliath,
	/mob/living/simple_animal/hostile/carp/megacarp = /datum/xenobiology_surgery_information/megacarp,
	/mob/living/simple_animal/hostile/megafauna/legion = /datum/xenobiology_surgery_information/legion,
	/mob/living/simple_animal/hostile/morph = /datum/xenobiology_surgery_information/morph,
	/mob/living/simple_animal/hostile/hellhound = /datum/xenobiology_surgery_information/hound,
	/mob/living/simple_animal/hostile/netherworld = /datum/xenobiology_surgery_information/sweating,
	/mob/living/simple_animal/hostile/netherworld/migo = /datum/xenobiology_surgery_information/migo,
	/mob/living/simple_animal/hostile/asteroid/basilisk = /datum/xenobiology_surgery_information/sweating,
	/mob/living/simple_animal/hostile/asteroid/basilisk/watcher = /datum/xenobiology_surgery_information/watcher,
	/mob/living/simple_animal/hostile/poison/giant_spider = /datum/xenobiology_surgery_information/spider,
	/mob/living/simple_animal/hostile/asteroid/hivelord = /datum/xenobiology_surgery_information/hivelord,
	/mob/living/simple_animal/hostile/headslug = /datum/xenobiology_surgery_information/headslug,
	/mob/living/simple_animal/hostile/megafauna/dragon = /datum/xenobiology_surgery_information/drake,
	/mob/living/simple_animal/hostile/megafauna/dragon/space_dragon = /datum/xenobiology_surgery_information/drake,
	/mob/living/simple_animal/hostile/asteroid/goldgrub = /datum/xenobiology_surgery_information/goldgrub,
	/mob/living/simple_animal/hostile/megafauna/ancient_robot = /datum/xenobiology_surgery_information/vetus,
	/mob/living/simple_animal/hostile/poison/terror_spider = /datum/xenobiology_surgery_information/terror_spider
	/mob/living/simple_animal/hostile/blob/blobbernaut = /datum/xenobiology_surgery_information/blobbernaut,
	/mob/living/simple_animal/hostile/killertomato = /datum/xenobiology_surgery_information/tomato,
	/mob/living/simple_animal/hostile/megafauna/hierophant = /datum/xenobiology_surgery_information/hierophant,
	/mob/living/simple_animal/hostile/asteroid/elite/herald = /datum/xenobiology_surgery_information/herald,
	/mob/living/simple_animal/hostile/megafauna/colossus = /datum/xenobiology_surgery_information/colossus,
	/mob/living/simple_animal/revenant = /datum/xenobiology_surgery_information/revenant,
	/mob/living/simple_animal/hostile/retaliate/clown = /datum/xenobiology_surgery_information/clown,
	/mob/living/carbon/alien = /datum/xenobiology_surgery_information/alien,
	/mob/living/carbon/alien/humanoid/queen = /datum/xenobiology_surgery_information/alien/queen,
	/mob/living/carbon/alien/humanoid/sentinel = /datum/xenobiology_surgery_information/alien/sentinel,
	/mob/living/carbon/alien/humanoid/drone = /datum/xenobiology_surgery_information/alien/drone,
	/mob/living/carbon/alien/humanoid/hunter = /datum/xenobiology_surgery_information/alien/hunter,
	/mob/living/carbon/alien/larva = /datum/xenobiology_surgery_information/alien/larva,
	/mob/living/simple_animal/hostile/megafauna/bubblegum = /datum/xenobiology_surgery_information/bubblegum,
	/mob/living/simple_animal/hostile/asteroid/elite/legionnaire = /datum/xenobiology_surgery_information/legionnaire,
	/mob/living/simple_animal/hostile/asteroid/elite/pandora = /datum/xenobiology_surgery_information/pandora,
	))
