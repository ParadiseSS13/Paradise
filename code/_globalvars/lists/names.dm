...
GLOBAL_LIST_INIT(first_names_russian_male, file2list("config/names/first_russian_male.txt"))
GLOBAL_LIST_INIT(first_names_russian_female, file2list("config/names/first_russian_female.txt"))
GLOBAL_LIST_INIT(last_names_russian_male, file2list("config/names/last_russian_male.txt"))
GLOBAL_LIST_INIT(last_names_russian_female, file2list("config/names/last_russian_female.txt"))
