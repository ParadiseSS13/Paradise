...
#define EMBEDDED_UNSAFE_REMOVAL_PAIN_MULTIPLIER 6	///Coefficient of multiplication for the damage the item does when it falls out or is removed without a surgery (this*item.w_class)
...
#define EMBED_CHANCE_SPEED_BONUS 10					///For thrown weapons, every extra speed it's thrown at above its normal throwspeed will add this to the embed chance

/// Default values, embedded list can be overridden in item definition to adjust
