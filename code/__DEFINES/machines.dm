...
#define VENDOR_TIP_CRIT_EFFECT_RANDOM 0
#define VENDOR_TIP_CRIT_EFFECT_SHATTER 1
#define VENDOR_TIP_CRIT_EFFECT_PIN 2
#define VENDOR_TIP_CRIT_EFFECT_EMBED 3
#define VENDOR_TIP_CRIT_EFFECT_MAIM_LIMB 4
#define VENDOR_TIP_CRIT_EFFECT_HEAD_ASPLODE 5
