...
#define PREFTOGGLE_DISABLE_SCOREBOARD 		1024
#define PREFTOGGLE_DISABLE_KARMA_REMINDER	2048
#define PREFTOGGLE_MEMBER_PUBLIC			4096
#define PREFTOGGLE_CHAT_NO_ADMINLOGS 		8192
#define PREFTOGGLE_DONATOR_PUBLIC			16384
#define PREFTOGGLE_CHAT_NO_TICKETLOGS 		32768
#define PREFTOGGLE_UI_DARKMODE 				65536
#define PREFTOGGLE_DISABLE_KARMA 			131072
#define PREFTOGGLE_CHAT_NO_MENTORTICKETLOGS 262144
#define PREFTOGGLE_TYPING_ONCE 				524288
#define PREFTOGGLE_AMBIENT_OCCLUSION 		1048576
#define PREFTOGGLE_CHAT_GHOSTPDA 			2097152
#define PREFTOGGLE_NUMPAD_TARGET 			4194304

#define TOGGLES_TOTAL 						8388608 // If you add or remove a preference toggle above, make sure you update this define with the total value of the toggles combined.
...
#define TYPING_INDICATOR_NONE	0
#define TYPING_INDICATOR_ALL	1
#define TYPING_INDICATOR_SAY	2 // 'Say' only, no indicator when typing 'me' emotes
