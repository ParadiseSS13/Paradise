...
#define span_boldnshit(str) ("<span class='boldnshit'>" + str + "</span>")
...
#define span_emoji_enabled(str) ("<span class='emoji_emabled'>" + str + "</span>")
...
#define span_restored(str) ("<span class='restored'>" + str + "</span>")
