...
#define span_bigsinister(str) ("<span class='big sinister'>" + str + "</span>")
#define span_reallybigsinister(str) ("<span class='reallybig sinister'>" + str + "</span>")
...
#define span_boldbody(str) ("<span class='bold body'>" + str + "</span>")
