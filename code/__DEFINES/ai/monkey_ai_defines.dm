...
#define MONKEY_DISPOSING_READY 0
#define MONKEY_DISPOSING_DRAGGING 1
#define MONKEY_DISPOSING_REACHED_DISPOSAL 2
#define MONKEY_DISPOSING_STUFFING 3
#define MONKEY_DISPOSING_FLUSHING 4
