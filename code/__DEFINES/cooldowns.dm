//// COOLDOWN SYSTEMS - Ported from TG
/*
...
#define COOLDOWN_ADD(cd_source, cd_index, cd_time) cd_source.cd_index += cd_time

#define COOLDOWN_SUB(cd_source, cd_index, cd_time) (cd_source.cd_index = max(0, cd_source.cd_index - cd_time))
