...
// MARK: Fluid pipes
#define PIPE_FLUID			300
#define PIPE_UNDERGROUND	301
#define PIPE_FLUID_PUMP		302
#define PIPE_PUMPJACK		303
#define PIPE_TANK			304
#define PIPE_BARRELFILLER	305
#define PIPE_REFINERY		306
