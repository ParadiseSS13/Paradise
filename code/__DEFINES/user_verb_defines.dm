...
#define VERB_NO_DESCRIPTION ""

#define VERB_VISIBILITY_FLAG_LOCALHOST "Localhost"
#define VERB_VISIBILITY_FLAG_MOREDEBUG "Moredebug"
...
#define VERB_CATEGORY_HIDDEN null
#define VERB_CATEGORY_EVENT "Event"
