...
// Construction times
#define APC_COVER_REPLACEMENT_TIME 2 SECONDS
#define APC_FRAME_REPLACEMENT_TIME 5 SECONDS
#define APC_FRAME_WELDING_TIME 5 SECONDS
#define APC_ELECTRONICS_INSTALLATION_TIME 1 SECONDS
#define APC_ELECTRONICS_CROWBAR_TIME 5 SECONDS
#define APC_TERMINAL_WIRING_TIME 2 SECONDS
