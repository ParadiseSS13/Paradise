...
#define SPECIAL_ROLE_ALIEN_QUEEN "Alien Queen"
#define SPECIAL_ROLE_ALIEN_HUNTER "Alien Hunter"
#define SPECIAL_ROLE_ALIEN_DRONE "Alien Drone"
#define SPECIAL_ROLE_ALIEN_SENTINEL "Alien Sentinel"
#define SPECIAL_ROLE_ALIEN_LARVA "Alien Larva"
