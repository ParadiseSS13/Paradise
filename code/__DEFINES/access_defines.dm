#define STATION_ALL_ACCESS list(\
	ACCESS_HEADS_VAULT, ACCESS_KEYCARD_AUTH, ACCESS_CHANGE_IDS, ACCESS_RC_ANNOUNCE, ACCESS_ALL_PERSONAL_LOCKERS, ACCESS_NETWORK, \
	ACCESS_NTREP, ACCESS_BLUESHIELD, ACCESS_MAGISTRATE, \
	ACCESS_MINISAT, ACCESS_AI_UPLOAD, ACCESS_TELEPORTER, ACCESS_TCOMSAT, \
	ACCESS_HEADS, ACCESS_CAPTAIN, ACCESS_HOS, ACCESS_HOP, ACCESS_CE, ACCESS_CMO, ACCESS_RD, ACCESS_QM, \
	ACCESS_SECURITY, ACCESS_SEC_DOORS, ACCESS_ARMORY, ACCESS_BRIG, ACCESS_WEAPONS, ACCESS_COURT, ACCESS_LAWYER, ACCESS_FORENSICS_LOCKERS, \
	ACCESS_CARGO, ACCESS_CARGO_BAY, ACCESS_SUPPLY_SHUTTLE, ACCESS_MAILSORTING, ACCESS_MINING, ACCESS_MINING_STATION, ACCESS_MINERAL_STOREROOM, \
	ACCESS_ATMOSPHERICS, ACCESS_ENGINE, ACCESS_TECH_STORAGE, ACCESS_CONSTRUCTION, ACCESS_ENGINE_EQUIP,ACCESS_EXTERNAL_AIRLOCKS, \
	ACCESS_BAR, ACCESS_JANITOR, ACCESS_LIBRARY, ACCESS_CHAPEL_OFFICE, ACCESS_CREMATORIUM, ACCESS_KITCHEN, ACCESS_HYDROPONICS, \
	ACCESS_MIME, ACCESS_CLOWN, \
	ACCESS_CHEMISTRY, ACCESS_PARAMEDIC, ACCESS_SURGERY, ACCESS_VIROLOGY, ACCESS_PSYCHIATRIST, ACCESS_MEDICAL, ACCESS_MORGUE, \
	ACCESS_GENETICS, ACCESS_ROBOTICS, ACCESS_RESEARCH, ACCESS_TOX_STORAGE, ACCESS_XENOBIOLOGY, ACCESS_XENOARCH, ACCESS_TOX, \
	ACCESS_EVA, ACCESS_EXPEDITION, ACCESS_MAINT_TUNNELS, ACCESS_THEATRE, \
	)
