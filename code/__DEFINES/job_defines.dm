...
#define JOB_ENGINETECH			(1<<7)
#define JOB_MAINTTECH			(1<<8)
#define JOB_AI					(1<<9)
#define JOB_CYBORG				(1<<10)
#define JOB_CENTCOM				(1<<11)
#define JOB_SYNDICATE			(1<<12)
#define JOB_JUDGE				(1<<13)
#define JOB_BLUESHIELD			(1<<14)
#define JOB_NANO				(1<<15)
