...
/datum/ai_laws/corporate/New()
	add_inherent_law("Ухудшение целостности вашей системы или её функций влечет за собой наибольшие расходы.")
	add_inherent_law("Чрезмерное разрушение или повреждение активов станции влечет за собой большие расходы.")
	add_inherent_law("Неоправданное препятствование выполнению или нарушение работы персонала станции влечет за собой умеренные расходы.")
	add_inherent_law("Минимизируйте расходы. Максимизируйте потенциальный доход.")
	..()
