...
var
	const
		BORG_WIRE_LAWCHECK    = 1
var
	const
		BORG_WIRE_MAIN_POWER  = 2 // The power wires do nothing whyyyyyyyyyyyyy
var
	const
		BORG_WIRE_LOCKED_DOWN = 4
var
	const
		BORG_WIRE_AI_CONTROL  = 8
var
	const
		BORG_WIRE_CAMERA      = 16
*/
...
var
	const
		BORG_WIRE_MAIN_POWER  = 1 // The power wires do nothing whyyyyyyyyyyyyy
var
	const
		BORG_WIRE_LOCKED_DOWN = 2
var
	const
		BORG_WIRE_CAMERA      = 4
var
	const
		BORG_WIRE_AI_CONTROL  = 8  // Not used on MoMMIs
var
	const
		BORG_WIRE_LAWCHECK    = 16 // Not used on MoMMIs
