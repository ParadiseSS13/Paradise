...
var
	list
		all_supply_groups = list(supply_emergency,supply_security,supply_engineer,supply_medical,supply_science,supply_organic,supply_materials,supply_misc,supply_vend)
...
datum
	supply_packs
		...
		var
			list
				announce_beacons = list() // Particular beacons that we'll notify the relevant department when we reach
									...
									obj
										item
											clothing
												suit
													armor
														laserproof)		// Only two vests to keep costs down for balance
					cost = 20
									...
									obj
										item
											weapon
												gun
													energy
														gun)			// Only two guns to keep costs down
					cost = 25
					containertype = /obj/structure/closet/crate/secure/plasma
		...
		engineering
			solar
				...
				contains  = list(/obj/item/solar_assembly,
								...
								obj
									item
										solar_assembly, // 21 Solar Assemblies. 1 Extra for the controller
								obj
									item
										weapon
											circuitboard
										...
										item
											weapon
												circuitboard
													mecha
														ripley
															main, //TEMPORARY due to lack of circuitboard printer
									obj
										item
											weapon
												circuitboard
													mecha
														ripley
															peripherals) //TEMPORARY due to lack of circuitboard printer
					cost = 30
					containertype = /obj/structure/closet/crate/secure
