...
/datum/uplink_item/explosives/detomatix
	...
	desc = "When inserted into a personal digital assistant, this cartridge gives you five opportunities to detonate PDAs of crewmembers who have their message feature enabled. The concussive effect from the explosion will knock down the recipient for a short period, and deafen them for longer."
	reference = "DEPC"
