...
datum
	cargoprofile
		var
			name = "All Items"
		var
			id = "all" // unique ID for the UI
		var
			enabled = 1
		var
			eject_speed = 1 // will change when emagged
		var
			const
				BIG_OBJECT_WORK = 10
		var
			...
			obj
				machinery
					programmable
						master = null
		var
			universal = 0 // set when both unary and binary machines work
		var
			mobcheck = 0
		...
		var
			list
				blacklist = null
		var
			dedicated_path = null // When constructing a new machine with this as default program, create a machine of the specified type instead.
							...
							obj
								item
									weapon
										storage
											bag
												tray, /obj/item/pizzabox, /obj/item/weapon/clipboard,
							obj
								item
									smallDelivery, /obj/structure/bigDelivery)
			...
			whitelist = list(/obj/item/stack/cable_coil,/obj/item/stack/rods,
							obj
								item
									stack
										sheet
											metal,/obj/item/stack/sheet/plasteel,
							obj
								item
									stack
										sheet
											glass,/obj/item/stack/sheet/rglass,
							obj
								item
									stack
										tile,/obj/item/weapon/light,
							obj
								item
									weapon
										table_parts)
			...
			whitelist = list(/obj/item/weapon/coin, /obj/item/weapon/spacecash, /obj/item/seeds,
							obj
								item
									stack
										sheet
											mineral,/obj/item/stack/sheet/wood,/obj/item/stack/sheet/leather)
		...
		organics
			...
			whitelist = list(/obj/item/weapon/tank,/obj/item/weapon/reagent_containers,
							obj
								item
									stack
										medical,/obj/item/weapon/storage/pill_bottle,/obj/item/weapon/gun/syringe,
							obj
								item
									weapon
										c4,/obj/item/weapon/grenade,/obj/item/ammo_box,
							obj
								item
									weapon
										gun
											grenadelauncher,/obj/item/weapon/flamethrower,	/obj/item/weapon/lighter,
							obj
								item
									weapon
										match,/obj/item/weapon/weldingtool)
			...
			whitelist = list(/obj/item/weapon/reagent_containers,/obj/item/stack/medical,/obj/item/weapon/storage/pill_bottle,
							obj
								item
									weapon
										gun
											syringe,/obj/item/weapon/grenade/chem_grenade,/obj/item/weapon/dnainjector,
							obj
								item
									weapon
										storage
											belt
												medical,/obj/item/weapon/storage/firstaid,/obj/item/weapon/implanter)
	...
	cargoprofile
		pressure
			empty
				...
				id = "pressure-low"
				var
					lowpressure = ONE_ATMOSPHERE

				contains(var/atom/A)
					if(..())
						var
							pressure = ONE_ATMOSPHERE * 10 // In case of fallthrough, fail test
	...
	cargoprofile
		pressure
			full
				...
				id = "pressure-high"
				var
					highpressure = ONE_ATMOSPHERE * 15 // stolen from canister.dm; Is this right?

				contains(var/atom/A)
					if(..())
						var
							pressure = 0 // In case of fallthrough, fail test
						if(istype(A,/obj/item/weapon/tank))
							var
								obj
									item
			...
			blacklist = list(/obj/item/weapon/tank/plasma,/obj/item/weapon/tank/anesthetic, // the rest are air tanks
							obj
								item
									clothing
										mask
											facehugger) // NOT CLOTHING AT ALLLLL
			whitelist = list(/obj/item/clothing,/obj/item/weapon/storage/belt,/obj/item/weapon/storage/backpack,
							obj
								item
									device
										radio
											headset,/obj/item/device/pda,/obj/item/weapon/card/id,/obj/item/weapon/tank,
							obj
								item
									weapon
										restraints
											handcuffs, /obj/item/weapon/restraints/legcuffs)
		...
		trash
			...
			whitelist = list(/obj/item/trash,/obj/item/toy,/obj/item/weapon/reagent_containers/food/snacks/ectoplasm,/obj/item/weapon/bananapeel,/obj/item/weapon/broken_bottle,/obj/item/weapon/bikehorn,
							obj
								item
									weapon
										cigbutt,/obj/item/weapon/contraband,/obj/item/weapon/corncob,/obj/item/weapon/paper,/obj/item/weapon/shard,
							obj
								item
									weapon
										sord,/obj/item/weapon/photo,/obj/item/weapon/folder,
							obj
								item
									areaeditor
										blueprints,/obj/item/weapon/contraband,/obj/item/weapon/kitchen,/obj/item/weapon/book,/obj/item/clothing/mask/facehugger)
		...
		weapons
			...
			whitelist = list(/obj/item/weapon/banhammer,/obj/item/weapon/sord,/obj/item/weapon/claymore,/obj/item/weapon/holo/esword,
							obj
								item
									weapon
										flamethrower,/obj/item/weapon/grenade,/obj/item/weapon/gun,/obj/item/weapon/hatchet,/obj/item/weapon/katana,
							obj
								item
									weapon
										kitchen
											knife,/obj/item/weapon/melee,/obj/item/weapon/nullrod,/obj/item/weapon/pickaxe,/obj/item/weapon/twohanded,
							obj
								item
									weapon
										c4,/obj/item/weapon/scalpel,/obj/item/weapon/shield,/obj/item/weapon/grown/nettle/death)
		...
		tools
			...
			whitelist = list(/obj/item/device,/obj/item/weapon/card,/obj/item/weapon/cartridge,/obj/item/weapon/cautery,/obj/item/weapon/stock_parts/cell,/obj/item/weapon/circuitboard,
							obj
								item
									weapon
										aiModule,/obj/item/weapon/airalarm_electronics,/obj/item/weapon/airlock_electronics,/obj/item/weapon/circular_saw,
							obj
								item
									weapon
										crowbar,/obj/item/weapon/disk,/obj/item/weapon/firealarm_electronics,/obj/item/weapon/hand_tele,
							obj
								item
									weapon
										hand_labeler,/obj/item/weapon/hemostat,/obj/item/weapon/mop,/obj/item/weapon/locator,/obj/item/weapon/minihoe,
							obj
								item
									stack
										packageWrap,/obj/item/weapon/pen,/obj/item/weapon/pickaxe,/obj/item/weapon/pinpointer,
							obj
								item
									weapon
										rcd,/obj/item/weapon/rcd_ammo,/obj/item/weapon/retractor,/obj/item/weapon/rsf,/obj/item/weapon/rsp,/obj/item/weapon/scalpel,
							obj
								item
									weapon
										screwdriver,/obj/item/weapon/shovel,/obj/item/weapon/soap,/obj/item/weapon/stamp,/obj/item/weapon/storage/bag/tray,/obj/item/weapon/weldingtool,
							obj
								item
									weapon
										wirecutters,/obj/item/weapon/wrench,/obj/item/weapon/extinguisher)
					...
					for(var/obj/item/stack/O in master.contents)
						if(O.type == I.type && O.amount < O.max_amount)
							if(I.amount + O.amount <= O.max_amount)
								...
								return O.w_class
							var
								leftover = I.amount + O.amount - O.max_amount
					...
					for(var/obj/item/stack/cable_coil/O in master.contents)
						if(O.type == I.type && O.amount < MAXCOIL)
							if(I.amount + O.amount <= MAXCOIL)
								...
								return O.w_class
							var
								leftover = I.amount + O.amount - MAXCOIL
							O.amount = MAXCOIL
							I.amount = leftover
							continue
					//end for
						...
						for(var/obj/item/stack/cable_coil/O in D.contents)
							if(O.type == I.type && O.amount < MAXCOIL)
								if(I.amount + O.amount <= MAXCOIL) // Why did they make it a #define.
									...
									return
								var
									leftover = I.amount + O.amount - MAXCOIL // That wasn't a question
			...
			blacklist = list(/mob/camera,/mob/new_player,/mob/living/simple_animal/hostile/blob/blobspore,/mob/living/simple_animal/hostile/creature,
							mob
								living
									simple_animal
										hostile
											spaceWorm,/mob/living/simple_animal/shade,/mob/living/simple_animal/hostile/faithless,/mob/dead)
			universal = 1
			mobcheck = 1
	...
	cargoprofile
		unary
			trainer
				...
				proc
					punch(var/mob/living/carbon/human/M,var/maxpunches)
						...
						var
							obj
								item
									organ
										external
											affecting = M.get_organ(ran_zone("chest",50))
						var
				...
				inlet_reaction(var/atom/W,var/turf/S,var/remaining)
					...
					if((M.lying || (M.health - M.staminaloss < 25))&& !master.emagged)
						...
						return 0 // Be polite
					var
						punches = punch(M,remaining / PUNCH_WORK)
