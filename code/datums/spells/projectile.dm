			...
			spell
				targeted
					projectile
						...
						var
							proj_type = "/obj/effect/proc_holder/spell/targeted" //IMPORTANT use only subtypes of this

						var
							proj_lingering = 0 //if it lingers or disappears upon hitting an obstacle
						var
							proj_homing = 1 //if it follows the target
						var
							proj_insubstantial = 0 //if it can pass through dense objects or not
						var
							proj_trigger_range = 0 //the range from target at which the projectile triggers cast(target)

						var
							proj_lifespan = 15 //in deciseconds * proj_step_delay
						var
