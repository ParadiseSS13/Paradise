...
/mob/living/carbon/human/proc/makeCluwne()
	...
	if(!istype(wear_mask, /obj/item/clothing/mask/cursedclown)) //Infinite loops otherwise
		unEquip(wear_mask, 1)
	equip_to_slot_if_possible(new /obj/item/clothing/under/cursedclown, SLOT_HUD_ICLOTHING, TRUE, TRUE)
	equip_to_slot_if_possible(new /obj/item/clothing/gloves/cursedclown, SLOT_HUD_GLOVES, TRUE, TRUE)
	equip_to_slot_if_possible(new /obj/item/clothing/mask/cursedclown, SLOT_HUD_MASK, TRUE, TRUE)
	equip_to_slot_if_possible(new /obj/item/clothing/shoes/cursedclown, SLOT_HUD_FEET, TRUE, TRUE)
...
/mob/living/carbon/human/proc/makeAntiCluwne()
	...
	equip_to_slot_if_possible(new /obj/item/clothing/under/rank/procedure/iaa/formal/black, SLOT_HUD_ICLOTHING, TRUE, TRUE)
	equip_to_slot_if_possible(new /obj/item/clothing/shoes/black, SLOT_HUD_FEET, TRUE, TRUE)
