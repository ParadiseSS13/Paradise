/obj/effect/proc_holder/spell/aoe/turf/knock
	name = "Knock"
...
/obj/effect/proc_holder/spell/aoe/turf/knock/cast(list/targets, mob/user = usr)
...
/obj/effect/proc_holder/spell/aoe/turf/knock/proc/try_open_airlock(obj/machinery/door/door)
...
/obj/effect/proc_holder/spell/aoe/turf/knock/proc/try_open_closet(obj/structure/closet/C)
	if(istype(C, /obj/structure/closet/secure_closet))
		var/obj/structure/closet/secure_closet/SC = C
		SC.locked = FALSE
	C.open()

/obj/effect/proc_holder/spell/aoe/turf/knock/greater
	name = "Greater Knock"
...
/obj/effect/proc_holder/spell/aoe/turf/knock/greater/cast(list/targets, mob/user = usr)
	if(!used)
		used = TRUE
