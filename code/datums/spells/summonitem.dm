						...
						cast(list/targets)
							for(var/mob/living/user in targets)
								...
								if(!marked_item) //linking item to the spell
									...
									var
										obj
											item_to_retrive = marked_item
									var
										infinite_recursion = 0 //I don't want to know how someone could put something inside itself but these are wizards so let's be safe
