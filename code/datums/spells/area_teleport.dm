			...
			spell
				targeted
					area_teleport
						...
						var
							randomise_selection = 0 //if it lets the usr choose the teleport loc or picks it from the list
						var
							invocation_area = 1 //if the invocation appends the selected area
obj
	effect
		proc_holder
			spell
				targeted
					area_teleport
						perform(list/targets, recharge = 1)
							var
								thearea = before_cast(targets)
	...
	effect
		proc_holder
			spell
				targeted
					area_teleport
						cast(list/targets,area/thearea)
	...
	effect
		proc_holder
			spell
				targeted
					area_teleport
						invocation(area/chosenarea = null)
