/datum/spell/touch/alien_spell
	...
	hand_path = "/obj/item/touch_attack/alien"
...
/obj/item/touch_attack/alien/customised_abstract_text()
	return

/obj/item/touch_attack/alien/proc/plasma_check(plasma, mob/living/carbon/user)
