			...
			spell
				targeted
					turf_teleport
						...
						var
							include_space = 0 //whether it includes space tiles in possible teleport locations
						var
							include_dense = 0 //whether it includes dense tiles in possible teleport locations
