/obj/effect/proc_holder/spell/aoe/turf/conjure/build/mime_wall
	name = "Invisible Wall"
...
/obj/effect/proc_holder/spell/aoe/turf/conjure/build/mime_wall/Click()
	if(usr && usr.mind)
		if(!usr.mind.miming)
...
/obj/item/spellbook/oneuse/mime
	spell = /obj/effect/proc_holder/spell/aoe/turf/conjure/build/mime_wall
