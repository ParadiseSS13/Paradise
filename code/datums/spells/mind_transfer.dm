/obj/effect/proc_holder/spell/targeted/mind_transfer
	...
	var/paralysis_amount_caster = 400 //how much the caster is paralysed for after the spell
	var/paralysis_amount_victim = 400 //how much the victim is paralysed for after the spell
