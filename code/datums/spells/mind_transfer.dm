			...
			spell
				targeted
					mind_transfer
						...
						var
							list
								protected_roles = list("Wizard","Changeling","Cultist") //which roles are immune to the spell
						var
							paralysis_amount_caster = 20 //how much the caster is paralysed for after the spell
						var
							paralysis_amount_victim = 20 //how much the victim is paralysed for after the spell
					...
					mind_transfer
						cast(list/targets,mob/user = usr)
							...
							var
								mob
									living
										victim = target//The target of the spell whos body will be transferred to.
							var
								mob
									caster = user//The wizard/whomever doing the body transferring.
