...
/proc/get_id_photo(mob/living/carbon/human/H, custom_job = null)
	...
	switch(job_clothes)
		...
		if("Quartermaster")
			...
			clothes_s.Blend(new /icon('icons/mob/clothing/feet.dmi', "brown"), ICON_UNDERLAY)
		if("Cargo Technician")
			clothes_s = new /icon('icons/mob/clothing/under/cargo.dmi', "cargotech_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/feet.dmi', "black"), ICON_UNDERLAY)
		if("Shaft Miner")
		...
		if("Chemist")
			clothes_s = new /icon('icons/mob/clothing/under/medical.dmi', "chemistrywhite_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/feet.dmi', "white"), ICON_UNDERLAY)
		...
		if("Geneticist")
			clothes_s = new /icon('icons/mob/clothing/under/rnd.dmi', "geneticswhite_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/feet.dmi', "white"), ICON_UNDERLAY)
