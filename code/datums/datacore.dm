...
/proc/get_id_photo(mob/living/carbon/human/H, var/custom_job = null)
	...
	switch(job_clothes)
		...
		if("Representante de Nanotrasen")
		...
		if("Ingeniero")
			...
			clothes_s.Blend(new /icon('icons/mob/belt.dmi', "utility"), ICON_OVERLAY)
		if("Expertto en Soporte de Vida")
