...
/proc/species_contextblend(icon/ico, datum/species/S, input)
	if(istype(S, /datum/species/vulpkanin) || istype(S, /datum/species/slime) || istype(S, /datum/species/tajaran) || istype(S, /datum/species/machine) || istype(S, /datum/species/unathi) || istype(S, /datum/species/skrell))
