...
/proc/species_contextblend(icon/ico, datum/species/S, input)
	if(istype(S, /datum/species/vulpkanin) || istype(S, /datum/species/slime || istype(S, /datum/species/tajaran))) //I have to snowflake the species that are complete until we finish the rest of species. This should not be here once all species are complete.
