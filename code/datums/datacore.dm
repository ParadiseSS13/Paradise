...
*/
	...
	switch(job_clothes)
		if("Head of Personnel")
			clothes_s = new /icon('icons/mob/uniform.dmi', "hop_alt_s")
		...
		if("Student Scientist")
			clothes_s = new /icon('icons/mob/uniform.dmi', "student_s")
			clothes_s.Blend(new /icon('icons/mob/feet.dmi', "white"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon('icons/mob/suit.dmi', "labcoat_tox_open"), ICON_OVERLAY)
		if("Chemist")
		...
		if("Paramedic")
			...
			clothes_s.Blend(new /icon('icons/mob/feet.dmi', "black"), ICON_UNDERLAY)
		if("Intern")
			clothes_s = new /icon('icons/mob/uniform.dmi', "intern_s")
			clothes_s.Blend(new /icon('icons/mob/feet.dmi', "white"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon('icons/mob/suit.dmi', "labcoat_open"), ICON_OVERLAY)
		if("Captain")
		...
		if("Security Officer")
			...
			clothes_s.Blend(new /icon('icons/mob/feet.dmi', "jackboots"), ICON_UNDERLAY)
		if("Security Cadet")
			clothes_s = new /icon('icons/mob/uniform.dmi', "cadet_s")
			clothes_s.Blend(new /icon('icons/mob/feet.dmi', "jackboots"), ICON_UNDERLAY)
		if("Chief Engineer")
		...
		if("Mechanic")
			...
			clothes_s.Blend(new /icon('icons/mob/belt.dmi', "utility"), ICON_OVERLAY)
		if("Trainee Engineer")
			clothes_s = new /icon('icons/mob/uniform.dmi', "trainee_s")
			clothes_s.Blend(new /icon('icons/mob/feet.dmi', "orange"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon('icons/mob/belt.dmi', "utility"), ICON_OVERLAY)
		if("Roboticist")
