...
/datum/disease/critical/shock
	...
	cures = list(/datum/reagent/medicine/salglu_solution, /datum/reagent/medicine/syndicate_nanites)
	cure_chance = 10
...
/datum/disease/critical/heart_failure
	...
	cures = list(/datum/reagent/medicine/atropine, /datum/reagent/medicine/epinephrine, /datum/reagent/heparin, /datum/reagent/medicine/syndicate_nanites)
	cure_chance = 10
