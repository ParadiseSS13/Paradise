...
/datum/symptom/itching/Activate(datum/disease/advance/A)
	...
	var/obj/item/organ/external/bodypart = M.get_organ(picked_bodypart)
	if(bodypart && bodypart.status != ORGAN_ROBOT)	 //robotic limbs will mean less scratching overall
