...
datum
	symptom
		fire
			proc
				Firestacks_stage_4(mob/living/M, datum/disease/advance/A)
					var
						get_stacks = (sqrt(20+A.totalStageSpeed()*2))-(sqrt(16+A.totalStealth()))
...
datum
	symptom
		fire
			proc
				Firestacks_stage_5(mob/living/M, datum/disease/advance/A)
					var
						get_stacks = (sqrt(20+A.totalStageSpeed()*3))-(sqrt(16+A.totalStealth()))
					M.adjust_fire_stacks(get_stacks)
