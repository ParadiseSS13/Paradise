datum
	disease
		transformation
			...
			var
				list
					stage1 = list("You feel unremarkable.")
			var
				list
					stage2 = list("You feel boring.")
			var
				list
					stage3 = list("You feel utterly plain.")
			var
				list
					stage4 = list("You feel white bread.")
			var
				list
					stage5 = list("Oh the humanity!")
			var
...
datum
	disease
		transformation
			proc
				do_disease_transformation(mob/living/affected_mob)
					if(istype(affected_mob, /mob/living/carbon) && affected_mob.stat != DEAD)
						...
						var
							mob
								living
									new_mob = new new_form(affected_mob.loc)
						if(istype(new_mob))
...
datum
	disease
		transformation
			jungle_fever
				do_disease_transformation(mob/living/carbon/human/affected_mob)
