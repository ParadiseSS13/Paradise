/datum/disease/wizarditis
	...
	desc = "Some speculate that this virus is the cause of Wizard Federation existence. Subjects affected show signs of mental retardation, yelling obscure sentences or total gibberish. In late stages, subjects sometime express feelings of inner power, and cite 'the ability to control the forces of cosmos themselves!' A gulp of strong, manly spirits usually reverts them to normal, humanlike condition."
	severity = HARMFUL
