...
/datum/map_template/ruin/lavaland/lavaland_relay
	...
	description = "Using the same technology as shelter capsules, these pods have been shot from orbit onto lavaland to demonstrate a quick and efficent way for an army to setup forward bases. \
