datum/spacelaw/major/contraband
	...
	desc = "To be in the possession of contraband items. Being in the possession of two or more contraband items, or any restricted Syndicate gadget or weapon, makes you an Enemy of the Corporation (see above). In addition, being caught committing a Major Crime or higher with any of these items makes you an Enemy of the Corporation as well. Personnel turning in these items to Security of their own volition are exempt from this law."
	min_brig = 10
	max_brig = 15
...
datum/spacelaw/major/aggrevatedassault
	...
	desc = "To assault someone with enough force to cause severe bodily damage (severe external bleeding, severe limb damage, broken bones, internal bleeding, organ damage, disfigurement), but not resulting in their immediate death."
	min_brig = 10
	max_brig = 15
...
datum/spacelaw/major/majortresspass
	...
	desc = "Being in a restricted area without prior authorization. This includes any Security Area, Command area (including EVA), the Engine Room, Atmos, or Toxins Research."
	min_brig = 10
	max_brig = 15
