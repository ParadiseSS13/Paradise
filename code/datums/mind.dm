...
/datum/mind/proc/memory_edit_implant(mob/living/carbon/human/H)
	if(ismindshielded(H))
		. = "Mindshield Microchip:<a href='?src=[UID()];implant=remove'>Remove</a>|<b><font color='green'>Implanted</font></b></br>"
	else
		. = "Mindshield Microchip:<b>No Microchip</b>|<a href='?src=[UID()];implant=add'>Microchip [H.p_them()]!</a></br>"
