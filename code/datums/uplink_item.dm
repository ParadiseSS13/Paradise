...
/datum/uplink_item/dangerous/powerfist
	...
	desc = "The power-fist is a metal gauntlet with a built-in piston-ram powered by an external gas supply.\
		 Upon hitting a target, the piston-ram will extend foward to make contact and throw them back an impressive distance. \
		 Comes with a full oxygen tank that's good for about 8 punches. Use a screwdriver to take out and replace any attached tanks."
	reference = "PF"
