	...
	machinery
		mineral
			mint
				...
				anchored = 1.0
				var
					amt_silver = 0 //amount of silver
				var
					amt_gold = 0   //amount of gold
				var
					amt_diamond = 0
				var
					amt_iron = 0
				...
				var
					amt_mythril = 0
				var
					newCoins = 0   //how many coins the machine made in it's last load
				var
					processing = 0
				var
					chosen = "metal" //which material will be used to make coins
				var
					coinsToProduce = 10
...
obj
	machinery
		mineral
			mint
				attack_hand(user as mob) //TODO: Adamantine coins! -Durandan
							...
							var
								obj
									item
										weapon
											moneybag
												M = locate(/obj/item/weapon/moneybag/, T)
							if(!M)
