	...
	item
		weapon
			ore
				...
				icon_state = "ore"
				var
					points = 0 //How many points this ore gets you from the ore redemption machine
				var
					refined_type = null //What this ore defaults to being refined into
				var
					datum
						geosample
							geologic_data
									...
									item
										stack
											sheet
												mineral
													sandstone
														SS = new /obj/item/stack/sheet/mineral/sandstone(user.loc)
				...
				required
					gibtonite
						...
						var
							det_time = 100
						var
							quality = 1 //How pure this gibtonite is, determines the explosion produced by it and is derived from the det_time of the rock wall it was taken from, higher value = better
						var
							attacher = "UNKNOWN"
						var
							datum
		...
		weapon
			twohanded
				required
					gibtonite
						proc
							GibtoniteReaction(mob/user, triggered_by = 0)
								if(!primed)
