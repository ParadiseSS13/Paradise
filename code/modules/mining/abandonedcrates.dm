					...
					loot
						New()
							...
							switch(loot)
								...
								if(55 to 56)
									var
										newitem = pick(subtypesof(/obj/item/toy/prize))
									new newitem(src)
								if(57 to 58)
								...
								if(63 to 64)
									for(var/i in 1 to rand(4, 7))
										var
											newcoin = pick(/obj/item/weapon/coin/silver, /obj/item/weapon/coin/silver, /obj/item/weapon/coin/silver, /obj/item/weapon/coin/iron, /obj/item/weapon/coin/iron, /obj/item/weapon/coin/iron, /obj/item/weapon/coin/gold, /obj/item/weapon/coin/diamond, /obj/item/weapon/coin/plasma, /obj/item/weapon/coin/uranium)
										new newcoin(src)
								if(65 to 66)
					...
					loot
						attack_hand(mob/user)
							if(locked)
								...
								var
									input = input(usr, "Enter [codelen] digits.", "Deca-Code Lock", "") as text
