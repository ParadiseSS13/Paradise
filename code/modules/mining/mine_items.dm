	...
	item
		weapon
			pickaxe
				...
				var
					list
						digsound = list('sound/effects/picaxe1.ogg','sound/effects/picaxe2.ogg','sound/effects/picaxe3.ogg')
				var
					drill_verb = "picking"
				sharp = 1
				edge = 1
	...
	item
		weapon
			pickaxe
				drill
					cyborg
						diamond //This is the BORG version!
...
obj
	item
		device
			mobcapsule
				attack(var/atom/A, mob/user, prox_flag)
...
obj
	item
		device
			mobcapsule
				proc
					capture(var/mob/target, var/mob/U as mob)
						var
							mob
								living
									simple_animal
