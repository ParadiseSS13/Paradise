						...
						var
							obj
								item
									stack
										sheet
											inp = machine.stack_list[text2path(href_list["release"])]
						var
							obj
								item
									stack
	...
	machinery
		mineral
			stacking_machine
				...
				var
					stack_amt = 50; //ammount to stack before releassing
				input_dir = EAST
				output_dir = WEST
