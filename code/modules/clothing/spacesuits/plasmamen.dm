					...
					eva
						plasmaman
							...
							var
								next_extinguish = 0
							var
								extinguish_cooldown = 10 SECONDS
							var
								extinguishes_left = 10 // Yeah yeah, reagents, blah blah blah.  This should be simple.
