					...
					rig
						ert
							...
							obj
								item
									device
										radio, /obj/item/device/analyzer, /obj/item/weapon/gun/energy/laser, /obj/item/weapon/gun/energy/pulse, \
							obj
								item
									weapon
										gun
											energy
												gun
													advtaser, /obj/item/weapon/melee/baton, /obj/item/weapon/gun/energy/gun)
							strip_delay = 130
