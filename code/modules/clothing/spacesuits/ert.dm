...
/obj/item/clothing/head/helmet/space/hardsuit/ert
	...
	armor = list(MELEE = 45, BULLET = 25, LASER = 30, ENERGY = 10, BOMB = 25, BIO = INFINITY, RAD = 50, FIRE = 80, ACID = 80)
...
/obj/item/clothing/head/helmet/space/hardsuit/ert/engineer
	...
	armor = list(MELEE = 45, BULLET = 25, LASER = 30, ENERGY = 10, BOMB = 25, BIO = INFINITY, RAD = 75, FIRE = 80, ACID = 80)
...
/obj/item/clothing/head/helmet/space/hardsuit/ert/engineer/gamma
	...
	max_heat_protection_temperature = FIRE_IMMUNITY_MAX_TEMP_PROTECT
	armor = list(MELEE = 45, BULLET = 25, LASER = 30, ENERGY = 10, BOMB = 25, BIO = INFINITY, RAD = INFINITY, FIRE = 80, ACID = 80)
...
/obj/item/clothing/head/helmet/space/hardsuit/ert/paranormal/inquisitor
	...
	armor = list(MELEE = 65, BULLET = 50, LASER = 50, ENERGY = 50, BOMB = 50, BIO = INFINITY, RAD = INFINITY, FIRE = 80, ACID = 80)
...
/obj/item/clothing/head/helmet/space/hardsuit/ert/solgov
	...
	armor = list(MELEE = 35, BULLET = 75, LASER = 15, ENERGY = 10, BOMB = 25, BIO = INFINITY, RAD = 50, FIRE = INFINITY, ACID = INFINITY)
