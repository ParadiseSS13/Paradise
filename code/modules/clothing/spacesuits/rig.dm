			...
			suit
				space
					rig
						...
						var
							obj
								item
									weapon
										stock_parts
											gloves = null     // Basic capacitor allows insulation, upgrades allow shock gloves etc.

						var
							attached_boots = 1                            // Can't wear boots if some are attached
						var
							obj
								item
									clothing
						...
						var
							attached_helmet = 1                           // Can't wear a helmet if one is deployable.
						var
							obj
								item
									clothing
						...
						var
							list
								max_mounted_devices = 0                  // Maximum devices. Easy.
						var
							list
								can_mount = null                         // Types of device that can be hardpoint mounted.
						var
							list
								mounted_devices = null                   // Holder for the above device.
						var
							obj
								item
									active_device = null                 // Currently deployed device, if any.
