...
/obj/item/clothing/head/helmet/space/capspace
	...
	armor = list(MELEE = 40, BULLET = 50, LASER = 50, ENERGY = 25, BOMB = 50, BIO = INFINITY, RAD = 50, FIRE = INFINITY, ACID = INFINITY)
...
/obj/item/clothing/suit/space/swat
	...
	armor = list(MELEE = 40, BULLET = 30, LASER = 30, ENERGY = 30, BOMB = 50, BIO = 90, RAD = 20, FIRE = INFINITY, ACID = INFINITY)
	strip_delay = 120
	resistance_flags = FIRE_PROOF | ACID_PROOF
	species_restricted = list("exclude", "Wryn")
...
/obj/item/clothing/head/helmet/space/eva/paramedic
	...
	armor = list(MELEE = 0, BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 0, BIO = INFINITY, RAD = 20, FIRE = 50, ACID = 65)
	species_restricted = list("exclude", "Wryn")
