			...
			rig
				ert
					...
					obj
						item
							weapon
								screwdriver, /obj/item/weapon/weldingtool, /obj/item/weapon/wirecutters, /obj/item/weapon/wrench, /obj/item/device/multitool, \
					obj
						item
							device
								radio, /obj/item/device/analyzer,/obj/item/weapon/storage/briefcase/inflatable, /obj/item/weapon/melee/baton, /obj/item/weapon/gun, \
					obj
						item
							weapon
								storage
									firstaid, /obj/item/weapon/reagent_containers/hypospray, /obj/item/roller)
