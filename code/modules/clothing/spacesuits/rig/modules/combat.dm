					...
					var
						obj
							item
								weapon
									grenade
										new_grenade = new charge.product_type(get_turf(H))
	...
	item
		rig_module
			mounted
				...
				var
					gun_type = /obj/item/weapon/gun/energy/lasercannon/mounted
				var
					obj
						item
							weapon
	...
	item
		rig_module
			fabricator
				...
				var
					fabrication_type = /obj/item/stack/tile/plasteel
				var
					fire_force = 30
				var
					fire_distance = 10
					...
					if(target)
						...
						if(H.l_hand && H.r_hand)
							...
							var
								obj
									item
										new_weapon = new fabrication_type()
