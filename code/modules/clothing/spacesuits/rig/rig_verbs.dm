					...
					select_module()
						...
						var
							obj
								item
									rig_module
										module = input("Which module do you wish to select?") as null|anything in selectable
					...
					toggle_module()
						...
						var
							obj
								item
									rig_module
										module = input("Which module do you wish to toggle?") as null|anything in selectable
					...
					engage_module()
						...
						var
							obj
								item
									rig_module
										module = input("Which module do you wish to engage?") as null|anything in selectable
