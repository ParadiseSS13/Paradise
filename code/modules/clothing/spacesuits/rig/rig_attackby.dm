				...
				attackby(obj/item/W as obj, mob/user as mob)
					...
					if(open)
						...
						// Check if this is a hardsuit upgrade or a modification.
							...
							var
								to_remove = input("Which would you like to modify?") as null|anything in current_mounts
							if(!to_remove)
								return
							...
							switch(to_remove)
								...
								if("system module")
									...
									var
										removal_choice = input("Which module would you like to remove?") as null|anything in possible_removals
									if(!removal_choice)
										return
									...
									var
										obj
											item
												rig_module
													removed = possible_removals[removal_choice]
...
obj
	item
		weapon
			rig
				emag_act(var/remaining_charges, var/mob/user)
					if(!subverted)
						req_access.Cut()
						req_one_access.Cut()
						locked = 0
