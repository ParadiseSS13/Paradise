...
/obj/item/clothing/shoes/combat
	...
	armor = list(MELEE = 25, BULLET = 25, LASER = 25, ENERGY = 25, BOMB = 50, RAD = 0, FIRE = 70, ACID = 50)
	strip_delay = 70
...
/obj/item/clothing/shoes/combat/swat
	...
	armor = list(MELEE = 40, BULLET = 30, LASER = 25, ENERGY = 25, BOMB = 50, RAD = 30, FIRE = 90, ACID = 50)
	no_slip = TRUE
...
/obj/item/clothing/shoes/galoshes
	...
	resistance_flags = NONE
	dyeable = FALSE
	armor = list(MELEE = 0, BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 0, RAD = 0, FIRE = 40, ACID = 75)
...
/obj/item/clothing/shoes/cowboy/lizard
	...
	armor = list(MELEE = 0, BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 0, RAD = 0, FIRE = 40, ACID = 0) //lizards like to stay warm
