				...
				storage
					paramedic
						...
						obj
							item
								device
									healthanalyzer, /obj/item/device/flashlight, /obj/item/device/radio, /obj/item/weapon/tank/emergency_oxygen,/obj/item/device/rad_laser)
				...
				storage
					brigdoc
						...
						obj
							item
								device
									healthanalyzer, /obj/item/device/flashlight, \
						obj
							item
								device
									radio, /obj/item/weapon/tank/emergency_oxygen,/obj/item/device/rad_laser)
