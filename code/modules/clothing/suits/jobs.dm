...
/obj/item/clothing/suit/storage/paramedic
	...
	armor = list(melee = 0, bullet = 0, laser = 0, energy = 0, bomb = 0, bio = 10, rad = 10, shock = 0)
...
/obj/item/clothing/suit/storage/brigdoc
	...
	armor = list(melee = 10, bullet = 0, laser = 0, energy = 0, bomb = 0, bio = 10, rad = 0, shock = 0)
	species_fit = list("Vox")
	sprite_sheets = list(
		"Vox" = 'icons/mob/species/vox/suit.dmi'
		)
...
/obj/item/clothing/suit/storage/det_suit
	...
	armor = list(melee = 25, bullet = 10, laser = 25, energy = 10, bomb = 0, bio = 0, rad = 0, shock = 15)
