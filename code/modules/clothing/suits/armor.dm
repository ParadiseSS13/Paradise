...
/obj/item/clothing/suit/armor/vest/capcarapace
	...
	item_state = "armor"
	body_parts_covered = UPPER_TORSO|LOWER_TORSO
	armor = list(MELEE = 50, BULLET = 40, LASER = 50, ENERGY = 10, BOMB = 25, BIO = 0, RAD = 0, FIRE = INFINITY, ACID = 90)
	dog_fashion = null
...
/obj/item/clothing/suit/armor/laserproof
	...
	blood_overlay_type = "armor"
	armor = list(MELEE = 10, BULLET = 10, LASER = 75, ENERGY = 50, BOMB = 0, BIO = 0, RAD = 0, FIRE = INFINITY, ACID = INFINITY)
...
/obj/item/clothing/suit/hooded/drake
	...
	armor = list(MELEE = 70, BULLET = 30, LASER = 50, ENERGY = 40, BOMB = 70, BIO = 60, RAD = 50, FIRE = INFINITY, ACID = INFINITY)
