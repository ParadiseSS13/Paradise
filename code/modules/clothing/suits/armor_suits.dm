...
// a fair alternative to bone armor, requiring alternative materials and gaining a suit slot
/obj/item/clothing/suit/hooded/goliath
	...
	armor = list(MELEE = 35, BULLET = 10, LASER = 25, ENERGY = 10, BOMB = 25, RAD = 0, FIRE = 60, ACID = 60)
