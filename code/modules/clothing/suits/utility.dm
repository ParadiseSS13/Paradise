...
/obj/item/clothing/suit/fire
	...
	slowdown = 1
	armor = list(MELEE = 15, BULLET = 5, LASER = 20, ENERGY = 10, BOMB = 20, RAD = 20, FIRE = 100, ACID = 50)
...
/obj/item/clothing/head/bomb_hood
	...
	armor = /obj/item/clothing/suit/bomb_suit::armor
...
/obj/item/clothing/suit/bomb_suit
	...
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|LEGS|FEET|ARMS|HANDS
	slowdown = 2
	armor = list(MELEE = 20, BULLET = 0, LASER = 20, ENERGY = 10, BOMB = 100, RAD = 0, FIRE = 80, ACID = 50)
...
/obj/item/clothing/head/radiation
	...
	flags = BLOCKHAIR|THICKMATERIAL
	flags_cover = HEADCOVERSEYES | HEADCOVERSMOUTH
	armor = /obj/item/clothing/suit/radiation::armor
	strip_delay = 60
	put_on_delay = 60
	resistance_flags = NONE
...
/obj/item/clothing/suit/radiation
	...
	slowdown = 0.75
	armor = list(MELEE = 0, BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 0, RAD = 100, FIRE = 30, ACID = 30)
	flags_inv = HIDEJUMPSUIT|HIDETAIL
	strip_delay = 60
	put_on_delay = 60
	resistance_flags = NONE
