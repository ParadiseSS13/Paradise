...
/obj/item/clothing/suit/fire
	...
	slowdown = 1
	armor = list(MELEE = 15, BULLET = 5, LASER = 20, ENERGY = 10, BOMB = 20, BIO = 10, RAD = 20, FIRE = INFINITY, ACID = 50)
...
/obj/item/clothing/head/bomb_hood
	...
	armor = list(MELEE = 20, BULLET = 0, LASER = 20, ENERGY = 10, BOMB = INFINITY, BIO = 0, RAD = 0, FIRE = 80, ACID = 50)
...
/obj/item/clothing/head/radiation
	...
	flags = BLOCKHAIR|THICKMATERIAL
	flags_cover = HEADCOVERSEYES | HEADCOVERSMOUTH
	armor = list(MELEE = 0, BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 0, BIO = 60, RAD = INFINITY, FIRE = 30, ACID = 30)
	strip_delay = 60
	put_on_delay = 60
	resistance_flags = NONE
