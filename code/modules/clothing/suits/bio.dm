...
/obj/item/clothing/head/bio_hood
	...
	armor = list(MELEE = 0, BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 0, BIO = INFINITY, RAD = 80, FIRE = 30, ACID = INFINITY)
...
/obj/item/clothing/head/bio_hood/security
	armor = list(MELEE = 25, BULLET = 15, LASER = 25, ENERGY = 10, BOMB = 25, BIO = INFINITY, RAD = 80, FIRE = 30, ACID = INFINITY)
