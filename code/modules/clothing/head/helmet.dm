...
/obj/item/clothing/head/helmet/alt
	...
	icon_state = "swat"
	item_state = "swat-alt"
	armor = list(MELEE = 15, BULLET = 75, LASER = 10, ENERGY = 10, BOMB = 40, BIO = 0, RAD = 0, FIRE = 50, ACID = 50)
	dog_fashion = null
...
/obj/item/clothing/head/helmet/thunderdome
	...
	armor = list(MELEE = 200, BULLET = 200, LASER = 50, ENERGY = 50, BOMB = INFINITY, BIO = INFINITY, RAD = INFINITY, FIRE = 90, ACID = 90)
	cold_protection = HEAD
	min_cold_protection_temperature = SPACE_HELM_MIN_TEMP_PROTECT
	heat_protection = HEAD
	max_heat_protection_temperature = SPACE_HELM_MAX_TEMP_PROTECT
...
/obj/item/clothing/head/helmet/roman
	...
	flags = null
	armor = list(MELEE = 25, BULLET = 0, LASER = 25, ENERGY = 10, BOMB = 10, BIO = 0, RAD = 0, FIRE = INFINITY, ACID = 50)
