...
/obj/item/clothing/head/soft/solgov
	name = "\improper Federation marine cap"
...
/obj/item/clothing/head/soft/solgov/marines/elite
	name = "\improper Federation MARSOC cap"
	desc = "A cap worn by marines of the Federation's Marine Special Operations Command. You aren't quite sure how they made this bulletproof, but you are glad it is!"
...
/obj/item/clothing/head/soft/solgov/marines/command
	name = "\improper Federation marine lieutenant's cap"
...
/obj/item/clothing/head/soft/solgov/marines/command/elite
	name = "\improper Federation MARSOC Lieutenant's cap"
	desc = "A cap worn by junior officers of the Federation's Marine Special Operations Command. You aren't quite sure how they made this bulletproof, but you are glad it is! The insignia signifies the wearer bears the rank of a Lieutenant."
	armor = list(MELEE = 25, BULLET = 75, LASER = 5, ENERGY = 5, BOMB = 15, RAD = 50, FIRE = 200, ACID = 200)
