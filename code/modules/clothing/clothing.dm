...
/obj/item/clothing/under/hit_reaction(mob/living/carbon/human/owner, atom/movable/hitby, attack_text = "the attack", final_block_chance = 0, damage = 0, attack_type = MELEE_ATTACK)
	for(var/obj/item/clothing/accessory/A in accessories)
		A.hit_reaction(owner, hitby, attack_text, final_block_chance, damage, attack_type)
	return ..()
