								...
								obj
									item
										clothing
											under
												color
													C = pick(subtypesof(/obj/item/clothing/under/color) - excluded)
							name = initial(C.name)
