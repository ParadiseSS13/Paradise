...
obj
	item
		clothing
			under
				contortionist
					dropped(mob/living/carbon/human/user)
	...
	item
		clothing
			under
				contortionist
					proc
						check_clothing(mob/user as mob)
							//Allowed to wear: glasses, shoes, gloves, pockets, mask, and jumpsuit (obviously)
							var
								list
									slot_must_be_empty = list(slot_back,slot_handcuffed,slot_legcuffed,slot_l_hand,slot_r_hand,slot_belt,slot_head,slot_wear_suit)
