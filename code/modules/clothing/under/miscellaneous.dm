...
/obj/item/clothing/under/solgov
	...
	item_state = "ro_suit"
	item_color = "solgov"
	armor = list(melee = 10, bullet = 0, laser = 0, energy = 0, bomb = 0, bio = 0, rad = 0, shock = 0)
	displays_id = 0
...
/obj/item/clothing/under/acj
	...
	armor = list(melee = 100, bullet = 100, laser = 100, energy = 100, bomb = 100, bio = 100, rad = 100, shock = 100)
...
/obj/item/clothing/under/vox/engi
	...
	item_state = "vengine"
	item_color = "vengine"
	armor = list(melee = 0, bullet = 0, laser = 0, energy = 0, bomb = 0, bio = 0, rad = 10, shock = 0)
