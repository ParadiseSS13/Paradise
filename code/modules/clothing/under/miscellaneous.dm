...
/obj/item/clothing/under/rank/centcom/blueshield
	desc = "Gold trim on space-black cloth, this uniform displays the rank of \"Lieutenant\" and bears \"N.T.D.S.F. Stratus\" on the left shounder."
...
/obj/item/clothing/under/rank/centcom/representative
	desc = "Gold trim on space-black cloth, this uniform displays the rank of \"Ensign\" and bears \"N.T.D.S.F. Stratus\" on the left shounder."
	name = "\improper Nanotrasen Navy Uniform"
	icon_state = "officer"
	item_state = "g_suit"
	item_color = "officer"
