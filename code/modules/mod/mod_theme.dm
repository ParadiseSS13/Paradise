	...
	var/list/skins = list(
		"standard" = list(
			HELMET_FLAGS = list(
				...
				SEALED_INVISIBILITY =  HIDEFACE | HIDEMASK | HIDEEARS | HIDEEYES | HIDEFACE,
		...
		"civilian" = list(
			HELMET_FLAGS = list(
				...
				UNSEALED_CLOTHING = THICKMATERIAL,
				SEALED_CLOTHING = STOPSPRESSUREDMAGE,
				UNSEALED_INVISIBILITY = HIDEFACE | HIDEMASK | HIDEEARS | HIDEEYES | HIDEFACE,
	...
	skins = list(
		"mining" = list(
			HELMET_FLAGS = list(
				...
				SEALED_INVISIBILITY = HIDEMASK | HIDEEARS | HIDEEYES | HIDEFACE | HIDEFACE,
				SEALED_COVER = HEADCOVERSMOUTH | HEADCOVERSEYES,
			),
			CHESTPLATE_FLAGS = list(
				UNSEALED_CLOTHING = THICKMATERIAL,
