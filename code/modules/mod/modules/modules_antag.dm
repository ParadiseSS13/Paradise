...
/obj/item/mod/module/stealth/on_activation()
	...
	mod.wearer.set_alpha_tracking(stealth_alpha, /obj/item/mod/module/stealth, update_alpha = FALSE)
...
/obj/item/mod/module/stealth/on_deactivation(display_message = TRUE, deleting = FALSE)
	...
	mod.wearer.set_alpha_tracking(ALPHA_VISIBLE, /obj/item/mod/module/stealth, update_alpha = FALSE)
	animate(mod.wearer, alpha = mod.wearer.get_alpha(), time = 1.5 SECONDS)
