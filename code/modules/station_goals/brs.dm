...
/datum/station_goal/bluespace_rift/get_report()
	...
	что некоторые следы присутствия блюспейс-активности подобного рода могут быть обнаружены при помощи инженерных T-ray сканеров. 
	Постарайтесь усовершенствовать данные приборы, у научного отдела станции должны быть все необходимые для этого технологии.
	<br><br>
	Разлом не представляет опасности для структкрной целостности станции. Тем не менее, сканирующая аппаратура может вызвать колебания его стабильности. \
