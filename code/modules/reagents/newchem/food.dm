...
datum
	reagent
		triple_citrus
			reaction_mob(var/mob/living/carbon/M as mob, var/method=TOUCH, var/volume)
...
datum
	reagent
		porktonium
			overdose_process(var/mob/living/M as mob, severity)
				if(prob(15))
	...
	reagent
		ectoplasm
			reaction_mob(var/mob/M, var/method=TOUCH, var/volume)
				...
				if(method == INGEST)
					var
						spooky_eat = pick("Ugh, why did you eat that? Your mouth feels haunted. Haunted with bad flavors.", "Ugh, why did you eat that? It has the texture of ham aspic.  From the 1950s.  Left out in the sun.", "Ugh, why did you eat that? It tastes like a ghost fart.", "Ugh, why did you eat that? It tastes like flavor died.")
...
datum
	reagent
		ectoplasm
			on_mob_life(var/mob/living/M as mob)
				var
					spooky_message = pick("You notice something moving out of the corner of your eye, but nothing is there...", "Your eyes twitch, you feel like something you can't see is here...", "You've got the heebie-jeebies.", "You feel uneasy.", "You shudder as if cold...", "You feel something gliding across your back...")
				if(prob(8))
