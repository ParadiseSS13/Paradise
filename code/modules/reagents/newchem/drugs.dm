	...
	reagent
		nicotine
			on_mob_life(var/mob/living/M as mob)
				...
				var
					smoke_message = pick("You feel relaxed.", "You feel calmed.", "You feel less stressed.", "You feel more placid.", "You feel more undivided.")
				if(prob(5))
	...
	reagent
		aranesp
			on_mob_life(var/mob/living/M as mob)
				...
				var
					high_message = pick("really buff", "on top of the world","like you're made of steel", "energized", "invigorated", "full of energy")
				if(prob(8))
		...
		lube
			ultra
				on_mob_life(var/mob/living/M as mob)
					if(!M) M = holder.my_atom
					var
						high_message = pick("You feel your servos whir!", "You feel like you need to go faster.", "You feel like you were just overclocked!")
					if(prob(1))
						if(prob(1))
		...
		surge
			overdose_process(var/mob/living/M as mob, severity)
				...
				if(prob(10))
					...
					var
						icon
							I=new('icons/obj/zap.dmi',"lightningend")
					I.Turn(-135)
					var
						obj
							effect
