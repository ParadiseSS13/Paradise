...
/datum/reagent/consumable/alcoholic/dragons_breath/reaction_mob(mob/living/M, method=TOUCH, volume)
...
/datum/reagent/consumable/alcoholic/synthanol/reaction_mob(mob/living/M, method=TOUCH, volume)
	if(M.dna.species.reagent_tag & PROCESS_SYN)
		return
	if(method == INGEST)
