...
/obj/machinery/chem_dispenser/soda
	...
	"watermelonjuice", "carrotjuice", "potato", "berryjuice", "strawberryjuice", "pineapplejuice", "coconutjuice", "raspberryjuice", "cranberryjuice","maplesyrup")
	upgrade_reagents = list("bananahonk", "milkshake", "cafe_latte", "cafe_mocha", "triple_citrus", "icecoffe","icetea")
	hacked_reagents = list("thirteenloko", "pearjuice", "mangojuice", "grapefruitjuice", "grapejuice")
...
/obj/machinery/chem_dispenser/beer
	...
	dispensable_reagents = list("ice", "cream", "cider", "beer", "darkbeer", "kahlua", "whiskey", "wine", "whitewine", "vodka", "gin", "rum", "tequila", "vermouth", "cognac", "ale", "mead", "synthanol","amaretto","bourbon","brandy","cointreau","watermelonliqueur","mintliqueur","peachliqueur","bananaliqueur","violetliqueur","nutliqueur","cherryliqueur","bluecuracao")
	upgrade_reagents = list("iced_beer", "irishcream", "manhattan", "antihol", "synthignon", "bravebull", "grappa", "bitters", "aperol")
	hacked_reagents = list("goldschlager", "patron", "absinthe", "ethanol", "nothing", "sake", "grappa", "champagne", "kumis", "boukha")
