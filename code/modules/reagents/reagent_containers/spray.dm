...
/obj/item/weapon/reagent_containers/spray/afterattack(atom/A as mob|obj, mob/user as mob)
	...
	if(reagents.has_reagent("sacid"))
		message_admins("[key_name_admin(user)](<A HREF='?_src_=holder;adminmoreinfo=\ref[user]'>?</A>) ([admin_jump_link(user, "holder")]) fired sulphuric acid from \a [src].")
		log_game("[key_name(user)](<A HREF='?_src_=holder;adminmoreinfo=\ref[user]'>?</A>) ([admin_jump_link(user, "holder")]) fired sulphuric acid from \a [src].")
	if(reagents.has_reagent("facid"))
		message_admins("[key_name_admin(user)](<A HREF='?_src_=holder;adminmoreinfo=\ref[user]'>?</A>) ([admin_jump_link(user, "holder")]) fired fluorosulfuric acid from \a [src].")
		log_game("[key_name(user)] fired Fluorosulfuric Acid from \a [src].")
	if(reagents.has_reagent("lube"))
		message_admins("[key_name_admin(user)](<A HREF='?_src_=holder;adminmoreinfo=\ref[user]'>?</A>) ([admin_jump_link(user, "holder")]) fired space lube from \a [src].")
