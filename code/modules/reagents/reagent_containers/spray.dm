		...
		weapon
			reagent_containers
				spray
					...
					throw_range = 7
					var
						spray_maxrange = 3 //what the sprayer will set spray_currentrange to in the attack_self.
					var
						spray_currentrange = 3 //the range of tiles the sprayer will reach when in fixed mode.
				...
				spray
					afterattack(atom/A as mob|obj, mob/user as mob)
						...
						if(istype(A, /obj/structure/reagent_dispensers) && get_dist(src,A) <= 1) //this block copypasted from reagent_containers/glass, for lack of a better solution
							...
							var
								trans = A.reagents.trans_to(src, A:amount_per_transfer_from_this)
							...
							var
								obj
									effect
										decal
											chempuff
												D = new /obj/effect/decal/chempuff(get_turf(src))
	...
	item
		weapon
			reagent_containers
				spray
					waterflower
						attack_self(var/mob/user) //Don't allow changing how much the flower sprays
							return
