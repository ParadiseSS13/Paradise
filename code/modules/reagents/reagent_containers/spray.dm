...
/obj/item/reagent_containers/spray/afterattack(atom/A, mob/user)
	...
	if(reagents.has_reagent("sacid"))
		msg_admin_attack("[key_name_admin(user)] fired sulphuric acid from \a [src] at [COORD(src)].", ATKLOG_FEW)
		log_game("[key_name(user)] fired sulphuric acid from \a [src] at [COORD(src)].")
	if(reagents.has_reagent("facid"))
		msg_admin_attack("[key_name_admin(user)] fired fluorosulfuric acid from \a [src] at [COORD(src)].", ATKLOG_FEW)
