				...
				food
					drinks
						bottle
							...
							var
								const
									duration = 13 //Directly relates to the 'weaken' duration. Lowered by armor (i.e. helmets)
							var
			...
			reagent_containers
				food
					drinks
						bottle
							proc
								smash(mob/living/target as mob, mob/living/user as mob)
									...
									var
										icon
											I = new('icons/obj/drinks.dmi', src.icon_state)
								...
								var
									obj
										item
											organ
												external
													affecting = user.zone_sel.selecting //Find what the player is aiming at

								var
									armor_block = 0 //Get the target's armour values for normal attack damage.
								var
									armor_duration = 0 //The more force the bottle has, the longer the duration.
											...
											living
												carbon
													human
														H = target
									var
										headarmor = 0 // Target's head armour
	...
	item
		weapon
			broken_bottle
				...
				var
					icon
						broken_outline = icon('icons/obj/drinks.dmi', "broken")
