...
obj
	structure
		reagent_dispensers
			verb
				set_APTFT() //set amount_per_transfer_from_this
					...
					if(usr.stat || !usr.canmove || usr.restrained())
						return
					var
						N = input("Amount per transfer from this:","[src]") as null|anything in possible_transfer_amounts
					if(N)
