...
obj
	structure
		disposalconstruct
			...
			var
				dpdir = 0	// directions as disposalpipe
			var
				base_state = "pipe-s"
		...
		disposalconstruct
			attackby(var/obj/item/I, var/mob/user, params)
				var
					nicetype = "pipe"
				var
					ispipe = 0 // Indicates if we should change the level of this pipe
								...
								if(ispipe) // Pipe
									...
									var
										obj
											machinery
												disposal
													P = new /obj/machinery/disposal(src.loc)
									src.transfer_fingerprints_to(P)
									...
									var
										obj
											structure
												disposaloutlet
													P = new /obj/structure/disposaloutlet(src.loc)
									src.transfer_fingerprints_to(P)
									P.dir = dir
									var
										obj
									...
									var
										obj
											machinery
												disposal
													deliveryChute
														P = new /obj/machinery/disposal/deliveryChute(src.loc)
									src.transfer_fingerprints_to(P)
									P.dir = dir
