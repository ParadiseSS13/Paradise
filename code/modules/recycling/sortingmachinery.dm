...
/obj/structure/bigDelivery/attackby__legacy__attackchain(obj/item/W as obj, mob/user as mob, params)
...
/obj/item/smallDelivery/attack_self__legacy__attackchain(mob/user)
...
/obj/item/smallDelivery/attackby__legacy__attackchain(obj/item/W as obj, mob/user as mob, params)
	if(istype(W, /obj/item/destTagger))
		var/obj/item/destTagger/O = W
...
/obj/item/destTagger/attack_self__legacy__attackchain(mob/user)
	add_fingerprint(user)
	ui_interact(user)
...
/obj/item/shippingPackage/attackby__legacy__attackchain(obj/item/O, mob/user, params)
	if(sealed)
		if(is_pen(O))
...
/obj/item/shippingPackage/attack_self__legacy__attackchain(mob/user)
	if(sealed)
