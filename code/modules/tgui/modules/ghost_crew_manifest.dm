...
/datum/ui_module/ghost_crew_manifest/ui_interact(user, ui_key = "GhostCrewManifest", datum/tgui/ui = null, datum/tgui/master_ui = null, state)
	ui = SStgui.try_update_ui(user, src, ui_key, ui)
	if(!ui)
		ui = new(user, src, ui_key, "GhostCrewManifest", name, 588, 510, master_ui, state)
