...
obj
	item
		ammo_casing
			energy
				laser
					hos //allows balancing of HoS and blueshit guns seperately from other energy weapons
...
obj
	item
		ammo_casing
			energy
				wormhole
					New(var/obj/item/weapon/gun/energy/wormhole_projector/wh)
						gun = wh
