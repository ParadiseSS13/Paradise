...
/obj/item/gun/projectile/automatic/lasercarbine
	...
	w_class = WEIGHT_CLASS_NORMAL
	origin_tech = "combat=4;materials=2"
	mag_type = /obj/item/ammo_box/magazine/lasercarbine
...
/obj/item/gun/projectile/automatic/laserrifle
	...
	mag_type = /obj/item/ammo_box/magazine/laserrifle
	fire_sound = 'sound/weapons/gunshots/gunshot_lascarbine.ogg'
	magin_sound = 'sound/weapons/gun_interactions/batrifle_magin.ogg'
	magout_sound = 'sound/weapons/gun_interactions/batrifle_magout.ogg'
	can_suppress = FALSE
...
/obj/item/gun/projectile/automatic/laserrifle/update_icon_state()
	icon_state = "laserrifle[magazine ? "-[CEILING(get_ammo(0)/6, 1)*6]" : ""]"
	item_state = "laserrifle[magazine ? "-[CEILING(get_ammo(0)/6, 1)*6]" : ""]"
