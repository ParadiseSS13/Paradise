...
/obj/item/weapon/gun/projectile/automatic/toy/pistol/enforcer
	name = "Foam Enforcer"
	desc = "A foam shooting version of the Enforcer meant to be used for training new caddets who can't be trusted with rubber bullets. Supposedly the colors mean something"
	icon_state = "enforcer-train"
	mag_type = /obj/item/ammo_box/magazine/toy/enforcer
	can_flashlight = TRUE
	unique_reskin = TRUE

/obj/item/weapon/gun/projectile/automatic/toy/pistol/enforcer/New()
	..()
...
/obj/item/weapon/gun/projectile/automatic/toy/pistol/enforcer/riot
	icon_state = "enforcer-riot"

/obj/item/weapon/gun/projectile/automatic/toy/pistol/enforcer/nt
