...
/obj/item/gun/energy/pulse/carbine
	...
	flight_x_offset = 18
	flight_y_offset = 12
	extended_description = "The pulse carbine is an iteration of the pulse rifle that trades off endurance for practicality. \
	The power cell has been downsized and the internals have been jammed closer together, allowing the frame to be reduced in size and also mass.<br><br>\
...
/obj/item/gun/energy/pulse/pistol
	...
	can_charge = FALSE
	extended_description = "The pulse pistol is the result of Nanotrasen R&D trying their best to miniaturise the pulse rifle as much as possible. \
	Miraculously, it works! It fits nicely into pockets, holsters, and any other place one may hide a traditional pistol.<br><br>\
	...
	The pistol's anaemic heatsink prevents it from efficiently rejecting the heat from firing, causing cumulative damage with every shot. \
...
/obj/item/gun/energy/pulse/pistol/m1911/examine(mob/user)
	. = ..()
	. += "<span class='notice'>This weapon has an experimental power cell with an effectively unlimited amount of energy. It will never run out of charge.</span>"
...
/obj/item/gun/energy/pulse/turret
	...
	ammo_x_offset = 2
	extended_description = "Most of the issues that affect pulse weaponry are negated or massively reduced when they are employed in emplacements. Significantly larger cooling systems and additional spacing between \
	...
	Whilst the laser does still cause damage to the optical assembly over time, the service life is still leaps and bounds ahead of handheld versions."
