/obj/item/gun/energy/kinetic_accelerator
	...
	desc = "A self recharging, ranged mining tool that does increased damage in low pressure. Capable of holding up to three slots worth of mod kits."
	...
	if(in_range(user, src))
		if(max_mod_capacity)
			...
			for(var/A in get_modkits())
				...
				. += "<span class='notice'>You can use a crowbar on it to remove it's installed mods.</span>"
