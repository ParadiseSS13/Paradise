/obj/item/gun/energy/laser
	...
	extended_description = "A compact but versatile laser carbine, and an icon of the Shellguard Munitions Co. arsenal. Its origins stem back to early corporate expansion, \
	...
	and most iconic laser brands throughout the Orion sector, thanks to low cost and excessive overproduction of units.<br><br>\
	...
	surprisingly light for its size. Heat generated during firing is dissipated by a fan-assisted heatsink, protecting the internal power cell and optical assembly from overheating.<br><br>\
	...
	Foregrips are among the most common modifications seen, as despite the lack of recoil generated by laser weapons, the \"tactical, militaristic\" appearance they are perceived to add makes them very popular.<br><br>\
...
/obj/item/gun/energy/laser/captain
	...
	icon_state = "caplaser"
	item_state = null
	desc = "This is an antique laser gun. All craftsmanship is of the highest quality. It is decorated with bovine leather and chrome. The object menaces with spikes of energy. On the item is an image of Space Station 13. The station is exploding."
	force = 10
	origin_tech = null
	ammo_x_offset = 3
	selfcharge = TRUE
	resistance_flags = INDESTRUCTIBLE | LAVA_PROOF | FIRE_PROOF | ACID_PROOF
	extended_description = "This unique laser gun was commissioned by the research director of Nanotrasen's old Martian research facility back in 2451. \
	...
	it was vastly superior to any of its contemporaries back when it was originally made.<br><br>\
	...
	The gun's furniture and decorative embellishments were all hand-made by small group highly trained artisans for a comparatively tiny cost.<br><br>\
...
/obj/item/gun/energy/laser/captain/examine(mob/user)
	. = ..()
	. += "<span class='notice'>The power cell of this item slowly recharges on its own.</span>"
...
/obj/item/gun/energy/laser/captain/scattershot
	...
	shaded_charge = FALSE
	extended_description = "<span class='notice'><i>You examine the scatter shot laser rifle closer, but find nothing of interest...</i></span>"	// Never seen this get used so it probably doesn't need an extended description.
...
/obj/item/gun/energy/laser/scatter
	...
	ammo_type = list(/obj/item/ammo_casing/energy/laser/scatter, /obj/item/ammo_casing/energy/laser)
	extended_description = "<span class='notice'><i>You examine the scatter laser gun closer, but find nothing of interest...</i></span>"	// Never seen this get used so it probably doesn't need an extended description.
...
/obj/item/gun/energy/lasercannon
	...
	extended_description = "This offering from Nanotrasen R&D is a real headscratcher. No one is quite sure how it works or how they did it, \
	but the fired beam becomes more damaging the further it travels from the barrel. Kind of like a gyrojet but made of light. No plasma or bluespace to account for this one.<br><br>\
...
/obj/item/gun/energy/xray
	...
	extended_description = "The X-Ray laser gun is an unusual entry into Nanotrasen's R&D line-up. \
	It generates beams of ultra-short wavelength light (~750 picometers) that are capable of passing through solid objects, \
	making it an ideal weapon for attacking targets in indoor environments or behind cover with impunity.<br><br>\
	...
	The very high energy used to generate the beam ensures that the damage dealt is roughly equivalent to a traditional laser rifle (at close range).<br><br>\
...
/obj/item/gun/energy/immolator
	...
	origin_tech = "combat=4;magnets=4;powerstorage=3"
	shaded_charge = TRUE
	extended_description = "The Immolator laser gun is a brutally effective laserarm that was accidentally created by Nanotrasen R&D whilst experimenting with plasma-based lasers. \
	...
	much less intense 650 nm red beam (responsible for the visibility of the fired beam).<br><br>\
	...
	Shots from the Immolator will ignite practically any remotely flammable material, from clothing to flesh, causing severe full-body burns in addition to the damage caused at the site of impact.<br><br>\
...
/obj/item/gun/energy/immolator/multi
	...
	extended_description = "Following numerous refinements by Nanotrasen R&D, the Immolator laser gun was upgraded to make it a truly terrifying killing machine. \
	Beefed up components, a more powerful lasing apparatus, and a bigger cell to offset the increased power draw lend this weapon more heft than the original, but also give it more powerful shots.<br><br>\
	...
	allowing entire rooms to be quickly peppered with incendiary laser fire.<br><br>\
...
/obj/item/gun/energy/emitter
	...
	ammo_x_offset = 3
	extended_description = "Emitters are very robust lasers used in special industrial applications. It doesn't take a genius to figure out that they can also be used in combat. \
	Their industrial nature makes them more bulky than laserarms designed from the onset as weapons, but this is offset by the larger and more powerful beam that they can generate.<br><br>\
...
/obj/item/gun/energy/laser/tag
	...
	ammo_x_offset = 2
	selfcharge = TRUE
	extended_description = "<span class='notice'><i>You examine the laser tag gun closer, but find nothing of interest...</i></span>"	// It's a laser tag gun.
