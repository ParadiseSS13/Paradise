...
/obj/item/gun/energy/laser/instakill/examine_more(mob/user)
	. = ..()
	. = list()
	. += "Utilizing top-shelf Shellguard batteries, a sleek off-white chassis, and a dense enough lense to make an optometrist cry, this rifle fires laser bolts that can violently disassemble anyone it hits. You're still not sure when it would be useful, though."
	. += ""
