...
/obj/item/gun/energy/plasma_pistol
	...
	Uniquely among its catalogue of experimental weapons, it uses plasma projectiles instead of lasers or other particles to deal damage.<br><br>\
...
/obj/item/gun/energy/bsg
	...
	extended_description = "When a bluespace crystal is correctly charged and agitated, it releases high-energy exotic particles that are very deadly to living beings. \
	The BSG is the culimination of Nanotrasen's research into portable weaponised bluespace technology.<br><br>\
	By using a captive flux anomaly core to supercharge the weapon's bluespace crytal, a massive sphere of condensed energy is released. This sphere will release an energy discharge upon hitting a solid object, \
	causing extensive damage to flesh and robotic components. As the sphere dischargers, it will also detonate, emitting a powerful pulse of infrared radition that will cause flash burns on anyone caught within the detonation radius.<br><br>\
