		...
		weapon
			gun
				energy
					wormhole_projector
						proc
							portal_destroyed(obj/effect/portal/P)
		...
		weapon
			gun
				energy
					wormhole_projector
						proc
							create_portal(obj/item/projectile/beam/wormhole/W)
								var
									obj
										effect
											portal
												P = new /obj/effect/portal(get_turf(W), null, src)
								P.precision = 0
								P.failchance = 0
		...
		weapon
			gun
				energy
					laser
						instakill
							emp_act() //implying you could stop the instagib
								return
			...
			gun
				energy
					temperature
						...
						var
							emagged = 0			//ups the temperature cap from 500 to 1000, targets hit by beams over 500 Kelvin will burst into flames
						var
							dat = ""
					...
					temperature
						process()
							...
							if(target_temperature != temperature)
								var
									difference = abs(target_temperature - temperature)
			...
			gun
				energy
					mimicgun
						...
						ammo_x_offset = 3
						var
							mimic_type = /obj/item/weapon/gun/projectile/automatic/pistol //Setting this to the mimicgun type does exactly what you think it will.
