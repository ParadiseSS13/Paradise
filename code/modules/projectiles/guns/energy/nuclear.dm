...
/obj/item/gun/energy/gun/nuclear/examine(mob/user)
	. = ..()
	. += "<span class='notice'>This items cell recharges on it's own. Known to drive people mad forced to wait for to wait for shots to recharge. Cannot be recharged in a recharger.</span>"
