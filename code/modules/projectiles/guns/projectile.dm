		...
		weapon
			gun
				projectile
					...
					var
						mag_type = /obj/item/ammo_box/magazine/m10mm //Removes the need for max_ammo and caliber info
					var
						obj
							item
								ammo_box
...
obj
	item
		weapon
			gun
				projectile
					process_chamber(eject_casing = 1, empty_chamber = 1)
						var
							obj
								item
									ammo_casing
										AC = chambered //Find chambered round
...
obj
	item
		weapon
			gun
				projectile
					attackby(var/obj/item/A as obj, mob/user as mob, params)
						..()
	...
	item
		weapon
			gun
				projectile
					proc
						get_ammo(countchambered = 1)
							var
								boolets = 0 //mature var names for mature people
