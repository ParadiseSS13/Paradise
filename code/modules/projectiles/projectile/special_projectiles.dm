...
/obj/item/projectile/energy/demonic_shocker
...
/obj/item/projectile/energy/demonic_shocker/on_hit(atom/target, blocked = 0)
	if(!isliving(target))
		return ..()
	chain(target, firer)
	return ..()

/obj/item/projectile/energy/demonic_shocker/proc/chain(mob/living/target, mob/source)
