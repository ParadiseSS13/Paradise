	...
	machinery
		computer3
			...
			var
				allow_disassemble	= 1
			var
				legacy_icon			= 0 // if 1, use old style icons
			var
				show_keyboard		= 1
			...
			var
				default_prog		= null											// the program running when spawned
			var
				list
					spawn_files	= list()										// files added when spawned
			var
				list
					spawn_parts	= list(/obj/item/part/computer/storage/hdd/big)	// peripherals to spawn
					...
					item
						part
							computer
								networking
									radio
										radio		= null	// not handled the same as other networks
			var
				obj
					item
						part
							computer
								networking
									cameras
										camnet	= null	// just plain special
			var
				obj
					item
						part
							computer
								networking
									net				= null	// Proximity, area, or cable network
			...
			var
				datum
					file
						program
							program		= null	// the active program (null if defaulting to os)
			var
				datum
					file
						program
							os			= null	// the base code of the machine (os or hardcoded program)
				...
				obj
					item
						weapon
							stock_parts
								cell
									battery	= null // uninterruptible power supply aka battery
			...
			*/
			...
			attackby(I as obj, mob/user as mob, params)
				...
				*/
				var
					list
						peripherals = list(hdd,floppy,radio,net,cardslot,cradle) //camnet, toybox removed
			...
			update_icon()
				...
				if(program)
					...
					var
						global
							image
								generic = image('icons/obj/computer3.dmi',icon_state="osod") // orange screen of death
