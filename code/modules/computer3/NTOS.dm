					...
					obj
						item
							part
								computer
									storage
										current // the drive being viewed, null for desktop/computer
				var
					fileop = "runfile"
...
datum
	file
		program
			ntos
				proc
					desktop(var/peripheralop = "viewperipheral")
						var
							dat = "<table border='0' align='left'>"
						var
							i = 0
						var
							list
								peripherals = list(computer.hdd,computer.floppy,computer.cardslot)
...
datum
	file
		program
			ntos
				proc
					window(var/title,var/buttonbar,var/content)
						return {"
						<div class='filewin'>
						...
						var
							obj
								item
									part
										computer
											C = locate(href_list["viewperipheral"])
