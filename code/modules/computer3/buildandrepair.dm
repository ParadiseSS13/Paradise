				...
				circuitboard
					...
					var
						datum
							file
								program
									OS = new/datum/file/program/ntos

obj
	machinery
		computer3
			proc
				disassemble(mob/user as mob) // todo
					return
						...
						part
							computer
								circuitboard
									circuit = null
			var
				completed = /obj/machinery/computer
					...
					item
						part
							computer
								networking
									subspace
										centcom	= null	// only for offstation communications
						...
						if(istype(P, /obj/item/weapon/screwdriver))
							...
							var
								obj
									machinery
										computer3
											B = new src.circuit.build_path ( src.loc, built=1 )
...
obj
	structure
		computer3frame
			proc
				remove_peripheral(var/obj/item/I = null)
...
obj
	structure
		computer3frame
			proc
				insert_peripheral(var/obj/item/I)
