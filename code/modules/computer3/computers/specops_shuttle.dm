	...
	specops_process()
		var
			area
				centcom
					control
						cent_com = locate()//To find announcer. This area should exist for this proc to work.
		var
			area
				centcom
					specops
		...
		var
			mob
				living
					silicon
						decoy
							announcer = locate() in cent_com//We need a fake AI to announce some stuff below. Otherwise it will be wonky.
