...
//RECORD FUNCTIONS
			if("Search Records")
				var
					t1 = input("Search String: (Partial Name or ID or Fingerprints or Rank)", "Secure. records", null, null)  as text
...
/*			if("Search Fingerprints")
				var
					t1 = input("Search String: (Fingerprint)", "Secure. records", null, null)  as text
...
//RECORD DELETE
			...
			if("Add Entry")
				...
				var
					a2 = active2
				var
					t1 = sanitize(copytext(input("Add Comment:", "Secure. records", null, null)  as message,1,MAX_MESSAGE_LEN))
				...
				switch(href_list["field"])
					if("name")
						if(istype(active1, /datum/data/record))
							var
								t1 = input("Please input name:", "Secure. records", active1.fields["name"], null)  as text
					...
					if("id")
						if(istype(active2, /datum/data/record))
							var
								t1 = sanitize(copytext(input("Please input id:", "Secure. records", active1.fields["id"], null)  as text,1,MAX_MESSAGE_LEN))
					...
					if("fingerprint")
						if(istype(active1, /datum/data/record))
							var
								t1 = sanitize(copytext(input("Please input fingerprint hash:", "Secure. records", active1.fields["fingerprint"], null)  as text,1,MAX_MESSAGE_LEN))
							if((!( t1 ) || !( authenticated ) || usr.stat || usr.restrained() || (!interactable() && (!istype(usr, /mob/living/silicon))) || active1 != a1))
								return
					...
					if("age")
						if(istype(active1, /datum/data/record))
							var
								t1 = input("Please input age:", "Secure. records", active1.fields["age"], null)  as num
							if((!( t1 ) || !( authenticated ) || usr.stat || usr.restrained() || (!interactable() && (!istype(usr, /mob/living/silicon))) || active1 != a1))
								return
					...
					if("mi_crim")
						if(istype(active2, /datum/data/record))
							var
								t1 = sanitize(copytext(input("Please input minor crimes list:", "Secure. records", active2.fields["mi_crim"], null)  as text,1,MAX_MESSAGE_LEN))
							if((!( t1 ) || !( authenticated ) || usr.stat || usr.restrained() || (!interactable() && (!istype(usr, /mob/living/silicon))) || active2 != a2))
								return
					...
					if("mi_crim_d")
						if(istype(active2, /datum/data/record))
							var
								t1 = sanitize(copytext(input("Please summarize minor crimes:", "Secure. records", active2.fields["mi_crim_d"], null)  as message,1,MAX_MESSAGE_LEN))
							if((!( t1 ) || !( authenticated ) || usr.stat || usr.restrained() || (!interactable() && (!istype(usr, /mob/living/silicon))) || active2 != a2))
								return
					...
					if("ma_crim")
						if(istype(active2, /datum/data/record))
							var
								t1 = sanitize(copytext(input("Please input major crimes list:", "Secure. records", active2.fields["ma_crim"], null)  as text,1,MAX_MESSAGE_LEN))
							if((!( t1 ) || !( authenticated ) || usr.stat || usr.restrained() || (!interactable() && (!istype(usr, /mob/living/silicon))) || active2 != a2))
								return
					...
					if("ma_crim_d")
						if(istype(active2, /datum/data/record))
							var
								t1 = sanitize(copytext(input("Please summarize major crimes:", "Secure. records", active2.fields["ma_crim_d"], null)  as message,1,MAX_MESSAGE_LEN))
							if((!( t1 ) || !( authenticated ) || usr.stat || usr.restrained() || (!interactable() && (!istype(usr, /mob/living/silicon))) || active2 != a2))
								return
					...
					if("notes")
						if(istype(active2, /datum/data/record))
							var
								t1 = trim(sanitize(copytext(input("Please summarize minor crimes:", "Secure. records", active2.fields["mi_crim_d"], null)  as message,1,MAX_MESSAGE_LEN)))
							if((!( t1 ) || !( authenticated ) || usr.stat || usr.restrained() || (!interactable() && (!istype(usr, /mob/living/silicon))) || active2 != a2))
								return
					...
					if("rank")
						var
							list
								L = list( "Head of Personnel", "Captain", "AI" )
					...
					if("species")
						if(istype(active1, /datum/data/record))
							var
								t1 = sanitize(copytext(input("Please enter race:", "General records", active1.fields["species"], null)  as message,1,MAX_MESSAGE_LEN))
							if((!( t1 ) || !( authenticated ) || usr.stat || usr.restrained() || (!interactable() && (!istype(usr, /mob/living/silicon))) || active1 != a1))
								return
