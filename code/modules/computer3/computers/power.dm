	...
	file
		program
			powermon
				...
				proc
					format(var/obj/machinery/power/apc/A)
						var
							static
								list
									S = list(" Off","AOff","  On", " AOn")
						var
							static
								list
									chg = list("N","C","F")
				...
				interact()
					...
					var
						list
							L = computer.net.get_machines(/obj/machinery/power/apc)
					var
						t = ""
					...
					if(!L || !L.len)
						...
						var
							datum
								powernet
									powernet = computer.net.connect_to(/datum/powernet,null)
						if(powernet)
