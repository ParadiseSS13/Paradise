...
obj/item/clothing/mask/gas/fluff/tyhailer // T0EPIC4U: Ty Omaha
	...
	desc = "A tacticool Security gas mask with modified 'Compli-o-nator 3000' device, let's Ty be the snowflake he is and choose the phrases it announces. It looks like it has some..residue..you probably don't want to touch it."
