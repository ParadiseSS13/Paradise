...
/datum/prize_item/joy_buzzer
	name = "Joy Buzzer"
	desc = "A small handheld device that provides harmless shocks to people that shake hands with the user."
	typepath = /obj/item/toy/joy_buzzer
	cost = 75
