		...
		toy
			prizeball
				...
				var
					opening = 0
				var
					possible_contents = list(/obj/random/carp_plushie, /obj/random/plushie, /obj/random/figure, /obj/item/toy/eight_ball, /obj/item/stack/tickets)
		...
		toy
			prizeball
				attack_self(mob/user as mob)
					...
					var
						prize_inside = pick(possible_contents)
					spawn(10)
						user.unEquip(src)
						if(istype(prize_inside, /obj/item/stack))
							var
								amount = pick(5, 10, 15, 25, 50)
