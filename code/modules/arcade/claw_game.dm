		...
		arcade
			claw
				...
				var
					machine_image = "_1"
				var
					bonus_prize_chance = 5		//chance to dispense a SECOND prize if you win, increased by matter bin rating

				//This is to make sure the images are available
				var
					list
						img_resources = list('icons/obj/arcade_images/backgroundsprite.png',
		...
		arcade
			claw
				start_play(mob/user as mob)
					...
					var
						my_game_html = replacetext(claw_game_html, "/* ref src */", "\ref[src]")
