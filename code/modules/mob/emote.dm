...
mob
	proc
		handle_emote_CD(cooldown = EMOTE_COOLDOWN)
...
mob
	proc
		custom_emote(var/m_type=1,var/message = null)
			...
			var
				muzzled = istype(src.wear_mask, /obj/item/clothing/mask/muzzle)
			...
			// Maybe some people are okay with that.
				...
				if(m_type & 1)
					var
						list
							can_see = get_mobs_in_view(1,src)  //Allows silicon & mmi mobs carried around to see the emotes of the person carrying them around.
