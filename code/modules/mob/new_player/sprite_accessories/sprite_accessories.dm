...
/datum/sprite_accessory/hair/bald
	...
	name = "Bald"
	icon_state = "bald"
	species_allowed = list("Human", "Unathi", "Vox", "Diona", "Kidan", "Grey", "Plasmaman", "Skeleton", "Vulpkanin", "Tajaran", "Moth")
	glasses_over = 1
...
/datum/sprite_accessory/body_markings
	...
	species_allowed = list("Unathi", "Tajaran", "Vulpkanin", "Machine", "Vox", "Kidan", "Moth")
	icon_state = "accessory_none"
...
/datum/sprite_accessory/underwear
	...
	species_allowed = list("Human", "Unathi", "Diona", "Vulpkanin", "Tajaran", "Kidan", "Grey", "Plasmaman", "Machine", "Skrell", "Slime People", "Skeleton", "Drask", "Vox", "Moth")
	sprite_sheets = list(
