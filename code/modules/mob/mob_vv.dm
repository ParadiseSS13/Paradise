...
/mob/vv_do_topic(list/href_list)
	...
	if(href_list[VV_HK_MOB_PLAYER_PANEL])
		SSadmin_verbs.invoke_verb(usr, /datum/admin_verb/show_player_panel, src)
		href_list["datumrefresh"] = UID()
	if(href_list[VV_HK_GIVE_SPELL])
		SSadmin_verbs.invoke_verb(usr, /datum/admin_verb/give_spell, src)
		href_list["datumrefresh"] = UID()
	if(href_list[VV_HK_GIVE_DISEASE])
		SSadmin_verbs.invoke_verb(usr, /datum/admin_verb/give_disease, src)
		href_list["datumrefresh"] = UID()
	if(href_list[VV_HK_GODMODE])
		SSadmin_verbs.invoke_verb(usr, /datum/admin_verb/godmode, src)
		href_list["datumrefresh"] = UID()
	if(href_list[VV_HK_GIB])
		SSadmin_verbs.invoke_verb(usr, /datum/admin_verb/gib_mob, src)
	...
	if(href_list[VV_HK_DIRECT_CONTROL])
		SSadmin_verbs.invoke_verb(usr, /datum/admin_verb/assume_direct_control, src)
