...
/mob/living/carbon/alien/larva/verb/evolve()
	...
	if(amount_grown >= max_grown)	//TODO ~Carn
		...
		to_chat(src, "<B>Hunters</B> [span_notice("are strong and agile, able to hunt away from the hive and rapidly move through ventilation shafts. Hunters generate plasma slowly and have low reserves.")]")
		to_chat(src, "<B>Sentinels</B> [span_notice("are tasked with protecting the hive and are deadly up close and at a range. They are not as physically imposing nor fast as the hunters.")]")
		to_chat(src, "<B>Drones</B> [span_notice("are the working class, offering the largest plasma storage and generation. They are the only caste which may evolve again, turning into the dreaded alien queen.")]")
