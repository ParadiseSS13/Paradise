mob
	living
		carbon
			human
				proc
					change_appearance(var/flags = APPEARANCE_ALL_HAIR, var/location = src, var/mob/user = src, var/check_species_whitelist = 1, var/list/species_whitelist = list(), var/list/species_blacklist = list(), var/datum/topic_state/state = default_state)
						var
							datum
								nano_module
									appearance_changer
										AC = new(location, src, check_species_whitelist, species_whitelist, species_blacklist)
						AC.flags = flags
...
mob
	living
		carbon
			human
				proc
					change_species(var/new_species)
						if(!new_species)
							return
...
mob
	living
		carbon
			human
				proc
					change_gender(var/gender, var/update_dna = 1)
						var
							obj
								item
									organ
						...
						var
							datum
								sprite_accessory
									hair
										current_hair = hair_styles_list[H.h_style]
						...
						var
							datum
								sprite_accessory
									hair
										current_fhair = facial_hair_styles_list[H.f_style]
...
mob
	living
		carbon
			human
				proc
					change_facial_hair(var/facial_hair_style)
						var
							obj
								item
									organ
...
mob
	living
		carbon
			human
				proc
					change_head_accessory(var/head_accessory_style)
						var
							obj
								item
									organ
...
mob
	living
		carbon
			human
				proc
					change_markings(var/marking_style)
						if(!marking_style)
							return
...
mob
	living
		carbon
			human
				proc
					change_body_accessory(var/body_accessory_style)
						var
							found
					...
					reset_hair()
						...
						if(m_style && m_style != "None") //Resets the markings if they were head markings.
							var
								datum
									sprite_accessory
										marking_style = marking_styles_list[m_style]
			...
			human
				proc
					reset_head_hair()
						...
						var
							list
								valid_hairstyles = generate_valid_hairstyles()
			...
			human
				proc
					reset_facial_hair()
						...
						var
							list
								valid_facial_hairstyles = generate_valid_facial_hairstyles()
			...
			human
				proc
					reset_markings()
						var
							list
								valid_markings = generate_valid_markings()
			...
			human
				proc
					reset_head_accessory()
						...
						var
							list
								valid_head_accessories = generate_valid_head_accessories()
...
mob
	living
		carbon
			human
				proc
					change_eye_color(var/red, var/green, var/blue)
...
mob
	living
		carbon
			human
				proc
					change_hair_color(var/red, var/green, var/blue)
						var
							obj
								item
									organ
...
mob
	living
		carbon
			human
				proc
					change_facial_hair_color(var/red, var/green, var/blue)
						var
							obj
								item
									organ
...
mob
	living
		carbon
			human
				proc
					change_head_accessory_color(var/red, var/green, var/blue)
						var
							obj
								item
									organ
...
mob
	living
		carbon
			human
				proc
					change_marking_color(var/red, var/green, var/blue)
...
mob
	living
		carbon
			human
				proc
					change_skin_color(var/red, var/green, var/blue)
...
mob
	living
		carbon
			human
				proc
					generate_valid_species(var/check_whitelist = 1, var/list/whitelist = list(), var/list/blacklist = list())
						var
							list
								valid_species = new()
						for(var/current_species_name in all_species)
							var
								datum
									species
										current_species = all_species[current_species_name]
...
mob
	living
		carbon
			human
				proc
					generate_valid_head_accessories()
						var
							list
								valid_head_accessories = new()
						var
							obj
								item
									organ
						...
						for(var/head_accessory in head_accessory_styles_list)
							var
								datum
									sprite_accessory
										S = head_accessory_styles_list[head_accessory]
...
mob
	living
		carbon
			human
				proc
					generate_valid_body_accessories()
						var
							list
								valid_body_accessories = new()
						for(var/B in body_accessory_by_name)
							var
								datum
									body_accessory
										A = body_accessory_by_name[B]
