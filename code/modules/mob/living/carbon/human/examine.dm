/mob/living/carbon/human/examine(mob/user)
	...
	for(var/obj/item/I in held_items)
		if(!(I.flags & ABSTRACT))
			if(I.blood_DNA)
				msg += "<span class='warning'>[t_He] [t_is] holding [bicon(I)] [I.gender==PLURAL?"some":"a"] [I.blood_color != "#030303" ? "blood-stained":"oil-stained"] [I.name] in [t_his] [get_held_index_name(get_held_index_of_item(I))]!</span>\n"
			else
