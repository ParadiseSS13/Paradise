...
/mob/living/carbon/human/examine_process_limb(limb_name)
	var/msg = ""
	switch(limb_name)
		if("hands")
			if(blood_DNA)
...
/mob/living/carbon/human/examine_limb_flavor(skip_gloves = FALSE, skip_suit_storage = FALSE, skip_jumpsuit = FALSE, skip_shoes = FALSE, skip_mask = FALSE, skip_ears = FALSE, skip_eyes = FALSE, skip_face = FALSE)
	var/msg = ""
