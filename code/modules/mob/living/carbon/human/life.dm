		...
		if((prob(10) && paralysis <= 1))
			...
			switch(rand(1, 3))
				if(1)
					emote("twitch")
				if(2 to 3)
					var/tourettes = pick("ÁËßÒÜ", "ÑÓÊÀ", "ØËÞÕÀ", "ÕÓÅÑÎÑ", "ÏÈÄÎÐ", "ÕÓÉ ÕÓÉ ÕÓÉ", "ÏÈÇÄÀÀÀÀÀ")
	...
	if(getBrainLoss() >= 60 && stat != 2)
		...
		if(prob(3))
			var/list/s1 = list("îãî åòî ëîññ õäõäõäõäõõäõäõäõä",
							   "à ÷å áåç âîçäóõà áëîá íå ðîñòåò?",
							   "ïðóãëî ñòàõï",
							   "[pick("", "ÏÎÌÎÃÈÒÅ, ÝÒÎÒ ÅÁÓ×ÈÉ ÒÐÅÒÎÐ")] [pick("âèíñåíò", "óèíñòîí", "âèííñäàðü", "âèíñòîí")] [pick("îäàð", "óäàð", "àíòäàð")] ÃÐÈÔÎÍÈÒ ÌÈÍß ÕÀËÏ!!!",
							   "ïàñàíû âêàëèòå ìèíå [pick("ÕÓËÊÀ","òåëåìîðôîçà","ñóïèðñèëûûû")]?",
							   "è êàêàÿ æè ñëåäóùàÿ ÷àñòü òâîåãî ìàñòåð ïëàíà",
							   "òóò âñå êòî ïî êàéôó åæææè",
							   "êîêîè êóñü",
							   "ïî÷åìó ýòîò òðåòîð òîêîè äîâîëíûé",
							   "ÂÑÅÌ ×ÌÀÔÊÈ Â ÝÒÎÌ ×ÀÒÈ")

			var/list/s2 = list("FUS RO DAH",
							   "Ýòî êàíàë àíèìå?",
							   "Êàê ïðîïàò÷èòü íàíîõóè ïîä ìîé ñèíäèêàòîâñêèé àïëèíê????",
							   ">èìïëàèíã íå äàóí",
							   "òðó ñòîðè, ÿ íå ïøøøø",
							   "ÁËßÄÜ ÊÒÎ ÍÈÁÓÄÜ ÑÍÈÌÈÒÅ Ñ ÌÅÍß ÝÒÓ ÕÓÅÒÓÓÓÓ",
							   "ïèçäà óïðàâëåíèå êîíåøíî",
							   "ÝÉ ÒÀÍÖÎÐ, ÝÉ ×ÅÒÎ-ÒÀÌ, ÏÀÒÈÌÅÉÊÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÐ",
							   "it just werksssss",
							   "We are Diamond Dogs.",
							   "If I pull that off will you die?",
							   "íîëüèçäèñÿòè, òåêñòóðêè 17 âåê ïèçäåö muh shaders",
							   "ïèçäà ãðèôåðû îõóåëè õàëï ìè ïëåç ;_;",
							   "I AM NUCLEAAAAAAAR, I'M WIIIIIIIIIIIIIILDDDDDDDDDDDDDDDDD",
							   "ñêð ñêð ñêð ñêð ñêð ñêð ñêð ñêð ñêð ñêð ñêð ñêð ñêð")
			switch(pick(1,2,3))
				if(1)
					say(pick(s1))
				if(2)
