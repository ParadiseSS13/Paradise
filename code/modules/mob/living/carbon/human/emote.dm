/mob/living/carbon/human/emote(act, m_type = 1, message = null, force)
	...
	switch(act)		//This is for actually making the emotes happen
		...
		if("help")
			...
			+ " shiver(s), shrug(s), sigh(s), signal(s)-#1-10,slap(s)-none/mob, smile(s),snap(s), sneeze(s), sniff(s), snore(s), stare(s)-none/mob, tremble(s), twitch(es), twitch(es)_s, puke, quill(s" \
