mob
	living
		carbon
			human
				emote(var/act,var/m_type=1,var/message = null,var/force)
								...
								var
									obj
										item
											organ
												external
													L = H.get_organ("l_hand")
								var
									obj
										item
											organ
												external
													R = H.get_organ("r_hand")
								var
									left_hand_good = 0
								var
									right_hand_good = 0
...
if("help")
			var
				emotelist = "aflap(s), airguitar, blink(s), blink(s)_r, blush(es), bow(s)-(none)/mob, burp(s), choke(s), chuckle(s), clap(s), collapse(s), cough(s),cry, cries, custom, dap(s)(none)/mob," \
