/datum/species/tajaran
	...
	allowed_consumed_mobs = list(/mob/living/basic/mouse, /mob/living/simple_animal/chick, /mob/living/simple_animal/butterfly, /mob/living/simple_animal/parrot, /mob/living/simple_animal/hostile/poison/bees)
