...
datum
	species
		wryn
			handle_death(var/mob/living/carbon/human/H)
...
datum
	species
		wryn
			handle_attack_hand(var/mob/living/carbon/human/H, var/mob/living/carbon/human/M)
				var
					obj
						item
							organ
									...
									item
										organ
											internal
												wryn
													hivenode
														node = new /obj/item/organ/internal/wryn/hivenode
...
datum
	species
		nucleation
			handle_post_spawn(var/mob/living/carbon/human/H)
