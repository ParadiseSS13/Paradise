/datum/species/monkey
	...
	no_equip = list(ITEM_SLOT_BELT, ITEM_SLOT_ID, ITEM_SLOT_LEFT_EAR, ITEM_SLOT_RIGHT_EAR, ITEM_SLOT_EYES, ITEM_SLOT_GLOVES, ITEM_SLOT_SHOES, ITEM_SLOT_OCLOTHING, ITEM_SLOT_ICLOTHING, ITEM_SLOT_LEFT_POCKET, ITEM_SLOT_RIGHT_POCKET, ITEM_SLOT_SUIT_STORE, ITEM_SLOT_PDA)
