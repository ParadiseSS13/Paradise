/datum/species/monkey
	...
	no_equip = list(slot_belt, slot_wear_id, slot_l_ear, slot_glasses, slot_gloves, slot_shoes, slot_wear_suit, slot_w_uniform, slot_l_store, slot_r_store, slot_s_store, slot_wear_pda, slot_neck)
	can_craft = FALSE
	is_small = 1
