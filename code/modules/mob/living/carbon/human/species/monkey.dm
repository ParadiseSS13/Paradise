/datum/species/monkey
	...
	no_equip = list(SLOT_HUD_BELT, SLOT_HUD_WEAR_ID, SLOT_HUD_LEFT_EAR, SLOT_HUD_RIGHT_EAR, SLOT_HUD_EYES, SLOT_HUD_GLOVES, SLOT_HUD_FEET, SLOT_HUD_OCLOTHING, SLOT_HUD_ICLOTHING, SLOT_HUD_LEFT_POCKET, SLOT_HUD_RIGHT_POCKET, SLOT_HUD_SUIT_STORE, SLOT_HUD_PDA)
