/datum/species/monkey
	...
	no_equip = list(slot_belt, slot_wear_id, SLOT_HUD_LEFT_EAR, SLOT_HUD_RIGHT_EAR, slot_glasses, slot_gloves, slot_shoes, slot_wear_suit, slot_w_uniform, SLOT_HUD_LEFT_STORE, SLOT_HUD_RIGHT_STORE, slot_s_store, slot_wear_pda)
