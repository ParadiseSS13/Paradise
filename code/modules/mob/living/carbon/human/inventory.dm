...
/mob/living/carbon/human/proc/has_organ_for_slot(slot)
	switch(slot)
		if(slot_back)
			return has_organ(ORGAN_CHEST)
		if(slot_wear_mask)
			return has_organ(ORGAN_HEAD)
		if(slot_handcuffed)
			return has_organ(ORGAN_HAND_L) && has_organ(ORGAN_HAND_R)
		if(slot_legcuffed)
			return has_organ(ORGAN_LEG_L) && has_organ(ORGAN_LEG_R)
		if(slot_l_hand)
			return has_organ(ORGAN_HAND_L)
		if(slot_r_hand)
			return has_organ(ORGAN_HAND_R)
		if(slot_belt)
			return has_organ(ORGAN_CHEST)
		if(slot_wear_id)
		...
		if(slot_head)
			return has_organ(ORGAN_HEAD)
		if(slot_shoes)
			return has_organ(ORGAN_FOOT_L) && has_organ(ORGAN_FOOT_R)
		if(slot_wear_suit)
			return has_organ(ORGAN_CHEST)
		if(slot_w_uniform)
			return has_organ(ORGAN_CHEST)
