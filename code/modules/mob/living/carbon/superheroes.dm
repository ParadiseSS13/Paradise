...
/datum/superheroes/owlman/equip(mob/living/carbon/human/H)
	...
	H.equip_to_slot_or_del(new /obj/item/clothing/neck/toggle/owlwings(H), slot_wear_suit)
...
/datum/superheroes/griffin/equip(mob/living/carbon/human/H)
	...
	H.equip_to_slot_or_del(new /obj/item/clothing/neck/toggle/owlwings/griffinwings(H), slot_wear_suit)
