...
datum
	superheroes
		...
		var
			list
				default_genes = list(REGEN, NO_BREATH, RESIST_COLD)
		var
			list
				default_spells = list()
...
datum
	superheroes
		proc
			create(var/mob/living/carbon/human/H)
				assign_genes(H)
				assign_spells(H)
				equip(H)
				assign_id(H)
...
datum
	superheroes
		proc
			assign_genes(var/mob/living/carbon/human/H)
...
datum
	superheroes
		proc
			assign_spells(var/mob/living/carbon/human/H)
...
datum
	superheroes
		proc
			assign_id(var/mob/living/carbon/human/H)
				var
					obj
						item
							weapon
					...
					obj
						item
							weapon
								implant
									freedom
										L = new/obj/item/weapon/implant/freedom(H)
				L.imp_in = H
				L.implanted = 1
				return 1
									...
									obj
										item
											organ
												external
													head
														head_organ = target.get_organ("head")
