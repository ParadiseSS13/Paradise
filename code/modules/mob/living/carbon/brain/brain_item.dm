		...
		organ
			internal
				brain
					...
					vital = 1
					var
						mmi_icon = 'icons/obj/assemblies.dmi'
					var
...
obj
	item
		organ
			internal
				brain
					insert(var/mob/living/target,special = 0)

						name = "[initial(name)]"
						var
							brain_already_exists = 0
...
obj
	item
		organ
			brain
				slime
					take_damage(var/amount, var/silent = 1)
