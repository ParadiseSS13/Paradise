		...
		device
			mmi
				...
				var
					alien = 0
				var
					syndiemmi = 0 //Whether or not this is a Syndicate MMI
				var
					mob
						living
							carbon
					...
					obj
						item
							organ
								internal
									brain
										held_brain = null // This is so MMI's aren't brainscrubber 9000's
				var
					mob
						living
							silicon
								robot
									robot = null//Appears unused.
				var
					obj
						mecha
				...
				proc
					transfer_identity(var/mob/living/carbon/human/H)//Same deal as the regular brain proc. Used for human-->robot people.
						...
						if(!istype(H.species) || isnull(H.species.return_organ("brain"))) // Diona/buggy people
							...
							var
								brain_path = H.species.return_organ("brain")
					...
					var
						obj
							item
								device
									radio
										radio = null//Let's give it a radio.
