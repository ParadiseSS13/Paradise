		...
		carbon
			brain
				...
				var
					timeofhostdeath = 0
				var
					emp_damage = 0//Handles a type of MMI damage
				var
					alert = null
...
mob
	living
		carbon
			brain
				ex_act() //you cant blow up brainmobs because it makes transfer_to() freak out when borgs blow up.
					return
