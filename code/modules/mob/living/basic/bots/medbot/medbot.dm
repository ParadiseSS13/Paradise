...
/mob/living/basic/bot/medbot
	...
	additional_access = list(ACCESS_MEDICAL, ACCESS_MORGUE, ACCESS_SURGERY, ACCESS_CHEMISTRY, ACCESS_VIROLOGY, ACCESS_GENETICS, ACCESS_MINERAL_STOREROOM, ACCESS_CHEMISTRY, ACCESS_MINERAL_STOREROOM, ACCESS_VIROLOGY, ACCESS_MAINT_TUNNELS)
