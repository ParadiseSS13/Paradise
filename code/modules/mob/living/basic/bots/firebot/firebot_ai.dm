...
/datum/ai_controller/basic_controller/bot/firebot/try_possess_pawn(atom/new_pawn)
	. = ..()
...
/datum/ai_planning_subtree/extinguishing_turfs/select_behaviors(datum/ai_controller/controller, seconds_per_tick)
	if(controller.blackboard_key_exists(BB_FIREBOT_EXTINGUISH_TARGET))
		return
...
/datum/ai_planning_subtree/firebot_speech/select_behaviors(datum/ai_controller/controller, seconds_per_tick)
