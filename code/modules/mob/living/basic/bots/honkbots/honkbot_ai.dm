...
/datum/ai_planning_subtree/play_with_clowns/select_behaviors(datum/ai_controller/basic_controller/bot/controller, seconds_per_tick)
...
/datum/ai_planning_subtree/use_mob_ability/random_honk/select_behaviors(datum/ai_controller/controller, seconds_per_tick)
