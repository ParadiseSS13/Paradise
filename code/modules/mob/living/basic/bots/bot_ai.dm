...
/datum/ai_planning_subtree/find_patrol_beacon/select_behaviors(datum/ai_controller/controller, seconds_per_tick)
...
/datum/ai_planning_subtree/respond_to_summon/select_behaviors(datum/ai_controller/controller, seconds_per_tick)
...
/datum/ai_planning_subtree/salute_authority/select_behaviors(datum/ai_controller/controller, seconds_per_tick)
	var/mob/living/basic/bot/bot_pawn = controller.pawn
