...
/datum/ai_planning_subtree/mug_robot/select_behaviors(datum/ai_controller/basic_controller/bot/controller, seconds_per_tick)
...
/datum/ai_planning_subtree/repairbot_deconstruction/select_behaviors(datum/ai_controller/basic_controller/bot/controller, seconds_per_tick)
	var/mob/living/basic/bot/living_bot = controller.pawn
	if(!(living_bot.bot_access_flags & BOT_COVER_EMAGGED))
		return
...
/datum/ai_planning_subtree/repairbot_speech/select_behaviors(datum/ai_controller/basic_controller/bot/controller, seconds_per_tick)
...
/datum/ai_planning_subtree/replace_floors/select_behaviors(datum/ai_controller/basic_controller/bot/controller, seconds_per_tick)
...
/datum/ai_planning_subtree/build_girder/select_behaviors(datum/ai_controller/basic_controller/bot/controller, seconds_per_tick)
	var/mob/living/basic/bot/repairbot/bot_pawn = controller.pawn
...
/datum/ai_planning_subtree/replace_window/select_behaviors(datum/ai_controller/controller, seconds_per_tick)
...
/datum/ai_planning_subtree/wall_girder/select_behaviors(datum/ai_controller/controller, seconds_per_tick)
	var/mob/living/basic/bot/repairbot/living_pawn = controller.pawn
...
/datum/ai_planning_subtree/fix_window/select_behaviors(datum/ai_controller/controller, seconds_per_tick)
