...
mob
	living
		silicon
			say_understands(var/other,var/datum/language/speaking = null)
...
mob
	living
		silicon
			ai
				proc
					holopad_talk(var/message, verb, datum/language/speaking)
...
mob
	living
		silicon
			ai
				proc
					holopad_emote(var/message) //This is called when the AI uses the 'me' verb while using a holopad.
