...
mob
	living
		silicon
			robot
				proc
					get_damaged_components(var/brute, var/burn, var/get_all)
						var
							list
								datum
									robot_component
...
mob
	living
		silicon
			robot
				take_organ_damage(var/brute = 0, var/burn = 0, var/sharp = 0, var/edge = 0)
					var
						list
							components = get_damageable_components()
					if(!components.len)
						return
