			...
			drone_control
				Topic(href, href_list)
					...
					if(href_list["setarea"])
						...
						var
							t_area = input("Select the area to ping.", "Set Target Area", null) as null|anything in TAGGERLOCATIONS
