...
obj
	item
		weapon
			gripper
				afterattack(atom/target as mob|obj|turf|area, mob/living/user as mob|obj, proximity, params)
			...
			robot
				drone
					installed_modules()
						...
						var
							dat = "<HEAD><TITLE>Drone modules</TITLE><META HTTP-EQUIV='Refresh' CONTENT='10'></HEAD><BODY>\n"
						...
						var
							tools = "<B>Tools and devices</B><BR>"
						var
							resources = "<BR><B>Resources</B><BR>"
