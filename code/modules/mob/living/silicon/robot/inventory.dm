...
mob
	living
		silicon
			robot
				proc
					activate_module(var/obj/item/O)
...
mob
	living
		silicon
			robot
				proc
					module_selected(var/module) //Module is 1-3
...
mob
	living
		silicon
			robot
				proc
					module_active(var/module) //Module is 1-3
...
mob
	living
		silicon
			robot
				proc
					select_module(var/module) //Module is 1-3
						if(module < 1 || module > 3) return
...
mob
	living
		silicon
			robot
				proc
					deselect_module(var/module) //Module is 1-3
						if(module < 1 || module > 3) return
...
mob
	living
		silicon
			robot
				proc
					toggle_module(var/module) //Module is 1-3
						if(module < 1 || module > 3) return
		...
		silicon
			robot
				proc
					cycle_modules()
						var
							slot_start = get_selected_module()
