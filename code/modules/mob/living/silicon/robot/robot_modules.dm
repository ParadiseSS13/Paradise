	...
	item
		weapon
			robot_module
				...
				var
					module_type = "NoMod" // For icon usage
...
obj
	item
		weapon
			robot_module
				proc
					rebuild()//Rebuilds the list so it's possible to add/remove items from the module
						var
							list
								temp_list = modules
						modules = list()
...
obj
	item
		weapon
			robot_module
				proc
					add_subsystems(var/mob/living/silicon/robot/R)
						R.verbs |= subsystems
...
obj
	item
		weapon
			robot_module
				proc
					remove_subsystems(var/mob/living/silicon/robot/R)
						R.verbs -= subsystems
										...
										weapon
											reagent_containers
												spray
													alien
														stun
															S = new /obj/item/weapon/reagent_containers/spray/alien/stun(src)
										...
										weapon
											reagent_containers
												spray
													alien
														smoke
															A = new /obj/item/weapon/reagent_containers/spray/alien/smoke(src)
