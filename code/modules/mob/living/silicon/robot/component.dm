...
datum
	robot_component
		New(mob/living/silicon/robot/R)
			src.owner = R
...
datum
	robot_component
		proc
			take_damage(brute, electronics, sharp, edge)
...
mob
	living
		silicon
			robot
				proc
					is_component_functioning(module_name)
						var
							datum
								robot_component
...
mob
	living
		silicon
			robot
				proc
					get_component(var/component_name)
						var
							datum
								robot_component
				...
				attack(mob/living/M as mob, mob/living/user as mob)
					...
					switch(scan_type)
						if("robot")
							...
							var
								list
									damaged = H.get_damaged_components(1,1,1)
