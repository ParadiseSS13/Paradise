mob
	living
		silicon
			...
			var
				list
					additional_law_channels = list("State" = "")
...
mob
	living
		silicon
			proc
				set_zeroth_law(var/law, var/law_borg)
...
mob
	living
		silicon
			proc
				clear_inherent_laws(var/silent = 0)
					throw_alert("newlaw", /obj/screen/alert/newlaw)
					laws_sanity_check()
...
mob
	living
		silicon
			proc
				clear_supplied_laws(var/silent = 0)
					throw_alert("newlaw", /obj/screen/alert/newlaw)
					laws_sanity_check()
...
mob
	living
		silicon
			proc
				statelaws(var/datum/ai_laws/laws)
					var
						prefix = ""
...
mob
	living
		silicon
			proc
				dostatelaws(var/method, var/prefix, var/datum/ai_laws/laws)
					...
					var
						can_state = statelaw("[prefix]Current Active Laws:")
