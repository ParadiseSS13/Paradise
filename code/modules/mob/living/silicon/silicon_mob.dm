/mob/living/silicon
	...
	var/filth_hud = DATA_HUD_JANITOR
...
/mob/living/silicon/proc/remove_med_sec_hud()
	...
	var/datum/atom_hud/filthsensor = GLOB.huds[filth_hud]
	secsensor.remove_hud_from(src)
	medsensor.remove_hud_from(src)
	diagsensor.remove_hud_from(src)
	filthsensor.remove_hud_from(src)
...
/mob/living/silicon/proc/add_filth_hud()
	var/datum/atom_hud/filthsensor = GLOB.huds[filth_hud]
	filthsensor.add_hud_to(src)
...
/mob/living/silicon/proc/toggle_sensor_mode()
	...
	var/static/list/sensor_choices = list("Security" = image(icon = 'icons/obj/clothing/glasses.dmi', icon_state = "securityhud"),
							...
							"Filth" = image(icon = 'icons/obj/clothing/glasses.dmi', icon_state = "janihud"),
