		...
		proc
			update()
				...
				for(var/camera in cameras)
					...
					var
						turf
							point = locate(src.x + (CHUNK_SIZE / 2), src.y + (CHUNK_SIZE / 2), src.z)
				...
				var
					list
						visAdded = newVisibleTurfs - visibleTurfs
				var
					list
						visRemoved = visibleTurfs - newVisibleTurfs
