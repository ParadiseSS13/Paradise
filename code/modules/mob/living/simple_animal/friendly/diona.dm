				...
				proc
					merge()
						...
						var
							mob
								living
									M = input(src,"Who do you wish to merge with?") in null|choices
							...
							obj
								machinery
									portable_atmospherics
										hydroponics
											target = input("Select a tray:") as null|anything in trays
