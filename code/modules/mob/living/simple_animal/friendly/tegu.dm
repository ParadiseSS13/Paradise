...
/mob/living/simple_animal/tegu/verb/lose_tail()
	set name = "Lose tail"
...
/mob/living/simple_animal/tegu/proc/new_tail()
	has_tail = TRUE
	to_chat(src, "<span class='notice'>You regrow your tail!</span>")

/mob/living/simple_animal/tegu/decompile_act(obj/item/matter_decompiler/C, mob/user)
	if(!isdrone(user))
