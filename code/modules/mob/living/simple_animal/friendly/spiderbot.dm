		...
		simple_animal
			spiderbot
				...
				var
					obj
						item
							held_item = null //Storage for single item they can hold.
				var
					emagged = 0               //IS WE EXPLODEN?
				var
					syndie = 0                //IS WE SYNDICAT? (currently unused)
...
mob
	living
		simple_animal
			spiderbot
				proc
					transfer_personality(var/obj/item/device/mmi/M as obj)
			...
			spiderbot
				verb
					get_item()
						...
						var
							obj
								selection = input("Select an item.", "Pickup") in items
