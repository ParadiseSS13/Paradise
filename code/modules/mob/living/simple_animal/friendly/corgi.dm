	...
	living
		simple_animal
			pet
				corgi
					proc
						place_on_head(obj/item/item_to_add, var/mob/user as mob)
									...
									if( /obj/item/clothing/glasses/sunglasses, /obj/item/clothing/head/that, /obj/item/clothing/head/collectable/paper,
											obj
												item
													clothing
														head
															hardhat, /obj/item/clothing/head/collectable/hardhat, /obj/item/clothing/head/hardhat/white,
											obj
												item
													weapon
														paper)
