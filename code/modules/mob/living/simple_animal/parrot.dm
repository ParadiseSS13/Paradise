...
/mob/living/simple_animal/parrot/Poly
	...
	clean_speak = list(
		...
		"Poly bet two crackers medchem will self immolate this shift!",
		"Who wants to build a singularity engine in the captain's office?",
		"I've searched high, I've searched low, far and wide and there still is not a single fuck to be found on this entire station.",
		"EMPIRES HAVE RISEN AND FALLEN IN THE TIME IT TAKES FOR THIS GOAL TO BE DONE! GET ON IT!",
		"If robotics steal the autolathe board AGAIN im cutting power to the entirety of science.",
		"I'm bored... Lets launch Supermatter shards into each other!",
		"Based? Based on what?",
		"Engineering is the best department. Don't argue it for it is an universal fact.",
		"CARGO! ORDER TEN SUPERMATTER SHARDS RIGHT THIS INSTANT!",
		"PROTECT THE NACHO ABOVE ALL ELSE!",
		"I'm not fat, im big winged.",
		"Emag man should be tossed into a singularity!",
		"Lady tesla is beautiful! Just make sure that she does not start to wander freely.",
		"Powersinks go in the SM!",
		"I wonder what war crimes atmos is up to...",
		"Quick, call gamma! Security ran out of donuts!",
		"Nothing quite like some rads to get you trough the day! On a totally unrelated note. Medical, how much pentetic do you have?",
		"Kill. All. Mice. Thank you!",
		"AI, open this door!",
		"Atmosia stronk!",
		"There are idiots among us.",
		"Poly is a master at soap-fu!",
		"You ever wondered why pda's can just explode like that?",
		"Don't you hate it when you loosen a pipe and you get yeeted across the room at mach five speed all because you forgot to turn on your magboots?",
		...
		"My calculator stopped working mid-way through my engineering exam. Poly can’t count on it anymore.",
		...
		"What song lyric do electrical engineers always get stuck in their heads? Watt is love? Baby, don’t hertz me.",
		...
		"Clown! Tell Poly a joke!",
		"Captain is comdom!",
		"STOP BRIDGE HOBO-ING AND BE USEFULL YA BUMS!",
		"Ian needs a whash! You know what to do.",
		"The research director is an imposter!",
		"CALIBRATE THE TELEPORTER YOU DIMWITS!",
		"The CE was totally picking his nose just now.",
		"Poly heard that the HOP was really into Enterprise Resource Planning.",
		"Why are vampires so naive? Because they are born suckers.",
		"Use pipes, not pumps!",
		"Poly want KFV!",
		"Poly has seen things no parrot should ever see...",
		"Engineers be bussin.",
		"Where is the engi bar?",
		"Next person that slips the HOS gets ten crackers from Poly.",
		"METEOR SHIELDS ARE LAME!",
		"HELP MANTIS!",
		)
	unique_pet = TRUE
