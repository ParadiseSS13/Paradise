							...
							effect
								decal
									cleanable
										target
					var
						max_targets = 50 //Maximum number of targets a cleanbot can ignore.
					var
						oldloc = null
					var
						closest_dist
...
mob
	living
		simple_animal
			bot
				cleanbot
					process_scan(obj/effect/decal/cleanable/D)
	...
	living
		simple_animal
			bot
				cleanbot
					proc
						clean(obj/effect/decal/cleanable/target)
							anchored = 1
