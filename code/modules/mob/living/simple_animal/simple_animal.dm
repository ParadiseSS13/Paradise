/mob/living/simple_animal
	...
	var/armour_penetration_flat = 0 //How much armour they ignore, as a flat reduction from the targets armour value
	var/armour_penetration_percentage = 0 //How much armour they ignore, as a percentage of their total armour
