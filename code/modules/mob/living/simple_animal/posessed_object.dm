...
/mob/living/simple_animal/possessed_object/start_pulling(atom/movable/AM, state, force = move_force, supress_message = FALSE)// Silly motherfuckers think they can pull things.
	if(!supress_message)
