...
/mob/living/simple_animal/hostile/poison/terror_spider/brown
	...
	spider_intro_text = "As a Brown Terror Spider, your role is to breach into areas for other spiders to attack. \
	Your attacks are strong and in addition to being able to open powered doors you can also break down walls. \
	Your unique skill is being able to breach welded vents, allowing groups of terror spiders to break into welded-off areas. \
