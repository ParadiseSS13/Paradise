...
/mob/living/simple_animal/hostile/poison/terror_spider/gray
	...
	spider_intro_text = "As a Gray Terror Spider, your role is to ambush prey by creating and waiting inside webs. \
	You create webs much faster than other spiders and said webs are also harder for the crew to see. \
	While laying in any web you are almost invisible and will deal double damage to prey unlucky enough to get webbed. \
