...
var
	global
		list
			protected_objects = list(/obj/structure/table, /obj/structure/cable, /obj/structure/window)
	...
	living
		simple_animal
			hostile
				mimic
					copy
						New(loc, obj/copy, mob/living/creator, destroy_original = 0)
							..(loc)
		...
		simple_animal
			hostile
				mimic
					copy
						proc
							CopyObject(var/obj/O, var/mob/living/user, var/destroy_original = 0)
		...
		simple_animal
			hostile
				mimic
					copy
						ranged
							CopyObject(obj/O, mob/living/creator, destroy_original = 0)
								if(..())
									...
									if(istype(G, /obj/item/weapon/gun/energy))
										Zapgun = G
										var
											selectfiresetting = Zapgun.select
										var
											obj
												item
													ammo_casing
														energy
															E = Zapgun.ammo_type[selectfiresetting]
										...
										var
											obj
												item
													ammo_casing
														energy
															shot = Zapgun.ammo_type[Zapgun.select]
