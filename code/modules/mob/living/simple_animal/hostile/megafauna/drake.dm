...
/mob/living/simple_animal/hostile/megafauna/dragon/space_dragon/Initialize(mapload)
	var/obj/effect/proc_holder/spell/aoe/turf/repulse/spacedragon/repulse_action = new /obj/effect/proc_holder/spell/aoe/turf/repulse/spacedragon(src)
...
/obj/effect/proc_holder/spell/aoe/turf/repulse/spacedragon
	name = "Tail Sweep"
...
/obj/effect/proc_holder/spell/aoe/turf/repulse/spacedragon/cast(list/targets, mob/user = usr)
	if(iscarbon(user))
