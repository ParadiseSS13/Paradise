...
///obj/effect/dummy/slaughter/singularity_act(blah)//this errored on me on compilre - Aurora
//	return

/mob/living/simple_animal/slaughterproc/giveSpells()
	if(src.mind)
		src.mind.spell_list += new /obj/effect/proc_holder/spell/targeted/slaughter_whisper
		return 1
	return 0

/obj/effect/proc_holder/spell/targeted/slaughter_whisper
	name = "Whisper"
...
/obj/effect/proc_holder/spell/targeted/slaughter_whisper/cast(list/targets, var/mob/simple_animal/slaughter/user = usr)
