...
/mob/dead/observer/verb/toggle_ghostsee()
	...
	if(ghost_flags & GHOST_VISION)
		...
		to_chat(src, "<span class='notice'>Ghost vision set to: Only your own ghost visible.</span>")
	else if(ghost_flags & GHOST_NO_VISION)
		ghost_flags &= ~GHOST_NO_VISION
		ghost_flags |= GHOST_VISION
		to_chat(src, "<span class='notice'>Ghost vision set to: All ghosts visible.</span>")
	else
		ghost_flags |= GHOST_NO_VISION
		to_chat(src, "<span class='notice'>Ghost vision set to: No ghosts visible.</span>")
	update_sight()
