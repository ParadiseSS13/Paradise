...
/mob/proc/update_flavor_text()
	...
	var/msg = tgui_input_text(usr, "Set the flavor text in your 'examine' verb. The flavor text should be a physical descriptor of your character at a glance. SFW Drawn Art of your character is acceptable.", "Flavor Text", flavor_text, multiline = TRUE, submit_on_enter = FALSE)
	if(isnull(msg))
		return
	if(stat)
		to_chat(usr, "<span class='notice'>You have to be conscious to change your flavor text</span>")
