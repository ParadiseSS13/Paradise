...
obj
	item
		weapon
			evidencebag
				afterattack(obj/item/I, mob/user,proximity)
					if(!proximity || loc == I)
						return
...
obj
	item
		weapon
			evidencebag
				proc
					evidencebagEquip(obj/item/I, mob/user)
						...
						var
							xx = I.pixel_x	//save the offset of the item
						var
							yy = I.pixel_y
						...
						var
							image
								img = image("icon"=I, "layer"=FLOAT_LAYER)	//take a snapshot. (necessary to stop the underlays appearing under our inventory-HUD slots ~Carn
