		...
		device
			detective_scanner
				attack_self(var/mob/user)
					var
						search = input(user, "Enter name, fingerprint or blood DNA.", "Find record", "")
					...
					var
						name
					var
						fingerprint = "FINGERPRINT NOT FOUND"
					var
						dna = "BLOOD DNA NOT FOUND"
...
obj
	item
		device
			detective_scanner
				proc
					add_log(var/msg, var/broadcast = 1)
						if(scanning)
