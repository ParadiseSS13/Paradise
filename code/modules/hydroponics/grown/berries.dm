...
/obj/item/seeds/berry/poison
	...
	reagents_add = list(/datum/reagent/cyanide = 0.15, /datum/reagent/staminatoxin = 0.2, /datum/reagent/consumable/nutriment/vitamin = 0.04, /datum/reagent/consumable/nutriment/plantmatter = 0.1)
...
/obj/item/seeds/berry/death
	...
	potency = 50
	mutatelist = list()
	reagents_add = list(/datum/reagent/coniine = 0.08, /datum/reagent/staminatoxin = 0.1, /datum/reagent/consumable/nutriment/vitamin = 0.04, /datum/reagent/consumable/nutriment/plantmatter = 0.1)
	rarity = 30
...
/obj/item/seeds/berry/glow
	...
	reagents_add = list(/datum/reagent/uranium = 0.25, /datum/reagent/iodine = 0.2, /datum/reagent/consumable/nutriment/vitamin = 0.04, /datum/reagent/consumable/nutriment/plantmatter = 0.1)
	rarity = 20
...
/obj/item/seeds/cherry
	...
	reagents_add = list(/datum/reagent/consumable/nutriment/plantmatter = 0.07, /datum/reagent/consumable/sugar = 0.07)
...
/obj/item/seeds/grape
	...
	reagents_add = list(/datum/reagent/consumable/nutriment/vitamin = 0.04, /datum/reagent/consumable/nutriment/plantmatter = 0.1, /datum/reagent/consumable/sugar = 0.1)
...
/obj/item/seeds/grape/green
	...
	reagents_add = list(/datum/reagent/medicine/kelotane = 0.2, /datum/reagent/consumable/nutriment/vitamin = 0.04, /datum/reagent/consumable/nutriment/plantmatter = 0.1, /datum/reagent/consumable/sugar = 0.1)
