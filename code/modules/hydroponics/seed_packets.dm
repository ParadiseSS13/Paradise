		...
		seeds
			proc
				update_appearance()
					...
					overlays.Cut()
					var
						is_seeds = ((seed.seed_noun in list("seeds","pits","nodes")) ? 1 : 0)
					var
						image
							seed_mask
					var
						seed_base_key = "base-[is_seeds ? seed.get_trait(TRAIT_PLANT_COLOUR) : "spores"]"
					...
					var
						image
							seed_overlay
					var
						seed_overlay_key = "[seed.get_trait(TRAIT_PRODUCT_ICON)]-[seed.get_trait(TRAIT_PRODUCT_COLOUR)]"
