...
/obj/machinery/hydroponics/proc/applyChemicals(datum/reagents/S, mob/user)
	...
	if(S.has_reagent(/datum/reagent/mutagen, 5) || S.has_reagent(/datum/reagent/radium, 10) || S.has_reagent(/datum/reagent/uranium, 10))
		switch(rand(100))
			if(91 to 100)
				adjustHealth(-10)
	...
	else if(S.has_reagent(/datum/reagent/mutagen, 2) || S.has_reagent(/datum/reagent/radium, 5) || S.has_reagent(/datum/reagent/uranium, 5))
		hardmutate()
	else if(S.has_reagent(/datum/reagent/mutagen, 1) || S.has_reagent(/datum/reagent/radium, 2) || S.has_reagent(/datum/reagent/uranium, 2))
		mutate()
	...
	if(S.has_reagent(/datum/reagent/fishwater, 1))
		adjustNutri(round(S.get_reagent_amount(/datum/reagent/fishwater) * 0.75))
		adjustWater(round(S.get_reagent_amount(/datum/reagent/fishwater) * 1))
	...
	if(S.has_reagent(/datum/reagent/consumable/drink/milk, 1))
		adjustNutri(round(S.get_reagent_amount(/datum/reagent/consumable/drink/milk) * 0.1))
		adjustWater(round(S.get_reagent_amount(/datum/reagent/consumable/drink/milk) * 0.9))
	...
	if(S.has_reagent(/datum/reagent/holywater, 1))
		adjustWater(round(S.get_reagent_amount(/datum/reagent/holywater) * 1))
		adjustHealth(round(S.get_reagent_amount(/datum/reagent/holywater) * 0.1))

	// A variety of nutrients are dissolved in club soda, without sugar.
	// These nutrients include carbon, oxygen, hydrogen, phosphorous, potassium, sulfur and sodium, all of which are needed for healthy plant growth.
	if(S.has_reagent(/datum/reagent/consumable/drink/cold/sodawater, 1))
		adjustWater(round(S.get_reagent_amount(/datum/reagent/consumable/drink/cold/sodawater) * 1))
		adjustHealth(round(S.get_reagent_amount(/datum/reagent/consumable/drink/cold/sodawater) * 0.1))
		adjustNutri(round(S.get_reagent_amount(/datum/reagent/consumable/drink/cold/sodawater) * 0.1))

	// Man, you guys are daft
	if(S.has_reagent(/datum/reagent/acid, 1))
		adjustHealth(-round(S.get_reagent_amount(/datum/reagent/acid) * 1))
		adjustToxic(round(S.get_reagent_amount(/datum/reagent/acid) * 1.5))
		adjustWeeds(-rand(1,2))

	// SERIOUSLY
	if(S.has_reagent(/datum/reagent/acid/facid, 1))
		adjustHealth(-round(S.get_reagent_amount(/datum/reagent/acid/facid) * 2))
		adjustToxic(round(S.get_reagent_amount(/datum/reagent/acid/facid) * 3))
		adjustWeeds(-rand(1,4))

	// Glyphosate is just as bad
	if(S.has_reagent(/datum/reagent/glyphosate, 1))
		adjustHealth(-round(S.get_reagent_amount(/datum/reagent/glyphosate) * 5))
		adjustToxic(round(S.get_reagent_amount(/datum/reagent/glyphosate) * 6))
	...
	//Weed Spray
	if(S.has_reagent(/datum/reagent/glyphosate/atrazine, 1))
		adjustToxic(round(S.get_reagent_amount(/datum/reagent/glyphosate/atrazine) * 0.5))
		//old toxicity was 4, each spray is default 10 (minimal of 5) so 5 and 2.5 are the new ammounts
		adjustWeeds(-rand(1,2))

	//Pest Spray
	if(S.has_reagent(/datum/reagent/pestkiller, 1))
		adjustToxic(round(S.get_reagent_amount(/datum/reagent/pestkiller) * 0.5))
		adjustPests(-rand(1,2))
	...
	if(S.has_reagent(/datum/reagent/consumable/nutriment/plantmatter, 1))
		adjustHealth(round(S.get_reagent_amount(/datum/reagent/consumable/nutriment/plantmatter) * 0.5))
		adjustNutri(round(S.get_reagent_amount(/datum/reagent/consumable/nutriment/plantmatter) * 1))
