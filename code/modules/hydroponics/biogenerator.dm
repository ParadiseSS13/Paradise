...
/obj/machinery/biogenerator/proc/activate()
	...
	for(var/obj/item/reagent_containers/food/snacks/grown/I in contents)
		S += 5
		if(I.reagents.get_reagent_amount(/datum/reagent/consumable/nutriment) + I.reagents.get_reagent_amount(/datum/reagent/consumable/nutriment/plantmatter) < 0.1)
			points += 1*productivity
		else
			points += (I.reagents.get_reagent_amount(/datum/reagent/consumable/nutriment) + I.reagents.get_reagent_amount(/datum/reagent/consumable/nutriment/plantmatter)) * 10 * productivity
		qdel(I)
	if(S)
		processing = 1
		update_icon()
