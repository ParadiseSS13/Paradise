...
#undef CLUSTER_CHECK_DIFFERENT_TURFS
#undef CLUSTER_CHECK_DIFFERENT_ATOMS
#undef CLUSTER_CHECK_SAME_TURFS
#undef CLUSTER_CHECK_SAME_ATOMS
#undef CLUSTER_CHECK_SAMES
#undef CLUSTER_CHECK_DIFFERENTS
#undef CLUSTER_CHECK_ALL_TURFS
#undef CLUSTER_CHECK_ALL_ATOMS
#undef CLUSTER_CHECK_ALL