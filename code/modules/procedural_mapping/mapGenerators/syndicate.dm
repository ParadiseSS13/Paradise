...
turf
	simulated
		shuttle
			floor
				syndicate //TODO: move to proper file/replace syndie shuttle turfs
					icon_state = "floor4"
	...
	mapGeneratorModule
		syndieFurniture
			...
			spawnableAtoms = list(/obj/structure/table = 20,/obj/structure/stool/bed/chair = 15,/obj/structure/stool = 10, \
				obj
					structure
						computerframe = 15, /obj/item/weapon/storage/toolbox/syndicate = 15 ,\
				obj
					structure
						closet
							syndicate = 25)
