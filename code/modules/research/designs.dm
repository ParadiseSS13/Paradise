...
/datum/design						//Datum for object designs, used in construction
	...
	var/list/make_reagents = list()			//Reagents produced. Format: "path" = amount. Currently only supported by the biogenerator.
	...
	var/list/reagents_list = list()			//List of reagents. Format: "path" = amount.
	var/maxstack = 1
