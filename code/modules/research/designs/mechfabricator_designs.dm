...
/datum/design/paint_odysseus_hermes
	...
	id = "p_hermes"
	build_type = MECHFAB
	req_tech = list("engineering" = 5, "biotech" = 3)
	build_path = /obj/item/paintkit/odysseus_hermes
	materials = list(MAT_METAL=10000, MAT_GOLD=2000)
	construction_time = 10 SECONDS
	category = list("Exosuit Paintkits")
...
/datum/design/paint_odysseus_reaper
	...
	id = "p_odyreaper"
	build_type = MECHFAB
	req_tech = list("combat" = 5, "biotech" = 3, "syndicate" = 3)
	build_path = /obj/item/paintkit/odysseus_death
	materials = list(MAT_METAL=10000, MAT_GOLD=2000, MAT_GLASS=2000)
	construction_time = 10 SECONDS
	category = list("Exosuit Paintkits")
...
/datum/design/paint_gygax_alt
	...
	id = "p_altgygax"
	build_type = MECHFAB
	req_tech = list("materials" = 6, "programming" = 5)
	build_path = /obj/item/paintkit/gygax_alt
	materials = list(MAT_METAL=15000, MAT_GLASS =2000)
...
/datum/design/paint_gygax_pobeda
	...
	materials = list(MAT_METAL=15000, MAT_URANIUM= 2000)
	construction_time = 20 SECONDS
	category = list("Exosuit Paintkits")
...
/datum/design/paint_gygax_white
	...
	id = "p_whitegygax"
	build_type = MECHFAB
	req_tech = list("engineering" = 6, "materials" = 5)
	build_path = /obj/item/paintkit/gygax_white
	materials = list(MAT_METAL=15000, MAT_TITANIUM=2000)
	construction_time = 20 SECONDS
	category = list("Exosuit Paintkits")
...
/datum/design/paint_gygax_mime
	...
	id = "p_gygax_mime"
	build_type = MECHFAB
	req_tech = list("biotech" = 6, "engineering" = 5)
...
/datum/design/paint_gygax_medgax
	...
	id = "p_medgax"
	build_type = MECHFAB
	req_tech = list("biotech" = 6, "materials" = 5)
...
/datum/design/paint_gygax_black
	...
	id = "p_blackgygax"
	build_type = MECHFAB
	req_tech = list("combat" = 6, "engineering" = 5, "syndicate" = 2)
...
/datum/design/paint_durand_black
	name = "Durand \"Syndicate\""
	id = "p_blackdurand"
	build_type = MECHFAB
	req_tech = list("combat" = 6, "engineering" = 6, "syndicate" = 2)
	build_path = /obj/item/paintkit/durand_syndie
	materials = list(MAT_METAL=20000, MAT_DIAMOND=3000)
...
/datum/design/paint_phazon_imperion
	...
	materials = list(MAT_METAL=25000, MAT_DIAMOND=3000, MAT_BLUESPACE=3000)
...
/datum/design/paint_phazon_plazmus
	...
	materials = list(MAT_METAL=25000, MAT_DIAMOND=3000, MAT_PLASMA=3000)
	construction_time = 40 SECONDS
	category = list("Exosuit Paintkits")
