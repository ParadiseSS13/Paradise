...
obj
	machinery
		r_n_d
			circuit_imprinter
				proc
					check_mat(datum/design/being_built, var/M)
						switch(M)
							if(MAT_GLASS)
									...
									obj
										item
											stack
												sheet
													glass
														G = new /obj/item/stack/sheet/glass(src.loc)
										...
										item
											stack
												sheet
													mineral
														gold
															G = new /obj/item/stack/sheet/mineral/gold(src.loc)
										...
										item
											stack
												sheet
													mineral
														diamond
															G = new /obj/item/stack/sheet/mineral/diamond(src.loc)
