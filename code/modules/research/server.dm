			...
			rdservercontrol
				Topic(href, href_list)
					...
					if(href_list["main"])
						...
						var
							num = text2num(href_list["upload_toggle"])
						...
						var
							num = text2num(href_list["download_toggle"])
						...
						var
							choice = alert("Technology Data Reset", "Are you sure you want to reset this technology to its default data? Data lost cannot be recovered.", "Continue", "Cancel")
						if(choice == "Continue")
						...
						var
							choice = alert("Design Data Deletion", "Are you sure you want to delete this design? If you still have the prerequisites for the design, it'll reset to its base reliability. Data lost cannot be recovered.", "Continue", "Cancel")
						if(choice == "Continue")
