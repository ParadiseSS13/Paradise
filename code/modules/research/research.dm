...
datum
	research								//Holder for all the existing, archived, and known tech. Individual to console.
...
datum
	research
		proc
			UpdateDesigns(var/obj/item/I, var/list/temp_tech)
...
datum
	tech	//Datum of individual technologies.
		...
		var
			max_level = 1          // Maximum level this can be at (for job objectives)
		var
			rare = 1						//How much CentCom wants to get that tech. Used in supply shuttle tech cost calculation.
		var
			list
				req_tech = list()			//List of ids associated values of techs required to research this tech. "id" = #
...
datum
	tech
		proc
			getCost(var/current_level = null)
