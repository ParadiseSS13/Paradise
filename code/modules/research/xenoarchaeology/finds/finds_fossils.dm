			...
			fossil
				base
					New()
						var
							list
								l = list("/obj/item/weapon/fossil/bone"=9,"/obj/item/weapon/fossil/skull"=3,
				...
				skull
					attackby(obj/item/weapon/W as obj, mob/user as mob, params)
						if(istype(W,/obj/item/weapon/fossil/bone))
							var
								obj
									o = new /obj/skeleton(get_turf(src))
							var
								a = new /obj/item/weapon/fossil/bone
							var
								b = new src.type
							o.contents.Add(a)
							o.contents.Add(b)
...
obj
	skeleton
		...
		var
			bstate = 0
		var
			plaque_contents = "Unnamed alien creature"
