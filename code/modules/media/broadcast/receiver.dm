...
obj
	machinery
		media
			receiver
				var
					media_frequency = 1015 // 123.4 MHz
				var
					media_crypto    = null // Crypto key
...
obj
	machinery
		media
			receiver
				proc
					receive_broadcast(var/url="", var/start_time=0)
						media_url = url
							...
							var
								obj
									machinery
										media
											transmitter
												B = pick(media_transmitters[freq])
