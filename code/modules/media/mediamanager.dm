	...
	verb
		change_volume()
			...
			if(!media || !istype(media))
				...
				return
			var
				value = input("Choose your Jukebox volume.", "Jukebox volume", media.get_volume())
