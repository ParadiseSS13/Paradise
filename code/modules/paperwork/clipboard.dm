				...
				var
					obj
						item
							weapon
								pen
									haspen		//The stored pen.
				var
					obj
						item
							weapon
								toppaper	//The topmost piece of paper.
...
obj
	item
		weapon
			clipboard
				MouseDrop(obj/over_object as obj) //Quick clipboard fix. -Agouri
					if(ishuman(usr))
						var
							mob
								M = usr
									...
									var
										obj
											item
												weapon
													paper
														newtop = locate(/obj/item/weapon/paper) in src
									if(newtop && (newtop != P))
										toppaper = newtop
									else
										toppaper = null
