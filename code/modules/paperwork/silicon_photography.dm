	...
	item
		device
			camera
				siliconcam
					proc
						injectaialbum(var/datum/picture/P, var/sufix = "") //stores image information to a list similar to that of the datacore
							photos_taken++
	...
	item
		device
			camera
				siliconcam
					proc
						injectmasteralbum(var/datum/picture/P) //stores image information to a list similar to that of the datacore
							var
								mob
									living
										silicon
	...
	item
		device
			camera
				siliconcam
					proc
						selectpicture(obj/item/device/camera/siliconcam/cam)
							if(!cam)
								cam = getsource()
	...
	item
		device
			camera
				siliconcam
					proc
						deletepicture(obj/item/device/camera/siliconcam/cam)
							var
								datum
									picture
										selection = selectpicture(cam)
	...
	item
		device
			camera
				siliconcam
					ai_camera
						printpicture(mob/user, datum/picture/P)
							injectaialbum(P)
							to_chat(usr, "<span class='unconscious'>Image recorded</span>")
