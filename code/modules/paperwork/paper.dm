...
/obj/item/paper/chef
	...
	info = "Welcome aboard, chef.<br><br>Right, so you're wanting to learn how to feed the teeming masses of the station yeah? Well I was asked to write these tips to help you not burn all of your meals and prevent food poisonings.<br><br>Okay first things first, making a humble ball of <b>dough</b>. Check the lockers for a bag or two of <b>flour</b> and then find a glass cup or a <b>beaker</b>, something that can hold liquids. Next pour 15 units of <b>flour</b> into the container and then pour 10 units of <b>water</b> in as well. You can get the latter from the sink on the wall.<br><br>Hey presto! You've made a ball of dough, which can lead to many possibilities.<br><br>Also, before I forget, <b>KEEP YOUR FOOD OFF THE DAMN FLOOR!</b> Space ants love getting onto any food not on a table or kept away in a closed locker. You wouldn't believe how many injuries have resulted from space ants...<br><br>Okay back on topic, let's make some <b>cheese</b>, just follow along with me here.<br><br>Look in the lockers again for some <b>milk</b> cartons and grab a <b>beaker</b> to mix with. Next look around for a green bottle with a red label, named <b>'Universal Enzyme'</b>. Now pour 5 units of <b>universal enzyme</b> into the beaker and 40 units of <b>milk</b> as well. In a matter of moments, you'll have a whole wheel of <b>cheese</b> at your disposal.<br><br>Okay, now that you've got the ingredients, let's make a classic crewman food, the <b>cheese bread</b>.<br><br>Make another ball of <b>dough</b>, and cut up your <b>cheese</b> wheel with your <b>kitchen knife</b>. Okay, now look around for an <b>oven</b> in the kitchen and put <b>2 balls of dough and 2 cheese wedges into the oven</b> and turn it on. After a few seconds a fresh and hot loaf of cheese bread will pop out. Lastly cut it into slices with a knife and serve.<br><br>Congratulations on making it this far. If you haven't created a burnt mess of slop after following these directions you might just be on your way to becoming a master chef someday. If you managed to get your oven dirty, try to ask for a space cleaner or a soap, or call over the janitor to get it cleaned.<br><br>Be sure to look up other dishes from the recipe book in your kitchen and ask botany for crops should you need any.<br><br>Good luck in the kitchen, and try not to burn down the place.<br><br>-Morgan Ramslay"
