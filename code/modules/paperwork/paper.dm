...
/obj/item/paper/attackby(obj/item/P, mob/living/user, params)
	...
	var/clown = 0
	if(user.mind && (user.mind.assigned_role == "Payaso"))
		clown = 1
...
/obj/item/paper/clownship
	name = "paper- 'Note'"
	info = "The call has gone out! Our ancestral home has been rediscovered! Not a small patch of land, but a true clown nation, a true Payaso Planet! We're on our way home at last!"
	...
	spawn(30)
		if(istype(target, /mob/living/carbon))
			...
			if(myeffect == "Borgification")
				...
				GLOB.event_announcement.Announce("[target.real_name] is hereby demoted to the rank of Civil. Process this demotion immediately. Failure to comply with these orders is grounds for termination.","CC Demotion Order")
