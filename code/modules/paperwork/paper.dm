...
/obj/item/paper/seed_vault/terraforming_introduction
	...
	info = "Thanks to genetic engineering, we modified this grass to be able grow on a rocky, waterless environment. Remember to grow the grass seeds first and when it matures, weave them together to create patches of grass; Cover as much ground with these patches as you can, and within time it will start producing oxygen, which will begin to increase the density of the atmosphere."
