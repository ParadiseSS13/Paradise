...
/obj/item/stamp/afterattack(atom/target, mob/user, proximity, params)
	...
	//this is to prevent floating stamp marks when someone takes off backpack etc
	//not an ideal system but its better than floating stamp marks on where inhand items were
	...
	H.update_misc_effects()			//render the new marks on person
