	...
	item
		weapon
			pen
				...
				var
					colour = "black"	//what colour the ink is!
	...
	item
		weapon
			pen
				multi
					proc
						select_colour(mob/user as mob)
							var
								newcolour = input(user, "Which colour would you like to use?", name, colour) as null|anything in colour_choices
							if(newcolour)
								colour = newcolour
			...
			pen
				multi
					update_icon()
						...
						var
							icon
								o = new(icon, pen_color_iconstate)
						var
							list
								c = colour_choices[colour]
