...
obj
	structure
		filingcabinet
			filingcabinet	//not changing the path to avoid unecessary map issues, but please don't name stuff like this in the future -Pete
			...
			Topic(href, href_list)
				if(href_list["retrieve"])
					...
					var
						obj
							item
								P = locate(href_list["retrieve"])//contents[retrieveindex]
