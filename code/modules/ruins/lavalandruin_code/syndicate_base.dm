...
/obj/effect/mob_spawn/human/lavaland_syndicate
	...
	flavour_text = "<span class='big bold'>Eres un agente del sindicato,</span><b> empleado para desarrollar armas biolÃ³gicas en una estaciÃ³n de investigaciÃ³n secreta. Deasfortunadamente, tu detestable enemigo, Nanotrasen, ha comenzado a minar en este sector. <b>ContinÃºa con tu trabajo lo mejor que puedas, manteniendo un bajo perfil. La base estÃ¡ cargada con explosivos, no dejes que caiga en manos del enemigo ni la abandones.</b> \
	<br><i>Eres libre de atacar a cualquiera que no estÃ© alineado en las cercanÃ­as alrededor de la base. <font size=6>NO</font> trabajes con agentes del sindicator (como traidores u operativos nucleares). Puedes trabajar con otros antagonistas dependiendo del caso. <font size=6>NO</font> abandones la base sin permiso de un admin.</i>"
