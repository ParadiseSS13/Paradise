...
obj
	structure
		powerswitch
			...
			var
				icon_state_on = "switch-dbl-down"
			var
				icon_state_off = "switch-dbl-up"
			density = 0
			anchored = 1
			var
				on = 0  //up is off, down is on
			var
				busy = 0 //set to 1 when you start pulling
						...
						for(var/direction in connection_dirs)
							var
								obj
									structure
										cable
											C = new/obj/structure/cable(src.loc)
							C.d1 = 0
							C.d2 = direction
