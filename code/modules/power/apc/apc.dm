	...
	if(in_range(user, src))
		...
		if(opened)
			...
			if(stat & MAINT)
				...
				. += "The cover is closed."
	. += span_notice("This powerful, yet small, device powers the entire room in which it is located. From lighting, airlocks, and equipment, an APC is able to power it all! You can unlock an APC by using an ID with the required access on it, or by a local synthetic.")
