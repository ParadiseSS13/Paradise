...
/obj/machinery/power/tesla_coil/crowbar_act(mob/user, obj/item/tool/I)
	. = TRUE
...
/obj/machinery/power/grounding_rod/screwdriver_act(mob/user, obj/item/tool/I)
	. = TRUE
	default_deconstruction_screwdriver(user, "grounding_rod_open[anchored]", "grounding_rod[anchored]", I)

/obj/machinery/power/grounding_rod/wrench_act(mob/user, obj/item/tool/I)
	. = TRUE
	default_unfasten_wrench(user, I)

/obj/machinery/power/grounding_rod/crowbar_act(mob/user, obj/item/tool/I)
	. = TRUE
	default_deconstruction_crowbar(user, I)
