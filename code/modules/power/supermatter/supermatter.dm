...
/obj/machinery/power/supermatter_crystal/process_atmos()
	...
	for(var/mob/living/carbon/human/l in view(src, HALLUCINATION_RANGE(power))) // If they can see it without mesons on.  Bad on them.
		if(!istype(l.glasses, /obj/item/clothing/glasses/meson) && !HAS_TRAIT(l, TRAIT_MESON_VISION) && !istype(l.get_int_organ(/obj/item/organ/internal/eyes), /obj/item/organ/internal/eyes/cybernetic/meson))
