			...
			oneinput
				process()
					...
					if(!input)
						var
							turf
								T = get_step(src, dir_input)
						if(T)
							var
								inv_dir = turn(dir_input, 180)
							for(var/obj/structure/cable/C in T)
								if(C.d1 == inv_dir || C.d2 == inv_dir)
									input = C
					...
					if(!output)
						var
							turf
								T = get_step(src, dir_output)
						if(T)
							var
								inv_dir = turn(dir_output, 180)
							for(var/obj/structure/cable/C in T)
								if(C.d1 == inv_dir || C.d2 == inv_dir)
									output = C
			...
			twoinput
				process()
					...
					if(!input1)
						var
							turf
								T = get_step(src, dir_input1)
						if(T)
							var
								inv_dir = turn(dir_input1, 180)
							for(var/obj/structure/cable/C in T)
								if(C.d1 == inv_dir || C.d2 == inv_dir)
									input1 = C
					...
					if(!input2)
						var
							turf
								T = get_step(src, dir_input2)
						if(T)
							var
								inv_dir = turn(dir_input2, 180)
							for(var/obj/structure/cable/C in T)
								if(C.d1 == inv_dir || C.d2 == inv_dir)
									input2 = C
				...
				and
					process()
						...
						var
							datum
								powernet
									pn_input1 = input1.powernet
						var
							datum
								powernet
									pn_input2 = input2.powernet
