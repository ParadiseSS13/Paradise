...
/obj/singularity/narsie/large/Initialize(mapload, starting_energy)
	...
	SEND_SOUND_NO_ECHO(world, pick('sound/hallucinations/im_here1.ogg', 'sound/hallucinations/im_here2.ogg'))
...
/obj/singularity/narsie/large/Destroy()
	...
	SEND_SOUND_NO_ECHO(world, 'sound/hallucinations/wail.ogg')
	var/datum/game_mode/gamemode = SSticker.mode
	if(gamemode)
