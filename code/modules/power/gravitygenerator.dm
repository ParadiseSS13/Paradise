...
var
	list
		gravity_generators = list() // We will keep track of this by adding new gravity generators to the list, and keying it with the z level.
...
var
	const
		GRAV_NEEDS_SCREWDRIVER = 0
var
	const
		GRAV_NEEDS_WELDING = 1
var
	const
		GRAV_NEEDS_PLASTEEL = 2
var
	const
		GRAV_NEEDS_WRENCH = 3
...
obj
	machinery
		gravity_generator
			main
				Destroy() // If we somehow get deleted, remove all of our other parts.
