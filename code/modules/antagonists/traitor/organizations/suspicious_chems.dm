...
/obj/item/reagent_containers/glass/bottle/experiment/Initialize(mapload)
	...
	reagents.add_reagent(pick("mitocholide", "hydrocodone", "synaptizine", "cryoxadone", "rezadone", "salglu_solution", "omnizine",
	"perfluorodecalin", "stimulants", "teporone", "heparin", "haloperidol"), 20)
