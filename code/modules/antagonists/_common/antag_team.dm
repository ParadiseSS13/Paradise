...
//Display members/victory/failure/objectives for team
/datum/team/proc/roundend_report()
	...
	if(objectives.len)
		...
		for(var/datum/objective/objective in objectives)
			...
			objective_count++
		if(win)
			report += "<span class='greentext'>The blood brothers were successful!</span>"
		else
			report += "<span class='redtext'>The blood brothers have failed!</span>"
