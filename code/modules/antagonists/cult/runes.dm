...
/obj/effect/rune/convert/invoke(var/list/invokers)
	...
	ticker.mode.add_cultist(L.mind, 1)
	...
	to_chat(L, "<span class='cultitalic'><b>Assist your new compatriots in their dark dealings. Your goal is theirs, and theirs is yours. You serve [ticker.cultdat.entity_title3] above all else. Bring it back.\
	</b></span>")
	rune_in_use = FALSE
...
/obj/effect/rune/narsie/invoke(var/list/invokers)
	...
	if(!(place in summon_objective.summon_spots))
		to_chat(user, "<span class='cultlarge'>[ticker.cultdat.entity_name] can only be summoned where the veil is weak - in [english_list(summon_objective.summon_spots)]!</span>")
		return
