...
/datum/antagonist/vampire/proc/check_sun()
	...
	if(bloodusable >= 10)	//burn through your blood to tank the light for a little while
		to_chat(owner.current, "<span class='biggerdanger'>The starlight saps your strength, you should get out of the light!</span>")
		subtract_usable_blood(10)
		vamp_burn(10)
	else		//You're in trouble, get out of the sun NOW
		to_chat(owner.current, "<span class='biggerdanger'>Your body is turning to ash, get out of the light NOW!</span>")
