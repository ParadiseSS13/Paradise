...
/datum/action/changeling/weapon/shield
	...
	helptext = "Organic tissue cannot resist damage forever. The shield will break after it is hit 6 times. Automatically Parries. Cannot be used while in lesser form."
