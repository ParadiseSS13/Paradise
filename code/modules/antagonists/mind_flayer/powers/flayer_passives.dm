...
/datum/mindflayer_passive/torque_enhancer
	...
	purchase_text = "Increase the strength of your melee blows by increasing the torque generated by swings."
...
/datum/mindflayer_passive/torque_enhancer/on_apply()
	...
	if(!melee_bonus_holder)
		melee_bonus_holder = user.physiology.melee_bonus
	user.physiology.melee_bonus += 5

/datum/mindflayer_passive/torque_enhancer/on_remove()
	var/mob/living/carbon/human/user = owner
	if(melee_bonus_holder)
		user.physiology.melee_bonus = melee_bonus_holder
