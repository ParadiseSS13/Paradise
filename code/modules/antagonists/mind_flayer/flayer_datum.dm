...
//	antag_hud_type = ANTAG_HUD_MIND_FLAYER
	...
	var/list/innate_powers = list(/obj/effect/proc_holder/spell/flayer/weapon/swarmprod, /datum/mindflayer_passive/new_crit) // They won't get newcrit for being a mindflayer, I just like having it during testing
