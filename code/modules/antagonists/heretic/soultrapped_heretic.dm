...
/datum/antagonist/soultrapped_heretic/greet()
	...
	messages.Add("<span class='warning'>You are the trapped soul of the Heretic you once were. You may attempt to convince your wielders to unbind you, granting you some degree of freedom, and them access to some of your powers. \
