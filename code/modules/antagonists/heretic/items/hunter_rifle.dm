...
/obj/item/gun/projectile/shotgun/boltaction/lionhunter/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/scope, range_modifier = 3.2, flags = SCOPE_TURF_ONLY | SCOPE_NEED_ACTIVE_HAND, trait_to_add = TRAIT_THERMAL_VISION, trait_required_to_add_trait = TRAIT_MANSUS_TOUCHED)
