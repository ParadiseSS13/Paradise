...
/datum/spell/touch/flesh_surgery/proc/steal_organ_from_mob(obj/item/melee/touch_attack/hand, mob/living/victim, mob/living/carbon/caster)
	...
	if(carbon_victim == caster)
		...
		caster.visible_message(
			"<span class='danger'>[caster]'s hand glows a brilliant red as [caster.p_they()] reach[caster.p_es()] directly into [caster.p_their()] own [parsed_zone]!</span>",
			"<span class='userdanger'>Your hand glows a brilliant red as you reach directly into your own [parsed_zone]!</span>",
		)

	else
		carbon_victim.visible_message(
			"<span class='danger'>[caster]'s hand glows a brilliant red as [caster.p_they()] reach[caster.p_es()] directly into [carbon_victim]'s [parsed_zone]!</span>",
			"<span class='userdanger'>[caster]'s hand glows a brilliant red as [caster.p_they()] reach[caster.p_es()] directly into your [parsed_zone]!</span>",
		)
	...
	if(carbon_victim == caster)
		caster.visible_message(
			"<span class='bolddanger'>[caster] pulls [caster.p_their()] own [chosen_organ] out of [caster.p_their()] [parsed_zone]!!</span>",
			"<span class='userdanger'>You pull your own [chosen_organ] out of your [parsed_zone]!!</span>",
		)

	else
		carbon_victim.visible_message(
			"<span class='bolddanger'>[caster] pulls [carbon_victim]'s [chosen_organ] out of [carbon_victim.p_their()] [parsed_zone]!!</span>",
			"<span class='userdanger'>[caster] pulls your [chosen_organ] out of your [parsed_zone]!!</span>",
		)
