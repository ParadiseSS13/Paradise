...
/datum/spell/shapeshift/eldritch/ascension
...
/datum/spell/shapeshift/eldritch/ascension/do_shapeshift(mob/living/caster)
	. = ..()
	if(!.)
		return
...
/datum/spell/shapeshift/eldritch/ascension/do_unshapeshift(mob/living/caster)
	. = ..()
