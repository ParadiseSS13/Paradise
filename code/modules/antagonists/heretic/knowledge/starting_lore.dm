...
/datum/heretic_knowledge/spell/basic/proc/on_grasp_cast(mob/living/carbon/cast_on, datum/spell/touch/touch_spell)
	SIGNAL_HANDLER
...
/datum/heretic_knowledge/codex_cicatrix/cleanup_atoms(list/selected_atoms)
	...
	body.visible_message("<span class='danger'>An awful ripping sound is heard as [ripped_thing]'s [exterior_text] is ripped straight out, wrapping around [le_book || "the book"], turning into an eldritch shade of blue!</span>")
	return ..()
...
/datum/heretic_knowledge/feast_of_owls/on_finished_recipe(mob/living/user, list/selected_atoms, turf/loc)
	...
	user.Paralyse(reward * 1 SECONDS)
