...
/client/New(TopicData)
	...
	if(_2fa_alert)
		to_chat(src,span_boldannounce("<big>You do not have 2FA enabled. Admin verbs will be unavailable until you have enabled 2FA.</big>")) // Very fucking obvious
...
/client/verb/resend_ui_resources()
	...
	if(choice == "Yes")
		...
		to_chat(usr, span_notice("UI resource files resent successfully. If you are still having issues, please try manually clearing your BYOND cache. <b>This can be achieved by opening your BYOND launcher, pressing the cog in the top right, selecting preferences, going to the Games tab, and pressing 'Clear Cache'.</b>"))
