...
/datum/quirk/positive/freerunner
	...
	cost = 4
	var/vault_multiplier = 1.2

/datum/quirk/positive/crafty
	name = "Crafty"
	desc = "You can craft things faster than normal."
	cost = 2
	var/crafting_multiplier = 1.2

/datum/quirk/positive/alcohol_tolerance
	name = "Heavy Drinker"
	desc = "Alcohol doesn't affect you as heavily as others."
	cost = 1
