...
/datum/gear/accessory/holobadge
	...
	allowed_roles = list("Head of Security", "Warden", "Constable", "Detective", "Security Officer", "Security Pod Pilot")
...
/datum/gear/accessory/armband_job/sec
	...
	allowed_roles = list("Head of Security", "Warden", "Detective", "Constable", "Security Officer", "Brig Physician", "Security Pod Pilot")
