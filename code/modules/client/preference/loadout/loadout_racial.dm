...
/datum/gear/racial/tajsec
	...
	description = "a common traditional nano-fiber veil worn by many Tajaran, It is rare and offensive to see it on other races. This one has a built in sec hud."
...
/datum/gear/racial/tajmed
	...
	description = "a common traditional nano-fiber veil worn by many Tajaran, It is rare and offensive to see it on other races. This one has a built in health hud."
