...
//	var/savefile_version = 0
	...
	var/afk_fast_cryo = FALSE			// If they want to be put into cryo the fast way by the AFK subsystem
...
*/
			...
			switch(href_list["preference"])
				...
				if("afk_fast_cryo")
					afk_fast_cryo = alert(user, "Would you like to be qualified for the fast cryoing? Being AFK for 5 minutes will result in cryoing then (instead of [config.auto_cryo_afk])", "Fast cryoing", "Yes", "No") == "Yes"
