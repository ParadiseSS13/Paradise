...
/datum/preferences
	...
	var/list/volume_mixer = list(
		"1012" = 30, // CHANNEL_GENERAL	//Note: This should stay on top because order in this list defines order of sliders in mixer's interface.
		...
		"1016" = 0, // CHANNEL_FIREALARM
		"1015" = 0, // CHANNEL_ASH_STORM
