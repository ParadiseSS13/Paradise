...
/datum/preferences/proc/ShowChoices(mob/user)
	...
	switch(current_tab)
		if(TAB_CHAR) // Character Settings
			...
			var/skintonename = "Skin Tone:"
			if(S.bodyflags & (HAS_SKIN_TONE|HAS_ICON_SKIN_TONE))
				if(S.has_sub)
					skintonename = "Sub Species:"
				dat += "<b>[skintonename]:</b> <a href='?_src_=prefs;preference=s_tone;task=input'>[S.bodyflags & HAS_ICON_SKIN_TONE ? "[s_tone]" : "[-s_tone + 35]/220"]</a><br>"
