...
/client/verb/toggle_ai_voice_annoucements()
	...
	SSblackbox.record_feedback("tally", "admin_verb", 1, "TAIvoice") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/verb/toggleprayernotify()
	...
	SSblackbox.record_feedback("tally", "admin_verb", 1, "TPS") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
