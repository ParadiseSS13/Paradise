...
/datum/preference_toggle/toggle_ghost_ears
	...
	preftoggle_category = PREFTOGGLE_GHOST
...
/datum/preference_toggle/toggle_admin_radio
	...
	preftoggle_category = PREFTOGGLE_ADMIN
...
/datum/preference_toggle/toggle_darkmode_ui
	name = "Toggle Darkmode"
	description = "Toggles UI style between dark and light"
	preftoggle_bitflag = PREFTOGGLE_UI_DARKMODE
	preftoggle_toggle = PREFTOGGLE_TOGGLE1
	preftoggle_category = PREFTOGGLE_GENERAL
	enable_message = "Darkmode has been enabled."
	disable_message = "Darkmode has been disabled."
	blackbox_message = "Toggle Darkmode"

/datum/preference_toggle/toggle_darkmode_ui/set_toggles(client/user)
	. = ..()
	if(user.prefs.toggles & PREFTOGGLE_UI_DARKMODE)
		user.activate_darkmode()
	else
		user.deactivate_darkmode()
...
/datum/preference_toggle/toggle_simple_stat_panel
	...
	preftoggle_toggle = PREFTOGGLE_TOGGLE2
	preftoggle_category = PREFTOGGLE_LIVING
