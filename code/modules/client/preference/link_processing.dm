...
//						var/languages_available
				...
				if("physique")
					var/new_physique = input(user, "Choose your descriptor for how built your character is on glance.", "Character Preference") as null|anything in list("rail thin", "thin", "of average build", "well-built", "heavily built")
					if(new_physique)
