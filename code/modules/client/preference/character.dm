			...
			if(JOB_EXPLORER)
				...
				switch(backbag)
					...
					if(4)
						clothes_s.Blend(new /icon('icons/mob/clothing/back.dmi', "satchel"), ICON_OVERLAY)
			if(JOB_BITRUNNER)
				clothes_s = new /icon('icons/mob/clothing/under/cargo.dmi', "bitrunner_s")
				clothes_s.Blend(new /icon('icons/mob/clothing/feet.dmi', "black"), ICON_UNDERLAY)
				clothes_s.Blend(new /icon('icons/mob/clothing/hands.dmi', "bgloves"), ICON_OVERLAY)
				clothes_s.Blend(new /icon('icons/mob/clothing/head/softcap.dmi', "cargosoft"), ICON_OVERLAY)
				has_gloves = TRUE
				if(prob(1))
					clothes_s.Blend(new /icon('icons/mob/clothing/mask.dmi', "fawkes"), ICON_OVERLAY)
				switch(backbag)
					if(2)
						clothes_s.Blend(new /icon('icons/mob/clothing/back.dmi', "backpack"), ICON_OVERLAY)
					if(3)
