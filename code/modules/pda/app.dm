	...
	data
		pda
			var
				icon = "tasks"
			var
				notify_icon = "exclamation-circle"
			var
				notify_silent = 0
			var
				hidden = 0				// program not displayed in main menu
			var
				category = "General"	// the category to list it in on the main menu
			var
				obj
					item
						device
							pda
								pda	// if this is null, and the app is running code, something's gone wrong
	...
	data
		pda
			app
				...
				size = 3
				var
					title = null	// what is displayed in the title bar when this is the current app
				var
					template = ""
				var
...
datum
	data
		pda
			utility
				scanmode
					New(obj/item/weapon/cartridge/C)
						..(C)
