	...
	if(!isnull(T))
		...
		if(total_moles)
			...
			results = list(
				...
				list("entry" = "Hydrogen", "units" = "%", "val" = "[round(h2_level*100,0.01)]", "bad_high" = 5, "poor_high" = 1, "poor_low" = 0, "bad_low" = 0),
				list("entry" = "Water Vapor", "units" = "%", "val" = "[round(h2o_level*100,0.1)]", "bad_high" = 10, "poor_high" = 5, "poor_low" = 0, "bad_low" = 0),
