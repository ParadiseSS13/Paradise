...
/obj/item/organ/internal/cyberimp/arm/examine(mob/user)
	. = ..()
	. += span_info("[src] is assembled in the [parent_organ == "r_arm" ? "right" : "left"] arm configuration. You can use a screwdriver to reassemble it.")
...
/obj/item/organ/internal/cyberimp/arm/gun/emp_act(severity)
	...
	if(prob(30/severity) && owner && !crit_fail)
		...
		to_chat(owner, span_userdanger("You feel an explosion erupt inside your [parent_organ == "r_arm" ? "right" : "left"] arm as your implant breaks!"))
