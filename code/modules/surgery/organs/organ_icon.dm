...
obj
	item
		organ
			external
				proc
					sync_colour_to_human(var/mob/living/carbon/human/H)
							...
							obj
								item
									organ
										internal
											eyes
												eyes = owner.get_int_organ(/obj/item/organ/internal/eyes)//owner.internal_organs_by_name["eyes"]
					...
					get_icon()
						...
						if(owner.m_style)
							var
								datum
									sprite_accessory
										marking_style = marking_styles_list[owner.m_style]
						...
						if(H.ha_style)
							var
								datum
									sprite_accessory
										head_accessory_style = head_accessory_styles_list[H.ha_style]
