...
/obj/item/organ/internal/heart/update_icon_state()
	var/datum/organ/heart/heart = organ_datums["heart"] // ctodo change, i dont like this
	if(heart.beating)
...
/obj/item/organ/internal/heart/safe_replace(mob/living/carbon/human/target) // ctodo figure out what the fuck safe_replace is
	var/datum/organ/heart/heart = organ_datums["heart"] // ctodo change, i dont like this
...
/obj/item/organ/internal/heart/cybernetic/upgraded/on_life()
	...
	var/datum/organ/heart/heart_datum = organ_datums["heart"] // ctodo change, i dont like this
