...
/obj/item/organ/external/head/remove()
	if(owner)
		...
		if(owner.glasses)
			owner.unEquip(owner.glasses, TRUE)
		if(owner.head)
			owner.unEquip(owner.head, TRUE)
		if(owner.l_ear)
			owner.unEquip(owner.l_ear, TRUE)
		if(owner.r_ear)
			owner.unEquip(owner.r_ear, TRUE)
		if(owner.wear_mask)
			owner.unEquip(owner.wear_mask, TRUE)
		owner.update_hair()
		owner.update_fhair()
