...
/obj/item/organ/internal/body_egg/insert(mob/living/carbon/M, special = 0)
	..()
	ADD_TRAIT(owner, TRAIT_ALIEN_HOST, TRAIT_GENERIC)
	ADD_TRAIT(owner, TRAIT_ALIEN_IMMUNE, "alien immune")
...
/obj/item/organ/internal/body_egg/remove(mob/living/carbon/M, special = 0)
	...
	if(owner)
		REMOVE_TRAIT(owner, TRAIT_ALIEN_HOST, TRAIT_GENERIC)
		REMOVE_TRAIT(owner, TRAIT_ALIEN_IMMUNE, "alien immune")
		owner.med_hud_set_status()
