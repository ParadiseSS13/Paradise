...
/datum/surgery_step/internal/can_use(mob/living/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery, surgery_behaviour)
	. = ..()
	if(ishuman(target))
...
/datum/surgery_step/internal/manipulate_organs/can_use(mob/living/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery, surgery_behaviour)
	if(!(. = ..()))
		return FALSE
	if(ishuman(target))
...
/datum/surgery_step/internal/manipulate_organs/heal_organs/begin_step(mob/living/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery, surgery_behaviour)
...
/datum/surgery_step/internal/manipulate_organs/heal_organs/end_step(mob/living/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery, surgery_behaviour)
...
/datum/surgery_step/internal/manipulate_organs/heal_organs/fail_step(mob/living/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery, surgery_behaviour)
	affected = target.get_organ(target_zone)
...
/datum/surgery_step/internal/manipulate_organs/clean/begin_step(mob/living/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery, surgery_behaviour)
	affected = target.get_organ(target_zone)
...
/datum/surgery_step/internal/manipulate_organs/clean/end_step(mob/living/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery, surgery_behaviour)
	if(!istype(tool,/obj/item/reagent_containers))
		return
	affected = target.get_organ(target_zone)
	var/obj/item/reagent_containers/C = tool
...
/datum/surgery_step/internal/manipulate_organs/clean/fail_step(mob/living/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery, surgery_behaviour)
	if(!istype(tool,/obj/item/reagent_containers))
		return
	affected = target.get_organ(target_zone)
	var/obj/item/reagent_containers/C = tool
...
/datum/surgery_step/internal/manipulate_organs/extract/begin_step(mob/living/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery, surgery_behaviour)
...
/datum/surgery_step/internal/manipulate_organs/extract/end_step(mob/living/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery, surgery_behaviour)
	var/mob/living/simple_animal/borer/B = target.has_brain_worms()
...
/datum/surgery_step/internal/manipulate_organs/extract/fail_step(mob/living/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery, surgery_behaviour)
	if(organ_being_removed && organ_being_removed.owner == target)
		if(affected)
...
/datum/surgery_step/internal/manipulate_organs/implant/begin_step(mob/living/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery, surgery_behaviour)
...
/datum/surgery_step/internal/manipulate_organs/implant/end_step(mob/living/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery, surgery_behaviour)
	var/obj/item/organ/internal/I = tool
	if(I.requires_robotic_bodypart)
		to_chat(user, "<span class='warning'>[I] is an organ that requires a robotic interface[target].</span>")
		return FALSE
...
/datum/surgery_step/internal/manipulate_organs/implant/fail_step(mob/living/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery, surgery_behaviour)
...
/datum/surgery_step/alien/can_use(mob/living/user, mob/living/carbon/alien/humanoid/target, target_zone, obj/item/tool, datum/surgery/surgery, surgery_behaviour)
	. = ..()
	if(!istype(target))
		return FALSE
...
/datum/surgery_step/alien/saw_carapace/begin_step(mob/living/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery, surgery_behaviour)
...
/datum/surgery_step/alien/saw_carapace/end_step(mob/living/user, mob/living/carbon/target, target_zone, obj/item/tool,datum/surgery/surgery, surgery_behaviour)
...
/datum/surgery_step/alien/saw_carapace/fail_step(mob/living/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery, surgery_behaviour)
...
/datum/surgery_step/alien/cut_carapace/begin_step(mob/living/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery, surgery_behaviour)
...
/datum/surgery_step/alien/cut_carapace/end_step(mob/living/user, mob/living/carbon/target, target_zone, obj/item/tool,datum/surgery/surgery, surgery_behaviour)
...
/datum/surgery_step/alien/cut_carapace/fail_step(mob/living/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery, surgery_behaviour)
