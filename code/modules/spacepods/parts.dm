			...
			pod_frame
				proc
					find_square()
						...
						*/
						var
							neededparts = list(/obj/item/pod_parts/pod_frame/aft_port, /obj/item/pod_parts/pod_frame/aft_starboard, /obj/item/pod_parts/pod_frame/fore_port, /obj/item/pod_parts/pod_frame/fore_starboard)
						var
							turf
								T
						var
					...
					if(istype(O, /obj/item/stack/rods))
						...
						var
							obj
								structure
									spacepod_frame
										pod = new /obj/structure/spacepod_frame(src.loc)
						pod.dir = src.dir
