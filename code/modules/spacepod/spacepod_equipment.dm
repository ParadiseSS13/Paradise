...
/obj/item/spacepod_equipment/proc/added(mob/user) // So that you can unload cargo when you remove the module
	my_atom.update_icon()

/obj/item/spacepod_equipment/proc/removed(mob/user) // So that you can unload cargo when you remove the module
	my_atom.update_icon()

/obj/item/spacepod_equipment/proc/on_power_loss()
	return


/obj/item/spacepod_equipment/action
	var/datum/action/vehicle/spacepod/equipment/action_type

/obj/item/spacepod_equipment/action/added(mob/user)
	. = ..()
	my_atom.initialize_controller_action_type(action_type, VEHICLE_CONTROL_PERMISSION)

/obj/item/spacepod_equipment/action/removed(mob/user)
	. = ..()
	my_atom.remove_controller_actions(action_type)

/obj/item/spacepod_equipment/action/proc/action_trigger(mob/owner)
	return
...
/obj/item/spacepod_equipment/weaponry/proc/fire_weapons(mob/user)
...
/obj/item/spacepod_equipment/weaponry/proc/do_fire(obj/item/projectile/projone, obj/item/projectile/projtwo)
...
/obj/item/spacepod_equipment/misc/tracker/screwdriver_act(mob/user, obj/item/tool)
	enabled = !enabled
...
/obj/item/spacepod_equipment/sec_cargo/back_seat
...
/obj/item/spacepod_equipment/action/cloaker
...
/obj/item/spacepod_equipment/action/cloaker/on_power_loss()
	my_atom.message_to_riders("<span class='warning'>\The [src] has lost power!</span>")
	animate(my_atom, alpha = 255, time = 12.5)

/obj/item/spacepod_equipment/action/cloaker/action_trigger(mob/owner)
	active = !active
...
/obj/item/lock_buster/attack_self(mob/user)
	on = !on
	if(on)
