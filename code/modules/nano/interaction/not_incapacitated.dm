...
GLOBAL_DATUM_INIT(not_incapacitated_state, /datum/topic/not_incapacitated_state, new())

 /**
  * This state checks if the user isn't incapacitated and that their loc is a turf
 **/
GLOBAL_DATUM_INIT(not_incapacitated_turf_state, /datum/topic/not_incapacitated_state, new(no_turfs = TRUE))
