...
var
	datum
		announcement
			priority
				security
					security_announcement_down = new(do_log = 0, do_newscast = 1)
					...
					var
						obj
							machinery
								computer
									communications
										CC = locate(/obj/machinery/computer/communications,world)
					if(CC)
							...
							machinery
								door
									airlock
										highsecurity
											red
												R = locate(/obj/machinery/door/airlock/highsecurity/red) in world
