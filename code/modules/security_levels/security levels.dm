		...
		switch(level)
			...
			if(SEC_LEVEL_RED)
				if(GLOB.security_level < SEC_LEVEL_RED)
					GLOB.security_announcement_up.Announce("Existe una amenaza inmediata y grave para la estacion. Seguridad puede portar armas en todo momento. Se permiten y aconsejan busquedas aleatorias.","Atencion! Codigo Rojo!")
				else
					GLOB.security_announcement_down.Announce("El nivel de alerta ha sido reducido, aunque todavia hay una amenaza inmediata y grave para la estacion. La seguridad puede portar en todo momento. Se permiten y aconsejan busquedas aleatorias.","Atencion! Codigo Rojo!")
			...
			if(SEC_LEVEL_EPSILON)
				GLOB.security_announcement_up.Announce("Comando Central ha ordenado el nivel de seguridad de Epsilon en la estacion. Consideren todos los contratos rescindidos.","Atencion! Nivel de seguridad Epsilon activado!", new_sound = sound('sound/effects/purge_siren.ogg'))
			...
			if(SEC_LEVEL_DELTA)
				GLOB.security_announcement_up.Announce("Se ha activado el mecanismo de autodestruccion de la estacion. Toda la tripulacion tiene instrucciones de obedecer todas las instrucciones dadas por los jefes de personal. Cualquier violacion de estas ordenes puede ser castigada con la muerte. Esto no es un simulacro.","Atencion! Nivel de seguridad Delta alcanzado!", new_sound = sound('sound/effects/deltaalarm.ogg'))
