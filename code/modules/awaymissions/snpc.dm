		...
		carbon
			human
				interactive
					away
						var
							away_area = /area/awaymission   // their overriden job area
						var
							override_under = null		   // optional type for uniform, else default for job
						var
							squad_member = 0				// was spawned by squad
						var
							home_z
								...
								datum
									data
										pda
											app
												messenger
													M = MYPDA.find_program(/datum/data/pda/app/messenger)
							M.toff = 1
							var
								datum
									data
										pda
											app
												chatroom
													C = MYPDA.find_program(/datum/data/pda/app/chatroom)
							C.toff = 1
	...
	effect
		spawner
			snpc_squad
				...
				invisibility = 101
				var
					squad_type = /mob/living/carbon/human/interactive/away
				var
					squad_size = 3
