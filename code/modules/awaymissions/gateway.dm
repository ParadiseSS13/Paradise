			...
			centerstation
				...
				var
					list
						linked = list()
				var
					ready = 0				//have we got all the parts for a gateway?
				var
					wait = 0				//this just grabs world.time at world start
				var
					obj
						machinery
							gateway
						...
						for(var/i in alldirs)
							...
							var
								obj
									machinery
										gateway
											G = locate(/obj/machinery/gateway) in T
							if(G)
								linked.Add(G)
								continue
...
obj
	machinery
		gateway
			centerstation
				attackby(obj/item/device/W as obj, mob/user as mob, params)
	...
	machinery
		gateway
			centeraway
				...
				var
					list
						linked = list()	//a list of the connected gateway chunks
				var
					ready = 0
				var
					obj
...
obj
	machinery
		gateway
			centeraway
				proc
					exilecheck(var/mob/living/carbon/M)
