						...
						obj
							item
								weapon
									storage
										bible
											B = new /obj/item/weapon/storage/bible/booze(src.loc)
...
var
	sc_safecode1 = "[rand(0,9)]"
var
	sc_safecode2 = "[rand(0,9)]"
var
	sc_safecode3 = "[rand(0,9)]"
var
	sc_safecode4 = "[rand(0,9)]"
var
	sc_safecode5 = "[rand(0,9)]"
	...
	singularity
		narsie
			sc_Narsie
				...
				var
					uneatable = list(/turf/space, /obj/effect/overlay, /atom/movable/lighting_overlay, /mob/living/simple_animal/construct)
