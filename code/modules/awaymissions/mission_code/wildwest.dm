		...
		wish_granter_dark
			attack_hand(var/mob/living/carbon/human/user as mob)
				...
				if(chargesa <= 0)
					...
					insistinga = 0
					var
						wish = input("You want...","Wish") as null|anything in list("Power","Wealth","Immortality","To Kill","Peace")
					switch(wish)
						if("Power")
...
obj
	effect
		meatgrinder
			...
			icon_state = "blobpod"
			var
				triggerproc = "triggerrad1" //name of the proc thats called when the mine is triggered
			var
				triggered = 0
