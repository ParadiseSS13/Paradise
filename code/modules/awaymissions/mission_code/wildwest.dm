...
/obj/machinery/wish_granter_dark
	name = "Wish Master 0.3 BETA"
	desc = "You're not so sure about this, maybe it just a virus?"
...
/obj/machinery/wish_granter_dark/attack_hand(var/mob/living/carbon/human/user as mob)
	...
	if(chargesa <= 0)
		to_chat(user, "The Wish Master lies silent.")
		return

	else if(!istype(user, /mob/living/carbon/human))
		to_chat(user, "You feel a dark stirring inside of the Wish Master, something you want nothing of. Your instincts are better than any man's.")
		return
		...
		switch(wish)
			if("Power")
				...
				to_chat(user, "The Wish Master punishes you for your selfishness, claiming your soul and warping your body to match the darkness in your heart.")
			...
			if("To Kill")
				to_chat(user, "<B>Your wish is granted, but at a terrible cost...</B>")
				to_chat(user, "The Wish Master punishes you for your wickedness, claiming your soul and warping your body to match the darkness in your heart.")
				...
				user.regenerate_icons()
			if("Peace")
				to_chat(user, "<B>Whatever alien sentience that the Wish Master possesses is satisfied with your wish. There is a distant wailing as the last of the Faithless begin to die, then silence.</B>")
