							...
							concierge
								proc
									concierge()
										...
										var
											verbs_use = pick_list(speak_file, "verbs_use")
										var
											verbs_touch = pick_list(speak_file, "verbs_touch")
										var
											verbs_move = pick_list(speak_file, "verbs_move")
										var
											nouns_generic = pick_list(speak_file, "nouns_generic")
										var
											adjective_insult = pick_list(speak_file, "adjective_insult")
										var
											adjective_objects = pick_list(speak_file, "adjective_objects")
										var
											adjective_generic = pick_list(speak_file, "adjective_generic")
										var
														...
														obj
															item
																weapon
																	card
																		hotel_card
																			K = hotel.checkin(D.id, id_owner, id)
													if(K)
														K.forceMove(idloc)
													else
