...
/datum/admins/New(initial_rank = "Temporary Admin", initial_rights = 0, ckey)
	if(IsAdminAdvancedProcCall())
		to_chat(usr, span_boldannounce("Admin rank creation blocked: Advanced ProcCall detected."))
...
/datum/admins/Destroy()
	if(IsAdminAdvancedProcCall())
		to_chat(usr, span_boldannounce("Admin rank deletion blocked: Advanced ProcCall detected."))
...
/datum/admins/proc/associate(client/C)
	if(IsAdminAdvancedProcCall())
		to_chat(usr, span_boldannounce("Rank association blocked: Advanced ProcCall detected."))
...
/datum/admins/proc/disassociate()
	if(IsAdminAdvancedProcCall())
		to_chat(usr, span_boldannounce("Rank disassociation blocked: Advanced ProcCall detected."))
...
/client/proc/deadmin()
	if(IsAdminAdvancedProcCall())
		to_chat(usr, span_boldannounce("Deadmin blocked: Advanced ProcCall detected."))
