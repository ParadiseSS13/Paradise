...
/client/proc/set_next_map()
	...
	if(announce_to_players == "Yes")
		to_chat(world, SPAN_BOLDANNOUNCEOOC("[key] has chosen the following map for next round: <font color='cyan'>[SSmapping.next_map.fluff_name] ([SSmapping.next_map.technical_name])</font>"))
