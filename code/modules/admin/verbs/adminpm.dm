...
/client/proc/cmd_admin_pm_context(mob/M as mob in GLOB.mob_list)
	...
	SSblackbox.add_details("admin_verb","APMM") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/cmd_admin_pm_panel()
	...
	SSblackbox.add_details("admin_verb","APM") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
