...
/client/proc/cmd_admin_pm_context(mob/M as mob in GLOB.mob_list)
	...
	SSblackbox.record_feedback("tally", "admin_verb", 1, "APMM") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/cmd_admin_pm_panel()
	...
	SSblackbox.record_feedback("tally", "admin_verb", 1, "APM") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
