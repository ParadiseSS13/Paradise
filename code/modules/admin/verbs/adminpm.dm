...
/client/proc/cmd_admin_pm(whom, msg, type = "PM")
	...
	recieve_message = "<div class='boxed_message red'><span class='[recieve_span]'>[type] from-<b>[recieve_pm_type][C.holder ? key_name(src, TRUE, type) : key_name_hidden(src, TRUE, type)]</b>:<br><br>[emoji_msg]</span></div>"
	to_chat(C, recieve_message)
