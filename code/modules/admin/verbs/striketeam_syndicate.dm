...
/mob/living/carbon/human/proc/equip_syndicate_commando(is_leader = FALSE, full_gear = FALSE)
	...
	equip_to_slot_or_del(new /obj/item/clothing/under/syndicate(src), SLOT_HUD_ICLOTHING)
	if(!full_gear)
		equip_to_slot_or_del(new /obj/item/clothing/shoes/combat(src), SLOT_HUD_FEET)
	...
	if(is_leader)
		...
		equip_to_slot_or_del(new /obj/item/grenade/plastic/c4/x4(src), SLOT_HUD_IN_BACKPACK)
	equip_to_slot_or_del(new /obj/item/card/emag(src), SLOT_HUD_RIGHT_POCKET)
	equip_to_slot_or_del(new /obj/item/melee/energy/sword/saber/red(src), SLOT_HUD_LEFT_POCKET)

	if(full_gear)
		equip_to_slot_or_del(new /obj/item/clothing/mask/gas/syndicate(src), SLOT_HUD_MASK)
		equip_to_slot_or_del(new /obj/item/clothing/suit/space/hardsuit/syndi/elite/sst(src), SLOT_HUD_OCLOTHING)
		equip_to_slot_or_del(new /obj/item/clothing/glasses/thermal(src), SLOT_HUD_EYES)
		...
		equip_to_slot_or_del(new /obj/item/clothing/shoes/magboots/elite(src), SLOT_HUD_FEET)
