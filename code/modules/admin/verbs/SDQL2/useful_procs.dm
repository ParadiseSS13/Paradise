...
// this function:
/*
CALL global.json_to_object_arbitrary_vars("{'type':'/obj/item/tool/crowbar', 'color':'#FF0000','force':5000,'name':'Greytides Gravedigger'}", loc) ON /mob/living/carbon/human WHERE ckey == 'crazylemon'".
*/
