...
/client/proc/play_sound(S as sound)
	...
	feedback_report("admin_verb","PGS") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/play_local_sound(S as sound)
	...
	feedback_report("admin_verb","PLS") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/play_server_sound()
	...
	play_sound(melody)
	feedback_report("admin_verb","PSS") //If you are copy-pasting this, ensure the 2nd paramter is unique to the new proc!
