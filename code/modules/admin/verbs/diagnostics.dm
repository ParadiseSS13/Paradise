/client/proc/air_status(turf/target as turf)
	...
	feedback_report("admin_verb","DAST") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/fix_next_move()
	...
	feedback_report("admin_verb","UFE") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
	return
...
/client/proc/radio_report()
	...
	feedback_report("admin_verb","RR") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/reload_admins()
	...
	load_admins()
	feedback_report("admin_verb","RLDA") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
