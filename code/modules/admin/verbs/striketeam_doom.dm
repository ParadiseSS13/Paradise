...
/mob/living/carbon/human/proc/equip_doom_commando()
	...
	equip_to_slot_or_del(new /obj/item/clothing/mask/gas/doom(src), slot_wear_mask)
	...
	equip_to_slot_or_del(new /obj/item/clothing/suit/space/doom(src), slot_wear_suit)
