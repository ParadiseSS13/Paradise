/client/proc/Debug2()
	...
	feedback_report("admin_verb","DG2") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/callproc()
	...
	spawn(0)
		...
		feedback_report("admin_verb","APC") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/callproc_datum(var/A as null|area|mob|obj|turf)
	...
	feedback_report("admin_verb","DPC") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/Cell()
	...
	feedback_report("admin_verb","ASL") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/makepAI(var/turf/T in mob_list)
	...
	feedback_report("admin_verb","MPAI") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/cmd_admin_alienize(var/mob/M in mob_list)
	...
	if(ishuman(M))
		...
		spawn(10)
			M:Alienize()
			feedback_report("admin_verb","MKAL") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/cmd_admin_slimeize(var/mob/M in mob_list)
	...
	if(ishuman(M))
		...
		spawn(10)
			M:slimeize()
			feedback_report("admin_verb","MKMET") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/cmd_debug_del_all()
	...
	feedback_report("admin_verb","DELA") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/cmd_debug_del_sing()
	...
	feedback_report("admin_verb","DELS") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/cmd_debug_make_powernets()
	...
	feedback_report("admin_verb","MPWN") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/cmd_admin_grantfullaccess(var/mob/M in mob_list)
	...
	if(istype(M, /mob/living/carbon/human))
		...
		alert("Invalid mob")
	feedback_report("admin_verb","GFA") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/cmd_assume_direct_control(var/mob/M in mob_list)
	...
	if( isobserver(adminmob) )
		qdel(adminmob)
	feedback_report("admin_verb","ADC") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/cmd_admin_dress(var/mob/living/carbon/human/M in mob_list)
	...
	feedback_report("admin_verb", "SEQ") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
	if(dostrip)
...
/client/proc/jump_to_ruin()
	...
	if(istype(landmark))
		...
		feedback_report("admin_verb","JT") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/toggle_medal_disable()
	...
	feedback_report("admin_verb","TMH") // If...
