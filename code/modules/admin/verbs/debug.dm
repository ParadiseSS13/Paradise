/client/proc/Debug2()
	...
	SSblackbox.record_feedback("tally", "admin_verb", 1, "DG2") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/callproc()
	...
	spawn(0)
		...
		SSblackbox.record_feedback("tally", "admin_verb", 1, "APC") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/callproc_datum(var/A as null|area|mob|obj|turf)
	...
	SSblackbox.record_feedback("tally", "admin_verb", 1, "DPC") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/Cell()
	...
	SSblackbox.record_feedback("tally", "admin_verb", 1, "ASL") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/makepAI(var/turf/T in GLOB.mob_list)
	...
	SSblackbox.record_feedback("tally", "admin_verb", 1, "MPAI") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/cmd_admin_alienize(var/mob/M in GLOB.mob_list)
	...
	if(ishuman(M))
		...
		spawn(10)
			M:Alienize()
			SSblackbox.record_feedback("tally", "admin_verb", 1, "MKAL") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/cmd_admin_slimeize(var/mob/M in GLOB.mob_list)
	...
	if(ishuman(M))
		...
		spawn(10)
			M:slimeize()
			SSblackbox.record_feedback("tally", "admin_verb", 1, "MKMET") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/cmd_debug_del_all()
	...
	SSblackbox.record_feedback("tally", "admin_verb", 1, "DELA") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/cmd_debug_del_sing()
	...
	SSblackbox.record_feedback("tally", "admin_verb", 1, "DELS") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/cmd_debug_make_powernets()
	...
	SSblackbox.record_feedback("tally", "admin_verb", 1, "MPWN") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/cmd_admin_grantfullaccess(var/mob/M in GLOB.mob_list)
	...
	if(istype(M, /mob/living/carbon/human))
		...
		alert("Invalid mob")
	SSblackbox.record_feedback("tally", "admin_verb", 1, "GFA") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/cmd_assume_direct_control(var/mob/M in GLOB.mob_list)
	...
	if( isobserver(adminmob) )
		qdel(adminmob)
	SSblackbox.record_feedback("tally", "admin_verb", 1, "ADC") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/cmd_admin_dress(var/mob/living/carbon/human/M in GLOB.mob_list)
	...
	SSblackbox.record_feedback("tally", "admin_verb", 1,  "SEQ") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
	if(dostrip)
...
/client/proc/jump_to_ruin()
	...
	if(istype(landmark))
		...
		SSblackbox.record_feedback("tally", "admin_verb", 1, "JT") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/toggle_medal_disable()
	...
	SSblackbox.record_feedback("tally", "admin_verb", 1, "TMH") // If...
