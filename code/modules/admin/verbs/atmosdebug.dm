/client/proc/atmosscan()
	...
	if(!src.holder)
		...
		return
	feedback_report("admin_verb","CP") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/powerdebug()
	...
	if(!src.holder)
		to_chat(src, "Only administrators may use this command.")
		return
	feedback_report("admin_verb","CPOW") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
