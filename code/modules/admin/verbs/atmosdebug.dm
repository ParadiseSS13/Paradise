/client/proc/atmosscan()
	...
	if(!src.holder)
		...
		return
	SSblackbox.record_feedback("tally", "admin_verb", 1, "CP") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/powerdebug()
	...
	if(!src.holder)
		to_chat(src, "Only administrators may use this command.")
		return
	SSblackbox.record_feedback("tally", "admin_verb", 1, "CPOW") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
