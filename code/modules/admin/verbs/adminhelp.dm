...
/client/verb/adminhelp()
	...
	switch(selected_type)
		...
		if("Adminhelp")
			...
			if(SStickets.checkForOpenTicket(usr.client)) // If user already has an open ticket
				var/datum/admin_ticket/T = SStickets.checkForOpenTicket(usr.client) // Make T equal to the ticket they have open
