...
/datum/admins/proc/view_txt_log()
	...
	if( fexists(path) )
		...
		return
	feedback_report("admin_verb","VTL") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
	return
...
/datum/admins/proc/view_atk_log()
	...
	feedback_report("admin_verb","SSAL") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
	return
