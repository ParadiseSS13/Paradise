...
/client/proc/camera_view()
	...
	feedback_report("admin_verb","mCRD") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
<B>The following anomalies have been detected. The ones in red need immediate attention: Some of those in black may be intentional.</B><BR><ul>"}
	...
	feedback_report("admin_verb","mCRP") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
		...
		for(var/obj/item/device/radio/intercom/I in world)
			for(var/turf/T in orange(7,I))
				...
				if(!(F in view(7,I.loc)))
					qdel(F)
	feedback_report("admin_verb","mIRD") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/count_objects_on_z_level()
	...
	feedback_report("admin_verb","mOBJZ") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/count_objects_all()
	...
	feedback_report("admin_verb","mOBJ") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
