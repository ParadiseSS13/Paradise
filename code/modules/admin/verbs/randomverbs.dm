/client/proc/cmd_admin_drop_everything(mob/M as mob in mob_list)
	...
	feedback_report("admin_verb","DEVR") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/cmd_admin_prison(mob/M as mob in mob_list)
	...
	if(ismob(M))
		...
		feedback_report("admin_verb","PRISON") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/cmd_admin_subtle_message(mob/M as mob in mob_list)
	...
	feedback_report("admin_verb","SMS") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/cmd_admin_world_narrate() // Allows administrators to fluff events a little easier -- TLE
	...
	feedback_report("admin_verb","GLN") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/cmd_admin_direct_narrate(var/mob/M)	// Targetted narrate -- TLE
	...
	feedback_report("admin_verb","DIRN") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/cmd_admin_godmode(mob/M as mob in mob_list)
	...
	feedback_report("admin_verb","GOD") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
proc/cmd_admin_mute(mob/M as mob, mute_type, automute = 0)
	...
	if(automute)
		...
		feedback_report("admin_verb","AUTOMUTE") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
		return
	...
	feedback_report("admin_verb","MUTE") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/cmd_admin_add_random_ai_law()
	...
	feedback_report("admin_verb","ION") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/respawn_character()
	...
	*/
	...
	feedback_report("admin_verb","RSPCH") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/cmd_admin_add_freeform_ai_law()
	...
	feedback_report("admin_verb","IONC") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/cmd_admin_rejuvenate(mob/living/M as mob in mob_list)
	...
	feedback_report("admin_verb","REJU") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
//the stuff on the list is |"report type" = "report title"|, if that makes any sense
	...
	feedback_report("admin_verb","CCR") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/cmd_admin_delete(atom/O as obj|mob|turf in view())
	...
	if(alert(src, "Are you sure you want to delete:\n[O]\nat ([O.x], [O.y], [O.z])?", "Confirmation", "Yes", "No") == "Yes")
		...
		feedback_report("admin_verb","DEL") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
		if(istype(O, /turf))
			var/turf/T = O
...
/client/proc/cmd_admin_list_open_jobs()
	...
	feedback_report("admin_verb","LFS") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/cmd_admin_explosion(atom/O as obj|mob|turf in view())
	...
	if((devastation != -1) || (heavy != -1) || (light != -1) || (flash != -1) || (flames != -1))
		...
		feedback_report("admin_verb","EXPL") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
		return
	else
		return
...
/client/proc/cmd_admin_gib(mob/M as mob in mob_list)
	...
	M.gib()
	feedback_report("admin_verb","GIB") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/cmd_admin_gib_self()
	...
	if(confirm == "Yes")
		...
		feedback_report("admin_verb","GIBS") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/cmd_admin_check_contents(mob/living/M as mob in mob_list)
	...
	for(var/t in L)
		to_chat(usr, "[t]")
	feedback_report("admin_verb","CC") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/toggle_view_range()
	...
	feedback_report("admin_verb","CVRA") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/admin_call_shuttle()
	...
	feedback_report("admin_verb","CSHUT") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/admin_cancel_shuttle()
	...
	feedback_report("admin_verb","CCSHUT") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/cmd_admin_attack_log(mob/M as mob in mob_list)
	...
	for(var/t in M.attack_log)
		to_chat(usr, t)
	feedback_report("admin_verb","ATTL") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/everyone_random()
	...
	feedback_report("admin_verb","MER") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/toggle_random_events()
	...
	feedback_report("admin_verb","TRE") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/reset_all_tcs()
	...
	feedback_report("admin_verb","RAT") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
