...
/proc/create_arbitrary_var(var/client/var_creator)
	var/datum/admins/adm = var_creator.holder
	if(adm && adm.marked_datum)
		...
		if(holder.marked_datum && class == "Marked datum ([adm.marked_datum.type])")
			class = "Marked datum"
	else
