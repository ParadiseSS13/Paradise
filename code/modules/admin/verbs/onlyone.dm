/client/proc/only_one()
	...
	for(var/mob/living/carbon/human/H in GLOB.player_list)
		...
		H.equip_to_slot_or_del(new /obj/item/clothing/under/costume/kilt(H), SLOT_HUD_ICLOTHING)
		...
		H.equip_to_slot_or_del(new /obj/item/clothing/shoes/combat(H), SLOT_HUD_FEET)
		H.equip_to_slot_or_del(new /obj/item/pinpointer(H.loc), SLOT_HUD_LEFT_POCKET)
...
/client/proc/only_me()
	...
	for(var/mob/living/carbon/human/H in GLOB.player_list)
		...
		var/obj/item/slot_item_ID = H.get_item_by_slot(SLOT_HUD_ID)
		qdel(slot_item_ID)
