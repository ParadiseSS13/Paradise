...
/obj/effect/bmode/buildhelp/Click()
	switch(master.cl.buildmode)
		...
		if(AREA_BUILDMODE)
			usr << "<span class='notice'>***********************************************************</span>"
			usr << "<span class='notice'>Left Mouse Button on turf/obj/mob      = Select corner</span>"
			usr << "<span class='notice'>Right Mouse Button on buildmode button = Select generator</span>"
			usr << "<span class='notice'>***********************************************************</span>"
	return 1
