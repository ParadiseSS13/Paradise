...
/client/proc/hide_verbs()
	...
	SSblackbox.record_feedback("tally", "admin_verb", 1, "TAVVH") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
	return
...
/client/proc/show_verbs()
	...
	SSblackbox.record_feedback("tally", "admin_verb", 1, "TAVVS") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/admin_ghost()
	...
	if(istype(mob,/mob/dead/observer))
		...
		SSblackbox.record_feedback("tally", "admin_verb", 1, "P") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
		...
		SSblackbox.record_feedback("tally", "admin_verb", 1, "O") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/player_panel()
	...
	SSblackbox.record_feedback("tally", "admin_verb", 1, "PP") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
	return
...
/client/proc/player_panel_new()
	...
	SSblackbox.record_feedback("tally", "admin_verb", 1, "PPN") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
	return
...
/client/proc/check_antagonists()
	...
	SSblackbox.record_feedback("tally", "admin_verb", 1, "CHA") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
	return
...
/client/proc/jobbans()
	...
	if(config.ban_legacy_system)
		...
		holder.DB_ban_panel()
	SSblackbox.record_feedback("tally", "admin_verb", 1, "VJB") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
	return
...
/client/proc/unban_panel()
	...
	if(config.ban_legacy_system)
		...
		holder.DB_ban_panel()
	SSblackbox.record_feedback("tally", "admin_verb", 1, "UBP") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
	return
...
/client/proc/game_panel()
	...
	holder.Game()
	SSblackbox.record_feedback("tally", "admin_verb", 1, "GP") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
	return
...
/client/proc/secrets()
	...
	holder.Secrets()
	SSblackbox.record_feedback("tally", "admin_verb", 1, "S") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
	return
...
/client/proc/stealth()
	...
	SSblackbox.record_feedback("tally", "admin_verb", 1, "SM") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/big_brother()
	...
	if(holder)
		...
		SSblackbox.record_feedback("tally", "admin_verb", 1, "BBSM")
...
/client/proc/warn(warned_ckey)
	...
	SSblackbox.record_feedback("tally", "admin_verb", 1, "WARN") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/drop_bomb() // Some admin dickery that can probably be done better -- TLE
	...
	SSblackbox.record_feedback("tally", "admin_verb", 1, "DB") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/give_spell(mob/T as mob in GLOB.mob_list) // -- Urist
	...
	SSblackbox.record_feedback("tally", "admin_verb", 1, "GS") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/give_disease(mob/T in GLOB.mob_list)
	...
	SSblackbox.record_feedback("tally", "admin_verb", 1, "GD") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/togglebuildmodeself()
	...
	SSblackbox.record_feedback("tally", "admin_verb", 1, "TBMS") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/object_talk(var/msg as text) // -- TLE
	...
	SSblackbox.record_feedback("tally", "admin_verb", 1, "OT") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/kill_air() // -- TLE
	...
	SSblackbox.record_feedback("tally", "admin_verb", 1, "KA") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/deadmin_self()
	...
	SSblackbox.record_feedback("tally", "admin_verb", 1, "DAS") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/readmin()
	...
	if(config.admin_legacy_system)
		...
		var/datum/DBQuery/query = SSdbcore.NewQuery("SELECT rank FROM [format_table_name("admin")] WHERE ckey = '[sql_ckey]'")
		query.Execute()
		while(query.NextRow())
	...
	if(!D)
		if(config.admin_legacy_system)
			...
			var/sql_ckey = sanitizeSQL(ckey)
			var/datum/DBQuery/query = SSdbcore.NewQuery("SELECT ckey, rank, flags FROM [format_table_name("admin")] WHERE ckey = '[sql_ckey]'")
			query.Execute()
			while(query.NextRow())
		...
		GLOB.deadmins -= ckey
		SSblackbox.record_feedback("tally", "admin_verb", 1, "RAS")
		return
	else
...
/client/proc/manage_silicon_laws()
	...
	SSblackbox.record_feedback("tally", "admin_verb", 1, "MSL") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/change_human_appearance_admin(mob/living/carbon/human/H in GLOB.mob_list)
	...
	SSblackbox.record_feedback("tally", "admin_verb", 1, "CHAA") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/change_human_appearance_self(mob/living/carbon/human/H in GLOB.mob_list)
	...
	SSblackbox.record_feedback("tally", "admin_verb", 1, "CMAS") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
