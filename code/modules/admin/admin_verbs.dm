...
/client/proc/hide_verbs()
	...
	SSblackbox.add_details("admin_verb","TAVVH") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
	return
...
/client/proc/show_verbs()
	...
	SSblackbox.add_details("admin_verb","TAVVS") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/admin_ghost()
	...
	if(istype(mob,/mob/dead/observer))
		...
		SSblackbox.add_details("admin_verb","P") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
		...
		SSblackbox.add_details("admin_verb","O") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/player_panel()
	...
	SSblackbox.add_details("admin_verb","PP") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
	return
...
/client/proc/player_panel_new()
	...
	SSblackbox.add_details("admin_verb","PPN") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
	return
...
/client/proc/check_antagonists()
	...
	SSblackbox.add_details("admin_verb","CHA") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
	return
...
/client/proc/jobbans()
	...
	if(config.ban_legacy_system)
		...
		holder.DB_ban_panel()
	SSblackbox.add_details("admin_verb","VJB") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
	return
...
/client/proc/unban_panel()
	...
	if(config.ban_legacy_system)
		...
		holder.DB_ban_panel()
	SSblackbox.add_details("admin_verb","UBP") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
	return
...
/client/proc/game_panel()
	...
	holder.Game()
	SSblackbox.add_details("admin_verb","GP") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
	return
...
/client/proc/secrets()
	...
	holder.Secrets()
	SSblackbox.add_details("admin_verb","S") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
	return
...
/client/proc/stealth()
	...
	SSblackbox.add_details("admin_verb","SM") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/big_brother()
	...
	if(holder)
		...
		SSblackbox.add_details("admin_verb","BBSM")
...
/client/proc/drop_bomb() // Some admin dickery that can probably be done better -- TLE
	...
	SSblackbox.add_details("admin_verb","DB") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/give_spell(mob/T as mob in GLOB.mob_list) // -- Urist
	...
	SSblackbox.add_details("admin_verb","GS") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/give_disease(mob/T in GLOB.mob_list)
	...
	SSblackbox.add_details("admin_verb","GD") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/togglebuildmodeself()
	...
	SSblackbox.add_details("admin_verb","TBMS") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/object_talk(var/msg as text) // -- TLE
	...
	SSblackbox.add_details("admin_verb","OT") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/kill_air() // -- TLE
	...
	SSblackbox.add_details("admin_verb","KA") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/deadmin_self()
	...
	SSblackbox.add_details("admin_verb","DAS") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/readmin()
	...
	if(!D)
		...
		GLOB.deadmins -= ckey
		SSblackbox.add_details("admin_verb","RAS")
		return
	else
...
/client/proc/manage_silicon_laws()
	...
	SSblackbox.add_details("admin_verb","MSL") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/change_human_appearance_admin(mob/living/carbon/human/H in GLOB.mob_list)
	...
	SSblackbox.add_details("admin_verb","CHAA") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/change_human_appearance_self(mob/living/carbon/human/H in GLOB.mob_list)
	...
	SSblackbox.add_details("admin_verb","CMAS") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
