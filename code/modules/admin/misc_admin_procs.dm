...
/datum/admins/proc/announce()
	...
	if(message)
		...
		to_chat(world, "<div class='boxed_message notice'><span class='notice'><b>[usr.client.holder.fakekey ? "Administrator" : usr.key] Announces:</b><br><br><p>[message]</p></span></div>")
