...
/datum/admins/proc/announce()
	...
	if(message)
		...
		to_chat(world, chat_box_notice("<span class='notice emoji_enabled linkify'><b>[usr.client.holder.fakekey ? "Administrator" : usr.key] Announces:</b><br><br><p>[message]</p></span>"))
