...
/datum/admins/proc/show_player_panel(var/mob/M in GLOB.mob_list)
	...
	SSblackbox.record_feedback("tally", "admin_verb", 1, "SPP") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/datum/admins/proc/restart()
	...
	SSblackbox.record_feedback("tally", "admin_verb", 1, "R") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/datum/admins/proc/end_round()
	...
	SSblackbox.record_feedback("tally", "admin_verb", 1, "END") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/datum/admins/proc/announce()
	...
	SSblackbox.record_feedback("tally", "admin_verb", 1, "A") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/datum/admins/proc/toggledsay()
	...
	SSblackbox.record_feedback("tally", "admin_verb", 1, "TDSAY") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc
...
/datum/admins/proc/toggleoocdead()
	...
	SSblackbox.record_feedback("tally", "admin_verb", 1, "TDOOC") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/datum/admins/proc/toggleemoji()
	...
	SSblackbox.record_feedback("tally", "admin_verb", 1, "TEMOJ")
...
/datum/admins/proc/startnow()
	...
	if(SSticker.current_state == GAME_STATE_PREGAME || SSticker.current_state == GAME_STATE_STARTUP)
		...
		SSblackbox.record_feedback("tally", "admin_verb", 1, "SN") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
		return 1
	else
...
/datum/admins/proc/toggleenter()
	...
	world.update_status()
	SSblackbox.record_feedback("tally", "admin_verb", 1, "TE") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/datum/admins/proc/toggleAI()
	...
	world.update_status()
	SSblackbox.record_feedback("tally", "admin_verb", 1, "TAI") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/datum/admins/proc/toggleaban()
	...
	world.update_status()
	SSblackbox.record_feedback("tally", "admin_verb", 1, "TR") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/datum/admins/proc/spawn_atom(var/object as text)
	...
	SSblackbox.record_feedback("tally", "admin_verb", 1, "SA") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/datum/admins/proc/show_traitor_panel(var/mob/M in GLOB.mob_list)
	...
	M.mind.edit_memory()
	SSblackbox.record_feedback("tally", "admin_verb", 1, "STP") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/datum/admins/proc/toggleguests()
	...
	SSblackbox.record_feedback("tally", "admin_verb", 1, "TGU") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/datum/admins/proc/cmd_ghost_drag(var/mob/dead/observer/frommob, var/tothing)
	...
	if(istype(tothing, /obj/item))
		...
		SSblackbox.record_feedback("tally", "admin_verb", 1, "CGD")
