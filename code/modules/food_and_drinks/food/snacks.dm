...
/obj/item/reagent_containers/food/snacks/attackby(obj/item/W, mob/user, params)
	...
	if(W.sharp) // First check if the object is sharp, we're probably trying to cut the food.
		...
		if(istype(W, /obj/item/kitchen/knife) || istype(W, /obj/item/scalpel)) // We do an accurate cut with these items, everything else is assumed inaccurate
	...
	if(W.w_class <= WEIGHT_CLASS_SMALL && istype(src,/obj/item/reagent_containers/food/snacks/sliceable))
