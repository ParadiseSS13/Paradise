...
/obj/item/food/burger/nothing
	...
	tastes = list("nothing" = 4, "absolutely nothing" = 1, "ambient temperature" = 1)

/obj/item/food/burger/nothing/On_Consume(mob/living/carbon/human/M, mob/user)
	. = ..()
	if(!istype(M))
		return
	M.adjust_nutrition(-50 * REAGENTS_METABOLISM)
