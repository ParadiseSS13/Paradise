...
/obj/item/reagent_containers/food/snacks/icecream/update_overlays()
	...
	filling.color = rgb(reagent_colors[1], (1.5*reagent_colors[2]), clamp(reagent_colors[3], 85, 100)	, space = COLORSPACE_HSV) //Clamping the brightness keeps us from having greyish ice cream while still alowing for a range of colours
	. += filling
