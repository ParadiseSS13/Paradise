...
/obj/machinery/cooking/attackby(obj/item/I, mob/user, params)
	if(on)
		...
		var/obj/item/F = I
		var/obj/item/food/customizable/C
...
/obj/machinery/cooking/oven/updatefood()
	...
	for(var/U in subtypesof(/obj/item/food/customizable/cook))
		var/obj/item/food/customizable/cook/V = new U
		food_choices += V
	return
...
/obj/machinery/cooking/candy/updatefood()
	for(var/U in food_choices)
		food_choices.Remove(U)
	for(var/U in subtypesof(/obj/item/food/customizable/candy))
		var/obj/item/food/customizable/candy/V = new U
		food_choices += V
	return
