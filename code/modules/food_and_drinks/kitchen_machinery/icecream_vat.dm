...
/obj/machinery/icemachine/attackby(obj/item/I, mob/user, params)
	if(istype(I, /obj/item/reagent_containers/glass))
		...
		updateUsrDialog()
		return
	if(istype(I, /obj/item/food/snacks/icecream))
...
/obj/machinery/icemachine/Topic(href, href_list)
	...
	if(href_list["add"])
		...
		name += " Chocolate Cone"
		var/obj/item/food/snacks/icecream/icecreamcup/C = new(loc)
		C.name = "[name]"
		C.pixel_x = rand(-8, 8)
		C.pixel_y = -16
		...
		var/name = generate_name(reagents.get_master_reagent_name())
		name += " Cone"
		var/obj/item/food/snacks/icecream/icecreamcone/C = new(loc)
		C.name = "[name]"
		C.pixel_x = rand(-8, 8)
		C.pixel_y = -16
		...
		var/name = generate_name(reagents.get_master_reagent_name())
		name += " Waffle Cone"
		var/obj/item/food/snacks/icecream/wafflecone/C = new(loc)
		C.name = "[name]"
		C.pixel_x = rand(-8, 8)
		C.pixel_y = -16
