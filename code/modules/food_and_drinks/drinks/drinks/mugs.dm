...
/datum/novelty_mug/best/New()
	...
	var/what = pick("Crewmember", "Spessman", "Employee", "Coffee", "Coffee-drinker", "Survivor", "Personality", "Lifeform", "Doctor", "Cientifico", "Engineer", "Officer", "Civillian", "Capitan", "Agent")
...
/obj/item/reagent_containers/food/drinks/mug/cap
	name = "captain's mug"
	desc = "An inscription on the side reads \"Best Capitan 2559\"... The last time the station had a worthy captain."
	icon_state = "mug_cap"
	preset = TRUE
