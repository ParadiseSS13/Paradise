/datum/crafting_recipe/sandwich
	...
	reqs = list(
		...
		/obj/item/food/slice/cheesewedge = 1,
	)
...
/datum/crafting_recipe/sushi_inari
	...
	result = list(/obj/item/food/slice/sushi_inari)
	category = CAT_FOOD
	subcategory = CAT_SUSHI
...
/datum/crafting_recipe/sushi_sake
	...
	result = list(/obj/item/food/slice/sushi_sake)
	category = CAT_FOOD
	subcategory = CAT_SUSHI
...
/datum/crafting_recipe/sushi_smoked_salmon
	...
	result = list(/obj/item/food/slice/sushi_smoked_salmon)
	category = CAT_FOOD
	subcategory = CAT_SUSHI
...
/datum/crafting_recipe/sushi_masago
	...
	result = list(/obj/item/food/slice/sushi_masago)
	category = CAT_FOOD
	subcategory = CAT_SUSHI
...
/datum/crafting_recipe/sushi_tobiko
	...
	result = list(/obj/item/food/slice/sushi_tobiko)
	category = CAT_FOOD
	subcategory = CAT_SUSHI
...
/datum/crafting_recipe/sushi_tobiko_egg
	...
	reqs = list(
		/obj/item/food/slice/sushi_tobiko = 1,
		/obj/item/food/egg = 1,
		/obj/item/stack/seaweed = 1,
	)
	result = list(/obj/item/food/slice/sushi_tobiko_egg)
	category = CAT_FOOD
	subcategory = CAT_SUSHI
...
/datum/crafting_recipe/tobiko_egg_maki
	...
	reqs = list(
		/obj/item/food/slice/sushi_tobiko = 4,
		/obj/item/food/egg = 4,
		/obj/item/stack/seaweed = 1,
	)
	pathtools = list(/obj/item/kitchen/sushimat)
...
/datum/crafting_recipe/sushi_tai
	...
	result = list(/obj/item/food/slice/sushi_tai)
	category = CAT_FOOD
	subcategory = CAT_SUSHI
