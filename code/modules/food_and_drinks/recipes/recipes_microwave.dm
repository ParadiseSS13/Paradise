...
/datum/recipe/microwave/mugcake
	reagents = list("sugar" = 5, "milk" = 5, "egg" = 5, "flour" = 5)
	items = list(/obj/item/reagent_containers/food/drinks/mug)
	result = /obj/item/reagent_containers/food/snacks/mugcake

/datum/recipe/microwave/vanilla_mugcake
	reagents = list("sugar" = 5, "milk" = 5, "egg" = 5, "flour" = 5, "vanilla" = 5)
	items = list(/obj/item/reagent_containers/food/drinks/mug)
	result = /obj/item/reagent_containers/food/snacks/vanilla_mugcake

/datum/recipe/microwave/chocolate_mugcake
	reagents = list("sugar" = 5, "milk" = 5, "egg" = 5, "flour" = 5, "cocoa" = 5)
	items = list(/obj/item/reagent_containers/food/drinks/mug)
	result = /obj/item/reagent_containers/food/snacks/chocolate_mugcake

/datum/recipe/microwave/banana_mugcake
	reagents = list("sugar" = 5, "milk" = 5, "egg" = 5, "flour" = 5)
	items = list(/obj/item/reagent_containers/food/drinks/mug, /obj/item/reagent_containers/food/snacks/grown/banana)
	result = /obj/item/reagent_containers/food/snacks/banana_mugcake

/datum/recipe/microwave/cherry_mugcake
	reagents = list("sugar" = 5, "milk" = 5, "egg" = 5, "flour" = 5)
	items = list(/obj/item/reagent_containers/food/drinks/mug, /obj/item/reagent_containers/food/snacks/grown/cherries)
	result = /obj/item/reagent_containers/food/snacks/cherry_mugcake

/datum/recipe/microwave/bluecherry_mugcake
	reagents = list("sugar" = 5, "milk" = 5, "egg" = 5, "flour" = 5)
	items = list(/obj/item/reagent_containers/food/drinks/mug, /obj/item/reagent_containers/food/snacks/grown/bluecherries)
	result = /obj/item/reagent_containers/food/snacks/bluecherry_mugcake

/datum/recipe/microwave/lime_mugcake
	reagents = list("sugar" = 5, "milk" = 5, "egg" = 5, "flour" = 5)
	items = list(/obj/item/reagent_containers/food/drinks/mug, /obj/item/reagent_containers/food/snacks/grown/citrus/lime)
	result = /obj/item/reagent_containers/food/snacks/lime_mugcake

/datum/recipe/microwave/amanita_mugcake
	reagents = list("sugar" = 5, "milk" = 5, "egg" = 5, "flour" = 5)
	items = list(/obj/item/reagent_containers/food/drinks/mug, /obj/item/reagent_containers/food/snacks/grown/mushroom/amanita)
