...
/datum/recipe/candy/chocolate_bar
	reagents = list(/datum/reagent/consumable/drink/milk/soymilk = 2, /datum/reagent/consumable/cocoa = 2, /datum/reagent/consumable/sugar = 2)
	items = list()
	result = /obj/item/reagent_containers/food/snacks/chocolatebar

/datum/recipe/candy/chocolate_bar2
	reagents = list(/datum/reagent/consumable/drink/milk = 2, /datum/reagent/consumable/cocoa = 2, /datum/reagent/consumable/sugar = 2)
	items = list()
	result = /obj/item/reagent_containers/food/snacks/chocolatebar
...
/datum/recipe/candy/fudge_cookies_n_cream
	reagents = list(/datum/reagent/consumable/sugar = 5, /datum/reagent/consumable/drink/milk = 5, /datum/reagent/consumable/drink/milk/cream = 5)
	items = list(
...
/datum/recipe/candy/caramel
	reagents = list(/datum/reagent/consumable/sugar = 5, /datum/reagent/consumable/drink/milk/cream = 5)
	items = list()
	result = /obj/item/reagent_containers/food/snacks/candy/caramel

/datum/recipe/candy/toffee
	reagents = list(/datum/reagent/consumable/sugar = 5, /datum/reagent/consumable/flour = 10)
	result = /obj/item/reagent_containers/food/snacks/candy/toffee

/datum/recipe/candy/taffy
	reagents = list(/datum/reagent/medicine/salglu_solution = 15)
	items = list()
	result = /obj/item/reagent_containers/food/snacks/candy/taffy

/datum/recipe/candy/nougat
	reagents = list(/datum/reagent/consumable/sugar = 5, /datum/reagent/consumable/cornoil = 5)
...
/datum/recipe/candy/cottoncandy
	reagents = list(/datum/reagent/consumable/sugar = 15)
	items = list(
		/obj/item/c_tube,
		)
...
/datum/recipe/candy/gummybear
	reagents = list(/datum/reagent/consumable/sugar = 5, /datum/reagent/water = 5, /datum/reagent/consumable/cornoil = 5)
	items = list(
...
/datum/recipe/candy/jawbreaker
	reagents = list(/datum/reagent/consumable/sugar = 10, /datum/reagent/consumable/cornoil = 5)
	items = list(
...
/datum/recipe/candy/cottoncandy_blue
	reagents = list(/datum/reagent/consumable/drink/berryjuice = 5)
	items = list(
		/obj/item/reagent_containers/food/snacks/candy/cotton,
		)
...
/datum/recipe/candy/cottoncandy_poison
	reagents = list(/datum/reagent/consumable/drink/poisonberryjuice = 5)
	items = list(
		/obj/item/reagent_containers/food/snacks/candy/cotton,
		)
...
/datum/recipe/candy/cottoncandy_green
	reagents = list(/datum/reagent/consumable/drink/limejuice = 5)
	items = list(
		/obj/item/reagent_containers/food/snacks/candy/cotton,
		)
...
/datum/recipe/candy/cottoncandy_yellow
	reagents = list(/datum/reagent/consumable/drink/lemonjuice = 5)
	items = list(
		/obj/item/reagent_containers/food/snacks/candy/cotton,
		)
...
/datum/recipe/candy/cottoncandy_orange
	reagents = list(/datum/reagent/consumable/drink/orangejuice = 5)
	items = list(
		/obj/item/reagent_containers/food/snacks/candy/cotton,
		)
...
/datum/recipe/candy/cottoncandy_purple
	reagents = list(/datum/reagent/consumable/drink/grapejuice = 5)
	items = list(
		/obj/item/reagent_containers/food/snacks/candy/cotton,
		)
...
/datum/recipe/candy/cottoncandy_pink
	reagents = list(/datum/reagent/consumable/drink/watermelonjuice = 5)
	items = list(
		/obj/item/reagent_containers/food/snacks/candy/cotton,
		)
...
/datum/recipe/candy/gummybear_wtf
	reagents = list(/datum/reagent/space_drugs = 5)
	items = list(
		/obj/item/reagent_containers/food/snacks/candy/gummybear,
		)
...
/datum/recipe/candy/jellybean_cola
	reagents = list(/datum/reagent/consumable/drink/cold/space_cola = 5)
	items = list(
		/obj/item/reagent_containers/food/snacks/candy/jellybean,
		)
...
/datum/recipe/candy/jellybean_coffee
	reagents = list(/datum/reagent/consumable/drink/coffee = 5)
	items = list(
		/obj/item/reagent_containers/food/snacks/candy/jellybean,
		)
	result = /obj/item/reagent_containers/food/snacks/candy/jellybean/cola
...
/datum/recipe/candy/jellybean_drgibb
	reagents = list(/datum/reagent/consumable/drink/cold/dr_gibb = 5)
	items = list(
		/obj/item/reagent_containers/food/snacks/candy/jellybean,
		)
	result = /obj/item/reagent_containers/food/snacks/candy/jellybean/cola
...
/datum/recipe/candy/crunch
	reagents = list(/datum/reagent/consumable/rice = 5)
	items = list(
		/obj/item/reagent_containers/food/snacks/candy/candybar,
		)
