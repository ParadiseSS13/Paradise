...
var
	list
		weighted_randomevent_locations = list()
var
	list
		weighted_mundaneevent_locations = list()
...
datum
	trade_destination
		...
		var
			can_shuttle_here = 0		//one day crew from the exodus will be able to travel to this destination
		var
			list
				viable_random_events = list()
		var
			list
				temp_price_change[BIOMEDICAL]
		var
			list
...
datum
	trade_destination
		proc
			get_custom_eventstring(var/event_type)
				return null
