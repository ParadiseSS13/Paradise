	...
	martial_art
		boxing
			harm_act(var/mob/living/carbon/human/A, var/mob/living/carbon/human/D)
				...
				var
					atk_verb = pick("left hook","right hook","straight punch")

				var
					damage = rand(5, 8) + A.species.punchdamagelow
				if(!damage)
				...
				if(D.getStaminaLoss() > 50)
					var
						knockout_prob = D.getStaminaLoss() + rand(-15,15)
	...
	martial_art
		drunk_brawling
			harm_act(var/mob/living/carbon/human/A, var/mob/living/carbon/human/D)
				...
				var
					atk_verb = pick("jab","uppercut","overhand punch","drunken right hook","drunken left hook")
