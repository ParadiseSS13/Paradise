...
datum
	martial_art
		mimejutsu
			proc
				mimeChuck(var/mob/living/carbon/human/A, var/mob/living/carbon/human/D)
...
datum
	martial_art
		mimejutsu
			proc
				mimeSmoke(var/mob/living/carbon/human/A, var/mob/living/carbon/human/D)
...
datum
	martial_art
		mimejutsu
			proc
				mimePalm(var/mob/living/carbon/human/A, var/mob/living/carbon/human/D)
					if(!D.stat && !D.stunned && !D.weakened)
					...
					if(!used)
						...
						var
							datum
								martial_art
									mimejutsu
										F = new/datum/martial_art/mimejutsu(null)
						F.teach(H)
