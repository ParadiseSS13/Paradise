...
/datum/martial_combo/superhuman/piston_kick/perform_combo(mob/living/carbon/human/user, mob/living/target, datum/martial_art/MA)
	if(user != target)
		...
		target.visible_message("<span class='warning'>[user]'s lower leg is explosively propelled into [target], sending them flying!</span>",
						"<span class='userdanger'>[user]'s lower leg is explosively propelled into you! Sending you flying and disorienting you!</span>")
