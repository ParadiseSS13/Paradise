		...
		krav_maga
			...
			var
				datum
					action
						neck_chop
							neckchop = new/datum/action/neck_chop()
			var
				datum
					action
						leg_sweep
							legsweep = new/datum/action/leg_sweep()
			var
				datum
					action
						lung_punch
							lungpunch = new/datum/action/lung_punch()
...
datum
	action
		lung_punch//referred to internally as 'quick choke'
...
datum
	martial_art
		krav_maga
			proc
				leg_sweep(var/mob/living/carbon/human/A, var/mob/living/carbon/human/D)
...
datum
	martial_art
		krav_maga
			proc
				quick_choke(var/mob/living/carbon/human/A, var/mob/living/carbon/human/D)//is actually lung punch
...
datum
	martial_art
		krav_maga
			proc
				neck_chop(var/mob/living/carbon/human/A, var/mob/living/carbon/human/D)
	...
	martial_art
		krav_maga
			harm_act(var/mob/living/carbon/human/A, var/mob/living/carbon/human/D)
				...
				var
					picked_hit_type = pick("punches", "kicks")
				var
					bonus_damage = 10
		...
		clothing
			gloves
				color
					black
						krav_maga
							sec//more obviously named, given to sec
