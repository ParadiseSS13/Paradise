...
datum
	martial_art
		the_sleeping_carp
			proc
				wristWrench(var/mob/living/carbon/human/A, var/mob/living/carbon/human/D)
...
datum
	martial_art
		the_sleeping_carp
			proc
				backKick(var/mob/living/carbon/human/A, var/mob/living/carbon/human/D)
...
datum
	martial_art
		the_sleeping_carp
			proc
				kneeStomach(var/mob/living/carbon/human/A, var/mob/living/carbon/human/D)
...
datum
	martial_art
		the_sleeping_carp
			proc
				headKick(var/mob/living/carbon/human/A, var/mob/living/carbon/human/D)
					if(!D.stat && !D.weakened)
						A.do_attack_animation(D)
...
datum
	martial_art
		the_sleeping_carp
			proc
				elbowDrop(var/mob/living/carbon/human/A, var/mob/living/carbon/human/D)
...
datum
	martial_art
		the_sleeping_carp
			harm_act(mob/living/carbon/human/A, mob/living/carbon/human/D)
				add_to_streak("H",D)
				if(check_streak(A,D))
					return 1
				A.do_attack_animation(D)
				var
					atk_verb = pick("punches", "kicks", "chops", "hits", "slams")
