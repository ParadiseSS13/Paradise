...
datum
	martial_art
		plasma_fist
			proc
				check_streak(var/mob/living/carbon/human/A, var/mob/living/carbon/human/D)
...
datum
	martial_art
		plasma_fist
			proc
				Tornado(var/mob/living/carbon/human/A, var/mob/living/carbon/human/D)
					A.say("TORNADO SWEEP!")
					spawn(0)
...
datum
	martial_art
		plasma_fist
			proc
				Throwback(var/mob/living/carbon/human/A, var/mob/living/carbon/human/D)
					...
					var
						atom
							throw_target = get_edge_target_turf(D, get_dir(D, get_step_away(D, A)))
...
datum
	martial_art
		plasma_fist
			proc
				Plasma(var/mob/living/carbon/human/A, var/mob/living/carbon/human/D)
