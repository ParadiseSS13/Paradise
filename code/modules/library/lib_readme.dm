...
/*
   ...
   convince the on-staff Bibliotecario to submit it to the Archives
...
// ---------------------
// 	- Visitor's computer should be able to search the current in-round library inventory (that the Bibliotecario has stocked and checked in)
...
//	- When the game sets up and the round begins, have it automatically pick random books from the DB to populate the library with. Even if the Bibliotecario is a useless fuck there are at least a few books around.
//  - Allow books to be "hollowed out" like the Capellan's Bible, allowing you to store one pocket-sized item inside.
