					...
					if(istype(W,/obj/item/pipe))
						...
						var
							obj
								item
									weaponcrafting
										ishotgunconstruction
											I = new /obj/item/weaponcrafting/ishotgunconstruction
						user.unEquip(src)
						user.put_in_hands(I)
						qdel(W)
						qdel(src)
					...
					if(istype(I, /obj/item/weapon/screwdriver))
						var
							obj
								item
									weaponcrafting
										ishotgunconstruction2
											C = new /obj/item/weaponcrafting/ishotgunconstruction2
						user.unEquip(src)
						user.put_in_hands(C)
											...
											gun
												projectile
													revolver
														doublebarrel
															improvised
																W = new /obj/item/weapon/gun/projectile/revolver/doublebarrel/improvised
							user.unEquip(src)
							user.put_in_hands(W)
