datum
	table_recipe
		...
		var
			reqs[] = list() //type paths of items consumed associated with how many are needed
		var
		...
		var
			chem_catalists[] = list() //like tools but for reagents
		var
...
datum
	table_recipe
		proc
			AdjustChems(var/obj/resultobj as obj)
