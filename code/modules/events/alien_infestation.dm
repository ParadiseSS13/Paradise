...
/datum/event/alien_infestation
	...
	role_weights = list(ASSIGNMENT_SECURITY = 4, ASSIGNMENT_CREW = 1.1, ASSIGNMENT_MEDICAL = 4)
	role_requirements = list(ASSIGNMENT_SECURITY = 4, ASSIGNMENT_CREW = 50, ASSIGNMENT_MEDICAL = 5)
