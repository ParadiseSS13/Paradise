/datum/event/spacevine
	name = "Space Vines"
	role_weights = list(ASSIGNMENT_TOTAL = 0.4, ASSIGNMENT_ENGINEERING = 1, ASSIGNMENT_BOTANIST = 2)
	role_requirements = list(ASSIGNMENT_TOTAL = 25 , ASSIGNMENT_BOTANIST = 1, ASSIGNMENT_ENGINEERING = 1)
