...
/datum/event/anomaly/announce()
	GLOB.event_announcement.Announce("Onda de flujo hiperenergetica detectada en los escaneres de largo alcance. Ubicacion esperada: [impact_area.name].", "Anomaly Alert")
