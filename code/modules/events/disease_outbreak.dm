...
/datum/event/disease_outbreak/announce()
	event_announcement.Announce("Confirmed outbreak of level 7 major viral biohazard aboard the [using_map.station_name]. All personnel must contain the outbreak.", "Biohazard Alert", new_sound = 'sound/AI/outbreak7.ogg')
