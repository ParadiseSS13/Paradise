...
/datum/event/disease_outbreak
	...
	var/list/disease_blacklist = list(/datum/disease/advance, /datum/disease/appendicitis, /datum/disease/kuru, /datum/disease/flock, /datum/disease/critical, /datum/disease/rhumba_beat, /datum/disease/fake_gbs,
