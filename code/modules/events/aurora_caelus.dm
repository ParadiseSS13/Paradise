...
/datum/event/aurora_caelus/announce()
	event_announcement.Announce("[using_map.station_name]: A harmless cloud of ions is approaching your station, and will exhaust their energy battering the hull.\
...
Have a pleasant shift, [using_map.station_name], and thank you for watching with us.",
