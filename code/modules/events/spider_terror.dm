...
/datum/event/spider_terror/announce()
	command_announcement.Announce("Confirmed outbreak of level 3 biohazard aboard [using_map.station_name]. All personnel must contain the outbreak.", "Biohazard Alert", 'sound/effects/siren-spooky.ogg')
