/datum/event/blob
	...
	role_weights = list(ASSIGNMENT_SECURITY = 5, ASSIGNMENT_TOTAL = 2.5, ASSIGNMENT_MEDICAL = 3)
	role_requirements = list(ASSIGNMENT_SECURITY = 3, ASSIGNMENT_TOTAL = 50, ASSIGNMENT_MEDICAL = 4)
