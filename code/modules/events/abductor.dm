					...
					var
						list
							mob
								dead
									observer
										candidates = pollCandidates("Do you wish to be considered for an Abductor Team?", ROLE_ABDUCTOR, 1)

					if(candidates.len >= 2)
						//Oh god why we can't have static functions
						var
							number =  ticker.mode.abductor_teams + 1
						...
						var
							mob
								living
									carbon
										human
											agent=makeBody(agent_mind)
						var
							mob
								living
									carbon
										human
											scientist=makeBody(scientist_mind)
