...
/datum/event/brand_intelligence/announce()
	event_announcement.Announce("Rampant brand intelligence has been detected aboard the [using_map.station_name], please stand-by. The origin is believed to be \a [originMachine.name].", "Machine Learning Alert")
