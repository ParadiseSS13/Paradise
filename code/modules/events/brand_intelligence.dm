datum
	event
		brand_intelligence
			...
			var
				list
					obj
						machinery
							vending
								vendingMachines = list()
			var
				list
					obj
						machinery
							vending
								infectedMachines = list()
			var
				obj
					machinery
						vending
			...
			var
				list
					rampant_speeches = list("Try our aggressive new marketing strategies!", \
									...
									living
										simple_animal
											hostile
												mimic
													copy
														M = new(upriser.loc, upriser, null, 1) // it will delete upriser on creation and override any machine checks
