...
/datum/event_container/major
	...
	available_events = list(
		...
		// new /datum/event_meta/alien(EVENT_LEVEL_MAJOR, "Alien Infestation",	/datum/event/alien_infestation, 		0,		list(ASSIGNMENT_SECURITY = 15), TRUE),//removed for now
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Traders",			/datum/event/traders,			0, 		is_one_shot = TRUE),
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Terror Spiders",	/datum/event/spider_terror, 	0,		list(ASSIGNMENT_SECURITY = 30), TRUE),
