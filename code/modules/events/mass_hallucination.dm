...
/datum/event/mass_hallucination/announce()
	event_announcement.Announce("It seems that the [using_map.station_name] is passing through a minor radiation field, this may cause some hallucination, but no further damage")
