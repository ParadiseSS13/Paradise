					...
					snacks
						customizable
							...
							var
								basename = "sandwich"
							var
								top = 1	//Do we have a top?
							var
								obj
									item
										toptype
							var
								add_overlays = 1	//Do we stack?
								...
								updateicon()
									...
									for(var/obj/item/O in ingredients)
										...
										if(!fullycustom)
											var
												image
													I = new(src.icon, "[baseicon]_filling")
		...
		weapon
			reagent_containers
				food
					snacks
						customizable
							attack(mob/M as mob, mob/user as mob, def_zone) //SNOOOOOOOWFLAAAAAAAAAAAAAAAAAKES
						...
						customizable
							proc
								newname()
									...
									var
										list
											levels = list("", "double", "triple", "quad", "huge")
			...
			reagent_containers
				food
					snacks
						customizable
							proc
								sortlist(var/list/unsorted, var/highest)
									var
										sorted[0]
