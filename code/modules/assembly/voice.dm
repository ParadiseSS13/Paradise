			...
			assembly
				voice
					...
					var
						listening = 0
					var
						recorded = null	//the activation message
					var
						recorded_type = 0 // 0 for say, 1 for emote
					...
					proc
						hear_input(mob/living/M as mob, msg, type)
							...
							if(listening)
								...
								var
									turf
										T = get_turf(src)	//otherwise it won't work in hand
