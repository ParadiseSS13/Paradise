	...
	item
		device
			assembly
				...
				var
					bomb_name = "bomb" // used for naming bombs / mines
				...
				var
					datum
						wires
							connected = null // currently only used by timer/signaler
				...
				proc
					describe()                  // Called by grenades to describe the state of the trigger (time left, etc)
...
/*
	...
	var
		list
			small_icon_state_overlays = null//Same here
	var
		obj
			holder = null
	var
