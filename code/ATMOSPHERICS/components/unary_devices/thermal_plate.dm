			...
			unary
				thermal_plate
					process()
						...
						var
							transfer_moles = 0.25 * environment.total_moles()
						var
							datum
								gas_mixture
						...
						var
							internal_transfer_moles = 0.25 * air_contents.total_moles()
						var
							datum
								gas_mixture
									internal_removed = air_contents.remove(internal_transfer_moles)
						...
						var
							combined_energy = internal_removed.temperature * internal_removed.heat_capacity() + external_removed.heat_capacity() * external_removed.temperature
				...
				thermal_plate
					proc
						radiate()
							...
							var
								combined_heat_capacity = internal_removed.heat_capacity() + RADIATION_CAPACITY
							var
								combined_energy = internal_removed.temperature * internal_removed.heat_capacity() + (RADIATION_CAPACITY * 6.4)
