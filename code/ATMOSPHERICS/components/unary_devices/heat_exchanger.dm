			...
			unary
				heat_exchanger
					process()
						...
						var
							other_air_heat_capacity = partner.air_contents.heat_capacity()
						var
						...
						var
							other_old_temperature = partner.air_contents.temperature

						if(combined_heat_capacity > 0)
							var
								combined_energy = partner.air_contents.temperature*other_air_heat_capacity + air_heat_capacity*air_contents.temperature
