		...
		atmospherics
			pipe
				simple
					...
					icon_state = ""
					var
						pipe_icon = "" //what kind of pipe it is and from which dmi is the icon manager getting its icons, "" for simple pipes, "hepipe" for HE pipes, "hejunction" for HE junctions
					name = "pipe"
				...
				simple
					initialize(initPipe = 1)
						...
						if(initPipe)
							...
							var
								turf
									T = loc			// hide if turf is not intact
							hide(T.intact)
							update_icon()
