...
/datum/controller/subsystem/mapping/Initialize()
	...
	GLOB.space_manager.add_new_zlevel("Empty Area", linkage = CROSSLINKED, traits = list(REACHABLE, REACHABLE_SPACE_ONLY))
...
/datum/controller/subsystem/mapping/proc/handleRuins()
	...
	for(var/i in 1 to num_extra_space)
		GLOB.space_manager.add_new_zlevel("Ruin Area #[i]", linkage = CROSSLINKED, traits = list(REACHABLE, SPAWN_RUINS, REACHABLE_SPACE_ONLY))
...
/datum/controller/subsystem/mapping/proc/loadStation()
	...
	var/map_z_level = GLOB.space_manager.add_new_zlevel(MAIN_STATION, linkage = CROSSLINKED, traits = list(STATION_LEVEL, STATION_CONTACT, REACHABLE, REACHABLE_SPACE_ONLY, AI_OK))
