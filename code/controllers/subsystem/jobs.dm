...
/datum/controller/subsystem/jobs/proc/AssignRank(var/mob/living/carbon/human/H, var/rank, var/joined_late = 0)
	...
	if(job.req_admin_notify)
		to_chat(H, "<b>You are playing a job that is important for the game progression. If you have to disconnect, please go to cryo and inform your command. If you are unable to do so, please notify the admins via adminhelp.</b>")
