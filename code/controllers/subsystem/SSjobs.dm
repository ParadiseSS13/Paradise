...
/datum/controller/subsystem/jobs/proc/AssignRank(mob/living/carbon/human/H, rank, joined_late = FALSE)
	...
	if(job.job_department_flags & DEP_FLAG_LEGAL)
		L.Add("Your job requires complete knowledge of [wiki_link("Corporate Law", "Corporate Law")] and [wiki_link("Legal_Standard_Operating_Procedure", "Legal Standard Operating Procedure")].")
	...
	if(job.job_department_flags & DEP_FLAG_SECURITY)
		L.Add("As a member of Security, you are to know [wiki_link("Corporate Law", "Corporate Law")] and [wiki_link("Legal_Standard_Operating_Procedure", "Legal Standard Operating Procedure")], as well as your [wiki_link("Standard_Operating_Procedure_(Security)", "Department SOP")].")
