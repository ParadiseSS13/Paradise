...
/datum/controller/subsystem/tickets/proc/autoRespond(N)
	...
	var/response_phrases = list("Thanks" = "Thanks, have a Paradise day!",
		...
		"Github Issue Report" = "To report a bug, please go to our <a href='[CONFIG_GET(string/githuburl)]'>Github page</a>. Then go to 'Issues'. Then 'New Issue'. Then fill out the report form. If the report would reveal current-round information, file it after the round ends.",
		...
		"Reject" = "Reject",
		"Man Up" = "Man Up",
		"Appeal on the Forums" = "Appealing a ban must occur on the forums. Privately messaging, or adminhelping about your ban will not resolve it. To appeal your ban, please head to <a href='[CONFIG_GET(string/banappeals)]'>[CONFIG_GET(string/banappeals)]</a>"
		)
