...
client
	proc
		restart_controller(controller in list("Master","Failsafe"))
			set category = "Debug"
...
client
	proc
		debug_controller(controller in list("Master","failsafe","Ticker","Air","Lighting","Jobs","Sun","Radio","Configuration","pAI", "Cameras","Garbage", "Transfer Controller","Event","Alarm","Scheduler","Nano"))
			set category = "Debug"
