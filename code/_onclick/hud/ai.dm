							...
							living
								silicon
									ai
										AI = usr
					var
						camera = input(AI, "Choose which camera you want to view", "Cameras") as null|anything in AI.get_camera_list()
								...
								living
									silicon
										ai
											AI = usr
						var
							target_name = input(AI) as null|anything in AI.trackable_mobs()
						if(target_name)
