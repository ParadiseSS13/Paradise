...
//Ghosts
#define ui_ghost_jumptomob "SOUTH:6,CENTER-2:1"
#define ui_ghost_orbit "SOUTH:6,CENTER-1:1"
#define ui_ghost_reenter_corpse "SOUTH:6,CENTER:1"
#define ui_ghost_teleport "SOUTH:6,CENTER+1:1"
#define ui_ghost_respawn_list "SOUTH:6,CENTER+2:1"
#define ui_ghost_respawn_mob "SOUTH:6+1,CENTER+2:1"
#define ui_ghost_respawn_pai "SOUTH:6+2,CENTER+2:1"
