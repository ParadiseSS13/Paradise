...
//Ghosts
#define ui_ghost_jumptomob "SOUTH:6,CENTER-2:17"
#define ui_ghost_orbit "SOUTH:6,CENTER-1:17"
#define ui_ghost_reenter_corpse "SOUTH:6,CENTER:17"
#define ui_ghost_teleport "SOUTH:6,CENTER+1:17"
