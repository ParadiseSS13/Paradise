...
mob
	proc
		throw_alert(category, type, severity, obj/new_master)
...
mob
	var
		list
			alerts = list() // contains /obj/screen/alert only // On /mob so clientless mobs will throw alerts properly
