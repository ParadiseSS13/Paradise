...
Desde hace <span class="warning">[text2num(time2text(world.realtime, "YY")) - 16]</span> años hemos estado creciendo y aprendiendo juntos para hacer de esta pequeña casita del árbol un lugar acogedor y divertido para todos. Hemos tenido nuestros altos y bajos, pero sin duda el esfuerzo entre todos ha dado sus frutos, y ahora más que nunca parece que estamos bien encaminados.
