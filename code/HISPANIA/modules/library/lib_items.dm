...
/obj/structure/bookcase
	...
	var/health = 50
	var/tmp/busy = 0
	var/list/allowed_books = list(/obj/item/book, /obj/item/paper_bundle, /obj/item/spellbook, /obj/item/storage/bible, /obj/item/tome) //Things allowed in the bookcase
...
/obj/structure/bookcase/attackby(obj/item/O as obj, mob/user as mob, params)
	...
	if(is_type_in_list(O, allowed_books))
		...
		if (/obj/item/paper_bundle.book == 0)
			return
		else
			O.forceMove(src)
			update_icon()
