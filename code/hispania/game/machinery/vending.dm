...
/obj/machinery/vending/security
	hispa_products = list(/obj/item/taperoll = 8, /obj/item/device/binoculars/security = 2, /obj/item/storage/toolbox/mre = 2)
	hispa_prices = list(/obj/item/storage/toolbox/mre = 450)
