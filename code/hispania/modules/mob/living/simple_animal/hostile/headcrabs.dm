...
/mob/living/simple_animal/hostile/headcrab/update_icons()
	...
	if(is_zombie)
		...
		var/image/I = image('icons/hispania/mob/headcrab.dmi', icon_state = "headcrabpod")
		if(host_species == "Vox")
			I = image('icons/hispania/mob/headcrab.dmi', icon_state = "headcrabpod_vox")
		else if(host_species == "Gray")
			I = image('icons/hispania/mob/headcrab.dmi', icon_state = "headcrabpod_gray")
		overlays += I
...
/mob/living/simple_animal/hostile/headcrab/fast/update_icons()
	...
	if(is_zombie)
		overlays.Cut()
		overlays = human_overlays
		var/image/I = image('icons/hispania/mob/headcrab.dmi', icon_state = "fast_headcrabpod")
		if(host_species == "Vox")
			I = image('icons/hispania/mob/headcrab.dmi', icon_state = "fast_headcrabpod_vox")
		else if(host_species == "Gray")
			I = image('icons/hispania/mob/headcrab.dmi', icon_state = "fast_headcrabpod_gray")
		overlays += I
...
/mob/living/simple_animal/hostile/headcrab/poison/update_icons()
	...
	if(is_zombie)
		overlays.Cut()
		overlays = human_overlays
		var/image/I = image('icons/hispania/mob/headcrab.dmi', icon_state = "poison_headcrabpod")
		if(host_species == "Vox")
			I = image('icons/hispania/mob/headcrab.dmi', icon_state = "poison_headcrabpod_vox")
		else if(host_species == "Gray")
			I = image('icons/hispania/mob/headcrab.dmi', icon_state = "poison_headcrabpod_gray")
		overlays += I
