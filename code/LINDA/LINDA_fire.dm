...
turf
	proc
		hotspot_expose(exposed_temperature, exposed_volume, soh = 0)
			return
				...
				perform_exposure()
					...
					if(bypassing)
						...
						var
							datum
								gas_mixture
									affected = location.air.remove_ratio(volume/location.air.volume)
			...
			process()
				...
				if(bypassing)
					...
					if(location.air.temperature > FIRE_MINIMUM_TEMPERATURE_TO_SPREAD)
						var
							radiated_temperature = location.air.temperature*FIRE_SPREAD_RADIOSITY_SCALE
