...
proc
	word_to_uristrune_bit(word)
		if(word_to_uristrune_table == null)
			...
			var
				list
					words = list("ire", "ego", "nahlizet", "certum", "veri", "jatkaa", "mgar", "balaq", "karazet", "geeri")
...
proc
	get_uristrune_cult(word1, word2, word3)
		...
		var
			bits = word_to_uristrune_bit(word1) \
...
proc
	get_uristrune(symbol_bits, animated = 0)
		...
		var
			icon
				I = icon('icons/effects/uristrunes.dmi', "blank")
			...
			for(var/y = 1, y <= 32, y++)
				...
				if(p == null)
					...
					if(n == "#000000" || s == "#000000" || e == "#000000" || w == "#000000")
						...
						var
							ne = I.GetPixel(x + 1, y + 1)
						var
							se = I.GetPixel(x + 1, y - 1)
						var
							nw = I.GetPixel(x - 1, y + 1)
						var
							sw = I.GetPixel(x - 1, y - 1)
