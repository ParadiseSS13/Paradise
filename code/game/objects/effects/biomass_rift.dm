		...
		biomass
			...
			var
				obj
					effect
						rift
							originalRift = null //the originating rift of that biomass
			var
			...
			var
				list
					obj
						effect
							biomass
								linkedBiomass = list() //all the biomass patches that have spread from it
			var
				newicon = 1 //DEBUG
				...
				for(var/turf/T in orange(1,src))
					...
					var
						obj
							effect
								biomass
									starting = new /obj/effect/biomass(T)
				...
				Spread(var/direction = dir)
					...
					var
						obj
							effect
								biomass
									newBiomass = new /obj/effect/biomass(get_step(src,direction))
					...
					if(!(curDistance%newSpreadDistance))
						var
							obj
								effect
									rift
										newrift = new /obj/effect/rift(loc)
...
proc
	IsValidBiomassLoc(turf/location,obj/effect/biomass/source = null)
		set background = 1
