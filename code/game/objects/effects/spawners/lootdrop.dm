	...
	effect
		spawner
			lootdrop
				...
				var
					lootdoubles = 1		//if the same item can be spawned twice
				var
					list
					...
					loot = list(
								...
								obj
									item
										clothing
											head
												that{throwforce = 1; throwing = 1} = 1,
								obj
									item
										clothing
											head
								...
								obj
									item
										weapon
											book
												manual
													engineering_construction = 1,
								obj
									item
										weapon
											book
												manual
													engineering_hacking = 1,
								obj
									item
										clothing
											head
