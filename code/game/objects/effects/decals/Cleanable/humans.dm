...
obj
	effect
		decal
			cleanable
				blood
					Crossed(mob/living/carbon/human/perp)
						if(!istype(perp))
							return
						if(amount < 1)
							return
						...
						var
							obj
								item
									organ
										external
											l_foot = perp.get_organ("l_foot")
						var
							obj
								item
									organ
										external
											r_foot = perp.get_organ("r_foot")
						var
							hasfeet = 1
				...
				blood
					gibs
						update_icon()
							...
							var
								icon
									blood = new(base_icon,"[icon_state]",dir)
							if(basecolor == "rainbow") basecolor = "#[pick(list("FF0000","FF7F00","FFFF00","00FF00","0000FF","4B0082","8F00FF"))]"
	...
	effect
		decal
			cleanable
				blood
					gibs
						cleangibs //most ironic name ever...
											...
											obj
												effect
													decal
														cleanable
															blood
																b = new /obj/effect/decal/cleanable/blood/splatter(src.loc)
