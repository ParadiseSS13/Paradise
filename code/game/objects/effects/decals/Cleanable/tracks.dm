			...
			cleanable
				blood
					tracks
						...
						*/
						proc
							AddTracks(var/list/DNA, var/comingdir, var/goingdir, var/bloodcolor="#A10808")
								var
									updated=0
								// Shift our goingdir 4 spaces to the left so it's in the GOING bitblock.
								var
									realgoing=goingdir<<4
								...
								var
									t=world.time + TRACKS_CRUSTIFY_TIME
						...
						update_icon()
							...
							for(var/datum/fluidtrack/track in stack)
								var
									stack_idx=setdirs["[track.direction]"]
								var
									state=coming_state
								...
								var
									image
										I = image(icon, icon_state=state, dir=num2dir(truedir))
