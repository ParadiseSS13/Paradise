					...
					var
						obj
							structure
								sign
									poster
										resulting_poster = null //The poster that will be created is initialised and stored through contraband/poster's constructor
					var
						subtype = 0
	...
	structure
		sign
			poster
				...
				anchored = 1
				var
					serial_number	//Will hold the value of src.loc if nobody initialises it
				var
					ruined = 0
				var
					subtype = 0
...
obj
	structure
		sign
			poster
				legit // For mappers looking to pre-spawn NT approved posters.
					subtype = 1
...
turf
	simulated
		wall
			proc
				place_poster(obj/item/weapon/contraband/poster/P, mob/user)
