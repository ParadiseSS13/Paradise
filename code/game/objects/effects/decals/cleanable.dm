	...
	effect
		decal
			cleanable
				...
				var
					targeted_by = null			// Used so cleanbots can't claim a mess.
				var
					noscoop = 0   //if it has this, don't let it be scooped up
				var
					noclear = 0    //if it has this, don't delete it when its' scooped up
