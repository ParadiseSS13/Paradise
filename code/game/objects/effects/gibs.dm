proc
	gibs(atom/location, var/list/viruses, var/datum/dna/MobDNA)		//CARN MARKER
...
obj
	effect
		gibspawner
			var
				sparks = 0 //whether sparks spread on Gib()
			var
				virusProb = 20 //the chance for viruses to spread on the gibs
			var
				list
					gibtypes = list()
			var
			...
			proc
				Gib(atom/location, var/list/viruses = list(), var/datum/dna/MobDNA = null)
