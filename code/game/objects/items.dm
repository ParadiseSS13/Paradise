...
/obj/item
	...
	var/slowdown = 0
	/// Item decreases armor by this value, happens before percentage armor penetration
	var/armor_penetration_flat = 0
	/// Item penetrates this percentage of armor, occurs after flat armor reduction
