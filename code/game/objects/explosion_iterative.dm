...
/turf/var/explosion_ratio = 1.0 //this affect the explosion spread, but by a % instead of direct value (should make walls a bit more meaningfull vs stronger bombs
/turf/var/datum/side_explosion/side_explosion_data = 0

/turf/space/explosion_resistance = 10
...
/turf/simulated/shuttle/wall/explosion_resistance = 5
/turf/simulated/shuttle/wall/explosion_ratio = 0.80
/turf/simulated/wall/explosion_resistance = 5
/turf/simulated/wall/explosion_ratio = 0.80

/turf/simulated/wall/r_wall/explosion_resistance = 15
/turf/simulated/wall/r_wall/explosion_ratio = 0.60
...
/obj/effect/fakefire/anchored = 1
/obj/effect/fakefire/mouse_opacity = 0
/obj/effect/fakefire/unacidable = 1//So you can't melt fire with acid.
/obj/effect/fakefire/icon = 'icons/effects/fire.dmi'
/obj/effect/fakefire/icon_state = "1"
/obj/effect/fakefire/layer = TURF_LAYER
/obj/effect/fakefire/blend_mode = BLEND_ADD
/obj/effect/fakefire/New()
	color = heat2color(25000)
	set_light(color)

 //used to manage the explosion itself
datum/line_explosion_controller/var/highestsidepower=0 //this is a value used to not have to iterate everytime through all the queued side. We only iterate to pick the next start point
datum/line_explosion_controller/var/list/queue_explosion_lines = list() //list of lines that we are currently exploding
datum/line_explosion_controller/var/list/queue_explosion_sides = list() //list of side explosions that we use to start new lines from. We find the highest power side explosion end start a line for each of the same power
datum/line_explosion_controller/var/turf/epicenter = 0
datum/line_explosion_controller/var/power = 0
datum/line_explosion_controller/var/list/explosion_turfs //list containing our calculated explosion to apply
datum/line_explosion_controller/var/delayBetweenWave = 1 //how long we sleep between each explosions wave
datum/line_explosion_controller/var/iterationperWave = 7 //how many steps between sleeps
datum/line_explosion_controller/var/destructionperWave = 15 //how many tiles do we apply the explosion on between sleeps
datum/line_explosion_controller/var/calculating = 0
datum/line_explosion_controller/var/devastation_boost_count = 0
datum/line_explosion_controller/var/heavy_impact_boost_count = 0
datum/line_explosion_controller/var/light_impact_boost_count = 0
datum/line_explosion_controller/var/highpower = 0
datum/line_explosion_controller/var/midpower = 0
datum/line_explosion_controller/var/lowpower = 0
datum/line_explosion_controller/proc/startExplosion(turf/m_epicenter, devastation_range, heavy_impact_range, light_impact_range)
...
datum/line_explosion_controller/proc/applyExplosion()
	var/count=0
...
datum/line_explosion_controller/proc/calculateExplosionSpread()
	var/totalresist = 0
...
datum/line_explosion_controller/proc/executeCalculations()
...
datum/side_explosion/var/direction=0 //direction were headed
datum/side_explosion/var/power=0
datum/side_explosion/New(startpower, startDirection)
	power = startpower
	direction = startDirection

datum/line_explosion/var/direction=0 //direction were headed
datum/line_explosion/var/power=0
datum/line_explosion/var/turf/nextTurf=0 //turf on which we explode next
datum/line_explosion/var/datum/line_explosion_controller/controller = 0 //our controller
datum/line_explosion/New(startpower, turf/startTurf, startDirection, datum/line_explosion_controller/ourController, newIsSide)
	power = startpower
	nextTurf = startTurf
	direction = startDirection
	controller = ourController

datum/line_explosion/proc/iterate() //explode the next tile
	if (nextTurf == null)
		return 1
