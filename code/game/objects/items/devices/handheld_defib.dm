...
/obj/item/hanheld_defibrillator/emag_act(mob/user)
	if(!emagged)
		emagged = TRUE
...
/obj/item/hanheld_defibrillator/emp_act(severity)
	if(emagged)
		emagged = FALSE
		desc = "Used to restart stopped hearts."
...
/obj/item/hanheld_defibrillator/attack(mob/living/carbon/human/H, mob/user)
	if(!istype(H))
		return ..()
...
/obj/item/hanheld_defibrillator/proc/short_charge()
	icon_state = "[icon_base]-off"

/obj/item/hanheld_defibrillator/proc/recharge()
	cooldown = FALSE
