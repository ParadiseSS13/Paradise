	...
	item
		device
			megaphone
				...
				var
					list
						insultmsg = list("FUCK EVERYONE!", "I'M A TATER!", "ALL SECURITY TO SHOOT ME ON SIGHT!", "I HAVE A BOMB!", "CAPTAIN IS A COMDOM!", "FOR THE SYNDICATE!")
		...
		device
			megaphone
				attack_self(mob/living/user as mob)
					...
					var
						message = input(user, "Shout a message:", "Megaphone") as text|null
					if(!message)
						return
...
obj
	item
		device
			megaphone
				proc
					saymsg(mob/living/user as mob, message)
