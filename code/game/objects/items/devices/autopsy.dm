...
/obj/item/autopsy_scanner/attackby(obj/item/P, mob/user)
	...
	var/dead_name = tgui_input_text(user, "Insert name of deceased individual", default=target_name, title="Coroner's Report")
	var/rank = tgui_input_text(user, "Insert rank of deceased individual", default=target_rank, title="Coroner's Report")
	var/tod = tgui_input_text(user, "Insert time of death", default=station_time_timestamp("hh:mm", timeofdeath), title="Coroner's Report")
	var/cause = tgui_input_text(user, "Insert cause of death", title="Coroner's Report")
