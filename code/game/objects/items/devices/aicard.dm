					...
					var
						mob
							living
								silicon
									ai
										AI = locate(/mob/living/silicon/ai) in src
						...
						var
							mob
								living
									silicon
										ai
											AI = locate(/mob/living/silicon/ai) in src //AI is inside.
						if(AI)
		...
		device
			aicard
				Topic(href, href_list, nowindow, state)
					...
					if(href_list["wipe"])
						var
							confirm = alert("Are you sure you want to wipe this card's memory? This cannot be undone once started.", "Confirm Wipe", "Yes", "No")
