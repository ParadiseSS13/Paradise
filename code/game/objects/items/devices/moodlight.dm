/obj/item/moodlight
	...
	var/range = 4
	var/brightness = 2
	var/amount_to_shift = 0.02 //The smaller the number the smoother the shift, but the longer it will take to shift. Percentage in decimals.
...
/obj/item/moodlight/process()
	...
	amount_shifted = amount_shifted + amount_to_shift
