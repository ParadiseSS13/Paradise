		...
		toy
			carpplushie
				dehy_carp
					var
						mob
							owner = null	// Carp doesn't attack owner, set when using in hand
					var
						owned = 1	// Boolean, no owner to begin with
								...
								mob
									living
										simple_animal
											hostile
												carp
													C = new /mob/living/simple_animal/hostile/carp(get_turf(src))
