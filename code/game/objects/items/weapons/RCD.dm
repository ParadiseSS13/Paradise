...
/obj/item/weapon/rcd
	...
	var/static/list/allowed_door_types = list(
		...
		/obj/machinery/door/airlock/command = "Command", /obj/machinery/door/airlock/glass_command = "Command (Glass)",
		/obj/machinery/door/airlock/security = "Security", /obj/machinery/door/airlock/glass_security = "Security (Glass)",
		/obj/machinery/door/airlock/engineering = "Engineering", /obj/machinery/door/airlock/glass_engineering = "Engineering (Glass)",
		/obj/machinery/door/airlock/medical = "Medical", /obj/machinery/door/airlock/glass_medical = "Medical (Glass)",
		/obj/machinery/door/airlock/maintenance = "Maintenance", /obj/machinery/door/airlock/glass_maintenance = "Maintenance (Glass)",
		...
		/obj/machinery/door/airlock/mining = "Mining", /obj/machinery/door/airlock/glass_mining = "Mining (Glass)",
		/obj/machinery/door/airlock/research = "Research", /obj/machinery/door/airlock/glass_research = "Research (Glass)",
		/obj/machinery/door/airlock/atmos = "Atmospherics", /obj/machinery/door/airlock/glass_atmos = "Atmospherics (Glass)",
