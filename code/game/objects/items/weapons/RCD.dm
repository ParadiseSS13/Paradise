		...
		weapon
			rcd
				...
				var
					static
						list
							allowed_door_types = list(/obj/machinery/door/airlock = "Standard",
								obj
									machinery
										door
											airlock
												command = "Command", /obj/machinery/door/airlock/security = "Security",
								obj
									machinery
										door
											airlock
												engineering = "Engineering", /obj/machinery/door/airlock/medical = "Medical",
								obj
									machinery
										door
											airlock
												maintenance = "Maintenance", /obj/machinery/door/airlock/external = "External",
								obj
									machinery
										door
											airlock
												glass = "Standard (Glass)", /obj/machinery/door/airlock/freezer = "Freezer",
								obj
									machinery
										door
											airlock
												glass_command = "Command (Glass)", /obj/machinery/door/airlock/glass_engineering = "Engineering (Glass)",
								obj
									machinery
										door
											airlock
												glass_security = "Security (Glass)", /obj/machinery/door/airlock/glass_medical = "Medical (Glass)",
								obj
									machinery
										door
											airlock
												mining = "Mining", /obj/machinery/door/airlock/atmos = "Atmospherics",
								obj
									machinery
										door
											airlock
												research = "Research", /obj/machinery/door/airlock/glass_research = "Research (Glass)",
								obj
									machinery
										door
											airlock
												glass_mining = "Mining (Glass)", /obj/machinery/door/airlock/glass_atmos = "Atmospherics (Glass)")
...
obj
	item
		weapon
			rcd
				ui_interact(mob/user, ui_key = "main", var/datum/nanoui/ui = null, var/force_open = 1, var/datum/topic_state/state = inventory_state)
					var
						list
							data = list()
					data["mode"] = mode
...
obj
	item
		weapon
			rcd
				Topic(href, href_list, nowindow, state)
					if(..())
						return 1
					...
					if(href_list["door_type"])
						var
							new_door_type = text2path(href_list["door_type"])
					...
					if(href_list["toggle_access"] && !locked)
						var
							href_access = text2num(href_list["toggle_access"])
