...
/obj/item/card/id/security
	...
	icon_state = "security"
	access = list(ACCESS_SECURITY, ACCESS_SECURITY_EQUIPMENT, ACCESS_SEC_DOORS, ACCESS_BRIG, ACCESS_COURT, ACCESS_MAINT_TUNNELS, ACCESS_MORGUE, ACCESS_WEAPONS)
...
/obj/item/card/id/hos
	...
	registered_name = "HoS"
	icon_state = "HoS"
	access = list(ACCESS_SECURITY, ACCESS_SECURITY_EQUIPMENT, ACCESS_SEC_DOORS, ACCESS_BRIG, ACCESS_ARMORY, ACCESS_COURT,
