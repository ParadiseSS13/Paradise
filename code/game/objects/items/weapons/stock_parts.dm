		...
		weapon
			storage
				part_replacer
					...
					var
						primary_sound = 'sound/items/rped.ogg'
					var
						alt_sound = null
...
obj
	item
		weapon
			storage
				part_replacer
					afterattack(obj/machinery/T as obj, mob/living/carbon/human/user as mob, flag, params)
						if(flag)
							return
						else
...
obj
	item
		weapon
			research//Makes testing much less of a pain -Sieve
				name = "research"
				icon = 'icons/obj/stock_parts.dmi'
				icon_state = "capacitor"
