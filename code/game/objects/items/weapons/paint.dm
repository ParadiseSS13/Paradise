...
/obj/item/reagent_containers/glass/paint/red
	...
	list_reagents = list(/datum/reagent/paint/red = 70)

/obj/item/reagent_containers/glass/paint/green
	name = "green paint bucket"
	icon_state = "paint_green"
	list_reagents = list(/datum/reagent/paint/green = 70)

/obj/item/reagent_containers/glass/paint/blue
	name = "blue paint bucket"
	icon_state = "paint_blue"
	list_reagents = list(/datum/reagent/paint/blue = 70)

/obj/item/reagent_containers/glass/paint/yellow
	name = "yellow paint bucket"
	icon_state = "paint_yellow"
	list_reagents = list(/datum/reagent/paint/yellow = 70)

/obj/item/reagent_containers/glass/paint/violet
	name = "violet paint bucket"
	icon_state = "paint_violet"
	list_reagents = list(/datum/reagent/paint/violet = 70)

/obj/item/reagent_containers/glass/paint/black
	name = "black paint bucket"
	icon_state = "paint_black"
	list_reagents = list(/datum/reagent/paint/black = 70)

/obj/item/reagent_containers/glass/paint/white
	name = "white paint bucket"
	icon_state = "paint_white"
	list_reagents = list(/datum/reagent/paint/white = 70)

/obj/item/reagent_containers/glass/paint/remover
	name = "paint remover bucket"
	list_reagents = list(/datum/reagent/paint_remover = 70)
