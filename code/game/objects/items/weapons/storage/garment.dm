...
/obj/item/storage/bag/garment/head_of_personnel/populate_contents()
	...
	new /obj/item/clothing/under/rank/civilian/hop/dress_hr(src)
	new /obj/item/clothing/under/rank/procedure/lawyer/black(src)
	new /obj/item/clothing/under/rank/procedure/lawyer/blue(src)
