...
/obj/item/storage/toolbox/electrical/populate_contents()
	...
	new /obj/item/crowbar(src)
	new /obj/item/stack/cable_coil/low_voltage(src, 30, paramcolor = pickedcolor)
	new /obj/item/stack/cable_coil/low_voltage(src, 30, paramcolor = pickedcolor)
	if(prob(5))
...
/obj/item/storage/toolbox/artistic/populate_contents()
	...
	new /obj/item/stack/cable_coil/low_voltage/yellow(src)
	new /obj/item/stack/cable_coil/low_voltage/blue(src)
	new /obj/item/stack/cable_coil/low_voltage/green(src)
	new /obj/item/stack/cable_coil/low_voltage/pink(src)
	new /obj/item/stack/cable_coil/low_voltage/orange(src)
	new /obj/item/stack/cable_coil/low_voltage/cyan(src)
	new /obj/item/stack/cable_coil/low_voltage/white(src)
