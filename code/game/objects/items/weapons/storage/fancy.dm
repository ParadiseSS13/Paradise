			...
			storage
				fancy
					cigarettes
						...
						var
							list
								unlaced_cigarettes = list() // Cigarettes that haven't received reagents yet
						var
							default_reagents = list("nicotine" = 15) // List of reagents to pre-generate for each cigarette
						var
		...
		weapon
			storage
				fancy
					cigarettes
						proc
							lace_cigarette(var/obj/item/clothing/mask/cigarette/C as obj)
					...
					cigarettes
						syndicate
							New()
								..()
								var
									new_name = pick("evil", "suspicious", "ominous", "donk-flavored", "robust", "sneaky")
