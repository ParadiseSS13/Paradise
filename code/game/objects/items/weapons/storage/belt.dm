		...
		weapon
			storage
				belt
					...
					var
						use_item_overlays = 0 // Do we have overlays for items held inside the belt?
		...
		weapon
			storage
				belt
					bluespace
						owlman
							afterattack(atom/target as obj|turf, mob/user as mob, flag)
								if(!flag)
									return
