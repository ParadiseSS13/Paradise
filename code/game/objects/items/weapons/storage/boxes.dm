...
/obj/item/storage/box/bartender_rare_ingredients_kit/populate_contents()
	var/list/reagent_list = list(/datum/reagent/acid, /datum/reagent/radium, /datum/reagent/medicine/ether, /datum/reagent/methamphetamine, /datum/reagent/plasma,
		/datum/reagent/gold, /datum/reagent/silver, /datum/reagent/consumable/capsaicin, /datum/reagent/psilocybin)
...
/obj/item/storage/box/chef_rare_ingredients_kit/populate_contents()
	...
	var/list/reagent_list = list(/datum/reagent/msg, /datum/reagent/consumable/drink/triple_citrus, /datum/reagent/medicine/salglu_solution, /datum/reagent/consumable/nutriment,
		/datum/reagent/consumable/gravy, /datum/reagent/consumable/honey, /datum/reagent/consumable/vitfro)
	for(var/reag in reagent_list)
		var/obj/item/reagent_containers/glass/bottle/B = new(src)
		B.reagents.add_reagent(reag, 30)
		B.name = "[reag] bottle"
