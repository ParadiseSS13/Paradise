					...
					holding
						...
						attackby(obj/item/weapon/W as obj, mob/user as mob, params)
							if(crit_fail)
								...
								var
									response = alert(user, "Are you sure you want to put the bag of holding inside another bag of holding?","Are you sure you want to die?","Yes","No")
								if(response == "Yes")
									...
									if(do_after(user,30,target=src))
										...
										var
											obj
												singularity
													singulo = new /obj/singularity(get_turf(user))
