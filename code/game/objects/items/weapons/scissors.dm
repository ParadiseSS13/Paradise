			...
			scissors
				attack(mob/living/carbon/M as mob, mob/user as mob)
					...
					if(ishuman(M))
								...
								for(var/i in facial_hair_styles_list)
									var
										datum
											sprite_accessory
												facial_hair
													tmp_facial = facial_hair_styles_list[i]
						...
						var
							f_new_style = input(user, "Select a facial hair style", "Grooming")  as null|anything in species_facial_hair
						//handle normal hair
						var
							list
								species_hair = list()
						...
						var
							h_new_style = input(user, "Select a hair style", "Grooming")  as null|anything in species_hair
