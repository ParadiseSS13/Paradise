...
/obj/item/extinguisher/Initialize(mapload)
	...
	if(!reagents)
		...
		reagents.add_reagent("sacid", max_water - 10)
		reagents.add_reagent("firefighting_foam", 10)
...
/obj/item/extinguisher/cyborg_recharge(coeff, emagged)
	reagents.check_and_add("sacid", max_water, 9 * coeff)
	reagents.check_and_add("firefighting_foam", max_water, 1 * coeff)
