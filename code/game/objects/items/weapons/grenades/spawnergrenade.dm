		...
		weapon
			grenade
				spawnergrenade
					...
					var
						spawner_type = null // must be an object path
					var
						deliveryamt = 1 // amount of type to deliver
	...
	item
		weapon
			grenade
				spawnergrenade
					feral_cats
						prime()			//Own proc for this because the regular one would flash people which was dumb.
							update_mob()
							if(spawner_type && deliveryamt)
								var
									turf
