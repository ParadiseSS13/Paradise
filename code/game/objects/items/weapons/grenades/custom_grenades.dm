...
/obj/item/storage/box/syndie_kit/remotegrenade/Initialize(mapload)
	. = ..()
...
/obj/item/storage/box/syndie_kit/remoteemp/Initialize(mapload)
	. = ..()
...
/obj/item/storage/box/syndie_kit/remotelube/Initialize(mapload)
	. = ..()
