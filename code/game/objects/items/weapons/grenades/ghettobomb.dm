																								...
																								obj
																									item
																										weapon
																											grenade
																												iedcasing
																													W = new /obj/item/weapon/grenade/iedcasing
																							user.unEquip(G)
																							user.unEquip(src)
																							user.put_in_hands(W)
...
obj
	item
		weapon
			grenade
				iedcasing
					afterattack(atom/target, mob/user , flag) //Filling up the can
						if(assembled == 0)
...
obj
	item
		weapon
			grenade
				iedcasing
					attackby(var/obj/item/I, mob/user as mob) //Wiring the can for ignition
