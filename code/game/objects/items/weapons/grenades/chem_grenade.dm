			...
			grenade
				chem_grenade
					...
					var
						bomb_state = "chembomb"
					var
						payload_name = null // used for spawned grenades
					w_class = 2
					force = 2
					var
						stage = EMPTY
					...
					var
						list
							allowed_containers = list(/obj/item/weapon/reagent_containers/glass/beaker, /obj/item/weapon/reagent_containers/glass/bottle)
					var
						affected_area = 3
					var
						obj
...
obj
	item
		weapon
			grenade
				chem_grenade
					Move() // prox sensors and infrared care about this
						..()
						if(nadeassembly)
				...
				chem_grenade
					prime()
						...
						if(nadeassembly)
							var
								mob
									M = get_mob_by_ckey(assemblyattacher)
							var
								mob
									last = get_mob_by_ckey(nadeassembly.fingerprintslast)
							var
								turf
									T = get_turf(src)
							var
							...
							var
								datum
									effect
										system
											steam_spread
												steam = new /datum/effect/system/steam_spread()
	...
	item
		weapon
			grenade
				chem_grenade
					proc
						CreateDefaultTrigger(var/typekey)
