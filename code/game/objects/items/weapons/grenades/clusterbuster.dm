		...
		weapon
			grenade
				clusterbuster
					...
					var
						payload = /obj/item/weapon/grenade/flashbang/cluster
	...
	item
		weapon
			grenade
				clusterbuster
					segment
						New(var/loc, var/payload_type = /obj/item/weapon/grenade/flashbang/cluster)
							..()
...
obj
	effect
		payload_spawner
			New(var/turf/newloc,var/type, var/numspawned as num)
