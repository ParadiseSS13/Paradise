		...
		weapon
			melee
				energy
					sword
						cyborg
							attack(mob/M, var/mob/living/silicon/robot/R)
								if(R.cell)
									var
										obj
											item
		...
		weapon
			melee
				energy
					sword
						cyborg
							saw //Used by medical Syndicate cyborgs
								name = "energy saw"
		...
		weapon
			melee
				energy
					sword
						saber
							attackby(obj/item/weapon/W, mob/living/user, params)
								..()
											...
											obj
												item
													weapon
														twohanded
															dualsaber
																newSaber = new /obj/item/weapon/twohanded/dualsaber(user.loc)
