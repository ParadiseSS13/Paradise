...
#undef BIOCHIP_EMOTE_TRIGGER_INTENTIONAL
#undef BIOCHIP_EMOTE_TRIGGER_UNINTENTIONAL
#undef BIOCHIP_EMOTE_TRIGGER_ALWAYS
#undef BIOCHIP_TRIGGER_DEATH_ONCE
#undef BIOCHIP_TRIGGER_DEATH_ANY
#undef BIOCHIP_TRIGGER_NOT_WHEN_GIBBED
#undef BIOCHIP_ACTIVATED_PASSIVE
#undef BIOCHIP_ACTIVATED_ACTIVE