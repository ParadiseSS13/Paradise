					...
					proc
						allow_thrust(num, mob/living/user as mob)
							...
							var
								datum
									gas_mixture
										G = src.air_contents.remove(num)

							var
								allgases = G.carbon_dioxide + G.nitrogen + G.oxygen + G.toxins	//fuck trace gases	-Pete
							if(allgases >= 0.005)
								. = 1
					...
					rig
						allow_thrust(num, mob/living/user as mob)
							...
							var
								obj
									item
										weapon
											tank
												pressure_vessel = holder.air_supply
							...
							var
								datum
									gas_mixture
										G = pressure_vessel.air_contents.remove(num)

							var
								allgases = G.carbon_dioxide + G.nitrogen + G.oxygen + G.toxins
							if(allgases >= 0.005)
								. = 1
							qdel(G)
