							...
							if(nozzle_mode == NANOFROST)
								...
								var
									obj
										effect
											nanofrost_container
												A = new /obj/effect/nanofrost_container(get_turf(src))
									...
									var
										obj
											effect
												effect
													foam
														F = new /obj/effect/effect/foam(get_turf(target), 1)
									F.amount = 0
						...
						obj
							effect
								decal
									cleanable
										flour
											F = new /obj/effect/decal/cleanable/flour(src.loc)
					F.color = "#B2FFFF"
					...
					if(amount)
						var
							datum
								effect
									system
										freezing_smoke_spread
											F = new /datum/effect/system/freezing_smoke_spread
							...
							var
								obj
									effect
										effect
											freezing_smoke
												smoke = new /obj/effect/effect/freezing_smoke(location, 0, 0)
							smoke.amount = 0
							var
