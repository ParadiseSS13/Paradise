		...
		weapon
			stock_parts
				cell
					...
					w_class = 2
					var
						charge = 0	// note %age conveted to actual charge in New
					var
						maxcharge = 10000
					rating = 1
					...
					var
						minor_fault = 0 //If not 100% reliable, it will build up faults.
					var
						chargerate = 1000 //how much power is given every tick in a recharger
					var
						self_recharge = 0 //does it self recharge, over time, or not?
