...
/obj/item/toy/plushie/orange_fox/grump/ComponentInitialize()
	...
	"Congrats, you just left a reference with your dirty client and now I'll never garbage collect properly", "Is it that time of day, again, for unecessary adminbus?")
