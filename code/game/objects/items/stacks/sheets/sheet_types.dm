...
GLOBAL_LIST_INIT(metal_recipes, list(
	...
	null,
	new /datum/stack_recipe("canister", /obj/machinery/atmospherics/portable/canister, 10, time = 15, one_per_turf = TRUE, on_floor = TRUE),
	null,
	...
	null,
	new /datum/stack_recipe("mass driver button frame", /obj/item/mounted/frame/driver_button, 1, time = 50, one_per_turf = FALSE, on_floor = TRUE),
	new /datum/stack_recipe("light switch frame", /obj/item/mounted/frame/light_switch, 1, time = 50, one_per_turf = FALSE, on_floor = TRUE),
	new /datum/stack_recipe("window tint control button frame", /obj/item/mounted/frame/light_switch/windowtint, 1, time = 50, one_per_turf = FALSE, on_floor = TRUE),
	null,
