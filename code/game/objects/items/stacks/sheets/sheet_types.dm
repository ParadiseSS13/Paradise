...
GLOBAL_LIST_INIT(cult_recipes, list ( \
	new /datum/stack_recipe/cult("runed door", /obj/machinery/door/airlock/cult, 1, time = 50, one_per_turf = TRUE, on_floor = TRUE, no_cult_structure = TRUE),
	new /datum/stack_recipe/cult("runed girder", /obj/structure/girder/cult, 1, time = 20, one_per_turf = TRUE, on_floor = TRUE, no_cult_structure = TRUE), \
