...
GLOBAL_LIST_INIT(wood_recipes, list(
	...
	new /datum/stack_recipe_list("wood structures", list(
		...
		new /datum/stack_recipe("signpost", /obj/structure/signpost, 2, time = 2 SECONDS, one_per_turf = TRUE, on_floor = TRUE),
		...
		new /datum/stack_recipe("torch sconce", /obj/item/match/torch, 5, time = 3 SECONDS, one_per_turf = TRUE, on_floor = TRUE),
		)),
