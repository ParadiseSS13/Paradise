				...
				var
					obj
						structure
							closet
								body_bag
									R = new /obj/structure/closet/body_bag(user.loc)
			...
			body_bag
				...
				attackby(W as obj, mob/user as mob, params)
					if(istype(W, /obj/item/weapon/pen))
						var
							t = input(user, "What would you like the label to be?", text("[]", src.name), null)  as text
						...
						obj
							structure
								closet
									body_bag
										cryobag
											R = new /obj/structure/closet/body_bag/cryobag(user.loc)
					R.add_fingerprint(user)
					qdel(src)
