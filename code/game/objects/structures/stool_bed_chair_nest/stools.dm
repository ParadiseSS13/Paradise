...
obj
	structure
		stool
			MouseDrop(atom/over_object, src_location, over_location, src_control, over_control, params, skip_fucking_stool_shit = 0)
							...
							obj
								item
									stack
										sheet
											metal
												m = new/obj/item/stack/sheet/metal
						m.loc = get_turf(src)
						qdel(src)
						var
							mob
