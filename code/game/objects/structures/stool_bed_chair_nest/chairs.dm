obj
	structure
		stool
			bed
				chair	//YES, chairs are a type of bed, which are a type of stool. This works, believe me.	-Pete
					name = "chair"
					...
					var
						propelled = 0 // Check for fire-extinguisher-driven chairs
...
obj
	structure
		stool
			bed
				chair
					handle_rotation()	//making this into a seperate proc so office chairs can call it on Move()
						if(src.dir == NORTH)
							src.layer = FLY_LAYER
						else
							src.layer = OBJ_LAYER
