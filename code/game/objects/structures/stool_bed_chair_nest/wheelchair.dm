...
/obj/structure/chair/wheelchair/plasteel
	...
	desc = "Made from a mixture of metal-plasma sheets, this wheelchair is 3 times stronger than classic model, and is very resistant to acid and corrosion. Thanks to this it can be used in various dangerous environments without the need to worry about safety."
...
/obj/structure/chair/wheelchair/plastitanium
	...
	desc = "Made from a mixture of titanium-plasma sheets, this wheelchair is 6 times stronger than classic model, and is very resistant to acid, corrosion and fire! Thanks to this, it can be used in various dangerous environments, without the need to worry about safety... <i>but remember to not try to bathe in lava.</i>"
