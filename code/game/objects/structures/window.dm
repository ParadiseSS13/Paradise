var
	global
		wcBar = pick(list("#0d8395", "#58b5c3", "#58c366", "#90d79a", "#ffffff"))
var
	global
		wcBrig = pick(list("#aa0808", "#7f0606", "#ff0000"))
var
	global
		wcCommon = pick(list("#379963", "#0d8395", "#58b5c3", "#49e46e", "#8fcf44", "#ffffff"))

obj
	proc
		color_windows(var/obj/W as obj)
			var
				list
					wcBarAreas = list(/area/crew_quarters/bar)
			var
				list
					wcBrigAreas = list(/area/security,/area/prison,/area/shuttle/gamma)
	...
	structure
		window
			...
			var
				basestate
			var
				shardtype = /obj/item/weapon/shard
			var
				glasstype = /obj/item/stack/sheet/glass
			var
				disassembled = 0
			var
				sheets = 1 // Number of sheets needed to build this window (determines how much shit is spawned by destroy())
...
obj
	structure
		window
			CheckExit(var/atom/movable/O, var/turf/target)
