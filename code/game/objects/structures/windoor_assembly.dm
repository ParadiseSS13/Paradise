...
obj
	structure
		windoor_assembly
			...
			var
				facing = "l"	//Does the windoor open to the left or right?
			var
				secure = 0		//Whether or not this creates a secure windoor
			var
				...
				switch(state)
					...
					if("02")
						...
						//Screwdriver to remove airlock electronics. Step 6 undone.
							...
							var
								t = stripped_input(user, "Enter the name for the door.", src.name, src.created_name,MAX_NAME_LEN)
							if(!t)
								return
										...
										var
											obj
												machinery
													door
														window
															windoor = new /obj/machinery/door/window(src.loc)
										if(src.facing == "l")
