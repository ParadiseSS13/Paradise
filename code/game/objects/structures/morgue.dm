...
obj
	structure
		morgue
			attackby(P as obj, mob/user as mob, params)
				if(istype(P, /obj/item/weapon/pen))
					var
						t = input(user, "What would you like the label to be?", text("[]", name), null)  as text
...
hook
	Login
		proc
			update_morgue(var/client/client, var/mob/L)
