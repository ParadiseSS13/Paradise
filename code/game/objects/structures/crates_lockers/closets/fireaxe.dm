	...
	structure
		closet
			fireaxecabinet
					...
					obj
						item
							weapon
								twohanded
									fireaxe
										fireaxe = new/obj/item/weapon/twohanded/fireaxe
				...
				density = 0
				var
					localopened = 0 //Setting this to keep it from behaviouring like a normal closet and obstructing movement in the map. -Agouri
				opened = 1
				var
					hitstaken = 0
				var
				...
				attackby(var/obj/item/O as obj, var/mob/living/user as mob)  //Marker -Agouri
					...
					var
						hasaxe = 0       //gonna come in handy later~
					if(fireaxe)
						hasaxe = 1
				...
				verb
					toggle_openness() //nice name, huh? HUH?! -Erro //YEAH -Agouri
						set name = "Open/Close"
						set category = "Object"
