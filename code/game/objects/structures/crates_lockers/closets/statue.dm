	...
	structure
		closet
			statue
				...
				var
					intialTox = 0 	//these are here to keep the mob from taking damage from things that logically wouldn't affect a rock
				var
					intialFire = 0	//it's a little sloppy I know but it was this or the GODMODE flag. Lesser of two evils.
				var
					intialBrute = 0
				var
					intialOxy = 0
				var
					timer = 240 //eventually the person will be freed

obj
	structure
		closet
			statue
				New(loc, var/mob/living/L)
