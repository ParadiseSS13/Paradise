...
/obj/structure/statue/sandstone/venus //call me when we add marble i guess
	...
	desc = "Похоже что это древняя мраморная статуя. Девушка имеет длинные косы, которые спускаются по всему телу до пола. В руках она держит ящик инструментов. Пожалуй, это лучшее изображение женщины, которые вы когла либо видели. Художник должен действительно быть мастером своего дела. Жаль что рука сломана."
...
/obj/structure/statue/thaumicnik
	name = "Unknown Hero"
	desc = "Перед собою вы наблюдаете интересного молодого человека, который держит в руках чертежи станции очень похожие на станцию Керберос. Возможно он как то принимал участие в разработке или в конструировании этой станции. В другой же руке вы замечаете планшет с листком, на котором рассписаны какие то даты и заметки к ним. Все что удается вам разглядеть, так это заголовок *event-times* на листочке. \n Надпись на табличке - Один из главных инженеров, принимающих участие в разработке передовой научно-исследовательской станции Kerberos."
