	...
	structure
		transit_tube
			station
				...
				var
					list
						disallowed_mobs = list(/mob/living/silicon/ai)
...
obj
	structure
		transit_tube
			station
				pod_stopped(obj/structure/transit_tube_pod/pod, from_dir)
					pod_moving = 1
					spawn(5)
