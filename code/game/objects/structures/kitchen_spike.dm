...
obj
	structure
		kitchenspike
			user_buckle_mob(mob/living/M, mob/living/user) //Don't want them getting put on the rack other than by spiking
				return

obj
	structure
		kitchenspike
			user_unbuckle_mob(mob/living/carbon/human/user)
