	...
	structure
		falsewall
			...
			obj
				structure
					falsewall
						reinforced,  // WHY DO WE SMOOTH WITH FALSE R-WALLS WHEN WE DON'T SMOOTH WITH REAL R-WALLS. //because we do smooth with real r-walls now
			turf
				simulated
					wall
						rust,
			...
			proc
				dismantle(mob/user)
					...
					if(mineral == "metal")
						...
						var
							P = text2path("/obj/item/stack/sheet/mineral/[mineral]")
						new P(loc)
						new P(loc)
