	...
	structure
		girder
			...
			var
				health = 200
			var
				metalUsed = 2 //used to determine amount returned in deconstruction

obj
	structure
		girder
			proc
				refundMetal(metalAmount) //refunds metal used in construction when deconstructed
