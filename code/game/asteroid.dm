var
	global
		list
			possiblethemes = list("organharvest","cult","wizden","cavein","xenoden","hitech","speakeasy","plantlab")
...
proc
	spawn_room(var/atom/start_loc, var/x_size, var/y_size, var/list/walltypes, var/floor, var/name)
		var
			list
				room_turfs = list("walls"=list(),"floors"=list())
			...
			for(var/y = 0, y < y_size, y++) //sets it on y axis.
				var
					turf
						T
				var
					cur_loc = locate(start_loc.x + x, start_loc.y + y, start_loc.z)
				...
				if(x == 0 || x == x_size-1 || y == 0 || y == y_size-1)
					var
						wall = pickweight(walltypes)//totally-solid walls are pretty boring.
					T = cur_loc
					T.ChangeTurf(wall)
					room_turfs["walls"] += T
...
proc
	make_mining_asteroid_secret()
		...
		var
			list
				walltypes = list(/turf/simulated/wall=3, /turf/simulated/mineral/random=1)
		var
			list
				floortypes = list(/turf/simulated/floor)
		var
			list
				treasureitems = list()//good stuff. only 1 is created per room.
		var
			list
				fluffitems = list()//lesser items, to help fill out the room and enhance the theme.
		...
		switch(pick(possiblethemes))//what kind of room is this gonna be?
			if("organharvest")
				...
				fluffitems = list(/obj/effect/decal/cleanable/blood=5,/obj/item/organ/internal/appendix=2,/obj/structure/closet/crate/freezer=2,
										obj
											machinery
												optable=1,/obj/item/weapon/scalpel=1,/obj/item/weapon/storage/firstaid/regular=3,
										obj
											item
												weapon
													tank
														anesthetic=1, /obj/item/weapon/surgical_drapes=2, /obj/item/device/mass_spectrometer/adv=1,/obj/item/clothing/glasses/hud/health=1)
				...
				treasureitems = list(/obj/item/device/soulstone=1, /obj/item/clothing/suit/space/cult=1, /obj/item/weapon/bedsheet/cult=2,
										obj
											item
												clothing
													suit
														cultrobes=2, /mob/living/simple_animal/hostile/creature=3)
				fluffitems = list(/obj/effect/gateway=1,/obj/effect/gibspawner=1,/obj/structure/cult/talisman=1,/obj/item/toy/crayon/red=2,
										obj
											item
												organ
													internal
														heart=2, /obj/effect/decal/cleanable/blood=4,/obj/structure/table/woodentable=2,/obj/item/weapon/ectoplasm=3,
										obj
											item
												clothing
													head
														helmet
															space
																cult=1, /obj/item/clothing/shoes/cult=1)
			...
			if("wizden")
								...
								obj
									item
										weapon
											spellbook
												oneuse
													forcewall=1, /obj/item/weapon/spellbook/oneuse/smoke=1, /obj/structure/constructshell = 1, /obj/item/toy/katana=3,/obj/item/voodoo=3)
				fluffitems = list(/obj/structure/safe/floor=1,/obj/structure/dresser=1,/obj/item/weapon/storage/belt/soulstone=1,/obj/item/trash/candle=3,
										obj
											item
												weapon
													dice=3,/obj/item/weapon/twohanded/staff=2,/obj/effect/decal/cleanable/dirt=3,/obj/item/weapon/coin/mythril=3)
				...
				treasureitems = list(/obj/mecha/working/ripley/mining=1, /obj/item/weapon/pickaxe/drill/diamonddrill=2,/obj/item/weapon/gun/energy/kinetic_accelerator/hyper=1,
								obj
									item
										weapon
											resonator
												upgraded=1, /obj/item/weapon/pickaxe/drill/jackhammer=5)
												...
												weapon
													reagent_containers
														food
															snacks
																grown
																	chili=1,/obj/item/weapon/tank/oxygen/red=2)
										...
										obj
											item
												weapon
													stock_parts
														matter_bin
															super=3,/obj/item/weapon/stock_parts/manipulator/pico=3,
										obj
											item
												weapon
													stock_parts
														capacitor
															super=3,/obj/item/device/pda/clear=1, /obj/effect/decal/mecha_wreckage/phazon=1)
			...
			if("speakeasy")
				...
				obj
					machinery
						reagentgrinder=2, /obj/machinery/computer/security/wooden_tv=4, /obj/machinery/vending/coffee=3)
											...
											item
												weapon
													reagent_containers
														food
															drinks
																shaker=1,/obj/item/weapon/reagent_containers/food/drinks/bottle/wine=3,
										obj
											item
												weapon
													reagent_containers
														food
															drinks
																bottle
																	whiskey=3,/obj/item/clothing/shoes/laceup=2)
			...
			if("plantlab")
				...
				obj
					item
						seeds
							coffeerseed=2, /obj/item/seeds/stobaccoseed=2)
				fluffitems = list(/obj/item/weapon/twohanded/required/kirbyplants=1,/obj/structure/table/reinforced=2,/obj/machinery/portable_atmospherics/hydroponics=1,
										obj
											effect
												glowshroom
													single=2,/obj/item/weapon/reagent_containers/syringe/charcoal=2,
										obj
											item
												weapon
													reagent_containers
														glass
															bottle
																diethylamine=3,/obj/item/weapon/reagent_containers/glass/bottle/ammonia=3)
