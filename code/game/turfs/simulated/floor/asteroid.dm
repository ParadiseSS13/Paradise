...
/turf/simulated/floor/plating/asteroid/airless/cave/volcanic
	mob_spawn_list = list(/obj/effect/landmark/mob/goliath = 50, /obj/structure/spawner/lavaland/goliath = 3,
		/obj/effect/landmark/mob/watcher = 40, /obj/structure/spawner/lavaland = 2,
		/obj/effect/landmark/mob/legion = 30, /obj/structure/spawner/lavaland/legion = 3,
		SPAWN_MEGAFAUNA = 6, /obj/effect/landmark/mob/goldgrub = 10)
