...
var
	list
		icons_to_ignore_at_floor_init = list("damaged1","damaged2","damaged3","damaged4",
...
turf
	simulated
		floor
			...
			var
				icon_regular_floor = "floor" //used to remember what icon the tile should have by default
			var
			...
			var
				burnt = 0
			var
				floor_tile = null //tile that this floor drops
			var
				obj
					item
						stack
							tile
								builtin_tile = null //needed for performance reasons when the singularity rips off floor tiles
			var
				list
...
turf
	simulated
		floor
			ChangeTurf(turf/simulated/floor/T)
				...
				var
					old_icon = icon_regular_floor
				var
					old_plating = icon_plating
				var
					old_dir = dir
				var
					turf
