...
turf
	unsimulated
		beach
			sand
				New()			//adds some aesthetic randomness to the beach sand
					...
					canSmoothWith = list(
						turf
							unsimulated
								beach
									water
										drop, /turf/unsimulated/beach/water/drop/dense,
						turf
							unsimulated
								beach
									water, /turf/unsimulated/beach/water/dense,
						turf
							unsimulated
								beach
									water
