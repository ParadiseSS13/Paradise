...
obj
	machinery
		apiary
			...
			var
				list
					owned_bee_swarms = list()
			var
				hydrotray_type = /obj/machinery/portable_atmospherics/hydroponics
