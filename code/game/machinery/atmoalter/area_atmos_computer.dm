	...
	machinery
		computer
			area_atmos
				...
				var
					zone = "This computer is working on a wireless range, the range is currently limited to 25 meters."
							...
							obj
								machinery
									portable_atmospherics
										scrubber
											huge
												scrubber = locate(href_list["scrub"])
