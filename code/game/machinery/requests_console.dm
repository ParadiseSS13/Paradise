...
/obj/machinery/requests_console/Topic(href, href_list)
	...
	if( href_list["department"] && message )
		...
		if(pass)
			...
			audible_message(text("[bicon(src)] *The Requests Console beeps: '<b>NOTICE:</b> No server detected!'"), null, 4)
	...
	if(href_list["printLabel"])
		...
		if(error_message)
			audible_message(text("[bicon(src)] *The Requests Console beeps: '<b>NOTICE:</b> [error_message]'"), null, 4)
			return
