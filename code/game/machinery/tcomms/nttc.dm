...
/datum/nttc_configuration
	...
	var/all_jobs = list(
		...
		"Federation General" = "dsquadradio",
		"Federation Representative" = "dsquadradio",
		"Federation MARSOC Lieutenant" = "dsquadradio",
		"Federation MARSOC Marine" = "dsquadradio",
		"Federation Lieutenant" = "dsquadradio",
		"Federation Marine" = "dsquadradio",
