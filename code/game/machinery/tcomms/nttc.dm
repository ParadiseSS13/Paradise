...
/datum/nttc_configuration
	...
	var/all_jobs = list(
		...
		"Blueshield" = "comradio",
		"Blueshield Officer" = "comradio",
		"Bodyguard" = "comradio",
		"Command Escort" = "comradio",
		"Captain" = "comradio",
		"Station Commander" = "comradio",
		"Admiral" = "comradio",
		"Commanding Officer" = "comradio",
		"Nanotrasen Representative" = "comradio",
		// Engineeering
		"Atmospheric Technician" = "engradio",
		"Firefighter" = "engradio",
		"Chief Engineer" = "engradio",
		"Engineering Director" = "engradio",
		"Senior Engineer" = "engradio",
		"Chief Foreman" = "engradio",
		...
		"Medical Director" = "medradio",
		"Senior Physician" = "medradio",
		"Coroner" = "medradio",
		"Mortician" = "medradio",
		...
		"Physician" = "medradio",
		"Paramedic" = "medradio",
		"Emergency Medical Technician" = "medradio",
		"First Responder" = "medradio",
		"Rescue Technician" = "medradio",
		...
		"Geneticist" = "sciradio",
		"Genetic Researcher" = "sciradio",
		"Mechatronic Engineer" = "sciradio",
		"Plasma Researcher" = "sciradio",
		"Research Director" = "sciradio",
		"Senior Researcher" = "sciradio",
		"Chief Research Officer" = "sciradio",
		"Roboticist" = "sciradio",
		"Scientist" = "sciradio",
		...
		// Security
		"Detective" = "secradio",
		"Investigator" = "secradio",
		"Forensic Technician" = "secradio",
		"Head of Security" = "secradio",
		"Security Director" = "secradio",
		"Security Marshal" = "secradio",
		...
		"Chief Logistics Officer" = "supradio",
		"Requisitions Supervisor" = "supradio",
		"Cargo Technician" = "supradio",
		"Mail Carrier" = "supradio",
		"Courier" = "supradio",
		"Logistics Technician" = "supradio",
		"Requisitions Specialist" = "supradio",
		"Smith" = "supradio",
		...
		"Head of Service" = "srvradio",
		"Crew Relations Officer" = "srvradio",
		"Bartender" = "srvradio",
		"Barkeep" = "srvradio",
		"Waiter" = "srvradio",
		"Brewmaster" = "srvradio",
		...
		"Deacon" = "srvradio",
		"Reverend" = "srvradio",
		"Occult Specialist" = "srvradio",
		"Paranormal Specialist" = "srvradio",
		"Rabbi" = "srvradio",
		"Monk" = "srvradio",
		"Kannushi" = "srvradio",
		"Chef" = "srvradio",
