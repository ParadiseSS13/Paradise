...
obj
	machinery
		doppler_array
			proc
				sense_explosion(var/x0,var/y0,var/z0,var/devastation_range,var/heavy_impact_range,var/light_impact_range,
																		var
																			took,var/orig_dev_range,var/orig_heavy_range,var/orig_light_range)
					...
					var
						list
							messages = list("Explosive disturbance detected.", \
