...
/obj/machinery/economy/vending/medidrobe
	...
	products = list(/obj/item/clothing/under/rank/medical/doctor = 3,
					...
					/obj/item/clothing/head/beret/md = 3,
					/obj/item/clothing/head/beret/md_alt = 3,
	...
	prices = list(/obj/item/clothing/under/rank/medical/doctor = 50,
				...
				/obj/item/clothing/head/beret/md = 20,
				/obj/item/clothing/head/beret/md_alt = 20,
...
/obj/machinery/economy/vending/traindrobe
	...
	products = list(
		...
		/obj/item/clothing/head/beret/md = 2,
		/obj/item/clothing/head/beret/chem = 2,
		/obj/item/clothing/head/beret/viro = 2,
