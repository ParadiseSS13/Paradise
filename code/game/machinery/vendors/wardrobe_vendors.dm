...
/obj/machinery/economy/vending/capdrobe
	...
	products = list(
		/obj/item/clothing/head/caphat = 2,
		/obj/item/clothing/head/caphat/parade = 2,
		/obj/item/clothing/head/caphat/parade/white = 2,
		/obj/item/clothing/head/beret/captain = 2,
		/obj/item/clothing/head/beret/captain/white = 2,
		...
		/obj/item/clothing/under/rank/captain = 2,
		/obj/item/clothing/under/rank/captain/skirt = 2,
		/obj/item/clothing/under/rank/captain/white = 2,
		/obj/item/clothing/under/rank/captain/skirt/white = 2,
