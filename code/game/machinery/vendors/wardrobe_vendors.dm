...
/obj/machinery/economy/vending/secdrobe
	...
	products = list(
		/obj/item/clothing/under/rank/security/officer/corporate = 4,
	...
	contraband = list(
		/obj/item/clothing/head/helmet/street_judge = 1,
	...
	prices = list(
		/obj/item/clothing/under/rank/security/officer/corporate = 50,
...
/obj/machinery/economy/vending/detdrobe
	...
	category = VENDOR_TYPE_CLOTHING
	ads_list = list(
		"Apply your brilliant deductive methods in style!",
	...
	prices = list(
		/obj/item/clothing/under/rank/security/detective = 50,
...
/obj/machinery/economy/vending/medidrobe
	...
	products = list(
		...
		/obj/item/clothing/head/beret/med_alt = 3,
		...
		/obj/item/clothing/head/cowboyhat/med = 4,
	...
	contraband = list(
		/obj/item/toy/figure/crew/md = 1,
		/obj/item/toy/figure/crew/cmo = 1,
	)

	prices = list(
		/obj/item/clothing/under/rank/medical/doctor = 50,
		...
		/obj/item/clothing/head/beret/med_alt = 20,
		...
		/obj/item/clothing/head/cowboyhat/med = 50,
...
/obj/machinery/economy/vending/virodrobe
	...
	category = VENDOR_TYPE_CLOTHING
	ads_list = list(
		"Viruses getting you down? Nothing a change of clothes can't fix!",
	...
	products = list(
		...
		/obj/item/clothing/head/beret/viro = 2,
		/obj/item/clothing/head/beret/viro_alt = 2,
		/obj/item/clothing/head/beret/viro_green = 2,
	...
	prices = list(
		/obj/item/clothing/under/rank/medical/virologist = 50,
		/obj/item/clothing/under/rank/medical/virologist/skirt = 50,
		/obj/item/clothing/head/beret/viro = 20,
		/obj/item/clothing/head/beret/viro_alt = 20,
		/obj/item/clothing/head/beret/viro_green = 20,
...
/obj/machinery/economy/vending/chemdrobe
	...
	products = list(
		...
		/obj/item/clothing/head/beret/chem_alt = 2,
		/obj/item/clothing/head/beret/chem_orange = 2,
	...
	prices = list(
		/obj/item/clothing/under/rank/medical/chemist = 50,
		/obj/item/clothing/under/rank/medical/chemist/skirt = 50,
		/obj/item/clothing/head/beret/chem = 20,
		/obj/item/clothing/head/beret/chem_alt = 20,
		/obj/item/clothing/head/beret/chem_orange = 20,
...
/obj/machinery/economy/vending/genedrobe
	...
	products = list(
		/obj/item/clothing/under/rank/rnd/geneticist = 3,
	...
	prices = list(
		/obj/item/clothing/under/rank/rnd/geneticist = 50,
...
/obj/machinery/economy/vending/scidrobe
	...
	category = VENDOR_TYPE_CLOTHING
	ads_list = list(
		"Longing for the smell of plasma burnt flesh?",
	...
	products = list(
		...
		/obj/item/clothing/head/cowboyhat/research = 4,
	...
	contraband = list(
		/obj/item/toy/figure/crew/rd = 1,
		/obj/item/toy/figure/crew/scientist = 1,
	)

	prices = list(
		/obj/item/clothing/under/rank/rnd/scientist = 50,
		...
		/obj/item/clothing/head/cowboyhat/research = 50,
...
/obj/machinery/economy/vending/robodrobe
	...
	contraband = list(
		/obj/item/toy/figure/crew/roboticist = 1,
		/obj/item/toy/figure/crew/borg = 1,
	)

	prices = list(
		/obj/item/clothing/under/rank/rnd/roboticist = 50,
...
/obj/machinery/economy/vending/engidrobe
	...
	products = list(
		/obj/item/clothing/under/rank/engineering/engineer = 6,
		...
		/obj/item/clothing/head/cowboyhat/engie = 4,
	...
	contraband = list(
		/obj/item/toy/figure/crew/ce = 1,
		/obj/item/toy/figure/crew/engineer = 1,
	)

	prices = list(
		/obj/item/clothing/under/rank/engineering/engineer = 50,
		...
		/obj/item/clothing/head/cowboyhat/engie = 50,
...
/obj/machinery/economy/vending/atmosdrobe
	...
	category = VENDOR_TYPE_CLOTHING
	ads_list = list(
		"Guaranteed to protect your feet from atmospheric accidents!",
		"Get your inflammable clothing right here!",
	)

	vend_reply = "Thank you for using the AtmosDrobe!"
	products = list(
		/obj/item/clothing/under/rank/engineering/atmospheric_technician = 6,
	...
	prices = list(
		/obj/item/clothing/under/rank/engineering/atmospheric_technician = 50,
...
/obj/machinery/economy/vending/cargodrobe
	...
	category = VENDOR_TYPE_CLOTHING
	ads_list = list(
		"Upgraded Assistant Style! Pick yours today!",
		"These shorts are comfy and easy to wear, get yours now!",
	)

	vend_reply = "Thank you for using the CargoDrobe!"
	products = list(
		/obj/item/clothing/under/rank/cargo/tech = 6,
		...
		/obj/item/clothing/head/hardhat/orange = 2,
		/obj/item/clothing/head/cowboyhat/supply = 4,
	...
	contraband = list(
		/obj/item/toy/figure/crew/qm = 1,
		/obj/item/toy/figure/crew/cargotech = 1,
	)

	prices = list(
		/obj/item/clothing/under/rank/cargo/tech = 50,
		...
		/obj/item/clothing/head/hardhat/orange = 30,
		/obj/item/clothing/head/cowboyhat/supply = 50,
		/obj/item/clothing/gloves/fingerless = 20,
...
/obj/machinery/economy/vending/minedrobe
	...
	products = list(
		/obj/item/clothing/under/rank/cargo/miner/lavaland/overalls = 3,
	...
	prices = list(
		/obj/item/clothing/under/rank/cargo/miner/lavaland/overalls = 50,
...
/obj/machinery/economy/vending/exploredrobe
	...
	products = list(
		/obj/item/clothing/under/rank/cargo/expedition = 3,
	...
	prices = list(
		/obj/item/clothing/under/rank/cargo/expedition = 50,
...
/obj/machinery/economy/vending/bardrobe
	...
	prices = list(
		/obj/item/clothing/under/rank/civilian/bartender = 50,
...
/obj/machinery/economy/vending/hydrodrobe
	...
	category = VENDOR_TYPE_CLOTHING
	ads_list = list(
		"Do you love soil? Then buy our clothes!",
	...
	products = list(
		...
		/obj/item/clothing/suit/storage/labcoat/hydro/alt = 3,
		...
		/obj/item/clothing/head/cowboyhat/hydro = 3,
	...
	prices = list(
		/obj/item/clothing/under/rank/civilian/hydroponics = 50,
		...
		/obj/item/clothing/suit/storage/labcoat/hydro/alt = 75,
		...
		/obj/item/clothing/head/cowboyhat/hydro = 20,
...
/obj/machinery/economy/vending/janidrobe
	...
	prices = list(
		/obj/item/clothing/under/rank/civilian/janitor = 50,
...
/obj/machinery/economy/vending/lawdrobe
	...
	products = list(
		/obj/item/clothing/under/rank/procedure/iaa = 2,
	...
	prices = list(
		/obj/item/clothing/under/rank/procedure/iaa = 50,
...
/obj/machinery/economy/vending/chapdrobe
	...
	products = list(
		/obj/item/clothing/under/rank/civilian/chaplain = 3,
	...
	prices = list(
		/obj/item/clothing/under/rank/civilian/chaplain = 50,
