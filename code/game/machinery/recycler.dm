...
/obj/machinery/recycler/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/material_container, list(MAT_WOOD, MAT_PLASTIC, MAT_METAL, MAT_GLASS, MAT_PLASMA, MAT_SILVER, MAT_GOLD, MAT_TITANIUM, MAT_URANIUM, MAT_DIAMOND, MAT_BLUESPACE, MAT_BANANIUM, MAT_TRANQUILLITE), 0, TRUE, null, null, null, TRUE)
