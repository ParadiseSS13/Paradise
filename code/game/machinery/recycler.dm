...
/obj/machinery/recycler/examine(mob/user)
	...
	. += "The operation light is [emergency_mode ? "<b>off</b>. \The [src] has detected a forbidden object with its sensors, and has shut down temporarily." : "<b>on</b>. \The [src] is functioning normally."]"
