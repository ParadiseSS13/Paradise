...
obj
	machinery
		light_switch
			...
			var
				light_connect = 1							//Allows the switch to control lights in its associated areas. When set to 0, using the switch won't affect the lights.
			var
				datum
					radio_frequency
						radio_connection
			var
				frequency = 0
			var
				logic_id_tag = "default"					//Defines the ID tag to send logic signals to.
			var
				logic_connect = 0							//Set this to allow the switch to send out logic signals.
