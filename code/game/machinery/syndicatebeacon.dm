	...
	machinery
		syndicate_beacon
			...
			attack_hand(var/mob/user as mob)
				usr.set_machine(src)
				var
					dat = "<font color=#005500><i>Scanning [pick("retina pattern", "voice print", "fingerprints", "dna sequence")]...<br>Identity confirmed,<br></i></font>"
				...
				if(href_list["betraitor"])
					...
					if(istype(M, /mob/living/carbon/human))
						...
						var
							datum
								objective
									custom_objective = new(objective)
