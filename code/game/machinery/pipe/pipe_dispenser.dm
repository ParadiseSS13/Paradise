					...
					if(!wait)
						...
						var
							obj
								item
									pipe
										P = new (/*usr.loc*/ src.loc, pipe_type=p_type, dir=p_dir)
						P.update()
...
obj
	machinery
		pipedispenser
			disposal
				Crossed(var/obj/structure/disposalconstruct/pipe as obj)
...
obj
	machinery
		pipedispenser
			disposal
				MouseDrop_T(var/obj/structure/disposalconstruct/pipe as obj, mob/usr as mob)
