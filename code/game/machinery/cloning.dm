...
/obj/item/paper/Cloning
	...
	<p>Clone profiles may be viewed through the profiles menu. Scanning implants a complementary HEALTH MONITOR BIOCHIP into the subject, which may be viewed from each profile.
