	...
	switch(state)
		...
		if(2)
			...
			if(istype(P, /obj/item/wirecutters))
				...
				state = 1
				icon_state = "box_0"
				var/obj/item/stack/cable_coil/low_voltage/A = new /obj/item/stack/cable_coil/low_voltage(src.loc,5)
				A.amount = 5
				return
		if(3)
...
/obj/item/circuitboard/slot_machine
	...
	req_components = list(
							/obj/item/stack/cable_coil/low_voltage = 3,
...
/obj/item/circuitboard/power_compressor
	...
	req_components = list(
							/obj/item/stack/cable_coil/high_voltage = 5,
...
/obj/item/circuitboard/tcomms/relay
	...
	req_components = list(/obj/item/stock_parts/manipulator = 2, /obj/item/stack/cable_coil/low_voltage = 2)
