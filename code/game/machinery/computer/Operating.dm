	...
	machinery
		computer
			operating
				...
				var
					verbose = 1 //general speaker toggle
				var
					patientName = null
				var
					oxyAlarm = 30 //oxy damage at which the computer will beep
				var
					choice = 0 //just for going into and out of the options menu
				var
					healthAnnounce = 1 //healther announcer toggle
				var
					crit = 1 //crit beeping toggle
				var
					nextTick = OP_COMPUTER_COOLDOWN
				var
					healthAlarm = 50
				var
					oxy = 1 //oxygen beeping toggle
...
obj
	machinery
		computer
			operating
				ui_interact(mob/user, ui_key = "main", var/datum/nanoui/ui = null, var/force_open = 1)//ui is mostly copy pasta from the sleeper ui
					var
						data[0]
					var
						mob
