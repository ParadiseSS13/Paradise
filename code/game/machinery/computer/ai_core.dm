				...
				switch(state)
								...
								var
									obj
										item
											stack
												cable_coil
													A = new /obj/item/stack/cable_coil( loc )
								A.amount = 5
					...
					if(4)
						...
						if(istype(P, /obj/item/weapon/screwdriver))
							...
							if(!brain)
								var
									open_for_latejoin = alert(user, "Would you like this core to be open for latejoining AIs?", "Latejoin", "Yes", "Yes", "No") == "Yes"
								var
									obj
										structure
											AIcore
								...
								var
									mob
										living
											silicon
												ai
													A = new /mob/living/silicon/ai ( loc, laws, brain )
...
client
	proc
		empty_ai_core_toggle_latejoin()
			...
			var
				id = input("Which core?", "Toggle AI Core Latejoin", null) as null|anything in cores
			if(!id) return
