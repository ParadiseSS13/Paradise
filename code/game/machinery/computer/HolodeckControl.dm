...
obj
	machinery
		computer
			HolodeckControl
				proc
					derez(var/obj/obj , var/silent = 1)
...
obj
	machinery
		computer
			HolodeckControl
				proc
					togglePower(var/toggleOn = 0)

						if(toggleOn)
							var
								area
									targetsource = locate(/area/holodeck/source_emptycourt)
...
active = 1
		...
		var
			area
				targetsource = locate(/area/holodeck/source_plating)
