...
/obj/machinery/computer/robotics/Topic(href, href_list)
	...
	// Locks or unlocks the cyborg
		...
		if(target.connected_ai)
			to_chat(target.connected_ai, "[!target.lockcharge ? "<span class='notice'>NOTICE - Cyborg lockdown lifted</span>" : "<span class='alert'>ALERT - Cyborg lockdown detected</span>"]: <a href='?src=\ref[target.connected_ai];track=[lhtml_encode(target.name)]'>[target.name]</a></span><br>")
