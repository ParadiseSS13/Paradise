		...
		weapon
			circuitboard
				rdconsole
					...
					var
						access_types = list("R&D Core", "Robotics", "E.X.P.E.R.I-MENTOR", "Mechanics", "Public")
					id = 1
obj
	item
		weapon
				...
				supplycomp
					attackby(obj/item/I as obj, mob/user as mob, params)
						if(istype(I,/obj/item/device/multitool))
							var
								catastasis = src.contraband_enabled
							var
								opposite_catastasis
							if(catastasis)
					...
					attackby(obj/item/I as obj, mob/user as mob, params)
						if(istype(I,/obj/item/weapon/card/id)||istype(I, /obj/item/device/pda))
							if(allowed(user))
								...
								var
									console_choice = input(user, "What do you want to configure the access to?", "Access Modification", "R&D Core") as null|anything in access_types
				...
				switch(state)
							...
							var
								obj
									item
										stack
											cable_coil
												A = new /obj/item/stack/cable_coil( src.loc )
							A.amount = 5
					...
					if(4)
						...
						if(istype(P, /obj/item/weapon/screwdriver))
							...
							var
								B = new src.circuit.build_path ( src.loc )
