...
/obj/machinery/computer/security/New() // Lists existing networks and their required access. Format: networks[<name>] = list(<access>)
	networks["SS13"] =              list(access_commander,access_captain)
	networks["Telecomms"] =         list(access_commander,access_captain)
	networks["Research Outpost"] =  list(access_rd,access_commander,access_captain)
	networks["Mining Outpost"] =    list(access_qm,access_hop,access_commander,access_captain)
	networks["Research"] =          list(access_rd,access_commander,access_captain)
	networks["Prison"] =            list(access_commander,access_captain)
	networks["Labor"] =             list(access_commander,access_captain)
	networks["Interrogation"] =     list(access_commander,access_captain)
	networks["Atmosphere Alarms"] = list(access_ce,access_commander,access_captain)
	networks["Fire Alarms"] =       list(access_ce,access_commander,access_captain)
	networks["Power Alarms"] =      list(access_ce,access_commander,access_captain)
	networks["Supermatter"] =       list(access_ce,access_commander,access_captain)
	networks["MiniSat"] =           list(access_rd,access_commander,access_captain)
	networks["Singularity"] =       list(access_ce,access_commander,access_captain)
	networks["Anomaly Isolation"] = list(access_rd,access_commander,access_captain)
	networks["Toxins"] =            list(access_rd,access_commander,access_captain)
	networks["Telepad"] =           list(access_rd,access_commander,access_captain)
	networks["TestChamber"] =       list(access_rd,access_commander,access_captain)
