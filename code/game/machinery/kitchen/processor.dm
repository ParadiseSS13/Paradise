...
datum
	food_processor_process
		proc
			process_food(loc, what, obj/machinery/processor/processor)
...
datum
	food_processor_process
		mob
			process_food(loc, what, processor)
				..()
