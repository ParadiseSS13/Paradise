...
obj
	machinery
		smartfridge
			MouseDrop_T(obj/over_object as obj, mob/user as mob)
		...
		smartfridge
			Topic(href, href_list)
				...
				var
					datum
						nanoui
							ui = nanomanager.get_open_ui(user, src, "main")
