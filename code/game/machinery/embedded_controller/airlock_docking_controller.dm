	...
	computer
		file
			embedded_program
				docking
					airlock
						New(var/obj/machinery/embedded_controller/M, var/datum/computer/file/embedded_program/airlock/docking/A)
							..(M)
							airlock_program = A
			...
			embedded_program
				docking
					airlock
						ready_for_undocking()
							var
								ext_closed = airlock_program.check_exterior_door_secured()
							var
								int_closed = airlock_program.check_interior_door_secured()
