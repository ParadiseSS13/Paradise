/obj/machinery/space_heater
	name = "space heater"
	desc = "A free-standing mobile space heater for heating rooms, featuring a temperature adjustment dial and an easy-swap power cell holder (both hidden behind a screwed-on panel)."
