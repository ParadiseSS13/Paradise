...
obj
	machinery
		door
			firedoor
				attackby(obj/item/weapon/C as obj, mob/user as mob, params)
					...
					var
						alarmed = A.air_doors_activated || A.fire
					...
					var
						answer = alert(user, "Are you sure you want to [density ? "open" : "close"] \the [src]?","\The [src] confirmation","Yes","No")
					if(answer == "No")
						return
