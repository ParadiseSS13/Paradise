...
/obj/machinery/door_timer/proc/print_report()
	...
	if(R)
		...
		if(istype(M) && M.wear_id)
			if(istype(M.wear_id,/obj/item/card/id))
				var/obj/item/card/id/I = M.wear_id
				rank = I.assignment
			else if(istype(M.wear_id,/obj/item/pda))
				var/obj/item/pda/P = M.wear_id
				if(P.id)
					var/obj/item/card/id/I = P.id
					rank = I.assignment
		else if(istype(M) && (M.l_hand || M.r_hand))
			if(istype(M.l_hand,/obj/item/card/id))
				var/obj/item/card/id/I = M.l_hand
				rank = I.assignment
			else if(istype(M.r_hand,/obj/item/card/id))
				var/obj/item/card/id/I = M.r_hand
				rank = I.assignment
