...
/obj/machinery/door_timer/proc/clear_data()
	comittedcrimes = null
	detaineename = null
	return 1

///////////////////////////////////////////////////////CELL LOGS AND ACCOUNTABILITY/////////////////////////////////////////////////
...
/obj/machinery/door_timer/proc/print_report() //Printing Cell Logs
 	for(var/obj/machinery/computer/prisoner/C in prisoncomputer_list)
 			...
 			P.info += {"<center><b><h3>[id] - Brig record</h3></b></center>
 						...
 						<br>This log file was generated automatically upon activation of a cell timer.<hr>"}
...
/obj/machinery/door_timer/proc/clearstringandtime() //Updating comitted crimes string list
	...
	for(var/datum/spacelaw/C in comittedcrimes)
		...
		suggestedbrigtime += (C.max_brig * C.maxM_brig)
...
/obj/machinery/door_timer/proc/add_charge(mob/user) //Adding Charges
	...
	switch(alert("Select Space Law Category.", "Space Law", "Crimes", "Modifiers", "Custom", "Abort"))
		...
		if("Custom")
			detaineecrimes = input(usr, "What would you like to charge [detaineename] with?") as null|text
			if(!isnull(detaineecrimes))
				suggestedbrigtime = input(usr, "For how long would you like to brig [detaineename] for?") as num
				return
		if("Abort")
			return
...
/obj/machinery/door_timer/interact(mob/user)
	...
	if(screen)//Main Menu
		dat += {"<br><b>Detainee Name:</b><a href='?src=[UID()];pickname=1'>[detaineename]</a><a href='?src=[UID()];pickname=1'>Set Name</a><br><br>
	...
	if(!screen) //Prisoner Menu
		...
		dat += {"<center><b><h2>Current Detainee Information</h2></b><hr></center><br><b>Detainee Name:	</b>[detaineename]<br><b>Charged with violation of:	</b><br>[detaineecrimes]
				<br><b>Duration brigged:	</b>[suggestedbrigtime]<br><b>Brigged by:	</b>[usr.name]"}
...
/obj/machinery/door_timer/Topic(href, href_list)
	...
	if(href_list["timingstart"])
		to_chat(usr,detaineecrimes, detaineename)
	...
	if(href_list["timingstop"])
		switch(alert("Are you sure you wish to stop the cell timer? It will clear all data", "Stop Cell Timer?","Stop", "Abort"))
			if("Stop")
				timer_end()
			if("Abort")
				return
