...
obj
	machinery
		door
			...
			var
				open_layer = DOOR_OPEN_LAYER
			var
				closed_layer = DOOR_CLOSED_LAYER
			...
			var
				normalspeed = 1
			var
				heat_proof = 0 // For glass airlocks/opacity firedoors
			var
				emergency = 0
			var
				air_properties_vary_with_direction = 0
			var
				block_air_zones = 1 //If set, air zones cannot merge across the door even when it is opened.
