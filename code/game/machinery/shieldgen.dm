...
/obj/machinery/shieldgen/attackby(var/obj/item/W, mob/user, params)
...
/obj/structure/shieldwall/syndicate
	name = "energy shield"
	desc = "A strange energy shield."
	icon_state = "shield-red"

/obj/structure/shieldwall/syndicate/CanPass(atom/movable/mover, turf/target, height=0)
	if(isliving(mover))
...
/obj/structure/shieldwall/syndicate/CanAStarPass(ID, to_dir, caller)
	if(isliving(caller))
...
/obj/structure/shieldwall/syndicate/proc/phaseout()
...
/obj/structure/shieldwall/syndicate/Bumped(atom/user)
	phaseout()
	return ..()

/obj/structure/shieldwall/syndicate/attackby(obj/item/W, mob/user, params)
	phaseout()
	return ..()

/obj/structure/shieldwall/syndicate/bullet_act(obj/item/projectile/Proj)
	phaseout()
	return ..()

/obj/structure/shieldwall/syndicate/ex_act(severity)
	phaseout()
	return ..()

/obj/structure/shieldwall/syndicate/emp_act(severity)
	phaseout()
	return ..()

/obj/structure/shieldwall/syndicate/attack_hand(mob/user)
	phaseout()
	return ..()

/obj/structure/shieldwall/syndicate/hitby(AM as mob|obj)
	phaseout()
	return ..()
