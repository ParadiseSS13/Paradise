...
/mob/living/silicon/ai/proc/get_camera_list(mob/user as mob, ui_key = "main", var/datum/nanoui/ui = null, var/force_open = 1)
	var/data[0]
	...
	if (!ui)
		ui = new(user, src, ui_key, "sec_camera.tmpl", "Camera List", 900, 800)
