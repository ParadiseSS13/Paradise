obj
	machinery
		optable
			...
			buckle_lying = 90
			var
				no_icon_updates = 0 //set this to 1 if you don't want the icons ever changing
						...
						var
							mob
								living
									carbon
										human
											M = locate(/mob/living/carbon/human, src.loc)
						if(M.lying)
							src.victim = M
							if(!no_icon_updates)
...
obj
	machinery
		optable
			proc
				take_victim(mob/living/carbon/C, mob/living/carbon/user as mob)
					if(C == user)
...
obj
	machinery
		optable
			attackby(obj/item/weapon/W as obj, mob/living/carbon/user as mob, params)
...
obj
	machinery
		optable
			proc
				check_table(mob/living/carbon/patient as mob)
