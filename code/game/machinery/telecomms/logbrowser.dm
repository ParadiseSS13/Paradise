				...
				server
						...
						if(1)
								...
								for(var/datum/comm_log_entry/C in SelectedServer.log_entries)
									...
									if(C.input_type == "Speech File")
										...
										var
											race			   // The actual race of the mob
										var
											language = "Human" // MMIs, pAIs, Cyborgs and humans all speak Human
										var
					...
					Topic(href, href_list)
						...
						if(href_list["network"])
							...
							var
								newnet = input(usr, "Which network do you want to view?", "Comm Monitor", network) as null|text
										...
										obj
											item
												weapon
													circuitboard
														comm_server
															M = new /obj/item/weapon/circuitboard/comm_server( A )
