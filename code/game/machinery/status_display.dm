...
obj
	machinery
		status_display
			...
			var
				picture_state	// icon_state of alert picture
			var
				message1 = ""	// message line 1
			var
				message2 = ""	// message line 2
			var
				index1			// display index for scrolling messages or 0 if non-scrolling
			var
				index2
			...
			var
				friendc = 0      // track if Friend Computer mode
			var
				ignore_friendc = 0
			...
			var
				const
					STATUS_DISPLAY_BLANK = 0
			var
				const
					STATUS_DISPLAY_TRANSFER_SHUTTLE_TIME = 1
			var
				const
					STATUS_DISPLAY_MESSAGE = 2
			var
				const
					STATUS_DISPLAY_ALERT = 3
			var
				const
					STATUS_DISPLAY_TIME = 4
			var
				const
					STATUS_DISPLAY_CUSTOM = 99
...
obj
	machinery
		status_display
			proc
				update_display(line1, line2, warning = 0)
					var
						new_text = {"<div style="font-size:[FONT_SIZE];color:[warning ? WARNING_FONT_COLOR : FONT_COLOR];font:'[FONT_STYLE]';text-align:center;" valign="top">[line1]<br>[line2]</div>"}
					if(maptext != new_text)
						maptext = new_text
...
obj
	machinery
		ai_status_display
			...
			var
				picture_state	// icon_state of ai picture
