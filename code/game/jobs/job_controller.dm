 ...
 **/
	...
	proc/EquipRank(var/mob/living/carbon/human/H, var/rank, var/joined_late = 0)
		...
		to_chat(H, "<b>For more information on how the station works, see https://nanotrasen.se/wiki/index.php/Standard_Operating_Procedure</b>")
		if(job.is_service)
			to_chat(H, "<b>As a member of Service, make sure to read up on https://nanotrasen.se/wiki/index.php/Standard_Operating_Procedure_&#40;Service&#41</b>")
		if(job.is_supply)
			to_chat(H, "<b>As a member of Supply, make sure to read up on https://nanotrasen.se/wiki/index.php/Standard_Operating_Procedure_&#40;Supply&#41</b>")
		if(job.is_command)
			to_chat(H, "<b>As an important member of Command, read up on https://nanotrasen.se/wiki/index.php/Standard_Operating_Procedure_&#40;Command&#41</b>")
		if(job.is_legal)
			to_chat(H, "<b>Your job requires complete knowledge of Space Law (https://nanotrasen.se/wiki/index.php/Space_law) and Legal Standard Operating Procedure (https://nanotrasen.se/wiki/index.php/Legal_Standard_Operating_Procedure)</b>")
		if(job.is_engineering)
			to_chat(H, "<b>As a member of Engineering, make sure to read up on https://nanotrasen.se/wiki/index.php/Standard_Operating_Procedure_&#40;Engineering&#41</b>")
		if(job.is_medical)
			to_chat(H, "<b>As a member of Medbay, make sure to read up on https://nanotrasen.se/wiki/index.php/Standard_Operating_Procedure_&#40;Medical&#41</b>")
		if(job.is_science)
			to_chat(H, "<b>As a member of Science, make sure to read up on https://nanotrasen.se/wiki/index.php/Standard_Operating_Procedure_&#40;Science&#41</b>")
		if(job.is_security)
			to_chat(H, "<b>As a member of Security, you are to know Space Law (https://nanotrasen.se/wiki/index.php/Space_law), Legal Standard Operating Procedure (https://nanotrasen.se/wiki/index.php/Legal_Standard_Operating_Procedure), as well as https://nanotrasen.se/wiki/index.php/Standard_Operating_Procedure_&#40;Security&#41</b>")
