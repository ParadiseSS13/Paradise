...
/datum/job_objective/further_research
	...
	description = "Utilize the facilities on this research installation to increase half the station's research levels above level 3, have cargo ship the research to centcomm in crates."
	gives_payout = TRUE
