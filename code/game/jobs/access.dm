...
/proc/get_syndicate_access(job)
	switch(job)
		if("Syndicate Operative")
			return list(ACCESS_SYNDICATE, ACCESS_SYNDICATE_ELITE)
		...
		if("Syndicate Officer")
			return list(ACCESS_SYNDICATE, ACCESS_SYNDICATE_ELITE, ACCESS_SYNDICATE_COMMAND)
...
/proc/get_all_syndicate_access()
	return list(ACCESS_SYNDICATE, ACCESS_SYNDICATE_ELITE, ACCESS_VOX, ACCESS_SYNDICATE_COMMAND)
