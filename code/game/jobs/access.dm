#define ALL_STATION_ACCESSES list(	\
	...
	ACCESS_CHEMISTRY, ACCESS_PARAMEDIC, ACCESS_SURGERY, ACCESS_VIROLOGY, ACCESS_PSYCHIATRIST, ACCESS_MEDICAL, ACCESS_MORGUE, \ // MEEDICAL
	ACCESS_GENETICS, ACCESS_ROBOTICS, ACCESS_RESEARCH, ACCESS_TOX_STORAGE, ACCESS_XENOBIOLOGY, ACCESS_XENOARCH,	ACCESS_TOX, \ // SCIENCE
	ACCESS_EVA, ACCESS_EXPEDITION, ACCESS_MAINT_TUNNELS, ACCESS_THEATRE, \ // GENERAL | PUBLIC
	)
