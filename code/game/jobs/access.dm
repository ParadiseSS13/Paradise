...
/proc/get_all_accesses()
	return list(ACCESS_MINISAT, ACCESS_AI_UPLOAD,  ACCESS_ARMORY, ACCESS_ATMOSPHERICS, ACCESS_BAR, ACCESS_SEC_DOORS, ACCESS_BLUESHIELD,
				...
				ACCESS_COURT, ACCESS_CONSTRUCTION, ACCESS_CONTROL_ROOM, ACCESS_CREMATORIUM, ACCESS_JANITOR, ACCESS_ENGINEER, ACCESS_EVA, ACCESS_EXTERNAL_AIRLOCKS, ACCESS_FORENSICS_LOCKERS,
				...
				ACCESS_LAWYER, ACCESS_LIBRARY, ACCESS_MAGISTRATE, ACCESS_MAINTENANCE_TECH, ACCESS_MAINT_TUNNELS, ACCESS_HEADS_VAULT, ACCESS_MEDICAL, ACCESS_MIME,
...
/proc/get_region_accesses(code)
	switch(code)
		...
		if(REGION_ENGINEERING) //engineering and maintenance
			return list(ACCESS_CONSTRUCTION, ACCESS_MAINT_TUNNELS, ACCESS_ENGINEER, ACCESS_ENGINE_EQUIP, ACCESS_EXTERNAL_AIRLOCKS, ACCESS_TECH_STORAGE, ACCESS_ATMOSPHERICS, ACCESS_MINISAT, ACCESS_CE, ACCESS_MAINTENANCE_TECH, ACCESS_CONTROL_ROOM)
...
/proc/get_access_desc(A)
	switch(A)
		...
		if(ACCESS_MAINTENANCE_TECH)
			return "Maintenance Technician"
		if(ACCESS_CONTROL_ROOM)
