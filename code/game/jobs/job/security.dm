...
/datum/job/officer
	...
	equip(var/mob/living/carbon/human/H)
		...
		H.equip_or_collect(new /obj/item/clothing/shoes/jackboots(H), slot_shoes)
		H.equip_or_collect(new /obj/item/clothing/suit/armor/vest/security/modern(H), slot_wear_suit)
		H.equip_to_slot_or_del(new /obj/item/clothing/head/helmet/modern(H), slot_head)
