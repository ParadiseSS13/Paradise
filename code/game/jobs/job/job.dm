...
/datum/job/proc/after_spawn(mob/living/carbon/human/H)
	...
	if(is_security | is_supply)
		setskill(H,"strength", roll_dice(2,FALSE,FALSE,8))
		setskill(H,"intelligence", roll_dice(4,FALSE,FALSE,1))
		setskill(H,"wisdom",roll_dice(4,FALSE,FALSE,2))
		setskill(H,"dexterity",roll_dice(20,FALSE,FALSE,1))
	if(is_science)
		setskill(H,"strength", roll_dice(2,FALSE,FALSE,2))
		setskill(H,"intelligence", roll_dice(2,FALSE,FALSE,8))
		setskill(H,"wisdom",roll_dice(2,FALSE,FALSE,2))
		setskill(H,"dexterity",roll_dice(20,FALSE,FALSE,1))
	if(is_engineering)
		setskill(H,"strength", roll_dice(2,FALSE,FALSE,4))
		setskill(H,"intelligence", roll_dice(2,FALSE,FALSE,3))
		setskill(H,"wisdom",roll_dice(2,FALSE,FALSE,8))
		setskill(H,"dexterity",roll_dice(20,FALSE,FALSE,1))
	if(is_medical)
		setskill(H,"strength", roll_dice(2,FALSE,FALSE,4))
		setskill(H,"intelligence", roll_dice(2,FALSE,FALSE,6))
		setskill(H,"wisdom",roll_dice(2,FALSE,FALSE,5))
		setskill(H,"dexterity",roll_dice(20,FALSE,FALSE,1))
	if(spawn_ert)
		setskill(H,"strength", roll_dice(10,FALSE,FALSE,2))
		setskill(H,"intelligence", roll_dice(10,FALSE,FALSE,2))
		setskill(H,"wisdom",roll_dice(10,FALSE,FALSE,2))
		setskill(H,"dexterity",roll_dice(20,FALSE,FALSE,1))
	if(is_command)
		setskill(H,"strength", roll_dice(2,FALSE,FALSE,5))
		setskill(H,"intelligence", roll_dice(2,FALSE,FALSE,5))
		setskill(H,"wisdom",roll_dice(2,FALSE,FALSE,5))
		setskill(H,"dexterity",roll_dice(2,FALSE,FALSE,5))
	if(title == "Assistant")
		setskill(H,"strength", roll_dice(10,FALSE,FALSE,1))
		setskill(H,"intelligence", roll_dice(10,FALSE,FALSE,1))
		setskill(H,"wisdom",roll_dice(8,FALSE,FALSE,1))
		setskill(H,"dexterity",roll_dice(20,FALSE,FALSE,1))
	if(title == "Clown")
	...
	if(title == "Roboticist")
		setskill(H,"intelligence", roll_dice(2,FALSE,FALSE,6))
		setskill(H,"wisdom",roll_dice(2,FALSE,FALSE,6))
		setskill(H,"dexterity",roll_dice(2,FALSE,FALSE,6))
	if(title == "Geneticist")
		setskill(H,"intelligence", roll_dice(2,FALSE,FALSE,6))
		setskill(H,"wisdom",roll_dice(2,FALSE,FALSE,6))
		setskill(H,"dexterity",roll_dice(2,FALSE,FALSE,6))
