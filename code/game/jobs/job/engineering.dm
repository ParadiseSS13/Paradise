...
/datum/job/mechanic
	...
	department_head = list("Chief Engineer")
	selection_color = "#fff5cc"
	access = list(access_engine, access_engine_equip, access_tech_storage, access_maint_tunnels, access_mechanic, access_external_airlocks, access_mineral_storeroom, access_eva, access_construction)
	minimal_access = list(access_maint_tunnels, access_emergency_storage, access_mechanic, access_external_airlocks, access_mineral_storeroom, access_eva, access_construction)
