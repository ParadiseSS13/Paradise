		...
		chaplain
			...
			equip(var/mob/living/carbon/human/H)
					...
					obj
						item
							weapon
								storage
									bible
										B = new /obj/item/weapon/storage/bible(H) //BS12 EDIT
				...
				spawn(0)
					...
					var
						new_religion = sanitize(copytext(input(H, "You are the crew services officer. Would you like to change your religion? Default is Christianity, in SPACE.", "Name change", religion_name),1,MAX_NAME_LEN))
				...
				spawn(1)
					...
					var
						new_deity = sanitize(copytext(input(H, "Would you like to change your deity? Default is Space Jesus.", "Name change", deity_name),1,MAX_NAME_LEN))
