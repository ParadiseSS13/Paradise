...
/datum/job/blueshield
	...
	access = list(ACCESS_SECURITY, ACCESS_SEC_DOORS, ACCESS_BRIG, ACCESS_COURT, ACCESS_FORENSICS_LOCKERS,
						...
						ACCESS_RD, ACCESS_CE, ACCESS_CMO, ACCESS_HOS, ACCESS_CAPTAIN)
	minimal_access = list(ACCESS_FORENSICS_LOCKERS, ACCESS_SEC_DOORS, ACCESS_MEDICAL, ACCESS_CONSTRUCTION, ACCESS_ENGINE, ACCESS_MAINT_TUNNELS, ACCESS_RESEARCH,
						ACCESS_RC_ANNOUNCE, ACCESS_KEYCARD_AUTH, ACCESS_HEADS, ACCESS_BLUESHIELD, ACCESS_WEAPONS, ACCESS_HOP, ACCESS_RD, ACCESS_CE, ACCESS_CMO,
						ACCESS_HOS, ACCESS_CAPTAIN)
