...
/datum/job/judge
	...
	important_information = "This role requires you to oversee legal matters and make important decisions about sentencing. You are required to have an extensive knowledge of Station Law and Security SOP and only operate within, not outside, the boundaries of the law."
...
/datum/job/lawyer
	...
	important_information = "Your job is to deal with affairs regarding Standard Operating Procedure. You are NOT in charge of Station Law affairs, nor can you override it. You are not a prisoner defence lawyer."
