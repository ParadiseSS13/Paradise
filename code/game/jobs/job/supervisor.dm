...
/datum/job/ntinstructor
	...
	minimal_access = list(ACCESS_TRAINER, ACCESS_LAWYER, ACCESS_SEC_DOORS, ACCESS_MAINT_TUNNELS, ACCESS_RESEARCH, ACCESS_MEDICAL, ACCESS_CONSTRUCTION, ACCESS_MAILSORTING)
	mentor_only = TRUE
	transfer_allowed = FALSE
