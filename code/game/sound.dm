...
/proc/get_sfx(soundin)
	if(istext(soundin))
		switch(soundin)
			...
			if("smcalm")
				soundin = pick('sound/creatures/dog_yelp.ogg', 'sound/goonstation/voice/female_scream.ogg', 'sound/goonstation/voice/male_scream.ogg', 'sound/goonstation/voice/monkey_scream.ogg', 'sound/goonstation/voice/robot_scream.ogg', 'sound/voice/scream_moth.ogg', 'sound/voice/shriek1.ogg', 'sound/voice/wilhelmscream.ogg')
			if("smdelam")
				soundin = pick('sound/creatures/dog_yelp.ogg', 'sound/goonstation/voice/female_scream.ogg', 'sound/goonstation/voice/male_scream.ogg', 'sound/goonstation/voice/monkey_scream.ogg', 'sound/goonstation/voice/robot_scream.ogg', 'sound/voice/scream_moth.ogg', 'sound/voice/shriek1.ogg', 'sound/voice/wilhelmscream.ogg')
	return soundin
