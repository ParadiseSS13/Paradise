...
datum
	directive
		terminations
			var
				list
					accounts_to_revoke = list()
			var
				list
					accounts_to_suspend = list()
			var
				list
...
hook
	revoke_payroll
		proc
			payroll_directive(datum/money_account/account)
				var
					datum
						directive
							terminations
								D = get_directive("terminations")
				if(!D) return 1
...
hook
	change_account_status
		proc
			suspension_directive(datum/money_account/account)
				var
					datum
						directive
							terminations
...
hook
	terminate_employee
		proc
			termination_directive(obj/item/weapon/card/id)
				var
					datum
						directive
							terminations
