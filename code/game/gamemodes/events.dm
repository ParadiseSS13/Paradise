proc
	alien_infestation(var/spawncount = 1) // -- TLE
		...
		spawn()
			var
				list
					candidates = pollCandidates("Do you want to play as an alien?", ROLE_ALIEN, 1)
...
proc
	lightsout(isEvent = 0, lightsoutAmount = 1,lightsoutRange = 25) //leave lightsoutAmount as 0 to break ALL lights
		if(isEvent)
