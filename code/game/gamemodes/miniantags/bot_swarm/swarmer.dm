...
/mob/living/simple_animal/hostile/swarmer/Login()
	...
	to_chat(src, "3. <span class='warning'>Biological and Sentient resources will be harvested at a later date, Do not actively seek to confront them. Defending yourself from direct attack is still permitted.</span>")
