	...
	surgery_step
		internal
			extract_organ
				...
				var
					list
						organ_types = list(/obj/item/organ/internal/heart)

datum
	surgery_step
		internal
			extract_organ
				begin_step(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery)
...
datum
	surgery_step
		internal
			extract_organ
				end_step(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery)
					var
						mob
							living
								carbon
