				...
				abductor
					...
					var
						datum
							action
								teleport_self
									tele_self_action = new
					var
						datum
							action
								vest_mode_swap
									vest_mode_action = new
					var
						datum
							action
								vest_disguise_swap
									vest_disguise_action = new
					var
						datum
							action
								set_droppoint
									set_droppoint_action = new
					var
						obj
							machinery
								abductor
...
obj
	machinery
		computer
			camera_advanced
				abductor
					GrantActions(mob/living/carbon/user)
	...
	machinery
		computer
			camera_advanced
				abductor
					proc
						IsAbductor(mob/living/carbon/human/H)
	...
	machinery
		computer
			camera_advanced
				abductor
					proc
						IsScientist(mob/living/carbon/human/H)
