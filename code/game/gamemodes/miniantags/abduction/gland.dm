							...
							var
								mob
									living
										carbon
											slime
												Slime = new/mob/living/carbon/slime(get_turf(owner))
				...
				gland
					pop
						activate()
							...
							var
								species = pick("Unathi","Skrell","Diona","Tajaran","Vulpkanin","Kidan","Grey","Diona")
				...
				gland
					viral
						activate()
							...
							var
								virus_type = pick(/datum/disease/beesease, /datum/disease/brainrot, /datum/disease/magnitis)
							var
								datum
									disease
										D = new virus_type()
...
obj
	item
		organ
			internal
				gland
					emp //TODO : Replace with something more interesting
						origin_tech = "materials=4;biotech=5;magnets=3;abductor=3"
						cooldown_low = 900
						cooldown_high = 1600
						uses = 10
...
obj
	effect
		cocoon
			abductor
				proc
					Copy(mob/living/carbon/human/H)
						var
							mob
								living
									carbon
						...
						var
							list
								slots = list(slot_back,slot_w_uniform,slot_wear_suit,\
