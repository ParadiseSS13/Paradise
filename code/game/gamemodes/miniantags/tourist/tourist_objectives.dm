...
/datum/objective/tourist/comedy_fan
	explanation_text = "You love clowns! Make sure to always laugh when they do any jokes, perhaps you could earn a picture from that?"
...
/datum/objective/tourist/fire_safety
    explanation_text = "You're paranoid about safety! Make sure to verify if the station has enough fire extinguisers, and if fire drills occur often."
...
/datum/objective/tourist/job_seeker
    explanation_text = "You are seeking a job opportunity on the station! Talk to at least three department heads about potential job openings and document their responses."
...
/datum/objective/tourist/entrepreneur
    explanation_text = "Start your own small business on the station. Find a suitable location, gather necessary supplies, and attract at least three customers."

/datum/objective/tourist/prisoner_visitation
    explanation_text = "You are curious about life behind bars. Visit the brig and have a conversation with a prisoner. Learn their story and document your experience."
