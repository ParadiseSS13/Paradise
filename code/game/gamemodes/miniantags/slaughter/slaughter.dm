	...
	living
		simple_animal
			slaughter
				...
				var
					feast_sound = 'sound/misc/Demon_consume.ogg'
				var
					...
					slaughterWhisper()
						...
						var
							mob
								living
									carbon
										M = input(src,"Who do you wish to talk to?") in null|choices
						spawn(0)
							var
	...
	objective
		demonFluff
			New()
				...
				var
					list
						explanationTexts = list("Attempt to make your presence unknown to the crew.", \
