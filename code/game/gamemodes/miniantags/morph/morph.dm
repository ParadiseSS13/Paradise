...
/mob/living/simple_animal/hostile/morph
	...
	var/playstyle_string = "<b><font size=3 color='red'>You are a morph.</font><br> As an abomination created primarily with changeling cells, \
							...
							less damage. In addition, anyone within three tiles will note an uncanny wrongness if examining you.<br> \
							You can attack any item or dead creature to consume it - creatures will restore 1/3 of your max health.<br> \
