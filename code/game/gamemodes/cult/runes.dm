...
/obj/effect/rune/convert/proc/do_sacrifice(mob/living/offering, list/invokers)
	...
	for(var/M in invokers)
		if(sacrifice_fulfilled)
			...
			if((ishuman(offering) && offering.mind?.offstation_role && offering.mind.special_role != SPECIAL_ROLE_ERT) || HAS_MIND_TRAIT(offering, TRAIT_ENLIGHTENED_HUMAN)) //If you try it on a ghost role, or an envolved caterpillar/nymph, you get nothing
