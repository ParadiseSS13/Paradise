...
/obj/item/melee/cultblade/dagger/attack(mob/living/M, mob/living/user)
	if(iscultist(M))
		if(M.reagents && M.reagents.has_reagent(/datum/reagent/holywater)) //allows cultists to be rescued from the clutches of ordained religion
			if(M == user) // Targeting yourself
				...
				var/amount = M.reagents.get_reagent_amount(/datum/reagent/holywater)
				M.reagents.del_reagent(/datum/reagent/holywater)
				M.reagents.add_reagent(/datum/reagent/fuel/unholywater, amount)
