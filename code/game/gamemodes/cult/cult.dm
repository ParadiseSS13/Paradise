...
/datum/game_mode/cult
	name = "cult"
	config_tag = "cult"
	protected_jobs = list("Chaplain", "AI", "Cyborg", "NTSF Officer", "NTSF Warden", "NTSF Investigator", "NTSF Commander", "Captain", "Blueshield", "Nanotrasen Representative", "NTSF Pilot", "Magistrate", "NTSF Medic", "Internal Affairs Agent", "Nanotrasen Navy Officer", "Special Operations Officer")
	protected_jobs = list()
	required_players = 30
	required_enemies = 3
