datum
	intercept_text
		...
		/*
		var
			prob_correct_person_lower = 20
		var
			prob_correct_person_higher = 80
		var
			prob_correct_job_lower = 20
		var
			prob_correct_job_higher = 80
		var
			prob_correct_prints_lower = 20
		var
			prob_correct_print_higher = 80
		var
			prob_correct_objective_lower = 20
		var
			prob_correct_objective_higher = 80
		*/
		var
			list
				org_names_1 = list(
...
datum
	intercept_text
		proc
			build(var/mode_type, datum/mind/correct_person)
				switch(mode_type)
					if("revolution")
						src.text = ""
...
datum
	intercept_text
		proc
			build_traitor(datum/mind/correct_person)
				var
					name_1 = pick(src.org_names_1)
				var
					name_2 = pick(src.org_names_2)
				...
				var
					fingerprints = num2text(md5(H.dna.uni_identity))
				var
					traitor_name = H.real_name
				var
					prob_right_dude = rand(1, 100)
...
datum
	intercept_text
		proc
			build_cult(datum/mind/correct_person)
				var
					name_1 = pick(src.org_names_1)
				var
					name_2 = pick(src.org_names_2)
...
datum
	intercept_text
		proc
			build_rev(datum/mind/correct_person)
				var
					name_1 = pick(src.org_names_1)
				var
					name_2 = pick(src.org_names_2)
...
datum
	intercept_text
		proc
			build_wizard(datum/mind/correct_person)
				var
					SWF_desc = pick(SWF_names)
...
datum
	intercept_text
		proc
			build_nuke(datum/mind/correct_person)
...
datum
	intercept_text
		proc
			build_malf(datum/mind/correct_person)
				var
					a_name = pick(src.anomalies)
...
datum
	intercept_text
		proc
			build_changeling(datum/mind/correct_person)
				var
					cname = pick(src.changeling_names)
				var
					orgname1 = pick(src.org_names_1)
				var
					orgname2 = pick(src.org_names_2)
				/*
				var
					changeling_name
				var
					changeling_job
				var
					prob_right_dude = rand(prob_correct_person_lower, prob_correct_person_higher)
				var
					prob_right_job = rand(prob_correct_job_lower, prob_correct_job_higher)
