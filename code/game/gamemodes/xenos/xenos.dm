...
datum
	game_mode
		xenos
			...
			var
				gammaratio = 4 //At what alien to human ratio will the Gamma security level be called and the nuke be made available?
	...
	game_mode
		xenos
			can_start()
				...
				var
					list
						candidates = get_players_for_role(ROLE_ALIEN)
				var
					playersready = 0
				var
							...
							obj
								machinery
									door
										airlock
											vault
												V = locate(/obj/machinery/door/airlock/vault) in world
