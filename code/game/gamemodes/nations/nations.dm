datum
	game_mode
		nations
			...
			var
				list
					cargonians = list("Quartermaster","Cargo Technician","Shaft Miner")
			var
				list
					servicion = list("Clown", "Mime", "Bartender", "Chef", "Botanist", "Librarian", "Chaplain", "Barber")
...
hook
	latespawn
		proc
			give_latejoiners_nations(var/mob/living/carbon/human/H)
				var
					datum
						game_mode
							nations
...
datum
	game_mode
		proc
			update_nations_icons_added(datum/mind/nations_mind,var/naticon)
				var
					datum
						atom_hud
							antag
								nations_hud = huds[GAME_HUD_NATIONS]
...
datum
	game_mode
		proc
			update_nations_icons_removed(datum/mind/nations_mind)
				var
					datum
						atom_hud
							antag
