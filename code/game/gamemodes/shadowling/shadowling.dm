...
/datum/game_mode/proc/greet_shadow(var/datum/mind/shadow)
	...
	to_chat(shadow.current, "<b>If you are new to shadowling, or want to read about abilities, check the wiki page at https://nsscyberiad.net/wiki/index.php/Shadowling</b><br>")
