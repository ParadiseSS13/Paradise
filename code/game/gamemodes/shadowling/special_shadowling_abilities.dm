...
var
	list
		possibleShadowlingNames = list("U'ruan", "Y`shej", "Nex", "Hel-uae", "Noaey'gief", "Mii`mahza", "Amerziox", "Gyrg-mylin", "Kanet'pruunance", "Vigistaezian") //Unpronouncable 2: electric boogalo)
obj
	effect
		proc_holder
			spell
					...
					shadowling_hatch
						cast(list/targets)
							...
							for(var/mob/living/carbon/human/H in targets)
								var
									hatch_or_no = alert(H,"Are you sure you want to hatch? You cannot undo this!",,"Yes","No")
								switch(hatch_or_no)
									if("No")
									...
									if("Yes")
										...
										var
											newNameId = pick(possibleShadowlingNames)
				...
				targeted
					shadowling_ascend
						cast(list/targets)
							...
							for(H in targets)
								var
									hatch_or_no = alert(H,"It is time to ascend. Are you sure about this?",,"Yes","No")
								switch(hatch_or_no)
									if("No")
									...
									if("Yes")
										...
										var
											mob
												A = new /mob/living/simple_animal/ascendant_shadowling(H.loc)
