...
obj
	item
		weapon
			antag_spawner
				proc
					spawn_antag(var/client/C, var/turf/T, var/type = "")
						return
			...
			antag_spawner
				borg_tele
					attack_self(mob/user as mob)
						...
						var
							list
								borg_candidates = pollCandidates("Do you want to play as a Syndicate [borg_to_spawn] borg?", ROLE_OPERATIVE, 1)
...
obj
	item
		weapon
			antag_spawner
				slaughter_demon //Warning edgiest item in the game
					name = "vial of blood"
					...
					var
						veil_msg = "<span class='warning'>You sense a dark presence lurking \
					...
					var
						mob
							living
								demon_type = /mob/living/simple_animal/slaughter
			...
			antag_spawner
				slaughter_demon
					attack_self(mob/user as mob)
						...
						var
							list
								candidates = pollCandidates("Do you want to play as a slaughter demon summoned by [user.real_name]?", ROLE_DEMON, 1, 100)
...
obj
	item
		weapon
			antag_spawner
				slaughter_demon
					spawn_antag(var/client/C, var/turf/T, var/type = "", mob/user as mob)
						...
						var
							datum
								objective
									assassinate
										KillDaWiz = new /datum/objective/assassinate
						...
						var
							datum
								objective
									KillDaCrew = new /datum/objective
