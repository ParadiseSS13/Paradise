...
/datum/game_mode/proc/remove_revolutionary(datum/mind/rev_mind , beingborged)
	if(rev_mind in revolutionaries)
		...
		if(beingborged)
			rev_mind.current << "<span class='warning'><FONT size = 3><B>The frame's firmware detects and deletes your neural reprogramming!  You remember nothing from the moment you were flashed until now.</B></FONT></span>"
			message_admins("[key_name_admin(rev_mind.current)] has been borged while being a member of the revolution.")
		else
			rev_mind.current << "<span class='warning'><FONT size = 3><B>You have been brainwashed! You are no longer a revolutionary! Your memory is hazy from the time you were a rebel...the only thing you remember is the name of the one who brainwashed you...</B></FONT></span>"
...
/datum/game_mode/revolution/declare_completion()
	if(finished == 1)
		...
		world << "<span class='warning'><FONT size = 3><B> The heads of staff were killed or abandoned the station! The revolutionaries win!</B></FONT></span>"
	else if(finished == 2)
