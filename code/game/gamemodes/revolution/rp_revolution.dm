...
/datum/game_mode/revolution/rp_revolution/declare_completion()
	if(finished == 1)
		...
		world << "<span class='warning'><FONT size = 3><B> The heads of staff were overthrown! The revolutionaries win!</B></FONT></span>"
	else if(finished == 2)
		feedback_set_details("round_end_result","loss - revolution stopped")
		world << "<span class='warning'><FONT size = 3><B> The heads of staff managed to stop the revolution!</B></FONT></span>"
	..()
	return 1
