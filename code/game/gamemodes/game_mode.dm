...
/datum/game_mode/proc/replace_jobbanned_player(mob/living/M, role_type)
	...
	if(length(candidates))
		...
		to_chat(M, "<span class='biggerdanger'>You have been converted into [role_type] with an active jobban. Your body was offered up but there were no ghosts to take over. You are allowed to play as [role_type], but any further violations of the rules on your part are likely to result in a permanent ban.</span>")
