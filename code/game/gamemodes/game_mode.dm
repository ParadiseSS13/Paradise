...
/datum/game_mode/proc/declare_completion()
	...
	if(escaped_on_shuttle > 0)
		SSblackbox.set_val("escaped_on_shuttle",escaped_on_shuttle)
	if(escaped_on_pod_1 > 0)
		SSblackbox.set_val("escaped_on_pod_1",escaped_on_pod_1)
	if(escaped_on_pod_2 > 0)
		SSblackbox.set_val("escaped_on_pod_2",escaped_on_pod_2)
	if(escaped_on_pod_3 > 0)
		SSblackbox.set_val("escaped_on_pod_3",escaped_on_pod_3)
	if(escaped_on_pod_5 > 0)
		SSblackbox.set_val("escaped_on_pod_5",escaped_on_pod_5)
