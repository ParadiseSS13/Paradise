...
/datum/game_mode/blob/proc/stage(var/stage)
	...
	switch(stage)
		...
		if(1)
			event_announcement.Announce("Confirmed outbreak of level 5 biohazard aboard [using_map.station_name]. All personnel must contain the outbreak.", "Biohazard Alert", 'sound/AI/outbreak5.ogg')
