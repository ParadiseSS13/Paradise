...
/datum/game_mode/blob/declare_completion()
	if(blobwincount <= blobs.len)
		feedback_report("round_end_result","win - blob took over")
		...
		feedback_report("round_end_result","halfwin - blob nuked")
		...
		feedback_report("round_end_result","loss - blob eliminated")
