...
/obj/item/contract/proc/equip_apprentice(action, mob/living/carbon/human/M, mob/living/carbon/human/H)
	...
	switch(action)
		if("fire")
			...
			to_chat(M, "<B>Your service has not gone unrewarded, however. Studying under [H.real_name], you have learned the basics of Fire bending. You are able to cast Fireball, Sacred Flame and Ethereal Jaunt.")
			to_chat(M, "<B>You are immune to fire, but you are NOT immune to the explosions caused by your fireballs. Neither is your teacher, for that matter. Be careful!")
		if("translocation")
		...
		if("stealth")
			...
			to_chat(M, "<B>Your service has not gone unrewarded, however. Studying under [H.real_name], you have learned stealthy, robeless spells. You are able to cast Mindswap, Knock, Homing Toolbox, Forcewall and Instant Summons, without needing wizard robes.")
		if("honk")
