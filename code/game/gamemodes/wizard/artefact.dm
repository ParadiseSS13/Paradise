...
/obj/item/necromantic_stone/examine(mob/user)
	...
	if(cooldown_time_left)
		. += "[src] is being strained by the amount of risen skeletons thralls. It cannot be used to rise another skeleton thrall for <b>[DisplayTimeText(cooldown_time_left)]</b>."
