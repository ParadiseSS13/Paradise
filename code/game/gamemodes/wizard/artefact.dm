...
/obj/item/multisword/proc/equip_copy(mob/living/carbon/human/M)
	...
	if(duplicate_self)
		...
		var/obj/mask = H.get_item_by_slot(SLOT_HUD_MASK)
		if(mask)
			M.equip_to_slot_or_del(new mask.type(M), SLOT_HUD_MASK)

		var/obj/glasses = H.get_item_by_slot(SLOT_HUD_EYES)
		if(glasses)
			M.equip_to_slot_or_del(new glasses.type(M), SLOT_HUD_EYES)
		...
		var/obj/uniform = H.get_item_by_slot(SLOT_HUD_ICLOTHING)
		if(uniform)
			M.equip_to_slot_or_del(new uniform.type(M), SLOT_HUD_ICLOTHING)

		var/obj/suit = H.get_item_by_slot(SLOT_HUD_OCLOTHING)
		if(suit)
			M.equip_to_slot_or_del(new suit.type(M), SLOT_HUD_OCLOTHING)

		var/obj/gloves = H.get_item_by_slot(SLOT_HUD_GLOVES)
		if(gloves)
			M.equip_to_slot_or_del(new gloves.type(M), SLOT_HUD_GLOVES)

		var/obj/shoes = H.get_item_by_slot(SLOT_HUD_FEET)
		if(shoes)
			M.equip_to_slot_or_del(new shoes.type(M), SLOT_HUD_FEET)

		var/obj/belt = H.get_item_by_slot(SLOT_HUD_BELT)
		if(belt)
			M.equip_to_slot_or_del(new belt.type(M), SLOT_HUD_BELT)

		var/obj/pda = H.get_item_by_slot(SLOT_HUD_PDA)
		if(pda)
			M.equip_to_slot_or_del(new pda.type(M), SLOT_HUD_PDA)
		...
		var/obj/left_pocket = H.get_item_by_slot(SLOT_HUD_LEFT_POCKET)
		if(left_pocket)
			M.equip_to_slot_or_del(new left_pocket.type(M), SLOT_HUD_LEFT_POCKET)

		var/obj/right_pocket = H.get_item_by_slot(SLOT_HUD_RIGHT_POCKET)
		if(right_pocket)
			M.equip_to_slot_or_del(new right_pocket.type(M), SLOT_HUD_RIGHT_POCKET)
		...
		if(istajaran(M) || isunathi(M))
			M.equip_to_slot_or_del(new /obj/item/clothing/shoes/sandal(M), SLOT_HUD_FEET)	//If they can't wear shoes, give them a pair of sandals.
		...
		switch(randomize)
			if("mobster")
				...
				M.equip_to_slot_or_del(new /obj/item/clothing/shoes/laceup(M), SLOT_HUD_FEET)
				...
				M.equip_to_slot_or_del(new /obj/item/clothing/glasses/sunglasses(M), SLOT_HUD_EYES)
				M.equip_to_slot_or_del(new /obj/item/clothing/under/suit/really_black(M), SLOT_HUD_ICLOTHING)
				M.equip_to_slot_or_del(sword, SLOT_HUD_RIGHT_HAND)

			if("roman")
				var/hat = pick(/obj/item/clothing/head/helmet/roman, /obj/item/clothing/head/helmet/roman/legionaire)
				M.equip_to_slot_or_del(new hat(M), SLOT_HUD_HEAD)
				M.equip_to_slot_or_del(new /obj/item/clothing/under/costume/roman(M), SLOT_HUD_ICLOTHING)
				M.equip_to_slot_or_del(new /obj/item/clothing/shoes/roman(M), SLOT_HUD_FEET)
				M.equip_to_slot_or_del(new /obj/item/shield/riot/roman(M), SLOT_HUD_LEFT_HAND)
				M.equip_to_slot_or_del(sword, SLOT_HUD_RIGHT_HAND)

			if("wizard")
				M.equip_to_slot_or_del(new /obj/item/clothing/under/color/lightpurple(M), SLOT_HUD_ICLOTHING)
				M.equip_to_slot_or_del(new /obj/item/clothing/suit/wizrobe/red(M), SLOT_HUD_OCLOTHING)
				M.equip_to_slot_or_del(new /obj/item/clothing/shoes/sandal(M), SLOT_HUD_FEET)
				M.equip_to_slot_or_del(new /obj/item/radio/headset(M), SLOT_HUD_LEFT_EAR)
			...
			if("cyborg")
				...
				M.equip_to_slot_or_del(new /obj/item/clothing/glasses/thermal/eyepatch(M), SLOT_HUD_EYES)
				M.equip_to_slot_or_del(sword, SLOT_HUD_RIGHT_HAND)

			if("syndicate")
				M.equip_to_slot_or_del(new /obj/item/clothing/under/syndicate(M), SLOT_HUD_ICLOTHING)
				M.equip_to_slot_or_del(new /obj/item/clothing/shoes/combat(M), SLOT_HUD_FEET)
				...
				M.equip_to_slot_or_del(new /obj/item/radio/headset(M), SLOT_HUD_LEFT_EAR)
				M.equip_to_slot_or_del(new /obj/item/clothing/suit/armor/vest(M), SLOT_HUD_OCLOTHING)
				M.equip_to_slot_or_del(new /obj/item/clothing/mask/gas(M),SLOT_HUD_MASK)
				M.equip_to_slot_or_del(sword, SLOT_HUD_RIGHT_HAND)

			if("assistant")
				M.equip_to_slot_or_del(new /obj/item/clothing/under/color/grey(M), SLOT_HUD_ICLOTHING)
				M.equip_to_slot_or_del(new /obj/item/radio/headset(M), SLOT_HUD_LEFT_EAR)
				M.equip_to_slot_or_del(new /obj/item/clothing/shoes/black(M), SLOT_HUD_FEET)
				M.equip_to_slot_or_del(sword, SLOT_HUD_RIGHT_HAND)
			...
			if("animu")
				...
				M.equip_to_slot_or_del(new /obj/item/clothing/under/dress/schoolgirl(M), SLOT_HUD_ICLOTHING)
				M.equip_to_slot_or_del(sword, SLOT_HUD_RIGHT_HAND)

			if("cultist")
				M.equip_to_slot_or_del(new /obj/item/clothing/suit/hooded/cultrobes/alt(M), SLOT_HUD_OCLOTHING)
				M.equip_to_slot_or_del(new /obj/item/clothing/shoes/cult(M), SLOT_HUD_FEET)
				M.equip_to_slot_or_del(new /obj/item/radio/headset(M), SLOT_HUD_LEFT_EAR)
				M.equip_to_slot_or_del(sword, SLOT_HUD_RIGHT_HAND)

			if("highlander")
				M.equip_to_slot_or_del(new /obj/item/clothing/under/costume/kilt(M), SLOT_HUD_ICLOTHING)
				M.equip_to_slot_or_del(new /obj/item/radio/headset(M), SLOT_HUD_LEFT_EAR)
			...
			if("clown")
				M.equip_to_slot_or_del(new /obj/item/clothing/under/rank/civilian/clown(M), SLOT_HUD_ICLOTHING)
				M.equip_to_slot_or_del(new /obj/item/radio/headset(M), SLOT_HUD_LEFT_EAR)
				M.equip_to_slot_or_del(new /obj/item/clothing/shoes/clown_shoes(M), SLOT_HUD_FEET)
				M.equip_to_slot_or_del(new /obj/item/clothing/mask/gas/clown_hat(M), SLOT_HUD_MASK)
				M.equip_to_slot_or_del(new /obj/item/bikehorn(M), SLOT_HUD_LEFT_POCKET)
				M.equip_to_slot_or_del(sword, SLOT_HUD_RIGHT_HAND)

			if("killer")
				M.equip_to_slot_or_del(new /obj/item/clothing/under/misc/overalls(M), SLOT_HUD_ICLOTHING)
				M.equip_to_slot_or_del(new /obj/item/clothing/shoes/white(M), SLOT_HUD_FEET)
				M.equip_to_slot_or_del(new /obj/item/clothing/gloves/color/latex(M), SLOT_HUD_GLOVES)
				M.equip_to_slot_or_del(new /obj/item/clothing/mask/surgical(M), SLOT_HUD_MASK)
				M.equip_to_slot_or_del(new /obj/item/clothing/head/welding(M), SLOT_HUD_HEAD)
				M.equip_to_slot_or_del(new /obj/item/radio/headset(M), SLOT_HUD_LEFT_EAR)
				M.equip_to_slot_or_del(new /obj/item/clothing/suit/apron(M), SLOT_HUD_OCLOTHING)
				M.equip_to_slot_or_del(new /obj/item/kitchen/knife(M), SLOT_HUD_LEFT_POCKET)
				M.equip_to_slot_or_del(new /obj/item/scalpel(M), SLOT_HUD_RIGHT_POCKET)
				M.equip_to_slot_or_del(sword, SLOT_HUD_RIGHT_HAND)
			...
			if("pirate")
				M.equip_to_slot_or_del(new /obj/item/clothing/under/costume/pirate(M), SLOT_HUD_ICLOTHING)
				M.equip_to_slot_or_del(new /obj/item/clothing/shoes/brown(M), SLOT_HUD_FEET)
				M.equip_to_slot_or_del(new /obj/item/clothing/head/bandana(M), SLOT_HUD_HEAD)
				M.equip_to_slot_or_del(new /obj/item/clothing/glasses/eyepatch(M), SLOT_HUD_EYES)
				M.equip_to_slot_or_del(new /obj/item/radio/headset(M), SLOT_HUD_LEFT_EAR)
				M.equip_to_slot_or_del(sword, SLOT_HUD_RIGHT_HAND)
			...
			if("soviet")
				...
				M.equip_to_slot_or_del(new /obj/item/clothing/gloves/combat(M), SLOT_HUD_GLOVES)
				M.equip_to_slot_or_del(new /obj/item/radio/headset(M), SLOT_HUD_LEFT_EAR)
				M.equip_to_slot_or_del(new /obj/item/clothing/suit/sovietcoat(M), SLOT_HUD_OCLOTHING)
				M.equip_to_slot_or_del(new /obj/item/clothing/under/new_soviet/sovietofficer(M), SLOT_HUD_ICLOTHING)
				M.equip_to_slot_or_del(sword, SLOT_HUD_RIGHT_HAND)
			...
			if("officer")
				...
				M.equip_to_slot_or_del(new /obj/item/clothing/shoes/combat(M), SLOT_HUD_FEET)
				M.equip_to_slot_or_del(new /obj/item/clothing/gloves/combat(M), SLOT_HUD_GLOVES)
				M.equip_to_slot_or_del(new /obj/item/clothing/mask/cigarette/cigar/havana(M), SLOT_HUD_MASK)
				M.equip_to_slot_or_del(new /obj/item/radio/headset(M), SLOT_HUD_LEFT_EAR)
				M.equip_to_slot_or_del(new /obj/item/clothing/suit/jacket/miljacket(M), SLOT_HUD_OCLOTHING)
				M.equip_to_slot_or_del(new /obj/item/clothing/under/syndicate(M), SLOT_HUD_ICLOTHING)
				M.equip_to_slot_or_del(new /obj/item/clothing/glasses/eyepatch(M), SLOT_HUD_EYES)
				M.equip_to_slot_or_del(sword, SLOT_HUD_RIGHT_HAND)
			...
			if("gladiator")
				...
				M.equip_to_slot_or_del(new /obj/item/clothing/under/costume/gladiator(M), SLOT_HUD_ICLOTHING)
				M.equip_to_slot_or_del(new /obj/item/radio/headset(M), SLOT_HUD_LEFT_EAR)
				M.equip_to_slot_or_del(new /obj/item/clothing/shoes/sandal(M), SLOT_HUD_FEET)
				M.equip_to_slot_or_del(sword, SLOT_HUD_RIGHT_HAND)
	...
	if(duplicate_self)
		var/duplicated_access = usr.get_item_by_slot(SLOT_HUD_ID)
	...
	W.SetOwnerInfo(M)
	M.equip_to_slot_or_del(W, SLOT_HUD_ID)
...
/obj/item/necromantic_stone/proc/equip_skeleton(mob/living/carbon/human/victim)
	...
	switch(skeleton_type)
		if("roman")
			...
			victim.equip_to_slot_or_del(new /obj/item/clothing/under/costume/roman(victim), SLOT_HUD_ICLOTHING)
			victim.equip_to_slot_or_del(new /obj/item/clothing/shoes/roman(victim), SLOT_HUD_FEET)
		...
		if("pirate")
			victim.equip_to_slot_or_del(new /obj/item/clothing/under/costume/pirate(victim), SLOT_HUD_ICLOTHING)
			victim.equip_to_slot_or_del(new /obj/item/clothing/suit/pirate_brown(victim),  SLOT_HUD_OCLOTHING)
			victim.equip_to_slot_or_del(new /obj/item/clothing/head/bandana(victim), SLOT_HUD_HEAD)
			victim.equip_to_slot_or_del(new /obj/item/clothing/shoes/sandal(victim), SLOT_HUD_FEET)
			victim.equip_to_slot_or_del(new /obj/item/clothing/glasses/eyepatch(victim), SLOT_HUD_EYES)
			victim.equip_to_slot_or_del(new /obj/item/claymore(victim), SLOT_HUD_RIGHT_HAND)
			victim.equip_to_slot_or_del(new /obj/item/spear(victim), SLOT_HUD_BACK)
			victim.equip_to_slot_or_del(new /obj/item/shield/riot/roman(victim), SLOT_HUD_LEFT_HAND)
		if("yand")//mine is an evil laugh
			...
			victim.equip_to_slot_or_del(new /obj/item/clothing/under/dress/schoolgirl(victim), SLOT_HUD_ICLOTHING)
			victim.equip_to_slot_or_del(new /obj/item/clothing/suit/armor/vest(victim),  SLOT_HUD_OCLOTHING)
			victim.equip_to_slot_or_del(new /obj/item/katana(victim), SLOT_HUD_RIGHT_HAND)
			victim.equip_to_slot_or_del(new /obj/item/shield/riot/roman(victim), SLOT_HUD_LEFT_HAND)
			victim.equip_to_slot_or_del(new /obj/item/spear(victim), SLOT_HUD_BACK)
		if("clown")
			victim.equip_to_slot_or_del(new /obj/item/clothing/under/rank/civilian/clown(victim), SLOT_HUD_ICLOTHING)
			victim.equip_to_slot_or_del(new /obj/item/clothing/shoes/clown_shoes(victim), SLOT_HUD_FEET)
			victim.equip_to_slot_or_del(new /obj/item/clothing/mask/gas/clown_hat(victim), SLOT_HUD_MASK)
			victim.equip_to_slot_or_del(new /obj/item/clothing/head/stalhelm(victim), SLOT_HUD_HEAD)
			victim.equip_to_slot_or_del(new /obj/item/bikehorn(victim), SLOT_HUD_LEFT_POCKET)
			victim.equip_to_slot_or_del(new /obj/item/claymore(victim), SLOT_HUD_RIGHT_HAND)
			victim.equip_to_slot_or_del(new /obj/item/shield/riot/roman(victim), SLOT_HUD_LEFT_HAND)
			victim.equip_to_slot_or_del(new /obj/item/spear(victim), SLOT_HUD_BACK)
