...
/obj/item/multisword/proc/equip_copy(mob/living/carbon/human/M)
	...
	if(duplicate_self)
		...
		var/obj/uniform = H.get_item_by_slot(ITEM_SLOT_ICLOTHING)
		if(uniform)
			M.equip_to_slot_or_del(new uniform.type(M), ITEM_SLOT_ICLOTHING)

		var/obj/suit = H.get_item_by_slot(ITEM_SLOT_OCLOTHING)
		if(suit)
			M.equip_to_slot_or_del(new suit.type(M), ITEM_SLOT_OCLOTHING)
		...
		switch(randomize)
			if("mobster")
				...
				M.equip_to_slot_or_del(new /obj/item/clothing/under/suit/really_black(M), ITEM_SLOT_ICLOTHING)
				M.equip_to_slot_or_del(sword, ITEM_SLOT_RIGHT_HAND)

			if("roman")
				var/hat = pick(/obj/item/clothing/head/helmet/roman, /obj/item/clothing/head/helmet/roman/legionaire)
				M.equip_to_slot_or_del(new hat(M), ITEM_SLOT_HEAD)
				M.equip_to_slot_or_del(new /obj/item/clothing/under/costume/roman(M), ITEM_SLOT_ICLOTHING)
			...
			if("wizard")
				M.equip_to_slot_or_del(new /obj/item/clothing/under/color/lightpurple(M), ITEM_SLOT_ICLOTHING)
				M.equip_to_slot_or_del(new /obj/item/clothing/suit/wizrobe/red(M), ITEM_SLOT_OCLOTHING)
			...
			if("syndicate")
				M.equip_to_slot_or_del(new /obj/item/clothing/under/syndicate(M), ITEM_SLOT_ICLOTHING)
				...
				M.equip_to_slot_or_del(new /obj/item/radio/headset(M), ITEM_SLOT_LEFT_EAR)
				M.equip_to_slot_or_del(new /obj/item/clothing/suit/armor/vest(M), ITEM_SLOT_OCLOTHING)
				M.equip_to_slot_or_del(new /obj/item/clothing/mask/gas(M),ITEM_SLOT_MASK)
				M.equip_to_slot_or_del(sword, ITEM_SLOT_RIGHT_HAND)

			if("assistant")
				M.equip_to_slot_or_del(new /obj/item/clothing/under/color/grey(M), ITEM_SLOT_ICLOTHING)
				M.equip_to_slot_or_del(new /obj/item/radio/headset(M), ITEM_SLOT_LEFT_EAR)
			...
			if("animu")
				...
				M.equip_to_slot_or_del(new /obj/item/clothing/under/dress/schoolgirl(M), ITEM_SLOT_ICLOTHING)
				M.equip_to_slot_or_del(sword, ITEM_SLOT_RIGHT_HAND)

			if("cultist")
				M.equip_to_slot_or_del(new /obj/item/clothing/suit/hooded/cultrobes/alt(M), ITEM_SLOT_OCLOTHING)
				M.equip_to_slot_or_del(new /obj/item/clothing/shoes/cult(M), ITEM_SLOT_FEET)
				M.equip_to_slot_or_del(new /obj/item/radio/headset(M), ITEM_SLOT_LEFT_EAR)
				M.equip_to_slot_or_del(sword, ITEM_SLOT_RIGHT_HAND)

			if("highlander")
				M.equip_to_slot_or_del(new /obj/item/clothing/under/costume/kilt(M), ITEM_SLOT_ICLOTHING)
				M.equip_to_slot_or_del(new /obj/item/radio/headset(M), ITEM_SLOT_LEFT_EAR)
			...
			if("clown")
				M.equip_to_slot_or_del(new /obj/item/clothing/under/rank/civilian/clown(M), ITEM_SLOT_ICLOTHING)
				M.equip_to_slot_or_del(new /obj/item/radio/headset(M), ITEM_SLOT_LEFT_EAR)
			...
			if("killer")
				M.equip_to_slot_or_del(new /obj/item/clothing/under/misc/overalls(M), ITEM_SLOT_ICLOTHING)
				...
				M.equip_to_slot_or_del(new /obj/item/radio/headset(M), ITEM_SLOT_LEFT_EAR)
				M.equip_to_slot_or_del(new /obj/item/clothing/suit/apron(M), ITEM_SLOT_OCLOTHING)
			...
			if("pirate")
				M.equip_to_slot_or_del(new /obj/item/clothing/under/costume/pirate(M), ITEM_SLOT_ICLOTHING)
			...
			if("soviet")
				...
				M.equip_to_slot_or_del(new /obj/item/clothing/gloves/combat(M), ITEM_SLOT_GLOVES)
				M.equip_to_slot_or_del(new /obj/item/radio/headset(M), ITEM_SLOT_LEFT_EAR)
				M.equip_to_slot_or_del(new /obj/item/clothing/suit/sovietcoat(M), ITEM_SLOT_OCLOTHING)
				M.equip_to_slot_or_del(new /obj/item/clothing/under/new_soviet/sovietofficer(M), ITEM_SLOT_ICLOTHING)
				M.equip_to_slot_or_del(sword, ITEM_SLOT_RIGHT_HAND)
			...
			if("officer")
				...
				M.equip_to_slot_or_del(new /obj/item/radio/headset(M), ITEM_SLOT_LEFT_EAR)
				M.equip_to_slot_or_del(new /obj/item/clothing/suit/jacket/miljacket(M), ITEM_SLOT_OCLOTHING)
				M.equip_to_slot_or_del(new /obj/item/clothing/under/syndicate(M), ITEM_SLOT_ICLOTHING)
				M.equip_to_slot_or_del(new /obj/item/clothing/glasses/eyepatch(M), ITEM_SLOT_EYES)
				M.equip_to_slot_or_del(sword, ITEM_SLOT_RIGHT_HAND)
			...
			if("gladiator")
				...
				M.equip_to_slot_or_del(new /obj/item/clothing/under/costume/gladiator(M), ITEM_SLOT_ICLOTHING)
				M.equip_to_slot_or_del(new /obj/item/radio/headset(M), ITEM_SLOT_LEFT_EAR)
				M.equip_to_slot_or_del(new /obj/item/clothing/shoes/sandal(M), ITEM_SLOT_FEET)
				M.equip_to_slot_or_del(sword, ITEM_SLOT_RIGHT_HAND)
...
/obj/item/necromantic_stone/proc/equip_skeleton(mob/living/carbon/human/victim)
	...
	switch(skeleton_type)
		...
		if("pirate")
			victim.equip_to_slot_or_del(new /obj/item/clothing/under/costume/pirate(victim), ITEM_SLOT_ICLOTHING)
			victim.equip_to_slot_or_del(new /obj/item/clothing/suit/pirate_brown(victim),  ITEM_SLOT_OCLOTHING)
			victim.equip_to_slot_or_del(new /obj/item/clothing/head/bandana(victim), ITEM_SLOT_HEAD)
			victim.equip_to_slot_or_del(new /obj/item/clothing/shoes/sandal(victim), ITEM_SLOT_FEET)
		...
		if("yand")//mine is an evil laugh
			...
			victim.equip_to_slot_or_del(new /obj/item/clothing/under/dress/schoolgirl(victim), ITEM_SLOT_ICLOTHING)
			victim.equip_to_slot_or_del(new /obj/item/clothing/suit/armor/vest(victim),  ITEM_SLOT_OCLOTHING)
			victim.equip_to_slot_or_del(new /obj/item/katana(victim), ITEM_SLOT_RIGHT_HAND)
			victim.equip_to_slot_or_del(new /obj/item/shield/riot/roman(victim), ITEM_SLOT_LEFT_HAND)
			victim.equip_to_slot_or_del(new /obj/item/spear(victim), ITEM_SLOT_BACK)
		if("clown")
			victim.equip_to_slot_or_del(new /obj/item/clothing/under/rank/civilian/clown(victim), ITEM_SLOT_ICLOTHING)
			victim.equip_to_slot_or_del(new /obj/item/clothing/shoes/clown_shoes(victim), ITEM_SLOT_FEET)
