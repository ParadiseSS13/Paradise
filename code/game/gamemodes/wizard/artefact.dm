		...
		if(href_list["school"])
			...
			if(candidates.len)
				...
				switch(href_list["school"])
					if("destruction")
						M.spell_list += new /obj/effect/proc_holder/spell/targeted/projectile/wizard/magic_missile(M)
						M.spell_list += new /obj/effect/proc_holder/spell/dumbfire/wizard/fireball(M)
					...
					if("bluespace")
						M.spell_list += new /obj/effect/proc_holder/spell/targeted/area_teleport/wizard/teleport(M)
						M.spell_list += new /obj/effect/proc_holder/spell/targeted/wizard/ethereal_jaunt(M)
					...
					if("healing")
						M.spell_list += new /obj/effect/proc_holder/spell/targeted/wizard/charge(M)
						M.spell_list += new /obj/effect/proc_holder/spell/aoe_turf/conjure/wizard/forcewall(M)
					...
					if("robeless")
						M.spell_list += new /obj/effect/proc_holder/spell/aoe_turf/wizard/knock(M)
						M.spell_list += new /obj/effect/proc_holder/spell/targeted/wizard/mind_transfer(M)
