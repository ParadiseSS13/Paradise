	...
	if(length(candidates))
		...
		switch(action)
			if("fire")
				...
				to_chat(M, "<B>Your service has not gone unrewarded, however. Studying under [H.real_name], you have learned direct combat magic. You are able to cast Fireball and Ethereal Jaunt.")
			if("earth")
				M.mind.AddSpell(new /obj/effect/proc_holder/spell/touch/flesh_to_stone/apprentice(null))
				M.mind.AddSpell(new /obj/effect/proc_holder/spell/ethereal_jaunt(null))
				M.equip_to_slot_or_del(new /obj/item/clothing/shoes/sandal(M), SLOT_HUD_SHOES)
				...
				to_chat(M, "<B>Your service has not gone unrewarded, however. Studying under [H.real_name], you have learned matter manipulation. You are able to cast Flesh to Stone and Ethereal Jaunt.")
			if("bluespace")
				...
				M.equip_to_slot_or_del(new /obj/item/clothing/suit/wizrobe(M), SLOT_HUD_OUTER_SUIT)
				M.equip_to_slot_or_del(new /obj/item/clothing/head/wizard(M), SLOT_HUD_HEAD)
				to_chat(M, "<B>Your service has not gone unrewarded, however. Studying under [H.real_name], you have learned reality bending mobility spells. You are able to cast Blink and Ethereal Jaunt.")
			if("honk")
				...
				to_chat(M, "<B>Your service has not gone unrewarded, honkever. Studying under [H.real_name], you have learned the art of magical honkings. You are able to cast Banana Touch, Ethereal Jaunt, Instant Summons and carry a Staff of Slipping.")
