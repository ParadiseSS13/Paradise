...
/obj/item/contract/proc/equip_apprentice(action, mob/living/carbon/human/M, mob/living/carbon/human/H)
	...
	switch(action)
		if("fire")
			M.mind.AddSpell(new /datum/spell/fireball/apprentice(null))
			M.mind.AddSpell(new  /datum/spell/sacred_flame(null))
			ADD_TRAIT(M, TRAIT_RESISTHEAT, MAGIC_TRAIT)
			ADD_TRAIT(M, TRAIT_RESISTHIGHPRESSURE, MAGIC_TRAIT)
			M.mind.AddSpell(new /datum/spell/ethereal_jaunt(null))
		...
		if("translocation")
			M.mind.AddSpell(new /datum/spell/area_teleport/teleport(null))
			M.mind.AddSpell(new /datum/spell/turf_teleport/blink(null))
			M.mind.AddSpell(new /datum/spell/ethereal_jaunt(null))
			M.equip_to_slot_or_del(new /obj/item/clothing/shoes/sandal(M), SLOT_HUD_SHOES)
		...
		if("restoration")
			M.mind.AddSpell(new /datum/spell/charge(null))
			M.mind.AddSpell(new /datum/spell/aoe/knock(null))
		...
		if("stealth")
			M.mind.AddSpell(new /datum/spell/mind_transfer(null))
			M.mind.AddSpell(new /datum/spell/aoe/knock(null))
			M.mind.AddSpell(new /datum/spell/fireball/toolbox(null))
			M.mind.AddSpell(new /datum/spell/disguise_self(null))
		...
		if("honk")
			M.mind.AddSpell(new /datum/spell/touch/banana/apprentice(null))
			M.mind.AddSpell(new /datum/spell/ethereal_jaunt(null))
			M.mind.AddSpell(new /datum/spell/summonitem(null))
