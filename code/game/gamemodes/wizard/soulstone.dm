...
/mob/living/simple_animal/hostile/construct/proc/init_construct(mob/living/simple_animal/shade/shade, obj/item/soulstone/SS, obj/structure/constructshell/shell)
	...
	if(SS.purified)
		...
		if(is_type_in_list(/obj/effect/proc_holder/spell/aoe/turf/conjure/build/soulstone, mob_spell_list))
			RemoveSpell(/obj/effect/proc_holder/spell/aoe/turf/conjure/build/soulstone)
			AddSpell(new /obj/effect/proc_holder/spell/aoe/turf/conjure/build/soulstone/holy)
