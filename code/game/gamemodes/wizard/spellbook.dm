				...
				if(!already_knows)
					switch(href_list["spell_choice"])
						...
						if("magicmissile")
							...
							H.spell_list += new /obj/effect/proc_holder/spell/targeted/projectile/wizard/magic_missile(H)
							temp = "You have learned magic missile."
						if("fireball")
							feedback_add_details("wizard_spell_learned","FB") //please do not change the abbreviation to keep data processing consistent. Add a unique id to any new spells
							H.spell_list += new /obj/effect/proc_holder/spell/dumbfire/wizard/fireball(H)
						...
						if("disintegrate")
							...
							H.spell_list += new /obj/effect/proc_holder/spell/targeted/inflict_handler/wizard/disintegrate(H)
							temp = "You have learned disintegrate."
						if("disabletech")
							feedback_add_details("wizard_spell_learned","DT") //please do not change the abbreviation to keep data processing consistent. Add a unique id to any new spells
							H.spell_list += new /obj/effect/proc_holder/spell/targeted/emplosion/wizard/disable_tech(H)
							temp = "You have learned disable technology."
						if("smoke")
							feedback_add_details("wizard_spell_learned","SM") //please do not change the abbreviation to keep data processing consistent. Add a unique id to any new spells
							H.spell_list += new /obj/effect/proc_holder/spell/targeted/wizard/smoke(H)
						...
						if("blind")
							...
							H.spell_list += new /obj/effect/proc_holder/spell/targeted/trigger/wizard/blind(H)
							temp = "You have learned blind."
						if("mindswap")
							feedback_add_details("wizard_spell_learned","MT") //please do not change the abbreviation to keep data processing consistent. Add a unique id to any new spells
							H.spell_list += new /obj/effect/proc_holder/spell/targeted/wizard/mind_transfer(H)
							temp = "You have learned mindswap."
						if("forcewall")
							feedback_add_details("wizard_spell_learned","FW") //please do not change the abbreviation to keep data processing consistent. Add a unique id to any new spells
							H.spell_list += new /obj/effect/proc_holder/spell/aoe_turf/conjure/wizard/forcewall(H)
						...
						if("blink")
							...
							H.spell_list += new /obj/effect/proc_holder/spell/targeted/turf_teleport/wizard/blink(H)
						...
						if("teleport")
							...
							H.spell_list += new /obj/effect/proc_holder/spell/targeted/area_teleport/wizard/teleport(H)
						...
						if("mutate")
							...
							H.spell_list += new /obj/effect/proc_holder/spell/targeted/genetic/wizard/mutate(H)
						...
						if("etherealjaunt")
							...
							H.spell_list += new /obj/effect/proc_holder/spell/targeted/wizard/ethereal_jaunt(H)
						...
						if("knock")
							...
							H.spell_list += new /obj/effect/proc_holder/spell/aoe_turf/wizard/knock(H)
							temp = "You have learned knock."
						if("horseman")
							feedback_add_details("wizard_spell_learned","HH") //please do not change the abbreviation to keep data processing consistent. Add a unique id to any new spells
							H.spell_list += new /obj/effect/proc_holder/spell/targeted/wizard/horsemask(H)
						...
						if("fleshtostone")
							...
							H.spell_list += new /obj/effect/proc_holder/spell/targeted/inflict_handler/wizard/flesh_to_stone(H)
						...
						if("soulstone")
							...
							H.spell_list += new /obj/effect/proc_holder/spell/aoe_turf/conjure/wizard/construct(H)
...
/obj/item/weapon/spellbook/oneuse/fireball
	spell = /obj/effect/proc_holder/spell/dumbfire/wizard/fireball
	spellname = "fireball"
...
/obj/item/weapon/spellbook/oneuse/smoke
	spell = /obj/effect/proc_holder/spell/targeted/wizard/smoke
	spellname = "smoke"
...
/obj/item/weapon/spellbook/oneuse/blind
	spell = /obj/effect/proc_holder/spell/targeted/trigger/wizard/blind
	spellname = "blind"
...
/obj/item/weapon/spellbook/oneuse/mindswap
	spell = /obj/effect/proc_holder/spell/targeted/wizard/mind_transfer
	spellname = "mindswap"
...
/obj/item/weapon/spellbook/oneuse/forcewall
	spell = /obj/effect/proc_holder/spell/aoe_turf/conjure/wizard/forcewall
	spellname = "forcewall"
...
/obj/item/weapon/spellbook/oneuse/knock
	spell = /obj/effect/proc_holder/spell/aoe_turf/wizard/knock
	spellname = "knock"
...
/obj/item/weapon/spellbook/oneuse/horsemask
	spell = /obj/effect/proc_holder/spell/targeted/wizard/horsemask
	spellname = "horses"
...
/obj/item/weapon/spellbook/oneuse/charge
	spell = /obj/effect/proc_holder/spell/targeted/wizard/charge
	spellname = "charging"
