...
/datum/spellbook_entry/summon/guns
	name = "Summon Guns"
	category = "Challenges"
	desc = "Nothing could possibly go wrong with arming a crew of lunatics just itching for an excuse to kill you. Just be careful not to stand still too long! Summoned guns will disappear shortly after your death."
	cost = 0
	log_name = "SG"
...
/datum/spellbook_entry/summon/magic
	name = "Summon Magic"
	category = "Challenges"
	desc = "Share the wonders of magic with the crew and show them why they aren't to be trusted with it at the same time. Summoned items will disappear shortly after your death."
	cost = 0
	log_name = "SU"
...
/obj/item/spellbook/proc/GetCategoryHeader(var/category)
	...
	switch(category)
		...
		if("Challenges")
			...
			dat += "Not recommended for new wizards!<BR>"
		if("Rituals")
