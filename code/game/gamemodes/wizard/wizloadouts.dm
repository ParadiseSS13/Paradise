...
/datum/spellbook_entry/loadout/gunreaper
	...
	desc = "Cloned over and over, the souls aboard this station yearn for a deserved rest.<br> \
		...
		</i>Provides a .357 Revolver, 6 speedloaders of ammo, Reaper's Lighter, Smoke, Knock, Greater Forcewall, Summon Item, No Clothes, and Bind Soul, with a unique armored coat.<i>"
	log_name = "GR"
	...
	spells_path = list(/obj/effect/proc_holder/spell/reaper_lighter, /obj/effect/proc_holder/spell/smoke, /obj/effect/proc_holder/spell/aoe_turf/knock, /obj/effect/proc_holder/spell/forcewall/greater, \
