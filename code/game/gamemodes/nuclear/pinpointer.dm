...
obj
	item
		weapon
			pinpointer
				proc
					point_at(atom/target, spawnself = 1)
						if(!active)
							return
						if(!target)
		...
		weapon
			pinpointer
				advpinpointer
					...
					var
						mode = 0  // Mode 0 locates disk, mode 1 locates coordinates.
					var
						turf
							location = null
					var
						...
						toggle_mode()
							...
							switch(alert("Please select the mode you want to put the pinpointer in.", "Pinpointer Mode Select", "Location", "Disk Recovery", "Other Signature"))
								if("Location")
									...
									var
										locationx = input(usr, "Please input the x coordinate to search for.", "Location?" , "") as num
									if(!locationx || !(usr in view(1,src)))
										return
									var
										locationy = input(usr, "Please input the y coordinate to search for.", "Location?" , "") as num
								...
								if("Other Signature")
									...
									switch(alert("Search for item signature or DNA fragment?" , "Signature Mode Select" , "Item" , "DNA"))
										if("Item")
											...
											var
												targetitem = input("Select item to search for.", "Item Mode Select","") as null|anything in item_names
											if(!targetitem)
												return
										...
										if("DNA")
											var
												DNAstring = input("Input DNA string to search for." , "Please Enter String." , "")
											if(!DNAstring)
												return
	...
	item
		weapon
			pinpointer
				nukeop
					var
						mode = 0	//Mode 0 locates disk, mode 1 locates the shuttle
					var
						obj
							docking_port
								mobile
