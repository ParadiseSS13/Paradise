...
/datum/game_mode/nuclear/declare_completion()
	...
	if(!disk_rescued && station_was_nuked && !syndies_didnt_escape)
		ticker.mode_result = "nuclear win - syndicate nuke"
		...
		ticker.mode_result = "nuclear halfwin - syndicate nuke - did not evacuate in time"
		...
		ticker.mode_result = "nuclear halfwin - blew wrong station"
		...
		ticker.mode_result = "nuclear halfwin - blew wrong station - did not evacuate in time"
		...
		ticker.mode_result = "nuclear loss - evacuation - disk secured - syndi team dead"
		...
		ticker.mode_result = "nuclear loss - evacuation - disk secured"
		to_chat(world, "<FONT size = 3><B>Crew Major Victory</B></FONT>")
		to_chat(world, "<B>The Research Staff has saved the disc and stopped the [syndicate_name()] Operatives!</B>")

	else if(!disk_rescued && is_operatives_are_dead())
		ticker.mode_result = "nuclear loss - evacuation - disk not secured"
		...
		ticker.mode_result = "nuclear halfwin - detonation averted"
		to_chat(world, "<FONT size = 3><B>Syndicate Minor Victory!</B></FONT>")
		...
		ticker.mode_result = "nuclear halfwin - interrupted"
