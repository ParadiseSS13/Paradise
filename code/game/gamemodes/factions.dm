...
/datum/faction/Wizard
	...
	desc = "The <b>Wizards Federation</b> is a mysterious organization of magically-talented individuals who act as an equal collective, and have no hierarchy. It is unknown how the wizards \
