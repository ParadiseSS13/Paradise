					...
					shield
						sting_action(var/mob/user)
							var
								datum
									changeling
										changeling = user.mind.changeling //So we can read the absorbedcount.
							if(!changeling)
								return
		...
		weapon
			shield
				changeling
					...
					var
						remaining_uses //Set by the changeling ability.
