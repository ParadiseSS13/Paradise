	...
	effect
		proc_holder
			changeling
				sting
					extract_dna
						sting_action(var/mob/user, var/mob/living/carbon/human/target)
	...
	effect
		proc_holder
			changeling
				sting
					mute
						sting_action(var/mob/user, var/mob/living/carbon/target)
