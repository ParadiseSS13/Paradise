...
/datum/game_mode/changeling
	...
	protected_jobs = list("Security Officer", "Warden", "Detective", "Head of Security", "Captain", "Blueshield", "Nanotrasen Representative", "Security Pod Pilot", "Magistrate", "Brig Physician", "Nanotrasen Navy Officer", "Special Operations Officer")
