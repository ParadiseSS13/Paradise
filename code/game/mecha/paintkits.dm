	...
	item
		weapon
			paintkit //Please don't use this for anything, it's a base type for custom mech paintjobs.
				...
				var
					new_name = "mech"    //What is the variant called?
				var
					new_desc = "A mech." //How is the new mech described?
				var
					new_icon = "ripley"  //What base icon will the new mech use?
				var
					removable = null     //Can the kit be removed?
				var
					list
						allowed_types = list() //Types of mech that the kit will work on.
