...
/obj/item/mecha_parts/mecha_equipment/cable_layer
	...
	var/obj/structure/cable/low_voltage/last_piece
	var/obj/item/stack/cable_coil/low_voltage/cable
	var/max_cable = 1000
...
/obj/item/mecha_parts/mecha_equipment/cable_layer/proc/layCable(obj/mecha/M, atom/OldLoc, Dir, Forced = FALSE)
	...
	for(var/obj/structure/cable/low_voltage/LC in new_turf)		// check to make sure there's not a cable there already
		if(LC.d1 == fdirn || LC.d2 == fdirn)
			return reset()
	if(!use_cable(1))
		return reset()
	var/obj/structure/cable/low_voltage/NC = new(new_turf)
	NC.cable_color("red")
	NC.d1 = NO_DIRECTION
	NC.d2 = fdirn
	NC.update_icon()
