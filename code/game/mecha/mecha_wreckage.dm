	...
	effect
		decal
			mecha_wreckage
				...
				var
					list
						welder_salvage = list(/obj/item/stack/sheet/plasteel,/obj/item/stack/sheet/metal,/obj/item/stack/rods)
				var
					list
						wirecutters_salvage = list(/obj/item/stack/cable_coil)
				var
					list
						crowbar_salvage
				var
					...
					if(istype(W, /obj/item/weapon/weldingtool))
						...
						if(salvage_num <= 0)
								...
								var
									obj
										item
											stack
												rods
													rods = new /obj/item/stack/rods(src.loc)
								rods.amount = 2
								qdel(src)
						else
							if(isemptylist(welder_salvage))
								...
								var
									type = prob(70)?pick(welder_salvage):null
								if(type)
									var
										N = new type(get_turf(user))
						...
						if(salvage_num <= 0)
							...
							var
								type = prob(70)?pick(wirecutters_salvage):null
							if(type)
								var
									N = new type(get_turf(user))
			...
			mecha_wreckage
				gygax
					...
					New()
						...
						var
							list
								parts = list(/obj/item/mecha_parts/part/gygax_torso,
															obj
																item
																	mecha_parts
																		part
