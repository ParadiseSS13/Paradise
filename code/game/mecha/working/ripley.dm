						...
						var
							obj
								item
									mecha_parts
										mecha_equipment
											ME = new /obj/item/mecha_parts/mecha_equipment/tool/safety_clamp
						ME.attach(src)
						return
									...
									item
										mecha_parts
											mecha_equipment
												tool
													drill
														D = new /obj/item/mecha_parts/mecha_equipment/tool/drill
							D.attach(src)
							...
							var
								obj
									item
										mecha_parts
											mecha_equipment
												M = new /obj/item/mecha_parts/mecha_equipment/weapon/energy/plasma
							M.attach(src)
								...
								item
									mecha_parts
										mecha_equipment
											tool
												hydraulic_clamp
													HC = new /obj/item/mecha_parts/mecha_equipment/tool/hydraulic_clamp
						HC.attach(src)
								...
								item
									mecha_parts
										mecha_equipment
											tool
												mining_scanner
													scanner = new /obj/item/mecha_parts/mecha_equipment/tool/mining_scanner
						scanner.attach(src)
			...
			ripley
				Topic(href, href_list)
					...
					if(href_list["drop_from_cargo"])
						var
							obj
								O = locate(href_list["drop_from_cargo"])
						if(O && O in src.cargo)
