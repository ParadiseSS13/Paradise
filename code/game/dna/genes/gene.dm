...
datum
	dna
		gene
			...
			var
				desc="Oh god who knows what this does."
...
datum
	dna
		gene
			proc
				activate(var/mob/living/M, var/connected, var/flags)
...
datum
	dna
		gene
			proc
				deactivate(var/mob/living/M, var/connected, var/flags)
					M.gene_stability += instability
					return
			...
			basic
				deactivate(var/mob/M)
					...
					if(deactivation_messages.len)
						var
							msg = pick(deactivation_messages)
