...
datum
	dna
		gene
			monkey
				activate(var/mob/living/carbon/human/H, var/connected, var/flags)
					...
					var
						atom
							movable
								overlay
									animation = new /atom/movable/overlay(H.loc)
...
datum
	dna
		gene
			monkey
				deactivate(var/mob/living/carbon/human/H, var/connected, var/flags)
					if(!istype(H,/mob/living/carbon/human))
						return
					for(var/obj/item/W in H)
