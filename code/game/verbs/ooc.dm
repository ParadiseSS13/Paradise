...
/client/proc/set_ooc(newColor as color)
	...
	feedback_report("admin_verb","SOOC")
...
/client/proc/reset_ooc()
	...
	feedback_report("admin_verb","ROOC")
...
/client/proc/colorooc()
	...
	feedback_report("admin_verb","OC") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/resetcolorooc()
	...
	feedback_report("admin_verb","ROC") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
