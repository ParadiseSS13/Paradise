/atom/movable
	...
	var/list/contents_mobs = list() // This list is maintained by /mob/proc/update_movable_container(), called by /mob/proc/Life()
...
/atom/movable/Move(atom/newloc, direct = 0)
	...
	for(var/mob/M in contents_mobs)
		if(M.hud_used)
...
/atom/movable/proc/forceMove(atom/destination)
	...
	for(var/mob/M in contents_mobs) // Update parallax of contents
		if(M.hud_used)
			M.hud_used.update_parallax()
