		...
		data
			human
				medical
					basic
						proc
							check_sensors(mob/living/carbon/human/H)
	...
	atom_hud
		data
			human
				medical
					basic
						add_to_single_hud(mob/M, mob/living/carbon/H)
		...
		data
			human
				medical
					basic
						proc
							update_suit_sensors(mob/living/carbon/H)
			...
			robot
				proc
					diag_hud_set_borgcell()
						var
							image
								holder = hud_list[DIAG_BATT_HUD]
						if(cell)
							var
								chargelvl = (cell.charge/cell.maxcharge)
...
mob
	living
		simple_animal
			bot
				proc
					diag_hud_set_botstat() //On (With wireless on or off), Off, EMP'ed
						var
							image
								holder = hud_list[DIAG_STAT_HUD]
						if(on)
...
mob
	living
		simple_animal
			bot
				proc
					diag_hud_set_botmode() //Shows a bot's current operation
						var
							image
								holder = hud_list[DIAG_BOT_HUD]
