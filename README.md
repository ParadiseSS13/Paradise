...
[Website](http://ntdsf13.boards.net/) - [Code](https://github.com/StratusSS13/Stratus) - [Discord](https://discord.gg/EbGYM7T)
...
Click [here](https://github.com/StratusSS13/Stratus/archive/master.zip) to get the latest code as a .zip file, then unzip it to wherever you want.
...
Open stratus.dme by double-clicking it, open the Build menu, and click compile.  
...
run Dream Daemon and enter the path to your compiled stratus.dmb file.  
...
and the SQL schema is in /SQL/stratus_schema.sql or /SQL/stratus_schema_prefix.sql,
...
Stratus is licensed under the GNU Affero General Public License version 3.
