/obj/item/clothing/suit/hooded/armor
	...
	icon = 'modular_hispania/icons/obj/clothing/suits.dmi'
	lefthand_file = 'modular_hispania/icons/mob/inhands/clothing_lefthand.dmi'
	righthand_file = 'modular_hispania/icons/mob/inhands/clothing_righthand.dmi'
	...
	sprite_sheets = list("Vox" = 'modular_hispania/icons/mob/species/vox/suit.dmi')
...
/obj/item/clothing/head/hooded/winterhood/security/warden
	...
	hispania_icon = TRUE
	sprite_sheets = list("Vox" = 'modular_hispania/icons/mob/species/vox/head.dmi')
